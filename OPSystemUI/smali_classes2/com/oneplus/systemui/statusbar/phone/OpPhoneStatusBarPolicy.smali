...
.method public constructor <init>(Landroid/content/Context;Lcom/android/systemui/statusbar/phone/StatusBarIconController;Landroid/content/SharedPreferences;)V
    ...
    iput-object p3, p0, Lcom/oneplus/systemui/statusbar/phone/OpPhoneStatusBarPolicy;->mSharedPreferences:Landroid/content/SharedPreferences;
    ...
    iget-object p3, p0, Lcom/oneplus/systemui/statusbar/phone/OpPhoneStatusBarPolicy;->mSettingObserver:Lcom/oneplus/systemui/statusbar/phone/OpPhoneStatusBarPolicy$SettingObserver;

    invoke-virtual {p1, p2, v0, p3, v2}, Landroid/content/ContentResolver;->registerContentObserver(Landroid/net/Uri;ZLandroid/database/ContentObserver;I)V
    ...
    iget-object p3, p0, Lcom/oneplus/systemui/statusbar/phone/OpPhoneStatusBarPolicy;->mContext:Landroid/content/Context;

    const-string v2, "pref_name_notify_shown"

    invoke-virtual {p3, v2, v0}, Landroid/content/Context;->getSharedPreferences(Ljava/lang/String;I)Landroid/content/SharedPreferences;

    move-result-object p3

    const-string v2, "pref_key_notify_shown"

    invoke-interface {p3, v2, v0}, Landroid/content/SharedPreferences;->getBoolean(Ljava/lang/String;Z)Z
    ...
    iput-object p3, p0, Lcom/oneplus/systemui/statusbar/phone/OpPhoneStatusBarPolicy;->mNotificationManager:Landroid/app/NotificationManager;
    ...
    const-string p3, "femtocell"

    iput-object p3, p0, Lcom/oneplus/systemui/statusbar/phone/OpPhoneStatusBarPolicy;->mSlotFemtoCell:Ljava/lang/String;

    const-string p3, "oneplus.intent.action.VZW_FEMTOCELL_STATE_CHANGED"

    invoke-virtual {p1, p3}, Landroid/content/IntentFilter;->addAction(Ljava/lang/String;)V

    const-string p3, "vice"

    iput-object p3, p0, Lcom/oneplus/systemui/statusbar/phone/OpPhoneStatusBarPolicy;->mSlotVice:Ljava/lang/String;

    const-string p3, "oneplus.intent.action.VZW_VICE_STATE_CHANGED"

    invoke-virtual {p1, p3}, Landroid/content/IntentFilter;->addAction(Ljava/lang/String;)V

    :cond_1
    const-string p3, "com.oem.intent.action.ACTION_USB_HEADSET_PLUG"
    ...
    invoke-virtual {p3, v2, p1, v1, v3}, Landroid/content/Context;->registerReceiver(Landroid/content/BroadcastReceiver;Landroid/content/IntentFilter;Ljava/lang/String;Landroid/os/Handler;)Landroid/content/Intent;
    ...
    sget p3, Lcom/android/systemui/R$drawable;->stat_sys_nfc:I

    const-string v2, "nfc"

    invoke-interface {p1, v2, p3, v1}, Lcom/android/systemui/statusbar/phone/StatusBarIconController;->setIcon(Ljava/lang/String;ILjava/lang/CharSequence;)V
    ...
    iget-object p3, p0, Lcom/oneplus/systemui/statusbar/phone/OpPhoneStatusBarPolicy;->mIconController:Lcom/android/systemui/statusbar/phone/StatusBarIconController;
    ...
    :goto_0
    invoke-interface {p3, v2, p2}, Lcom/android/systemui/statusbar/phone/StatusBarIconController;->setIconVisibility(Ljava/lang/String;Z)V
    :try_end_0
    ...
    const-string p3, "Fail to get Nfc adapter "
...
.method protected updateVolumeZen(I)Lcom/oneplus/systemui/statusbar/phone/OpPhoneStatusBarPolicy$OpUpdateVolumeZenObject;
    ...
    const-string v8, "three key in normal state, no icon shows on status bar"

    const-string v9, "show no disturb icon on status bar"
    ...
    const-string v9, "show disturb icon on status bar"
    ...
    invoke-static {v10, v3}, Lcom/android/systemui/volume/Events;->writeEvent(I[Ljava/lang/Object;)V
    ...
    :cond_7
    iget-object v0, p0, Lcom/oneplus/systemui/statusbar/phone/OpPhoneStatusBarPolicy;->mSharedPreferences:Landroid/content/SharedPreferences;
    ...
    invoke-static {v0}, Lcom/android/systemui/qs/tiles/DndTile;->isCombinedIcon(Landroid/content/SharedPreferences;)Z
    ...
    :goto_5
    new-instance v8, Lcom/oneplus/systemui/statusbar/phone/OpPhoneStatusBarPolicy$OpUpdateVolumeZenObject;
