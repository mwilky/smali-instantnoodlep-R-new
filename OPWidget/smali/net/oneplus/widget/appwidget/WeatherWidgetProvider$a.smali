.class Lnet/oneplus/widget/appwidget/WeatherWidgetProvider$a;
...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Lnet/oneplus/widget/appwidget/WeatherWidgetProvider;->onUpdate(Landroid/content/Context;Landroid/appwidget/AppWidgetManager;[I)V
.end annotation
...
# direct methods
.method constructor <init>(Lnet/oneplus/widget/appwidget/WeatherWidgetProvider;Landroid/content/Context;[ILandroid/appwidget/AppWidgetManager;)V
    .locals 0

    iput-object p2, p0, Lnet/oneplus/widget/appwidget/WeatherWidgetProvider$a;->b:Landroid/content/Context;

    iput-object p3, p0, Lnet/oneplus/widget/appwidget/WeatherWidgetProvider$a;->c:[I

    iput-object p4, p0, Lnet/oneplus/widget/appwidget/WeatherWidgetProvider$a;->d:Landroid/appwidget/AppWidgetManager;
...
.method public run()V
    ...
    const-string v0, "WeatherWidgetProvider"

    iget-object v1, p0, Lnet/oneplus/widget/appwidget/WeatherWidgetProvider$a;->b:Landroid/content/Context;
    ...
    iget-object v4, p0, Lnet/oneplus/widget/appwidget/WeatherWidgetProvider$a;->b:Landroid/content/Context;
    ...
    iget-object v6, p0, Lnet/oneplus/widget/appwidget/WeatherWidgetProvider$a;->b:Landroid/content/Context;

    invoke-static {v6, v3, v2}, Lnet/oneplus/widget/a/c;->a(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)V

    iget-object v3, p0, Lnet/oneplus/widget/appwidget/WeatherWidgetProvider$a;->b:Landroid/content/Context;
    ...
    :cond_3
    iget-object v0, p0, Lnet/oneplus/widget/appwidget/WeatherWidgetProvider$a;->c:[I
    ...
    iget-object v4, p0, Lnet/oneplus/widget/appwidget/WeatherWidgetProvider$a;->d:Landroid/appwidget/AppWidgetManager;

    invoke-virtual {v4, v3}, Landroid/appwidget/AppWidgetManager;->getAppWidgetOptions(I)Landroid/os/Bundle;

    move-result-object v4

    iget-object v5, p0, Lnet/oneplus/widget/appwidget/WeatherWidgetProvider$a;->b:Landroid/content/Context;

    invoke-static {v5, v4, v3}, Lnet/oneplus/widget/a/g;->a(Landroid/content/Context;Landroid/os/Bundle;I)V
