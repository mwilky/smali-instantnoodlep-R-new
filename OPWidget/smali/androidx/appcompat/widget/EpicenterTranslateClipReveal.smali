...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Landroidx/appcompat/widget/EpicenterTranslateClipReveal$d;,
        Landroidx/appcompat/widget/EpicenterTranslateClipReveal$c;,
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Landroidx/appcompat/widget/EpicenterTranslateClipReveal;->b:Landroid/animation/TimeInterpolator;

    iput-object v0, p0, Landroidx/appcompat/widget/EpicenterTranslateClipReveal;->c:Landroid/animation/TimeInterpolator;

    iput-object v0, p0, Landroidx/appcompat/widget/EpicenterTranslateClipReveal;->d:Landroid/animation/TimeInterpolator;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    sget-object v0, Lb/b/j;->EpicenterTranslateClipReveal:[I
    ...
    sget v0, Lb/b/j;->EpicenterTranslateClipReveal_interpolatorX:I
    ...
    :cond_0
    sget-object v0, Lb/a/f;->f:Landroid/view/animation/Interpolator;

    :goto_0
    iput-object v0, p0, Landroidx/appcompat/widget/EpicenterTranslateClipReveal;->b:Landroid/animation/TimeInterpolator;

    sget v0, Lb/b/j;->EpicenterTranslateClipReveal_interpolatorY:I
    ...
    sget v0, Lb/b/j;->EpicenterTranslateClipReveal_interpolatorZ:I
    ...
    :cond_2
    sget-object p1, Lb/a/f;->f:Landroid/view/animation/Interpolator;

    :goto_2
    iput-object p1, p0, Landroidx/appcompat/widget/EpicenterTranslateClipReveal;->d:Landroid/animation/TimeInterpolator;
...
.method private static a(Landroid/view/View;Landroidx/appcompat/widget/EpicenterTranslateClipReveal$b;Landroidx/appcompat/widget/EpicenterTranslateClipReveal$b;FLandroidx/appcompat/widget/EpicenterTranslateClipReveal$b;Landroidx/appcompat/widget/EpicenterTranslateClipReveal$b;FLandroid/transition/TransitionValues;Landroid/animation/TimeInterpolator;Landroid/animation/TimeInterpolator;Landroid/animation/TimeInterpolator;)Landroid/animation/Animator;
    .locals 5

    new-instance v0, Landroidx/appcompat/widget/EpicenterTranslateClipReveal$c;

    const/4 v1, 0x0

    invoke-direct {v0, v1}, Landroidx/appcompat/widget/EpicenterTranslateClipReveal$c;-><init>(Landroidx/appcompat/widget/EpicenterTranslateClipReveal$a;)V
    ...
    :cond_0
    new-instance p10, Landroidx/appcompat/widget/EpicenterTranslateClipReveal$d;

    const/16 v1, 0x78

    invoke-direct {p10, v1}, Landroidx/appcompat/widget/EpicenterTranslateClipReveal$d;-><init>(C)V
    ...
    :cond_1
    new-instance p4, Landroidx/appcompat/widget/EpicenterTranslateClipReveal$d;

    const/16 p8, 0x79

    invoke-direct {p4, p8}, Landroidx/appcompat/widget/EpicenterTranslateClipReveal$d;-><init>(C)V
...
.method public captureEndValues(Landroid/transition/TransitionValues;)V
    ...
    invoke-direct {p0, p1}, Landroidx/appcompat/widget/EpicenterTranslateClipReveal;->a(Landroid/transition/TransitionValues;)V
...
.method public onAppear(Landroid/view/ViewGroup;Landroid/view/View;Landroid/transition/TransitionValues;Landroid/transition/TransitionValues;)Landroid/animation/Animator;
    ...
    invoke-direct {p0, v2}, Landroidx/appcompat/widget/EpicenterTranslateClipReveal;->a(Landroid/graphics/Rect;)Landroid/graphics/Rect;
    ...
    invoke-direct {p0, v7}, Landroidx/appcompat/widget/EpicenterTranslateClipReveal;->b(Landroid/transition/TransitionValues;)Landroid/graphics/Rect;

    move-result-object v9

    invoke-direct {p0, v9}, Landroidx/appcompat/widget/EpicenterTranslateClipReveal;->a(Landroid/graphics/Rect;)Landroid/graphics/Rect;
    ...
    new-instance v4, Landroidx/appcompat/widget/EpicenterTranslateClipReveal$b;

    iget v12, v9, Landroid/graphics/Rect;->left:I

    iget v13, v9, Landroid/graphics/Rect;->right:I

    invoke-direct {v4, v12, v13, v5}, Landroidx/appcompat/widget/EpicenterTranslateClipReveal$b;-><init>(IIF)V

    new-instance v5, Landroidx/appcompat/widget/EpicenterTranslateClipReveal$b;

    iget v12, v10, Landroid/graphics/Rect;->top:I

    iget v10, v10, Landroid/graphics/Rect;->bottom:I

    invoke-direct {v5, v12, v10, v2}, Landroidx/appcompat/widget/EpicenterTranslateClipReveal$b;-><init>(IIF)V
    ...
    invoke-direct {v10, v2, v9, v6}, Landroidx/appcompat/widget/EpicenterTranslateClipReveal$b;-><init>(IIF)V

    iget-object v9, v0, Landroidx/appcompat/widget/EpicenterTranslateClipReveal;->b:Landroid/animation/TimeInterpolator;

    iget-object v12, v0, Landroidx/appcompat/widget/EpicenterTranslateClipReveal;->c:Landroid/animation/TimeInterpolator;

    iget-object v13, v0, Landroidx/appcompat/widget/EpicenterTranslateClipReveal;->d:Landroid/animation/TimeInterpolator;
...
.method public onDisappear(Landroid/view/ViewGroup;Landroid/view/View;Landroid/transition/TransitionValues;Landroid/transition/TransitionValues;)Landroid/animation/Animator;
    ...
    invoke-direct {p0, v1}, Landroidx/appcompat/widget/EpicenterTranslateClipReveal;->b(Landroid/transition/TransitionValues;)Landroid/graphics/Rect;

    move-result-object v1

    invoke-direct {p0, v1}, Landroidx/appcompat/widget/EpicenterTranslateClipReveal;->a(Landroid/graphics/Rect;)Landroid/graphics/Rect;
    ...
    invoke-direct {v5, v1, v4, v2}, Landroidx/appcompat/widget/EpicenterTranslateClipReveal$b;-><init>(IIF)V

    iget-object v9, v0, Landroidx/appcompat/widget/EpicenterTranslateClipReveal;->b:Landroid/animation/TimeInterpolator;

    iget-object v13, v0, Landroidx/appcompat/widget/EpicenterTranslateClipReveal;->c:Landroid/animation/TimeInterpolator;

    iget-object v14, v0, Landroidx/appcompat/widget/EpicenterTranslateClipReveal;->d:Landroid/animation/TimeInterpolator;
