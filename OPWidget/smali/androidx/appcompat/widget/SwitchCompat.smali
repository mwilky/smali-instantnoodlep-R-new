...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput-object v11, v7, Landroidx/appcompat/widget/SwitchCompat;->c:Landroid/content/res/ColorStateList;

    iput-object v11, v7, Landroidx/appcompat/widget/SwitchCompat;->d:Landroid/graphics/PorterDuff$Mode;

    const/4 v12, 0x0

    iput-boolean v12, v7, Landroidx/appcompat/widget/SwitchCompat;->e:Z

    iput-boolean v12, v7, Landroidx/appcompat/widget/SwitchCompat;->f:Z
    ...
    iput-object v0, v7, Landroidx/appcompat/widget/SwitchCompat;->w:Landroid/view/VelocityTracker;

    new-instance v0, Landroid/graphics/Rect;

    invoke-direct {v0}, Landroid/graphics/Rect;-><init>()V

    iput-object v0, v7, Landroidx/appcompat/widget/SwitchCompat;->N:Landroid/graphics/Rect;
    ...
    iput-object v0, v7, Landroidx/appcompat/widget/SwitchCompat;->G:Landroid/text/TextPaint;

    invoke-virtual {p0}, Landroid/widget/CompoundButton;->getResources()Landroid/content/res/Resources;

    move-result-object v0

    iget-object v1, v7, Landroidx/appcompat/widget/SwitchCompat;->G:Landroid/text/TextPaint;
    ...
    sget-object v0, Lb/b/j;->SwitchCompat:[I

    invoke-static {v8, v9, v0, v10, v12}, Landroidx/appcompat/widget/x0;->a(Landroid/content/Context;Landroid/util/AttributeSet;[III)Landroidx/appcompat/widget/x0;
    ...
    invoke-virtual {v14}, Landroidx/appcompat/widget/x0;->a()Landroid/content/res/TypedArray;
    ...
    :cond_0
    sget v0, Lb/b/j;->SwitchCompat_android_thumb:I

    invoke-virtual {v14, v0}, Landroidx/appcompat/widget/x0;->b(I)Landroid/graphics/drawable/Drawable;

    move-result-object v0

    iput-object v0, v7, Landroidx/appcompat/widget/SwitchCompat;->b:Landroid/graphics/drawable/Drawable;

    iget-object v0, v7, Landroidx/appcompat/widget/SwitchCompat;->b:Landroid/graphics/drawable/Drawable;
    ...
    :cond_1
    sget v0, Lb/b/j;->SwitchCompat_track:I
    ...
    iget-object v0, v7, Landroidx/appcompat/widget/SwitchCompat;->g:Landroid/graphics/drawable/Drawable;
    ...
    :cond_2
    sget v0, Lb/b/j;->SwitchCompat_android_textOn:I

    invoke-virtual {v14, v0}, Landroidx/appcompat/widget/x0;->e(I)Ljava/lang/CharSequence;

    move-result-object v0

    iput-object v0, v7, Landroidx/appcompat/widget/SwitchCompat;->p:Ljava/lang/CharSequence;

    sget v0, Lb/b/j;->SwitchCompat_android_textOff:I

    invoke-virtual {v14, v0}, Landroidx/appcompat/widget/x0;->e(I)Ljava/lang/CharSequence;

    move-result-object v0

    iput-object v0, v7, Landroidx/appcompat/widget/SwitchCompat;->q:Ljava/lang/CharSequence;

    sget v0, Lb/b/j;->SwitchCompat_showText:I

    invoke-virtual {v14, v0, v13}, Landroidx/appcompat/widget/x0;->a(IZ)Z

    move-result v0

    iput-boolean v0, v7, Landroidx/appcompat/widget/SwitchCompat;->r:Z

    sget v0, Lb/b/j;->SwitchCompat_thumbTextPadding:I

    invoke-virtual {v14, v0, v12}, Landroidx/appcompat/widget/x0;->c(II)I

    move-result v0

    iput v0, v7, Landroidx/appcompat/widget/SwitchCompat;->l:I

    sget v0, Lb/b/j;->SwitchCompat_switchMinWidth:I

    invoke-virtual {v14, v0, v12}, Landroidx/appcompat/widget/x0;->c(II)I

    move-result v0

    iput v0, v7, Landroidx/appcompat/widget/SwitchCompat;->m:I

    sget v0, Lb/b/j;->SwitchCompat_switchPadding:I

    invoke-virtual {v14, v0, v12}, Landroidx/appcompat/widget/x0;->c(II)I

    move-result v0

    iput v0, v7, Landroidx/appcompat/widget/SwitchCompat;->n:I

    sget v0, Lb/b/j;->SwitchCompat_splitTrack:I

    invoke-virtual {v14, v0, v12}, Landroidx/appcompat/widget/x0;->a(IZ)Z

    move-result v0

    iput-boolean v0, v7, Landroidx/appcompat/widget/SwitchCompat;->o:Z

    sget v0, Lb/b/j;->SwitchCompat_android_radius:I

    const/4 v1, -0x1

    invoke-virtual {v14, v0, v1}, Landroidx/appcompat/widget/x0;->c(II)I

    move-result v0

    invoke-direct {p0, v0}, Landroidx/appcompat/widget/SwitchCompat;->setRadius(I)V

    sget v0, Lb/b/j;->SwitchCompat_thumbTint:I

    invoke-virtual {v14, v0}, Landroidx/appcompat/widget/x0;->a(I)Landroid/content/res/ColorStateList;

    move-result-object v0

    if-eqz v0, :cond_3

    iput-object v0, v7, Landroidx/appcompat/widget/SwitchCompat;->c:Landroid/content/res/ColorStateList;

    iput-boolean v13, v7, Landroidx/appcompat/widget/SwitchCompat;->e:Z

    :cond_3
    sget v0, Lb/b/j;->SwitchCompat_thumbTintMode:I

    invoke-virtual {v14, v0, v1}, Landroidx/appcompat/widget/x0;->d(II)I

    move-result v0

    invoke-static {v0, v11}, Landroidx/appcompat/widget/e0;->a(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuff$Mode;

    move-result-object v0

    iget-object v2, v7, Landroidx/appcompat/widget/SwitchCompat;->d:Landroid/graphics/PorterDuff$Mode;

    if-eq v2, v0, :cond_4

    iput-object v0, v7, Landroidx/appcompat/widget/SwitchCompat;->d:Landroid/graphics/PorterDuff$Mode;

    iput-boolean v13, v7, Landroidx/appcompat/widget/SwitchCompat;->f:Z

    :cond_4
    iget-boolean v0, v7, Landroidx/appcompat/widget/SwitchCompat;->e:Z

    if-nez v0, :cond_5

    iget-boolean v0, v7, Landroidx/appcompat/widget/SwitchCompat;->f:Z
    ...
    :cond_6
    sget v0, Lb/b/j;->SwitchCompat_trackTint:I
    ...
    :cond_7
    sget v0, Lb/b/j;->SwitchCompat_trackTintMode:I
    ...
    iget-object v1, v7, Landroidx/appcompat/widget/SwitchCompat;->i:Landroid/graphics/PorterDuff$Mode;
    ...
    invoke-virtual {v14, v0, v12}, Landroidx/appcompat/widget/x0;->g(II)I

    move-result v0

    if-eqz v0, :cond_b

    invoke-virtual {p0, v8, v0}, Landroidx/appcompat/widget/SwitchCompat;->a(Landroid/content/Context;I)V
    ...
    iput-object v0, v7, Landroidx/appcompat/widget/SwitchCompat;->M:Landroidx/appcompat/widget/y;

    iget-object v0, v7, Landroidx/appcompat/widget/SwitchCompat;->M:Landroidx/appcompat/widget/y;

    invoke-virtual {v0, v9, v10}, Landroidx/appcompat/widget/y;->a(Landroid/util/AttributeSet;I)V

    invoke-virtual {v14}, Landroidx/appcompat/widget/x0;->b()V
    ...
    iput v1, v7, Landroidx/appcompat/widget/SwitchCompat;->t:I

    invoke-virtual {v0}, Landroid/view/ViewConfiguration;->getScaledMinimumFlingVelocity()I

    move-result v0

    iput v0, v7, Landroidx/appcompat/widget/SwitchCompat;->x:I
    ...
    iput-object v0, v7, Landroidx/appcompat/widget/SwitchCompat;->P:Landroid/os/Vibrator;
...
.method public a(Landroid/content/Context;I)V
    ...
    invoke-virtual {p1, p2}, Landroidx/appcompat/widget/x0;->a(I)Landroid/content/res/ColorStateList;
    ...
    invoke-virtual {p1, p2, v0}, Landroidx/appcompat/widget/x0;->c(II)I
    ...
    invoke-virtual {p1, p2, v1}, Landroidx/appcompat/widget/x0;->d(II)I

    move-result p2

    sget v2, Lb/b/j;->TextAppearance_android_textStyle:I

    invoke-virtual {p1, v2, v1}, Landroidx/appcompat/widget/x0;->d(II)I
    ...
    new-instance p2, Lb/b/n/a;

    invoke-virtual {p0}, Landroid/widget/CompoundButton;->getContext()Landroid/content/Context;

    move-result-object v0

    invoke-direct {p2, v0}, Lb/b/n/a;-><init>(Landroid/content/Context;)V
...
.method public performClick()Z
    ...
    invoke-static {v0}, Lc/b/a/h;->a(Landroid/content/Context;)Z
    ...
    iget-object v1, p0, Landroidx/appcompat/widget/SwitchCompat;->P:Landroid/os/Vibrator;

    iget v2, p0, Landroidx/appcompat/widget/SwitchCompat;->Q:I

    invoke-static {v0, v1, v2}, Lc/b/a/h;->a(Landroid/content/Context;Landroid/os/Vibrator;I)[J

    move-result-object v0

    iput-object v0, p0, Landroidx/appcompat/widget/SwitchCompat;->O:[J

    iget-object v0, p0, Landroidx/appcompat/widget/SwitchCompat;->O:[J

    iget-object v1, p0, Landroidx/appcompat/widget/SwitchCompat;->P:Landroid/os/Vibrator;

    invoke-static {v0, v1}, Lc/b/a/h;->a([JLandroid/os/Vibrator;)V
