...
.method public static final initializeAlishanFeatures()V
    ...
    const-string v4, "Burst.MaxPictureCount"

    const/16 v5, 0x14

    invoke-virtual {v0, v4, v5}, Lcom/oneplus/camera/features/FeatureInitializer;->set(Ljava/lang/String;I)V

    const-string v4, "Camcorder.HevcBitrate1080P30Fps"

    const v5, 0x989680

    invoke-virtual {v0, v4, v5}, Lcom/oneplus/camera/features/FeatureInitializer;->set(Ljava/lang/String;I)V

    const-string v4, "Camcorder.HevcBitrate1080P60Fps"

    const v5, 0xe4e1c0

    invoke-virtual {v0, v4, v5}, Lcom/oneplus/camera/features/FeatureInitializer;->set(Ljava/lang/String;I)V

    const-string v4, "Camcorder.HevcBitrate4K30Fps"

    const v5, 0x18cba80

    invoke-virtual {v0, v4, v5}, Lcom/oneplus/camera/features/FeatureInitializer;->set(Ljava/lang/String;I)V

    const-string v4, "Camcorder.HevcBitrate4K60Fps"

    const v5, 0x2625a00

    invoke-virtual {v0, v4, v5}, Lcom/oneplus/camera/features/FeatureInitializer;->set(Ljava/lang/String;I)V

    const-string v4, "Camcorder.H264Bitrate1080P30Fps"

    const v5, 0x1312d00

    invoke-virtual {v0, v4, v5}, Lcom/oneplus/camera/features/FeatureInitializer;->set(Ljava/lang/String;I)V

    const-string v4, "Camcorder.H264Bitrate1080P60Fps"

    const v5, 0x17d7840

    invoke-virtual {v0, v4, v5}, Lcom/oneplus/camera/features/FeatureInitializer;->set(Ljava/lang/String;I)V

    const-string v4, "Camcorder.H264Bitrate4K30Fps"

    const v5, 0x280de80

    invoke-virtual {v0, v4, v5}, Lcom/oneplus/camera/features/FeatureInitializer;->set(Ljava/lang/String;I)V

    const-string v4, "Camcorder.H264Bitrate4K60Fps"

    const v5, 0x4c4b400

    invoke-virtual {v0, v4, v5}, Lcom/oneplus/camera/features/FeatureInitializer;->set(Ljava/lang/String;I)V

    const-string v4, "Camera2Core.MaxMultiFrameShutterCapturingDuration"

    const/16 v5, 0x6e

    invoke-virtual {v0, v4, v5}, Lcom/oneplus/camera/features/FeatureInitializer;->set(Ljava/lang/String;I)V

    const-string v4, "Camera2Core.MaxSingleFrameShutterCapturingDuration"

    const/16 v5, 0xa

    invoke-virtual {v0, v4, v5}, Lcom/oneplus/camera/features/FeatureInitializer;->set(Ljava/lang/String;I)V

    const-string v4, "Camera2Core.ShortSideOfCopiedGLPreviewFrame"
    ...
    const-string v5, "OPFullPictureSizeCamera.DisableHdrCamera"
    ...
    const-string v5, "ScreenFlashPresenter.ClosingDelay"
    ...
    const-string v5, "VideoCaptureMode.Disable1080P60FPSFilter"
