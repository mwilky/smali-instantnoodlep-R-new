...
.method public static final initializeBillie8Features()V
    ...
    const-string v4, "FingerprintManager.IsFingerprintEnabled"

    invoke-virtual {v0, v4, v3}, Lcom/oneplus/camera/features/FeatureInitializer;->set(Ljava/lang/String;Z)V

    const-string v4, "MorphoPanoramaCamera.DefaultShrinkRatio"
    ...
    const-string v4, "OPFullPictureSizeCamera.AlwaysUsingUpscale"

    invoke-virtual {v0, v4, v3}, Lcom/oneplus/camera/features/FeatureInitializer;->set(Ljava/lang/String;Z)V

    const-string v4, "OPFullPictureSizeCamera.UseSinglePictureSize"

    invoke-virtual {v0, v4, v3}, Lcom/oneplus/camera/features/FeatureInitializer;->set(Ljava/lang/String;Z)V

    const/4 v3, 0x0

    const-string v4, "OPHyperImageStabilizationCamera.IsEnabled"

    invoke-virtual {v0, v4, v3}, Lcom/oneplus/camera/features/FeatureInitializer;->set(Ljava/lang/String;Z)V

    const-string v4, "SettingsFragment.IsTripodSupported"
