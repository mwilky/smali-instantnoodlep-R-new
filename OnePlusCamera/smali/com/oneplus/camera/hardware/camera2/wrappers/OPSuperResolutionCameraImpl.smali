...
.method public onCaptureDecisionCompleted(Lcom/oneplus/camera/next/hardware/Camera$PreviewParams;Lcom/oneplus/camera/next/hardware/OperationResult;Landroid/os/Bundle;Landroid/os/Bundle;)Lcom/oneplus/camera/next/hardware/OperationResult;
    ...
    sget-object p1, Lcom/oneplus/camera/hardware/camera2/wrappers/OPSuperResolutionCameraImpl;->EXTRA_CAPTURE_DECISION:Lcom/oneplus/camera/next/hardware/Camera$ExtraKey;
    ...
    check-cast p0, Lcom/oneplus/camera/hardware/camera2/wrappers/OPSuperResolutionCameraImpl$CaptureDecision;

    if-eqz p0, :cond_1

    const/4 p1, 0x0

    const-string p2, "IsSuperResolutionSuggested"

    invoke-virtual {p3, p2, p1}, Landroid/os/Bundle;->getBoolean(Ljava/lang/String;Z)Z

    move-result p1

    invoke-virtual {p0, p1}, Lcom/oneplus/camera/hardware/camera2/wrappers/OPSuperResolutionCameraImpl$CaptureDecision;->setSuperResolutionSuggested(Z)V

    invoke-virtual {p0}, Lcom/oneplus/camera/hardware/camera2/wrappers/OPSuperResolutionCameraImpl$CaptureDecision;->isSuperResolutionSuggested()Z
    ...
    invoke-virtual {p0, p1}, Lcom/oneplus/camera/hardware/camera2/wrappers/OPSuperResolutionCameraImpl$CaptureDecision;->setTargetFrameCount(I)V
