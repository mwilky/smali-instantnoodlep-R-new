...
.method protected onBuildImage(Landroid/media/Image;)Lcom/oneplus/camera/next/media/Image;
    ...
    invoke-direct {p0, p1, v1, v2, v0}, Lcom/oneplus/camera/next/media/SystemImage;-><init>(Landroid/media/Image;ZILkotlin/jvm/internal/DefaultConstructorMarker;)V

    check-cast p0, Lcom/oneplus/camera/next/media/Image;

    const/4 p1, 0x1

    invoke-static {p0, v1, p1, v0}, Lcom/oneplus/camera/next/media/ImageKt;->verifyReleasingState$default(Lcom/oneplus/camera/next/media/Image;ZILjava/lang/Object;)Z

    :try_start_0
    new-instance p1, Lcom/oneplus/camera/next/media/IONImage;

    invoke-direct {p1, p0}, Lcom/oneplus/camera/next/media/IONImage;-><init>(Lcom/oneplus/camera/next/media/Image;)V
    :try_end_0
