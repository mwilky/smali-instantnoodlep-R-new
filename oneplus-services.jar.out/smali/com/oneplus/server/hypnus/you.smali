.class public Lcom/oneplus/server/hypnus/you;
...
.field private static ssp:Lcom/oneplus/server/hypnus/you; = null
...
.method static constructor <clinit>()V
    ...
    sput v0, Lcom/oneplus/server/hypnus/you;->rtg:I
...
.method private constructor <init>()V
    ...
    new-instance v0, Lcom/oneplus/server/hypnus/you$zta;

    invoke-direct {v0, p0}, Lcom/oneplus/server/hypnus/you$zta;-><init>(Lcom/oneplus/server/hypnus/you;)V

    iput-object v0, p0, Lcom/oneplus/server/hypnus/you;->you:Landroid/os/IBinder$DeathRecipient;

    invoke-direct {p0}, Lcom/oneplus/server/hypnus/you;->you()Landroid/os/IBinder;

    return-void
.end method

.method public static declared-synchronized sis()Lcom/oneplus/server/hypnus/you;
    .locals 2

    const-class v0, Lcom/oneplus/server/hypnus/you;

    monitor-enter v0

    :try_start_0
    sget-object v1, Lcom/oneplus/server/hypnus/you;->ssp:Lcom/oneplus/server/hypnus/you;

    if-nez v1, :cond_0

    new-instance v1, Lcom/oneplus/server/hypnus/you;

    invoke-direct {v1}, Lcom/oneplus/server/hypnus/you;-><init>()V

    sput-object v1, Lcom/oneplus/server/hypnus/you;->ssp:Lcom/oneplus/server/hypnus/you;
...
.method private tsu()Z
    ...
    iget-object v0, p0, Lcom/oneplus/server/hypnus/you;->zta:Landroid/os/IBinder;
...
.method private you()Landroid/os/IBinder;
    ...
    iput-object v1, p0, Lcom/oneplus/server/hypnus/you;->zta:Landroid/os/IBinder;

    if-eqz v1, :cond_0

    :try_start_0
    iget-object v2, p0, Lcom/oneplus/server/hypnus/you;->you:Landroid/os/IBinder$DeathRecipient;
    ...
    iget-object v2, p0, Lcom/oneplus/server/hypnus/you;->zta:Landroid/os/IBinder;
    ...
    iget-object p0, p0, Lcom/oneplus/server/hypnus/you;->zta:Landroid/os/IBinder;

    return-object p0
.end method

.method static synthetic zta(Lcom/oneplus/server/hypnus/you;Landroid/os/IBinder;)Landroid/os/IBinder;
    .locals 0

    iput-object p1, p0, Lcom/oneplus/server/hypnus/you;->zta:Landroid/os/IBinder;
...
.method public cno(Ljava/lang/String;Ljava/lang/String;II)V
    ...
    invoke-direct {p0}, Lcom/oneplus/server/hypnus/you;->tsu()Z
