...
.method static synthetic gwm(Lcom/android/server/display/color/DisplayTransformManager;IZLandroid/animation/ValueAnimator;)V
    .locals 0
...
.method private sis()V
    ...
    invoke-direct {p0}, Lcom/oneplus/android/server/display/tsu;->oif()I

    move-result v0

    sput v0, Lcom/oneplus/android/server/display/tsu;->bvj:I

    invoke-direct {p0}, Lcom/oneplus/android/server/display/tsu;->qbh()F
    ...
    invoke-direct/range {v1 .. v8}, Lcom/oneplus/android/server/display/tsu;->tsu([F[FZIZJ)V

    :cond_0
    return-void
.end method

.method private tsu([F[FZIZJ)V
    .locals 7
...
.method public bio()V
    ...
    invoke-direct/range {v2 .. v9}, Lcom/oneplus/android/server/display/tsu;->tsu([F[FZIZJ)V
...
.method public cjf()V
    ...
    invoke-direct/range {v3 .. v10}, Lcom/oneplus/android/server/display/tsu;->tsu([F[FZIZJ)V
...
.method public dma()V
    ...
    invoke-direct {p0, v3}, Lcom/oneplus/android/server/display/tsu;->fto(Z)V
    ...
    :cond_5
    invoke-direct {p0}, Lcom/oneplus/android/server/display/tsu;->bvj()Z
...
.method public gck()V
    ...
    invoke-direct {p0, v4}, Lcom/oneplus/android/server/display/tsu;->fto(Z)V
...
.method public obl()V
    ...
    invoke-direct/range {v0 .. v7}, Lcom/oneplus/android/server/display/tsu;->tsu([F[FZIZJ)V
...
.method public ugm(Z)V
    ...
    sput v2, Lcom/oneplus/android/server/display/tsu;->bvj:I

    invoke-direct {p0}, Lcom/oneplus/android/server/display/tsu;->qbh()F

    move-result v2

    sput v2, Lcom/oneplus/android/server/display/tsu;->ibl:F

    sget v3, Lcom/oneplus/android/server/display/tsu;->bvj:I

    invoke-static {v3, v2}, Lcom/oneplus/android/server/display/ssp;->you(IF)[F
    ...
    iget-object v3, p0, Lcom/oneplus/android/server/display/tsu;->you:Landroid/content/Context;
    ...
    sget-object v1, Lcom/oneplus/android/server/display/tsu;->hmo:[F

    goto :goto_0

    :cond_3
    sget-object v1, Lcom/oneplus/android/server/display/tsu;->cjf:[F
