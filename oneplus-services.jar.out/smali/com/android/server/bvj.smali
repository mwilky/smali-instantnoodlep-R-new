...
.field qbh:Lcom/android/server/oif;

.field final rtg:Lcom/android/server/bvj$zta;
...
.method static constructor <clinit>()V
    ...
    sput-boolean v0, Lcom/android/server/bvj;->oif:Z

    const/4 v0, 0x0

    sput-boolean v0, Lcom/android/server/bvj;->obl:Z

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    sput-object v0, Lcom/android/server/bvj;->lqr:Ljava/util/List;
...
.method public constructor <init>()V
    ...
    iput-object v1, p0, Lcom/android/server/bvj;->rtg:Lcom/android/server/bvj$zta;

    new-instance v1, Ljava/util/HashMap;

    invoke-direct {v1}, Ljava/util/HashMap;-><init>()V

    iput-object v1, p0, Lcom/android/server/bvj;->cno:Ljava/util/HashMap;
    ...
    iput-object v1, p0, Lcom/android/server/bvj;->bio:Ljava/util/List;
    ...
    iput-object v0, p0, Lcom/android/server/bvj;->wtn:Ljava/util/HashMap;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, Lcom/android/server/bvj;->gck:Ljava/util/List;
...
.method private cno(Ljava/util/HashMap;Ljava/util/List;Z)V
    ...
    sget-boolean v3, Lcom/android/server/bvj;->oif:Z
...
.method private igw(Ljava/lang/String;Landroid/app/PendingIntent;I)J
    ...
    iget-object p0, p0, Lcom/android/server/bvj;->cno:Ljava/util/HashMap;
    ...
    sget-boolean p0, Lcom/android/server/bvj;->oif:Z
...
.method private kth(Ljava/util/List;)V
    ...
    iget-object v0, p0, Lcom/android/server/bvj;->cno:Ljava/util/HashMap;
    ...
    iget-object v1, p0, Lcom/android/server/bvj;->cno:Ljava/util/HashMap;
...
.method private wtn(Lorg/json/JSONArray;)V
    ...
    iget-object p0, p0, Lcom/android/server/bvj;->ssp:Ljava/util/List;
    ...
    iget-object v4, p0, Lcom/android/server/bvj;->ssp:Ljava/util/List;
    ...
    :try_start_1
    iget-object v6, p0, Lcom/android/server/bvj;->ssp:Ljava/util/List;
    ...
    iget-object v7, p0, Lcom/android/server/bvj;->ssp:Ljava/util/List;
    ...
    sget-object v6, Lcom/android/server/bvj;->lqr:Ljava/util/List;
    ...
    :try_start_3
    sget-object v7, Lcom/android/server/bvj;->lqr:Ljava/util/List;
    ...
    sget-object v8, Lcom/android/server/bvj;->lqr:Ljava/util/List;
    ...
    iget-object v6, p0, Lcom/android/server/bvj;->bio:Ljava/util/List;
    ...
    :try_start_5
    iget-object v7, p0, Lcom/android/server/bvj;->bio:Ljava/util/List;
    ...
    sget-boolean v8, Lcom/android/server/bvj;->oif:Z
    ...
    :cond_5
    iget-object v8, p0, Lcom/android/server/bvj;->bio:Ljava/util/List;
    ...
    :cond_6
    iget-object v4, p0, Lcom/android/server/bvj;->kth:Ljava/util/HashMap;
    ...
    iget-object v4, p0, Lcom/android/server/bvj;->gck:Ljava/util/List;
    ...
    :try_start_7
    iget-object v6, p0, Lcom/android/server/bvj;->gck:Ljava/util/List;
    ...
    sget-boolean v7, Lcom/android/server/bvj;->oif:Z
    ...
    :cond_8
    iget-object v7, p0, Lcom/android/server/bvj;->gck:Ljava/util/List;
    ...
    :cond_9
    iget-object v3, p0, Lcom/android/server/bvj;->wtn:Ljava/util/HashMap;

    iget-object v6, p0, Lcom/android/server/bvj;->gck:Ljava/util/List;

    invoke-direct {p0, v3, v6, v5}, Lcom/android/server/bvj;->cno(Ljava/util/HashMap;Ljava/util/List;Z)V
    ...
    iget-object v1, p0, Lcom/android/server/bvj;->ssp:Ljava/util/List;
    ...
    sget-object v1, Lcom/android/server/bvj;->lqr:Ljava/util/List;
    ...
    iget-object p1, p0, Lcom/android/server/bvj;->ssp:Ljava/util/List;

    invoke-direct {p0, p1}, Lcom/android/server/bvj;->kth(Ljava/util/List;)V
    :try_end_8
...
.method static synthetic zta(Lcom/android/server/bvj;Lorg/json/JSONArray;)V
    ...
    invoke-direct {p0, p1}, Lcom/android/server/bvj;->wtn(Lorg/json/JSONArray;)V
...
.method public alleviateFirePendingLocked(Ljava/util/ArrayList;)Z
    ...
    iget-object v1, v0, Lcom/android/server/bvj;->dma:Lcom/android/server/AlarmManagerService$AmsInner;
    ...
    :cond_3
    iget-object v4, v0, Lcom/android/server/bvj;->dma:Lcom/android/server/AlarmManagerService$AmsInner;
    ...
    iget-object v4, v0, Lcom/android/server/bvj;->qbh:Lcom/android/server/oif;
    ...
    iput-object v4, v0, Lcom/android/server/bvj;->qbh:Lcom/android/server/oif;
    ...
    iget-object v5, v0, Lcom/android/server/bvj;->dma:Lcom/android/server/AlarmManagerService$AmsInner;
    ...
    :goto_9
    sget-boolean v5, Lcom/android/server/bvj;->oif:Z
...
.method public bio(Ljava/lang/String;)Z
    ...
    sget-object p0, Lcom/android/server/bvj;->lqr:Ljava/util/List;
    ...
    :goto_0
    :try_start_0
    sget-object v2, Lcom/android/server/bvj;->lqr:Ljava/util/List;
...
.method public dumpNextWakeFromIdleInfo()V
    ...
    sget-object p0, Lcom/android/server/bvj;->zgw:Lcom/android/server/AlarmManagerService;
    ...
    sget-object v0, Lcom/android/server/bvj;->zgw:Lcom/android/server/AlarmManagerService;
    ...
    :cond_0
    sget-boolean v0, Lcom/android/server/bvj;->oif:Z
    ...
    sget-object v5, Lcom/android/server/bvj;->zgw:Lcom/android/server/AlarmManagerService;
    ...
    sget-object v4, Lcom/android/server/bvj;->zgw:Lcom/android/server/AlarmManagerService;
    ...
    sget-object v3, Lcom/android/server/bvj;->zgw:Lcom/android/server/AlarmManagerService;
    ...
    sget-object v2, Lcom/android/server/bvj;->zgw:Lcom/android/server/AlarmManagerService;
...
.method public ifDropPkgAlarm(Lcom/android/server/AlarmManagerService$Alarm;Z)Z
    ...
    :cond_0
    iget-boolean v0, p0, Lcom/android/server/bvj;->igw:Z

    if-eqz v0, :cond_1

    iget-object v0, p0, Lcom/android/server/bvj;->wtn:Ljava/util/HashMap;
...
.method public ifHandleCommand(Ljava/io/PrintWriter;[Ljava/lang/String;)Z
    ...
    sget-boolean v4, Lcom/android/server/bvj;->oif:Z

    if-ne v4, v3, :cond_2

    iget-object p2, p0, Lcom/android/server/bvj;->kth:Ljava/util/HashMap;

    invoke-direct {p0, p2, p1, v0}, Lcom/android/server/bvj;->rtg(Ljava/util/HashMap;Ljava/io/PrintWriter;Z)V

    iget-object p2, p0, Lcom/android/server/bvj;->wtn:Ljava/util/HashMap;
...
.method public ifNeedPending(Lcom/android/server/AlarmManagerService$Alarm;)Z
    ...
    sget-boolean v0, Lcom/android/server/bvj;->obl:Z
    ...
    iget-object v0, p0, Lcom/android/server/bvj;->qbh:Lcom/android/server/oif;
    ...
    iput-object v0, p0, Lcom/android/server/bvj;->qbh:Lcom/android/server/oif;
    ...
    invoke-virtual {p0, p1}, Lcom/android/server/bvj;->bio(Ljava/lang/String;)Z
...
.method public initInstance(Lcom/android/server/AlarmManagerService;Landroid/content/Context;)V
    ...
    :cond_0
    sput-object p1, Lcom/android/server/bvj;->zgw:Lcom/android/server/AlarmManagerService;
...
.method public modifyMinTrigger(JJJILandroid/app/PendingIntent;ILjava/lang/String;J)[J
    ...
    invoke-direct {p0, v0, p8, p7}, Lcom/android/server/bvj;->igw(Ljava/lang/String;Landroid/app/PendingIntent;I)J
...
.method public onStart(Lcom/android/server/AlarmManagerService$AmsInner;)V
    ...
    :cond_0
    iput-object p1, p0, Lcom/android/server/bvj;->dma:Lcom/android/server/AlarmManagerService$AmsInner;
    ...
    :cond_1
    iput-boolean p1, p0, Lcom/android/server/bvj;->igw:Z
    ...
    iget-object v2, p0, Lcom/android/server/bvj;->wtn:Ljava/util/HashMap;
    ...
    iput-object p1, p0, Lcom/android/server/bvj;->ssp:Ljava/util/List;
    ...
    iget-object v0, p0, Lcom/android/server/bvj;->ssp:Ljava/util/List;
    ...
    iget-object v1, p0, Lcom/android/server/bvj;->rtg:Lcom/android/server/bvj$zta;
    ...
    iput-object p1, p0, Lcom/android/server/bvj;->ywr:Lcom/oneplus/config/ConfigObserver;
    ...
    sget-object p1, Lcom/android/server/bvj;->lqr:Ljava/util/List;
    ...
    iget-object p0, p0, Lcom/android/server/bvj;->rtg:Lcom/android/server/bvj$zta;
...
.method public setDeepSleepMode(Z)V
    ...
    :cond_0
    sput-boolean p1, Lcom/android/server/bvj;->obl:Z
...
.method public setPkgNetworkAlarmRestriction(Z)V
    ...
    :cond_0
    iput-boolean v3, p0, Lcom/android/server/bvj;->igw:Z
...
.method public updateFlag(Ljava/lang/String;ILandroid/app/AlarmManager$AlarmClockInfo;)I
    ...
    iget-object p0, p0, Lcom/android/server/bvj;->tsu:Ljava/util/List;
