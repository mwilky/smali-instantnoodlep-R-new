...
# instance fields
.field final synthetic zta:Lcom/android/server/igw;
...
.method constructor <init>(Lcom/android/server/igw;Landroid/os/Looper;)V
    ...
    iput-object p1, p0, Lcom/android/server/igw$tsu;->zta:Lcom/android/server/igw;
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    :pswitch_0
    iget-object v1, v0, Lcom/android/server/igw$tsu;->zta:Lcom/android/server/igw;
    ...
    invoke-static {v1}, Lcom/android/server/igw;->irq(Lcom/android/server/igw;)Lnet/oneplus/odm/OpDeviceManagerInjector;
    ...
    iget-object v4, v0, Lcom/android/server/igw$tsu;->zta:Lcom/android/server/igw;

    invoke-static {v4}, Lcom/android/server/igw;->irq(Lcom/android/server/igw;)Lnet/oneplus/odm/OpDeviceManagerInjector;

    move-result-object v4

    iget-object v0, v0, Lcom/android/server/igw$tsu;->zta:Lcom/android/server/igw;

    invoke-static {v0}, Lcom/android/server/igw;->ivd(Lcom/android/server/igw;)Landroid/content/Context;
    ...
    iget-object v2, v0, Lcom/android/server/igw$tsu;->zta:Lcom/android/server/igw;

    invoke-static {v2}, Lcom/android/server/igw;->irq(Lcom/android/server/igw;)Lnet/oneplus/odm/OpDeviceManagerInjector;
    ...
    iget-object v1, v1, Lcom/android/server/igw;->ywr:Landroid/os/BatteryManager;
    ...
    invoke-static {v0}, Lcom/android/server/igw;->qeg(Lcom/android/server/igw;)V
    ...
    invoke-static {v0}, Lcom/android/server/igw;->vdw(Lcom/android/server/igw;)Landroid/app/Notification;
    ...
    invoke-static {v1}, Lcom/android/server/igw;->ivd(Lcom/android/server/igw;)Landroid/content/Context;
    ...
    invoke-static {v2}, Lcom/android/server/igw;->ivd(Lcom/android/server/igw;)Landroid/content/Context;
    ...
    iget-object v12, v0, Lcom/android/server/igw$tsu;->zta:Lcom/android/server/igw;

    move-object/from16 v16, v11

    invoke-static {v12}, Lcom/android/server/igw;->e(Lcom/android/server/igw;)J
    ...
    iget-object v8, v0, Lcom/android/server/igw$tsu;->zta:Lcom/android/server/igw;

    invoke-static {v8}, Lcom/android/server/igw;->vju(Lcom/android/server/igw;)Landroid/app/AlarmManager;
    ...
    invoke-static {v8}, Lcom/android/server/igw;->ivd(Lcom/android/server/igw;)Landroid/content/Context;
    ...
    invoke-static {v8, v10}, Lcom/android/server/igw;->bud(Lcom/android/server/igw;Landroid/app/AlarmManager;)Landroid/app/AlarmManager;
    ...
    invoke-static {v1}, Lcom/android/server/igw;->e(Lcom/android/server/igw;)J

    move-result-wide v1

    iget-object v6, v0, Lcom/android/server/igw$tsu;->zta:Lcom/android/server/igw;

    invoke-static {v6}, Lcom/android/server/igw;->you(Lcom/android/server/igw;)J
    ...
    invoke-static {v1, v6, v9}, Lcom/android/server/igw;->g(Lcom/android/server/igw;Ljava/lang/String;Ljava/lang/String;)V

    iget-object v1, v0, Lcom/android/server/igw$tsu;->zta:Lcom/android/server/igw;

    invoke-static {v1}, Lcom/android/server/igw;->a(Lcom/android/server/igw;)I
    ...
    invoke-virtual {v1, v9}, Lcom/android/server/igw;->w(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v1}, Lcom/android/server/igw;->d(Lcom/android/server/igw;)Lcom/android/server/igw$tsu;
    ...
    invoke-static {v0}, Lcom/android/server/igw;->vju(Lcom/android/server/igw;)Landroid/app/AlarmManager;
    ...
    invoke-static {v1, v2, v9}, Lcom/android/server/igw;->g(Lcom/android/server/igw;Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget-object v5, v0, Lcom/android/server/igw$tsu;->zta:Lcom/android/server/igw;
    ...
    invoke-static {v2}, Lcom/android/server/igw;->hmo(Lcom/android/server/igw;)Lcom/android/server/igw$you;

    move-result-object v2

    iget-object v3, v0, Lcom/android/server/igw$tsu;->zta:Lcom/android/server/igw;

    invoke-static {v3}, Lcom/android/server/igw;->fto(Lcom/android/server/igw;)Landroid/content/IntentFilter;
    ...
    invoke-static {v1}, Lcom/android/server/igw;->zgw(Lcom/android/server/igw;)Landroid/content/ContentResolver;
    ...
    invoke-static {v3}, Lcom/android/server/igw;->lqr(Lcom/android/server/igw;)Lcom/android/server/igw$sis;
    ...
    invoke-static {v1}, Lcom/android/server/igw;->c(Lcom/android/server/igw;)Z
    ...
    invoke-static {v0}, Lcom/android/server/igw;->lqr(Lcom/android/server/igw;)Lcom/android/server/igw$sis;
    ...
    invoke-static {}, Lcom/android/server/igw$rtg;->zta()Lcom/android/server/igw$rtg;

    move-result-object v4

    iget-wide v4, v4, Lcom/android/server/igw$rtg;->sis:J
    ...
    iget-wide v4, v4, Lcom/android/server/igw$rtg;->tsu:J
    ...
    invoke-static {v4}, Lcom/android/server/igw;->zta(Lcom/android/server/igw;)I
    ...
    invoke-virtual {v4}, Lcom/android/server/igw;->o()I
    ...
    iget-wide v4, v4, Lcom/android/server/igw$rtg;->rtg:J
    ...
    iget-wide v4, v4, Lcom/android/server/igw$rtg;->ssp:J
    ...
    invoke-static {v4}, Lcom/android/server/igw;->ear(Lcom/android/server/igw;)I
    ...
    invoke-static {v4}, Lcom/android/server/igw;->obl(Lcom/android/server/igw;)I
    ...
    invoke-static {v4}, Lcom/android/server/igw;->bvj(Lcom/android/server/igw;)I
    ...
    invoke-static {v5}, Lcom/android/server/igw;->ear(Lcom/android/server/igw;)I
    ...
    invoke-static {v5}, Lcom/android/server/igw;->obl(Lcom/android/server/igw;)I
    ...
    invoke-static {v5}, Lcom/android/server/igw;->bvj(Lcom/android/server/igw;)I
    ...
    invoke-static {v4, v5}, Lcom/android/server/igw;->ire(Lcom/android/server/igw;I)I

    iget-object v4, v0, Lcom/android/server/igw$tsu;->zta:Lcom/android/server/igw;

    invoke-static {v4, v13}, Lcom/android/server/igw;->oxb(Lcom/android/server/igw;I)I

    iget-object v4, v0, Lcom/android/server/igw$tsu;->zta:Lcom/android/server/igw;

    invoke-static {v4, v13}, Lcom/android/server/igw;->ibl(Lcom/android/server/igw;I)I
    ...
    invoke-virtual {v2}, Lcom/android/server/igw$rtg;->toString()Ljava/lang/String;
    ...
    invoke-virtual {v1}, Lcom/android/server/igw$rtg;->ssp()V

    iget-object v0, v0, Lcom/android/server/igw$tsu;->zta:Lcom/android/server/igw;

    invoke-virtual {v0}, Lcom/android/server/igw;->y()V
    ...
    invoke-static {v0, v1}, Lcom/android/server/igw;->les(Lcom/android/server/igw;Ljava/lang/String;)Landroid/app/Notification;
    ...
    invoke-virtual {v1}, Lcom/android/server/igw$rtg;->sis()V

    invoke-static {}, Lcom/android/server/igw$rtg;->zta()Lcom/android/server/igw$rtg;

    move-result-object v1

    invoke-virtual {v1}, Lcom/android/server/igw$rtg;->rtg()V

    iget-object v1, v0, Lcom/android/server/igw$tsu;->zta:Lcom/android/server/igw;

    invoke-virtual {v1}, Lcom/android/server/igw;->n()V
    ...
    invoke-static {v1, v4, v5}, Lcom/android/server/igw;->f(Lcom/android/server/igw;J)J
    ...
    invoke-static {v2}, Lcom/android/server/igw;->e(Lcom/android/server/igw;)J
    ...
    invoke-virtual {v1}, Lcom/android/server/igw$rtg;->you()V
    ...
    invoke-virtual {v0}, Lcom/android/server/igw$rtg;->tsu()V

    invoke-static {}, Lcom/android/server/igw$rtg;->zta()Lcom/android/server/igw$rtg;

    move-result-object v0

    invoke-virtual {v0}, Lcom/android/server/igw$rtg;->rtg()V
    ...
    invoke-virtual {v0}, Lcom/android/server/igw;->l()V
    ...
    invoke-static {v1, v2}, Lcom/android/server/igw;->b(Lcom/android/server/igw;I)I
    ...
    invoke-static {v2}, Lcom/android/server/igw;->a(Lcom/android/server/igw;)I
    ...
    iget-object v2, v2, Lcom/android/server/igw;->ywr:Landroid/os/BatteryManager;
    ...
    invoke-virtual {v8, v10, v11}, Lcom/android/server/igw$rtg;->kth(J)V
    ...
    iget-object v11, v0, Lcom/android/server/igw$tsu;->zta:Lcom/android/server/igw;

    invoke-static {v11}, Lcom/android/server/igw;->a(Lcom/android/server/igw;)I
    ...
    iget-object v10, v0, Lcom/android/server/igw$tsu;->zta:Lcom/android/server/igw;

    invoke-static {v10}, Lcom/android/server/igw;->tsu(Lcom/android/server/igw;)J
    ...
    invoke-static {v12}, Lcom/android/server/igw;->rtg(Lcom/android/server/igw;)Z
    ...
    invoke-static {v8}, Lcom/android/server/igw;->a(Lcom/android/server/igw;)I
    ...
    invoke-static {v6}, Lcom/android/server/igw;->e(Lcom/android/server/igw;)J
    ...
    invoke-static {v1}, Lcom/android/server/igw;->veq(Lcom/android/server/igw;)J
    ...
    invoke-virtual {v1, v8}, Lcom/android/server/igw;->w(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v1}, Lcom/android/server/igw;->tsu(Lcom/android/server/igw;)J

    move-result-wide v14

    iget-object v1, v0, Lcom/android/server/igw$tsu;->zta:Lcom/android/server/igw;

    invoke-static {v1}, Lcom/android/server/igw;->cgv(Lcom/android/server/igw;)J
    ...
    invoke-static {v1}, Lcom/android/server/igw;->vju(Lcom/android/server/igw;)Landroid/app/AlarmManager;
    ...
    invoke-virtual {v0}, Lcom/android/server/igw;->n()V
    ...
    invoke-virtual {v4}, Lcom/android/server/igw;->l()V

    iget-object v4, v0, Lcom/android/server/igw$tsu;->zta:Lcom/android/server/igw;

    invoke-static {v4}, Lcom/android/server/igw;->c(Lcom/android/server/igw;)Z
    ...
    invoke-virtual {v4, v5}, Lcom/android/server/igw;->w(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v4}, Lcom/android/server/igw;->d(Lcom/android/server/igw;)Lcom/android/server/igw$tsu;
    ...
    invoke-static {v4, v6, v9}, Lcom/android/server/igw;->g(Lcom/android/server/igw;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v4, v5, v6}, Lcom/android/server/igw$rtg;->bio(J)V
    ...
    invoke-static {v5}, Lcom/android/server/igw;->vju(Lcom/android/server/igw;)Landroid/app/AlarmManager;
