...
# static fields
.field private static final bvj:Ljava/lang/String; = "OpAlarmManager"

.field private static final cjf:I = 0x1

.field private static final ear:I = 0x2

.field private static final fto:Ljava/lang/String; = "ProcessManagement"

.field public static final gwm:I = 0x2
...
.field static lqr:Ljava/util/List; = null
...
.field private static final oxb:I = 0x0

.field public static final ugm:I = 0x4

.field public static final vdb:I = 0x8

.field private static zgw:Lcom/android/server/AlarmManagerService;
...
.field private final cno:Ljava/util/HashMap;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/HashMap<",
            "Ljava/lang/String;",
...
.field private dma:Lcom/android/server/AlarmManagerService$AmsInner;
...
.field qbh:Lcom/android/server/ywr;

.field final rtg:Lcom/android/server/qbh$zta;
...
.field private ywr:Lcom/oneplus/config/ConfigObserver;
...
.method static constructor <clinit>()V
    ...
    sput-boolean v0, Lcom/android/server/qbh;->oif:Z

    const/4 v0, 0x0

    sput-boolean v0, Lcom/android/server/qbh;->obl:Z

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    sput-object v0, Lcom/android/server/qbh;->lqr:Ljava/util/List;
...
.method public constructor <init>()V
    ...
    iput-boolean v0, p0, Lcom/android/server/qbh;->you:Z

    new-array v1, v0, [I

    iput-object v1, p0, Lcom/android/server/qbh;->sis:[I

    new-instance v1, Lcom/android/server/qbh$zta;
    ...
    invoke-direct {v1, p0, v2}, Lcom/android/server/qbh$zta;-><init>(Lcom/android/server/qbh;Landroid/os/Looper;)V

    iput-object v1, p0, Lcom/android/server/qbh;->rtg:Lcom/android/server/qbh$zta;

    new-instance v1, Ljava/util/HashMap;

    invoke-direct {v1}, Ljava/util/HashMap;-><init>()V

    iput-object v1, p0, Lcom/android/server/qbh;->cno:Ljava/util/HashMap;

    new-instance v1, Ljava/util/HashMap;

    invoke-direct {v1}, Ljava/util/HashMap;-><init>()V

    iput-object v1, p0, Lcom/android/server/qbh;->kth:Ljava/util/HashMap;

    new-instance v1, Ljava/util/ArrayList;

    invoke-direct {v1}, Ljava/util/ArrayList;-><init>()V

    iput-object v1, p0, Lcom/android/server/qbh;->bio:Ljava/util/List;

    iput-boolean v0, p0, Lcom/android/server/qbh;->igw:Z

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    iput-object v0, p0, Lcom/android/server/qbh;->wtn:Ljava/util/HashMap;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, Lcom/android/server/qbh;->gck:Ljava/util/List;
...
.method private cno(Ljava/util/HashMap;Ljava/util/List;Z)V
    ...
    sget-boolean v3, Lcom/android/server/qbh;->oif:Z
...
.method private igw(Ljava/lang/String;Landroid/app/PendingIntent;I)J
    .locals 1

    if-eqz p2, :cond_2

    iget-object p0, p0, Lcom/android/server/qbh;->cno:Ljava/util/HashMap;
    ...
    check-cast p3, Lcom/android/server/qbh$you;

    if-eqz p3, :cond_1

    iget-object v0, p3, Lcom/android/server/qbh$you;->sis:Ljava/lang/String;
    ...
    sget-boolean p0, Lcom/android/server/qbh;->oif:Z
    ...
    :cond_0
    iget-wide p0, p3, Lcom/android/server/qbh$you;->you:J
...
.method private kth(Ljava/util/List;)V
    ...
    iget-object v0, p0, Lcom/android/server/qbh;->cno:Ljava/util/HashMap;
    ...
    new-instance v3, Lcom/android/server/qbh$you;

    invoke-direct {v3, v2, v1, v0}, Lcom/android/server/qbh$you;-><init>(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget-object v1, p0, Lcom/android/server/qbh;->cno:Ljava/util/HashMap;
...
.method private wtn(Lorg/json/JSONArray;)V
    ...
    iget-object p0, p0, Lcom/android/server/qbh;->ssp:Ljava/util/List;
    ...
    iget-object v4, p0, Lcom/android/server/qbh;->ssp:Ljava/util/List;
    ...
    :try_start_1
    iget-object v6, p0, Lcom/android/server/qbh;->ssp:Ljava/util/List;
    ...
    iget-object v7, p0, Lcom/android/server/qbh;->ssp:Ljava/util/List;
    ...
    sget-object v6, Lcom/android/server/qbh;->lqr:Ljava/util/List;
    ...
    :try_start_3
    sget-object v7, Lcom/android/server/qbh;->lqr:Ljava/util/List;
    ...
    sget-object v8, Lcom/android/server/qbh;->lqr:Ljava/util/List;
    ...
    iget-object v6, p0, Lcom/android/server/qbh;->bio:Ljava/util/List;
    ...
    :try_start_5
    iget-object v7, p0, Lcom/android/server/qbh;->bio:Ljava/util/List;
    ...
    sget-boolean v8, Lcom/android/server/qbh;->oif:Z
    ...
    :cond_5
    iget-object v8, p0, Lcom/android/server/qbh;->bio:Ljava/util/List;
    ...
    :cond_6
    iget-object v4, p0, Lcom/android/server/qbh;->kth:Ljava/util/HashMap;

    iget-object v7, p0, Lcom/android/server/qbh;->bio:Ljava/util/List;

    invoke-direct {p0, v4, v7, v0}, Lcom/android/server/qbh;->cno(Ljava/util/HashMap;Ljava/util/List;Z)V
    ...
    iget-object v4, p0, Lcom/android/server/qbh;->gck:Ljava/util/List;
    ...
    :try_start_7
    iget-object v6, p0, Lcom/android/server/qbh;->gck:Ljava/util/List;
    ...
    sget-boolean v7, Lcom/android/server/qbh;->oif:Z
    ...
    :cond_8
    iget-object v7, p0, Lcom/android/server/qbh;->gck:Ljava/util/List;
    ...
    :cond_9
    iget-object v3, p0, Lcom/android/server/qbh;->wtn:Ljava/util/HashMap;

    iget-object v6, p0, Lcom/android/server/qbh;->gck:Ljava/util/List;

    invoke-direct {p0, v3, v6, v5}, Lcom/android/server/qbh;->cno(Ljava/util/HashMap;Ljava/util/List;Z)V
    ...
    iget-object v1, p0, Lcom/android/server/qbh;->ssp:Ljava/util/List;
    ...
    sget-object v1, Lcom/android/server/qbh;->lqr:Ljava/util/List;
    ...
    iget-object p1, p0, Lcom/android/server/qbh;->ssp:Ljava/util/List;

    invoke-direct {p0, p1}, Lcom/android/server/qbh;->kth(Ljava/util/List;)V
    :try_end_8
...
.method static synthetic you(Lcom/android/server/qbh;)Landroid/content/Context;
    .locals 0

    iget-object p0, p0, Lcom/android/server/qbh;->zta:Landroid/content/Context;

    return-object p0
.end method

.method static synthetic zta(Lcom/android/server/qbh;Lorg/json/JSONArray;)V
    .locals 0

    invoke-direct {p0, p1}, Lcom/android/server/qbh;->wtn(Lorg/json/JSONArray;)V
...
.method public alleviateFirePendingLocked(Ljava/util/ArrayList;)Z
    ...
    iget-object v1, v0, Lcom/android/server/qbh;->dma:Lcom/android/server/AlarmManagerService$AmsInner;
    ...
    :cond_3
    iget-object v4, v0, Lcom/android/server/qbh;->dma:Lcom/android/server/AlarmManagerService$AmsInner;
    ...
    iget-object v4, v0, Lcom/android/server/qbh;->qbh:Lcom/android/server/ywr;
    ...
    check-cast v4, Lcom/android/server/ywr;

    iput-object v4, v0, Lcom/android/server/qbh;->qbh:Lcom/android/server/ywr;
    ...
    invoke-virtual {v4, v3}, Lcom/android/server/ywr;->rtg(Ljava/lang/String;)Z
    ...
    invoke-static {v5, v6}, Lcom/android/server/qbh;->sis(J)J
    ...
    iget-object v5, v0, Lcom/android/server/qbh;->dma:Lcom/android/server/AlarmManagerService$AmsInner;
    ...
    :goto_9
    sget-boolean v5, Lcom/android/server/qbh;->oif:Z
...
.method public bio(Ljava/lang/String;)Z
    ...
    sget-object p0, Lcom/android/server/qbh;->lqr:Ljava/util/List;
    ...
    :goto_0
    :try_start_0
    sget-object v2, Lcom/android/server/qbh;->lqr:Ljava/util/List;
...
.method public dumpNextWakeFromIdleInfo()V
    ...
    sget-object p0, Lcom/android/server/qbh;->zgw:Lcom/android/server/AlarmManagerService;
    ...
    sget-object v0, Lcom/android/server/qbh;->zgw:Lcom/android/server/AlarmManagerService;
    ...
    :cond_0
    sget-boolean v0, Lcom/android/server/qbh;->oif:Z
    ...
    sget-object v5, Lcom/android/server/qbh;->zgw:Lcom/android/server/AlarmManagerService;
    ...
    sget-object v4, Lcom/android/server/qbh;->zgw:Lcom/android/server/AlarmManagerService;
    ...
    sget-object v3, Lcom/android/server/qbh;->zgw:Lcom/android/server/AlarmManagerService;
    ...
    sget-object v2, Lcom/android/server/qbh;->zgw:Lcom/android/server/AlarmManagerService;
...
.method public ifDropPkgAlarm(Lcom/android/server/AlarmManagerService$Alarm;Z)Z
    ...
    iget-object v0, p0, Lcom/android/server/qbh;->kth:Ljava/util/HashMap;

    const/4 v1, 0x0

    invoke-direct {p0, v0, p1, v1, p2}, Lcom/android/server/qbh;->ssp(Ljava/util/HashMap;Lcom/android/server/AlarmManagerService$Alarm;ZZ)Z
    ...
    :cond_0
    iget-boolean v0, p0, Lcom/android/server/qbh;->igw:Z

    if-eqz v0, :cond_1

    iget-object v0, p0, Lcom/android/server/qbh;->wtn:Ljava/util/HashMap;

    invoke-direct {p0, v0, p1, v2, p2}, Lcom/android/server/qbh;->ssp(Ljava/util/HashMap;Lcom/android/server/AlarmManagerService$Alarm;ZZ)Z
...
.method public ifEnableLogDump()Z
    ...
    iget-boolean p0, p0, Lcom/android/server/qbh;->you:Z
...
.method public ifHandleCommand(Ljava/io/PrintWriter;[Ljava/lang/String;)Z
    ...
    sget-boolean v4, Lcom/android/server/qbh;->oif:Z

    if-ne v4, v3, :cond_2

    iget-object p2, p0, Lcom/android/server/qbh;->kth:Ljava/util/HashMap;

    invoke-direct {p0, p2, p1, v0}, Lcom/android/server/qbh;->rtg(Ljava/util/HashMap;Ljava/io/PrintWriter;Z)V

    iget-object p2, p0, Lcom/android/server/qbh;->wtn:Ljava/util/HashMap;

    invoke-direct {p0, p2, p1, v3}, Lcom/android/server/qbh;->rtg(Ljava/util/HashMap;Ljava/io/PrintWriter;Z)V
    ...
    invoke-virtual {p0, p1, p2, v1}, Lcom/android/server/qbh;->tsu(Ljava/io/PrintWriter;[Ljava/lang/String;I)V
...
.method public ifNeedPending(Lcom/android/server/AlarmManagerService$Alarm;)Z
    ...
    sget-boolean v0, Lcom/android/server/qbh;->obl:Z
    ...
    iget-object v0, p0, Lcom/android/server/qbh;->qbh:Lcom/android/server/ywr;
    ...
    check-cast v0, Lcom/android/server/ywr;

    iput-object v0, p0, Lcom/android/server/qbh;->qbh:Lcom/android/server/ywr;
    ...
    :cond_1
    invoke-virtual {v0, p1}, Lcom/android/server/ywr;->gck(Lcom/android/server/AlarmManagerService$Alarm;)Z
    ...
    invoke-virtual {p0, p1}, Lcom/android/server/qbh;->bio(Ljava/lang/String;)Z
...
.method public initInstance(Lcom/android/server/AlarmManagerService;Landroid/content/Context;)V
    ...
    :cond_0
    sput-object p1, Lcom/android/server/qbh;->zgw:Lcom/android/server/AlarmManagerService;

    iput-object p2, p0, Lcom/android/server/qbh;->zta:Landroid/content/Context;
...
.method public modifyMinTrigger(JJJILandroid/app/PendingIntent;ILjava/lang/String;J)[J
    ...
    invoke-direct {p0, v0, p8, p7}, Lcom/android/server/qbh;->igw(Ljava/lang/String;Landroid/app/PendingIntent;I)J
...
.method public onStart(Lcom/android/server/AlarmManagerService$AmsInner;)V
    ...
    :cond_0
    iput-object p1, p0, Lcom/android/server/qbh;->dma:Lcom/android/server/AlarmManagerService$AmsInner;
    ...
    :cond_1
    iput-boolean p1, p0, Lcom/android/server/qbh;->igw:Z
    ...
    iget-object v2, p0, Lcom/android/server/qbh;->wtn:Ljava/util/HashMap;

    invoke-direct {p0, v2, v0, p1}, Lcom/android/server/qbh;->cno(Ljava/util/HashMap;Ljava/util/List;Z)V

    :cond_3
    new-instance p1, Ljava/util/ArrayList;

    iget-object v0, p0, Lcom/android/server/qbh;->zta:Landroid/content/Context;
    ...
    iput-object p1, p0, Lcom/android/server/qbh;->ssp:Ljava/util/List;
    ...
    iget-object v0, p0, Lcom/android/server/qbh;->ssp:Ljava/util/List;
    ...
    iget-object v1, p0, Lcom/android/server/qbh;->rtg:Lcom/android/server/qbh$zta;

    new-instance v2, Lcom/android/server/qbh$sis;

    invoke-direct {v2, p0}, Lcom/android/server/qbh$sis;-><init>(Lcom/android/server/qbh;)V
    ...
    iput-object p1, p0, Lcom/android/server/qbh;->ywr:Lcom/oneplus/config/ConfigObserver;
    ...
    iput-object p1, p0, Lcom/android/server/qbh;->tsu:Ljava/util/List;

    sget-object p1, Lcom/android/server/qbh;->lqr:Ljava/util/List;
    ...
    iget-object p0, p0, Lcom/android/server/qbh;->rtg:Lcom/android/server/qbh$zta;
...
.method public setDeepSleepMode(Z)V
    ...
    :cond_0
    sput-boolean p1, Lcom/android/server/qbh;->obl:Z
...
.method public setDeepSleepWhitelist([I)V
    ...
    iput-object p1, p0, Lcom/android/server/qbh;->sis:[I
...
.method public setPkgNetworkAlarmRestriction(Z)V
    ...
    :cond_0
    iput-boolean v3, p0, Lcom/android/server/qbh;->igw:Z
...
.method protected tsu(Ljava/io/PrintWriter;[Ljava/lang/String;I)V
    ...
    iput-boolean p1, p0, Lcom/android/server/qbh;->you:Z

    if-eqz v0, :cond_3

    :goto_0
    invoke-virtual {v0, p1}, Lcom/android/server/ywr;->bio(Z)Z
...
.method public updateFlag(Ljava/lang/String;ILandroid/app/AlarmManager$AlarmClockInfo;)I
    ...
    iget-object p0, p0, Lcom/android/server/qbh;->tsu:Ljava/util/List;
