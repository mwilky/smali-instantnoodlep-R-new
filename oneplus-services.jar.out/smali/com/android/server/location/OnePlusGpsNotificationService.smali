...
.method public updateGpsRequstPackage(Z)V
    ...
    iget-object p1, p0, Lcom/android/server/location/OnePlusGpsNotificationService;->mLocationManager:Landroid/location/LocationManager;

    const-string v0, "gps"

    invoke-virtual {p1, v0}, Landroid/location/LocationManager;->getCurrentProviderPackageList(Ljava/lang/String;)Ljava/util/List;
    ...
    :cond_0
    iget-object p1, p0, Lcom/android/server/location/OnePlusGpsNotificationService;->mCurrentGpsPackageList:Ljava/util/ArrayList;

    monitor-enter p1

    :try_start_0
    sget-boolean v1, Lcom/android/server/location/OnePlusGpsNotificationService;->DEBUG:Z

    if-eqz v1, :cond_1

    sget-object v1, Lcom/android/server/location/OnePlusGpsNotificationService;->TAG:Ljava/lang/String;

    new-instance v2, Ljava/lang/StringBuilder;

    invoke-direct {v2}, Ljava/lang/StringBuilder;-><init>()V

    const-string v3, "updateGpsRequstPackage  mLastIsCancel = "

    invoke-virtual {v2, v3}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget-boolean v3, p0, Lcom/android/server/location/OnePlusGpsNotificationService;->mLastIsCancel:Z
    ...
    iget-object v3, p0, Lcom/android/server/location/OnePlusGpsNotificationService;->mCurrentGpsLists:Ljava/util/ArrayList;
    ...
    invoke-virtual {v3, v0}, Ljava/util/ArrayList;->equals(Ljava/lang/Object;)Z

    move-result v3

    if-eqz v3, :cond_3

    iget-object v1, p0, Lcom/android/server/location/OnePlusGpsNotificationService;->mHandler:Lcom/android/server/location/OnePlusGpsNotificationService$you;
    ...
    const-string v0, " mCurrentGpsLists ="

    invoke-virtual {v2, v0}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget-object p0, p0, Lcom/android/server/location/OnePlusGpsNotificationService;->mCurrentGpsLists:Ljava/util/ArrayList;

    invoke-virtual {v2, p0}, Ljava/lang/StringBuilder;->append(Ljava/lang/Object;)Ljava/lang/StringBuilder;

    const-string p0, " same return"
    ...
    :cond_3
    iget-wide v5, p0, Lcom/android/server/location/OnePlusGpsNotificationService;->mLastNotifyTime:J
    ...
    iget v1, p0, Lcom/android/server/location/OnePlusGpsNotificationService;->idCount:I

    add-int/lit8 v1, v1, 0x1

    iput v1, p0, Lcom/android/server/location/OnePlusGpsNotificationService;->idCount:I
    ...
    iget-wide v11, p0, Lcom/android/server/location/OnePlusGpsNotificationService;->mLastNotifyTime:J
    ...
    :cond_5
    iput v6, p0, Lcom/android/server/location/OnePlusGpsNotificationService;->idCount:I
    ...
    invoke-virtual {p0, v0, v9, v10}, Landroid/os/Handler;->sendMessageDelayed(Landroid/os/Message;J)Z
    ...
    invoke-virtual {p0, v0, v7, v8}, Landroid/os/Handler;->sendMessageDelayed(Landroid/os/Message;J)Z
