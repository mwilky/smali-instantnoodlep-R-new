...
.method static constructor <clinit>()V
    ...
    sput-boolean v0, Lcom/android/server/dma;->oif:Z
    ...
    sput-object v0, Lcom/android/server/dma;->veq:Ljava/lang/String;
    ...
    sput-object v0, Lcom/android/server/dma;->cgv:Ljava/lang/String;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    sput-object v0, Lcom/android/server/dma;->bud:Ljava/util/ArrayList;

    new-instance v0, Ljava/lang/Object;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    sput-object v0, Lcom/android/server/dma;->les:Ljava/lang/Object;

    const/4 v0, 0x1

    sput-boolean v0, Lcom/android/server/dma;->irq:Z
...
.method public constructor <init>()V
    ...
    iput-boolean v0, p0, Lcom/android/server/dma;->tsu:Z

    iput-boolean v0, p0, Lcom/android/server/dma;->rtg:Z

    new-instance v0, Ljava/util/HashSet;

    invoke-direct {v0}, Ljava/util/HashSet;-><init>()V

    iput-object v0, p0, Lcom/android/server/dma;->qbh:Ljava/util/HashSet;
...
.method private ssp(I)V
    ...
    invoke-virtual {v0, v1}, Lcom/android/server/ywr;->kth(Z)Z
    ...
    invoke-virtual {v0, p1}, Lcom/android/server/ywr;->kth(Z)Z
...
.method private you(I)V
    ...
    iget-object p0, p0, Lcom/android/server/dma;->bio:Landroid/content/ContentResolver;
    ...
    :cond_0
    sget-object p1, Lcom/android/server/dma;->cgv:Ljava/lang/String;

    goto :goto_0

    :cond_1
    sget-object p1, Lcom/android/server/dma;->veq:Ljava/lang/String;
...
.method private zta(I)V
    ...
    sget-boolean v0, Lcom/android/server/dma;->oif:Z
    ...
    :cond_0
    iget-object v0, p0, Lcom/android/server/dma;->qbh:Ljava/util/HashSet;

    monitor-enter v0

    :try_start_0
    iget-object p0, p0, Lcom/android/server/dma;->qbh:Ljava/util/HashSet;
...
.method public anyMotionResultOverride(I)I
    ...
    invoke-virtual {p0}, Lcom/android/server/dma;->tsu()Z
...
.method public clearWhitelistUid()V
    ...
    sget-object v0, Lcom/android/server/dma;->les:Ljava/lang/Object;
    ...
    :goto_0
    :try_start_0
    sget-object v2, Lcom/android/server/dma;->bud:Ljava/util/ArrayList;
    ...
    iget-object v3, p0, Lcom/android/server/dma;->you:Lcom/android/server/DeviceIdleController;
    ...
    :cond_0
    sget-object p0, Lcom/android/server/dma;->bud:Ljava/util/ArrayList;
...
.method public getStopGpsState()Z
    ...
    sget-boolean p0, Lcom/android/server/dma;->irq:Z
...
.method public mayUseAggressiveTimeoutLocked(FJJJJJFJJ)Z
    ...
    iget v1, v0, Lcom/android/server/dma;->zta:I

    const/4 v2, 0x1

    if-ne v1, v2, :cond_0

    iget-object v0, v0, Lcom/android/server/dma;->kth:Lcom/android/server/DeviceIdleController$Constants;
...
.method public onChange(ZLandroid/net/Uri;)V
    ...
    iget-object p2, p0, Lcom/android/server/dma;->bio:Landroid/content/ContentResolver;
    ...
    sget-boolean p1, Lcom/android/server/dma;->oif:Z
    ...
    iget p2, p0, Lcom/android/server/dma;->zta:I
    ...
    :cond_0
    iget p1, p0, Lcom/android/server/dma;->zta:I

    invoke-direct {p0, p1}, Lcom/android/server/dma;->you(I)V

    iget p1, p0, Lcom/android/server/dma;->zta:I

    invoke-direct {p0, p1}, Lcom/android/server/dma;->ssp(I)V
...
.method public prepareDeviceIdleController(Lcom/android/server/DeviceIdleController$DeviceIdleControllerInner;)V
    ...
    sput-object p1, Lcom/android/server/dma;->vju:Lcom/android/server/DeviceIdleController$DeviceIdleControllerInner;

    invoke-virtual {p1}, Lcom/android/server/DeviceIdleController$DeviceIdleControllerInner;->getContext()Landroid/content/Context;

    move-result-object v0

    iput-object v0, p0, Lcom/android/server/dma;->ssp:Landroid/content/Context;
    ...
    iput-object v0, p0, Lcom/android/server/dma;->you:Lcom/android/server/DeviceIdleController;
    ...
    iput-object v0, p0, Lcom/android/server/dma;->kth:Lcom/android/server/DeviceIdleController$Constants;
    ...
    iput-object v0, p0, Lcom/android/server/dma;->bio:Landroid/content/ContentResolver;

    invoke-virtual {p1}, Lcom/android/server/DeviceIdleController$DeviceIdleControllerInner;->getHandler()Landroid/os/Handler;

    move-result-object v0

    iput-object v0, p0, Lcom/android/server/dma;->igw:Landroid/os/Handler;
    ...
    iput-object v0, p0, Lcom/android/server/dma;->wtn:Landroid/location/LocationManager;
    ...
    iput-object p1, p0, Lcom/android/server/dma;->gck:Landroid/location/LocationListener;

    iget-object p1, p0, Lcom/android/server/dma;->bio:Landroid/content/ContentResolver;
    ...
    iget-object v2, p0, Lcom/android/server/dma;->kth:Lcom/android/server/DeviceIdleController$Constants;
    ...
    iget v0, p0, Lcom/android/server/dma;->zta:I
...
.method public shellCommand(Lcom/android/server/DeviceIdleController$Shell;Ljava/lang/String;Ljava/io/PrintWriter;)Z
    ...
    iget v3, p0, Lcom/android/server/dma;->zta:I
    ...
    invoke-direct {p0, v0}, Lcom/android/server/dma;->you(I)V
...
.method tsu()Z
    ...
    invoke-virtual {p0}, Lcom/android/server/dma;->sis()Z
