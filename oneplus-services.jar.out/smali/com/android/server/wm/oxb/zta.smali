.class public Lcom/android/server/wm/oxb/zta;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/android/server/wm/oxb/zta;->tsu:Ljava/util/Set;
    ...
    sput-object v3, Lcom/android/server/wm/oxb/zta;->rtg:Ljava/util/Set;
    ...
    sput-object v0, Lcom/android/server/wm/oxb/zta;->ssp:Ljava/util/Set;
    ...
    sput-object v4, Lcom/android/server/wm/oxb/zta;->cno:Ljava/util/Set;
    ...
    sput-object v4, Lcom/android/server/wm/oxb/zta;->kth:Ljava/util/Set;

    new-instance v4, Landroid/util/ArrayMap;

    invoke-direct {v4}, Landroid/util/ArrayMap;-><init>()V

    sput-object v4, Lcom/android/server/wm/oxb/zta;->bio:Landroid/util/ArrayMap;
    ...
    sget-object v4, Lcom/android/server/wm/oxb/zta;->bio:Landroid/util/ArrayMap;
    ...
    sput-object v4, Lcom/android/server/wm/oxb/zta;->igw:Ljava/util/Map;
    ...
    sget-object v3, Lcom/android/server/wm/oxb/zta;->igw:Ljava/util/Map;

    invoke-interface {v3, v1, v6}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    sget-object v1, Lcom/android/server/wm/oxb/zta;->igw:Ljava/util/Map;
    ...
    sput-object v1, Lcom/android/server/wm/oxb/zta;->wtn:Landroid/util/ArrayMap;
    ...
    sput-object v1, Lcom/android/server/wm/oxb/zta;->gck:Landroid/util/ArrayMap;
