.class public Lcom/android/server/wm/gck$zta;
...
.annotation system Ldalvik/annotation/EnclosingClass;
    value = Lcom/android/server/wm/gck;
.end annotation
...
.field public static final bud:I = 0x6f

.field private static final bvj:Ljava/lang/String; = "force-off"

.field private static final cgv:I = 0x6d

.field private static final cjf:Ljava/lang/String; = "com.netflix.mediaclient"

.field private static final ear:I = -0x1

.field private static final fto:I = 0x2

.field private static final gwm:Ljava/lang/String; = "force-on-color"

.field private static final hmo:I = 0x1

.field private static final ibl:Ljava/lang/String; = "force-on"

.field private static final ire:I = 0x0

.field private static irq:Lcom/android/internal/statusbar/IStatusBarService; = null

.field public static final ivd:I = 0x0

.field private static les:Landroid/app/NotificationManager; = null

.field private static final lqr:I = 0x1f4

.field private static final obl:Ljava/lang/String; = "com.oneplus.gallery"

.field private static final oif:Ljava/lang/String; = "OemSceneModeActivityStack"

.field private static final oxb:Ljava/lang/String; = "com.amazon.avod.thirdpartyclient"

.field public static final qbh:I = 0x1

.field private static qeg:Lcom/android/server/wm/ActivityRecord; = null

.field private static final ugm:Ljava/lang/String; = "0"

.field private static final vdb:Ljava/lang/String; = "1"

.field private static vdw:Lcom/android/server/wm/ActivityRecord; = null

.field private static final veq:I = 0x6c

.field private static final vju:I = 0x6e

.field public static final ywr:I = 0x0

.field private static final zgw:Ljava/lang/String; = "com.oneplus.camera"
...
.field final dma:Landroid/content/BroadcastReceiver;
...
.method public constructor <init>()V
    ...
    iput v0, p0, Lcom/android/server/wm/gck$zta;->cno:I

    const/4 v1, 0x0

    iput-object v1, p0, Lcom/android/server/wm/gck$zta;->kth:Ljava/lang/String;

    iput-boolean v0, p0, Lcom/android/server/wm/gck$zta;->bio:Z

    iput-object v1, p0, Lcom/android/server/wm/gck$zta;->igw:Ljava/lang/String;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, Lcom/android/server/wm/gck$zta;->wtn:Ljava/util/ArrayList;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, Lcom/android/server/wm/gck$zta;->gck:Ljava/util/ArrayList;

    new-instance v0, Lcom/android/server/wm/gck$zta$you;

    invoke-direct {v0, p0}, Lcom/android/server/wm/gck$zta$you;-><init>(Lcom/android/server/wm/gck$zta;)V

    iput-object v0, p0, Lcom/android/server/wm/gck$zta;->dma:Landroid/content/BroadcastReceiver;

    return-void
.end method

.method static synthetic bio(Lcom/android/server/wm/gck$zta;)Lcom/android/server/wm/ActivityStack;
    .locals 0

    iget-object p0, p0, Lcom/android/server/wm/gck$zta;->rtg:Lcom/android/server/wm/ActivityStack;

    return-object p0
.end method

.method private bvj(Lcom/android/server/wm/ActivityRecord;Lcom/android/server/wm/ActivityRecord;)Z
    .locals 1
...
.method static synthetic cno(Lcom/android/server/wm/gck$zta;ILjava/lang/String;I)V
    .locals 0

    invoke-direct {p0, p1, p2, p3}, Lcom/android/server/wm/gck$zta;->gck(ILjava/lang/String;I)V

    return-void
.end method

.method private gck(ILjava/lang/String;I)V
    .locals 3
    ...
    iget-object v0, p0, Lcom/android/server/wm/gck$zta;->ssp:Lcom/android/server/wm/ActivityStackSupervisor;
    ...
    sput-object p1, Lcom/android/server/wm/gck$zta;->qeg:Lcom/android/server/wm/ActivityRecord;

    invoke-virtual {p0, p1, v1}, Lcom/android/server/wm/gck$zta;->cjf(Lcom/android/server/wm/ActivityRecord;Lcom/android/server/wm/ActivityRecord;)V
...
.method private igw(Ljava/lang/String;I)V
    ...
    sget-object p0, Lcom/android/server/wm/gck$zta;->irq:Lcom/android/internal/statusbar/IStatusBarService;
    ...
    sput-object p0, Lcom/android/server/wm/gck$zta;->irq:Lcom/android/internal/statusbar/IStatusBarService;
    ...
    :goto_0
    sget-object p0, Lcom/android/server/wm/gck$zta;->les:Landroid/app/NotificationManager;
...
.method static synthetic kth(Lcom/android/server/wm/gck$zta;)Landroid/content/Intent;
    .locals 0

    iget-object p0, p0, Lcom/android/server/wm/gck$zta;->you:Landroid/content/Intent;

    return-object p0
.end method

.method static synthetic rtg(Lcom/android/server/wm/gck$zta;Landroid/app/AlertDialog;)Landroid/app/AlertDialog;
    .locals 0

    iput-object p1, p0, Lcom/android/server/wm/gck$zta;->zta:Landroid/app/AlertDialog;

    return-object p1
.end method

.method static synthetic sis()Landroid/app/NotificationManager;
    .locals 1

    sget-object v0, Lcom/android/server/wm/gck$zta;->les:Landroid/app/NotificationManager;

    return-object v0
.end method

.method static synthetic ssp(Lcom/android/server/wm/gck$zta;Ljava/lang/String;I)V
    .locals 0

    invoke-direct {p0, p1, p2}, Lcom/android/server/wm/gck$zta;->igw(Ljava/lang/String;I)V

    return-void
.end method

.method static synthetic tsu(Lcom/android/server/wm/gck$zta;)Landroid/app/AlertDialog;
    .locals 0

    iget-object p0, p0, Lcom/android/server/wm/gck$zta;->zta:Landroid/app/AlertDialog;
...
.method private wtn(Ljava/lang/String;)V
    ...
    iget-object v0, p0, Lcom/android/server/wm/gck$zta;->sis:Landroid/content/Context;
    ...
    sput-object v0, Lcom/android/server/wm/gck$zta;->les:Landroid/app/NotificationManager;

    :cond_0
    sget-object v0, Lcom/android/server/wm/gck$zta;->les:Landroid/app/NotificationManager;

    iget-object v1, p0, Lcom/android/server/wm/gck$zta;->tsu:Ljava/lang/String;
    ...
    iget-object p0, p0, Lcom/android/server/wm/gck$zta;->tsu:Ljava/lang/String;
...
.method static synthetic you(Lcom/android/server/wm/gck$zta;)Ljava/lang/String;
    .locals 0
...
.method static synthetic zta(Lcom/android/server/wm/gck$zta;)Landroid/content/Context;
    .locals 0

    iget-object p0, p0, Lcom/android/server/wm/gck$zta;->sis:Landroid/content/Context;
...
# virtual methods
.method public cjf(Lcom/android/server/wm/ActivityRecord;Lcom/android/server/wm/ActivityRecord;)V
    .locals 4

    invoke-static {}, Lcom/android/server/wm/gck;->zta()Z
    ...
    iget-object v1, p0, Lcom/android/server/wm/gck$zta;->rtg:Lcom/android/server/wm/ActivityStack;
    ...
    sget-boolean p0, Lcom/android/server/wm/gck;->zta:Z
    ...
    :cond_5
    sget-boolean v0, Lcom/android/server/wm/gck;->zta:Z
    ...
    sget-object v1, Lcom/android/server/wm/gck$zta;->vdw:Lcom/android/server/wm/ActivityRecord;
    ...
    sget-object v1, Lcom/android/server/wm/gck$zta;->qeg:Lcom/android/server/wm/ActivityRecord;
    ...
    invoke-direct {p0, p1, p2}, Lcom/android/server/wm/gck$zta;->bvj(Lcom/android/server/wm/ActivityRecord;Lcom/android/server/wm/ActivityRecord;)Z

    move-result v0

    if-eqz v0, :cond_8

    sget-object v0, Lcom/android/server/wm/gck$zta;->vdw:Lcom/android/server/wm/ActivityRecord;
    ...
    :try_start_0
    iget-object v1, p0, Lcom/android/server/wm/gck$zta;->ssp:Lcom/android/server/wm/ActivityStackSupervisor;
    ...
    sget-object v0, Lcom/android/server/wm/gck$zta;->qeg:Lcom/android/server/wm/ActivityRecord;

    sget-object v1, Lcom/android/server/wm/gck$zta;->vdw:Lcom/android/server/wm/ActivityRecord;

    if-eq v0, v1, :cond_c

    invoke-direct {p0, v0, p2}, Lcom/android/server/wm/gck$zta;->bvj(Lcom/android/server/wm/ActivityRecord;Lcom/android/server/wm/ActivityRecord;)Z
    ...
    :cond_c
    sput-object p2, Lcom/android/server/wm/gck$zta;->qeg:Lcom/android/server/wm/ActivityRecord;

    invoke-virtual {p0, p1, p2}, Lcom/android/server/wm/gck$zta;->zgw(Lcom/android/server/wm/ActivityRecord;Lcom/android/server/wm/ActivityRecord;)V

    invoke-virtual {p0, p1, p2}, Lcom/android/server/wm/gck$zta;->oxb(Lcom/android/server/wm/ActivityRecord;Lcom/android/server/wm/ActivityRecord;)V

    invoke-virtual {p0, p1, p2}, Lcom/android/server/wm/gck$zta;->obl(Lcom/android/server/wm/ActivityRecord;Lcom/android/server/wm/ActivityRecord;)V
...
.method public dma()V
    ...
    iget-object v0, p0, Lcom/android/server/wm/gck$zta;->wtn:Ljava/util/ArrayList;

    iget-object v1, p0, Lcom/android/server/wm/gck$zta;->kth:Ljava/lang/String;

    invoke-virtual {v0, v1}, Ljava/util/ArrayList;->remove(Ljava/lang/Object;)Z

    iget-object v0, p0, Lcom/android/server/wm/gck$zta;->gck:Ljava/util/ArrayList;
    ...
    iput-object v0, p0, Lcom/android/server/wm/gck$zta;->kth:Ljava/lang/String;

    const/4 v1, 0x0

    iput-boolean v1, p0, Lcom/android/server/wm/gck$zta;->bio:Z

    iput-object v0, p0, Lcom/android/server/wm/gck$zta;->igw:Ljava/lang/String;

    return-void
.end method

.method public ear(Lcom/android/server/wm/ActivityRecord;Lcom/android/server/wm/ActivityRecord;)V
    .locals 3
    ...
    sput-object p1, Lcom/android/server/wm/gck$zta;->vdw:Lcom/android/server/wm/ActivityRecord;

    goto :goto_0

    :cond_2
    sput-object v0, Lcom/android/server/wm/gck$zta;->vdw:Lcom/android/server/wm/ActivityRecord;
    ...
    :cond_4
    iget-object p1, p0, Lcom/android/server/wm/gck$zta;->rtg:Lcom/android/server/wm/ActivityStack;
    ...
    sput-object v0, Lcom/android/server/wm/gck$zta;->qeg:Lcom/android/server/wm/ActivityRecord;
...
.method public fto(I)V
    .locals 2

    iget-object v0, p0, Lcom/android/server/wm/gck$zta;->rtg:Lcom/android/server/wm/ActivityStack;
...
.method public gwm(Lcom/android/server/wm/ActivityRecord;Lcom/android/server/wm/ActivityRecord;)V
    .locals 4

    iget-object p2, p0, Lcom/android/server/wm/gck$zta;->sis:Landroid/content/Context;
    ...
    iput-object p1, p0, Lcom/android/server/wm/gck$zta;->igw:Ljava/lang/String;
    ...
    iput-object v3, p0, Lcom/android/server/wm/gck$zta;->igw:Ljava/lang/String;
    ...
    :cond_2
    iget-boolean p2, p0, Lcom/android/server/wm/gck$zta;->bio:Z

    if-eqz p2, :cond_3

    iget-object p2, p0, Lcom/android/server/wm/gck$zta;->igw:Ljava/lang/String;
...
.method public hmo(Z)V
    ...
    iget-object p1, p0, Lcom/android/server/wm/gck$zta;->gck:Ljava/util/ArrayList;

    iget-object v0, p0, Lcom/android/server/wm/gck$zta;->kth:Ljava/lang/String;
    ...
    iput-boolean p1, p0, Lcom/android/server/wm/gck$zta;->bio:Z

    iget-object p1, p0, Lcom/android/server/wm/gck$zta;->kth:Ljava/lang/String;
...
.method public ibl(Ljava/lang/String;I)V
    .locals 2
...
.method public lqr(Lcom/android/server/am/ActivityManagerService;Lcom/android/server/wm/ActivityRecord;)V
    .locals 7
    ...
    invoke-static {p1, p2}, Lcom/android/server/wm/gck;->kth(Lcom/android/server/wm/ActivityTaskManagerService;Lcom/android/server/wm/ActivityRecord;)Z
    ...
    invoke-virtual {p0, v2}, Lcom/android/server/wm/gck$zta;->fto(I)V
...
.method public obl(Lcom/android/server/wm/ActivityRecord;Lcom/android/server/wm/ActivityRecord;)V
    .locals 5

    iget-object p1, p0, Lcom/android/server/wm/gck$zta;->ssp:Lcom/android/server/wm/ActivityStackSupervisor;
    ...
    :cond_1
    iget-object v4, p0, Lcom/android/server/wm/gck$zta;->sis:Landroid/content/Context;
...
.method public oif(Lcom/android/server/wm/ActivityStack;Lcom/android/server/wm/ActivityStackSupervisor;)V
    .locals 0

    iput-object p1, p0, Lcom/android/server/wm/gck$zta;->rtg:Lcom/android/server/wm/ActivityStack;

    iput-object p2, p0, Lcom/android/server/wm/gck$zta;->ssp:Lcom/android/server/wm/ActivityStackSupervisor;
    ...
    iput-object p1, p0, Lcom/android/server/wm/gck$zta;->sis:Landroid/content/Context;
...
.method public oxb(Lcom/android/server/wm/ActivityRecord;Lcom/android/server/wm/ActivityRecord;)V
    ...
    iget-object v2, p0, Lcom/android/server/wm/gck$zta;->rtg:Lcom/android/server/wm/ActivityStack;
...
.method public ugm(Lcom/android/server/wm/ActivityRecord;)V
    .locals 12
    ...
    iget-object v4, p0, Lcom/android/server/wm/gck$zta;->ssp:Lcom/android/server/wm/ActivityStackSupervisor;
    ...
    iput-object v3, p0, Lcom/android/server/wm/gck$zta;->tsu:Ljava/lang/String;
    ...
    iput-object v3, p0, Lcom/android/server/wm/gck$zta;->you:Landroid/content/Intent;

    const v4, 0x10008000

    invoke-virtual {v3, v4}, Landroid/content/Intent;->setFlags(I)Landroid/content/Intent;

    iget-object v3, p0, Lcom/android/server/wm/gck$zta;->sis:Landroid/content/Context;
    ...
    invoke-direct {p0, v3}, Lcom/android/server/wm/gck$zta;->wtn(Ljava/lang/String;)V
    ...
    iget-object v6, p0, Lcom/android/server/wm/gck$zta;->sis:Landroid/content/Context;
    ...
    iget-object v9, p0, Lcom/android/server/wm/gck$zta;->sis:Landroid/content/Context;
    ...
    iget-object p1, p0, Lcom/android/server/wm/gck$zta;->sis:Landroid/content/Context;
    ...
    iget-object v7, p0, Lcom/android/server/wm/gck$zta;->sis:Landroid/content/Context;
    ...
    iget-object v8, p0, Lcom/android/server/wm/gck$zta;->tsu:Ljava/lang/String;
    ...
    iget-object v2, p0, Lcom/android/server/wm/gck$zta;->sis:Landroid/content/Context;

    iget-object v3, p0, Lcom/android/server/wm/gck$zta;->you:Landroid/content/Intent;
    ...
    new-instance v3, Lcom/android/server/wm/gck$zta$zta;

    invoke-direct {v3, p0, p1}, Lcom/android/server/wm/gck$zta$zta;-><init>(Lcom/android/server/wm/gck$zta;Landroid/app/Notification$Builder;)V
...
.method vdb(IZ)V
    ...
    :cond_2
    :goto_0
    iget-object p2, p0, Lcom/android/server/wm/gck$zta;->rtg:Lcom/android/server/wm/ActivityStack;

    iget-object p2, p2, Lcom/android/server/wm/ActivityStack;->mHandler:Landroid/os/Handler;

    new-instance v0, Lcom/android/server/wm/gck$zta$sis;

    invoke-direct {v0, p0, p1}, Lcom/android/server/wm/gck$zta$sis;-><init>(Lcom/android/server/wm/gck$zta;Ljava/lang/String;)V
...
.method public zgw(Lcom/android/server/wm/ActivityRecord;Lcom/android/server/wm/ActivityRecord;)V
    .locals 7
    ...
    iget-object v3, p0, Lcom/android/server/wm/gck$zta;->wtn:Ljava/util/ArrayList;
    ...
    iput-object v2, p0, Lcom/android/server/wm/gck$zta;->igw:Ljava/lang/String;
    ...
    iget-boolean v4, p0, Lcom/android/server/wm/gck$zta;->bio:Z

    if-eqz v4, :cond_5

    iget-object v4, p0, Lcom/android/server/wm/gck$zta;->gck:Ljava/util/ArrayList;
    ...
    invoke-virtual {p0, v4, p1}, Lcom/android/server/wm/gck$zta;->vdb(IZ)V
    ...
    invoke-virtual {p0, v1, p1}, Lcom/android/server/wm/gck$zta;->vdb(IZ)V
    ...
    :cond_9
    iput-object v2, p0, Lcom/android/server/wm/gck$zta;->kth:Ljava/lang/String;
    ...
    sget-boolean v2, Lcom/android/server/wm/gck;->zta:Z
    ...
    iget-boolean v2, p0, Lcom/android/server/wm/gck$zta;->bio:Z
