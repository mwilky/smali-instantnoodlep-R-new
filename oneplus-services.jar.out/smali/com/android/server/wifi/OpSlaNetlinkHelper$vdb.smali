.class Lcom/android/server/wifi/OpSlaNetlinkHelper$vdb;
...
.method constructor <init>(Lcom/android/server/wifi/OpSlaNetlinkHelper;Landroid/os/Handler;)V
    ...
    iput-object p1, p0, Lcom/android/server/wifi/OpSlaNetlinkHelper$vdb;->zta:Lcom/android/server/wifi/OpSlaNetlinkHelper;
...
.method public onChange(Z)V
    ...
    iget-object p1, p0, Lcom/android/server/wifi/OpSlaNetlinkHelper$vdb;->zta:Lcom/android/server/wifi/OpSlaNetlinkHelper;

    invoke-static {p1}, Lcom/android/server/wifi/OpSlaNetlinkHelper;->ibl(Lcom/android/server/wifi/OpSlaNetlinkHelper;)Z

    move-result v0

    invoke-static {p1, v0}, Lcom/android/server/wifi/OpSlaNetlinkHelper;->igw(Lcom/android/server/wifi/OpSlaNetlinkHelper;Z)Z

    new-instance p1, Ljava/lang/StringBuilder;

    invoke-direct {p1}, Ljava/lang/StringBuilder;-><init>()V

    const-string v0, "mDownloadingOTANotify:"

    invoke-virtual {p1, v0}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget-object v0, p0, Lcom/android/server/wifi/OpSlaNetlinkHelper$vdb;->zta:Lcom/android/server/wifi/OpSlaNetlinkHelper;

    invoke-static {v0}, Lcom/android/server/wifi/OpSlaNetlinkHelper;->bio(Lcom/android/server/wifi/OpSlaNetlinkHelper;)Z
    ...
    iget-object p0, p0, Lcom/android/server/wifi/OpSlaNetlinkHelper$vdb;->zta:Lcom/android/server/wifi/OpSlaNetlinkHelper;
