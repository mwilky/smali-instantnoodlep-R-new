...
# static fields
.field private static final A:Ljava/lang/String; = "WhitelistAdaptiveColorGamutPackage"
...
.field private static final E:Ljava/lang/String; = "oneplus.action.front_package_changed"

.field private static final F:Ljava/lang/String; = "com.heytap.speechassist"

.field private static final G:Ljava/lang/String; = "driving_mode_state"
...
.field private static final L:Ljava/lang/String; = "smart_fiveg_whitelist"

.field private static final M:Landroid/net/Uri;

.field private static final N:I = 0x5

.field private static final O:Ljava/lang/String; = "BlacklistVideoEnhancerConfig"

.field private static final P:Ljava/lang/String; = "LMKD_TUNE"

.field public static final Q:Ljava/lang/String; = "/sys/module/memplus_core/parameters/memory_plus_wake_memex"

.field private static final R:Z

.field private static final S:Ljava/lang/String; = "TPD"

.field private static final T:Ljava/lang/String; = "/sys/module/tpd/parameters/tpd_cmds"

.field private static final U:Ljava/lang/String; = "/sys/module/tpd/parameters/tpd_enable"

.field private static final V:Ljava/lang/String; = "/sys/module/tpd/parameters/tpd_dynamic"

.field private static final W:Ljava/lang/String; = "com.google.android.providers.media.module"

.field private static final X:Ljava/lang/String; = "oneplus.intent.action.THERMAL_STATUS"

.field private static final Y:I = 0x2

.field private static final h:Z

.field private static final i:Ljava/lang/String; = "CommonFrontMonitor"

.field private static j:Lcom/android/server/ibl; = null
...
.field private static final o:Ljava/lang/String; = "op_video_enhancer"

.field private static final p:Ljava/lang/String; = "com.oneplus.retailmode"

.field private static final q:Landroid/net/Uri;

.field private static final r:Ljava/lang/String; = "smart_fiveg"

.field private static final s:I = 0x1

.field private static final t:Ljava/lang/String; = "Whitelist5GConfig"

.field private static final u:Landroid/net/Uri;

.field private static final v:Ljava/lang/String; = "WhitelistFastOutputConfig"

.field private static final w:Ljava/lang/String; = "WhitelistGameDolbyConfig"

.field private static final x:Ljava/lang/String; = "WhitelistGameDolbyPackage"

.field private static final y:Ljava/lang/String; = "EnableImageImproveConfig"

.field private static final z:Ljava/lang/String; = "WhitelistAdaptiveColorGamutConfig"


# instance fields
.field private a:Lcom/oneplus/config/ConfigObserver;
...
.field private ire:Ljava/lang/Object;
...
.field private obl:Landroid/database/ContentObserver;
...
.field private vju:Ljava/util/ArrayList;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/ArrayList<",
            "Ljava/lang/String;",
...
.method static constructor <clinit>()V
    ...
    sput-boolean v0, Lcom/android/server/ibl;->h:Z

    const/4 v0, 0x0

    sput-object v0, Lcom/android/server/ibl;->j:Lcom/android/server/ibl;
    ...
    sput-object v0, Lcom/android/server/ibl;->u:Landroid/net/Uri;
    ...
    sput-boolean v1, Lcom/android/server/ibl;->B:Z
    ...
    sput-object v1, Lcom/android/server/ibl;->H:Landroid/net/Uri;
    ...
    sput-object v1, Lcom/android/server/ibl;->M:Landroid/net/Uri;
    ...
    sput-boolean v0, Lcom/android/server/ibl;->R:Z
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/android/server/ibl;->vdb:Ljava/util/ArrayList;
    ...
    iput-object v0, p0, Lcom/android/server/ibl;->cjf:Ljava/util/ArrayList;

    new-instance v0, Ljava/lang/Object;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    iput-object v0, p0, Lcom/android/server/ibl;->ire:Ljava/lang/Object;

    const/4 v0, 0x1

    iput-boolean v0, p0, Lcom/android/server/ibl;->hmo:Z

    const-wide/16 v2, 0xc00

    iput-wide v2, p0, Lcom/android/server/ibl;->fto:J

    new-instance v2, Ljava/util/HashSet;

    invoke-direct {v2}, Ljava/util/HashSet;-><init>()V

    iput-object v2, p0, Lcom/android/server/ibl;->lqr:Ljava/util/HashSet;

    iput-boolean v1, p0, Lcom/android/server/ibl;->cgv:Z

    new-instance v2, Ljava/util/ArrayList;

    invoke-direct {v2}, Ljava/util/ArrayList;-><init>()V

    iput-object v2, p0, Lcom/android/server/ibl;->vju:Ljava/util/ArrayList;

    new-instance v2, Ljava/util/ArrayList;

    invoke-direct {v2}, Ljava/util/ArrayList;-><init>()V

    iput-object v2, p0, Lcom/android/server/ibl;->bud:Ljava/util/ArrayList;
    ...
    iput-object v2, p0, Lcom/android/server/ibl;->irq:Landroid/os/Handler;

    iput-boolean v0, p0, Lcom/android/server/ibl;->vdw:Z

    iput-boolean v1, p0, Lcom/android/server/ibl;->qeg:Z

    new-instance v2, Ljava/lang/Object;

    invoke-direct {v2}, Ljava/lang/Object;-><init>()V

    iput-object v2, p0, Lcom/android/server/ibl;->ivd:Ljava/lang/Object;

    new-instance v2, Ljava/util/HashMap;

    invoke-direct {v2}, Ljava/util/HashMap;-><init>()V

    iput-object v2, p0, Lcom/android/server/ibl;->b:Ljava/util/HashMap;

    iput-boolean v0, p0, Lcom/android/server/ibl;->c:Z

    iput-boolean v1, p0, Lcom/android/server/ibl;->d:Z

    const/4 v0, 0x2

    iput v0, p0, Lcom/android/server/ibl;->e:I

    const/4 v0, -0x1

    iput v0, p0, Lcom/android/server/ibl;->f:I
    ...
    iput-object v0, p0, Lcom/android/server/ibl;->g:Landroid/content/BroadcastReceiver;
...
.method private declared-synchronized a()V
    ...
    iget-object v2, p0, Lcom/android/server/ibl;->cjf:Ljava/util/ArrayList;
    ...
    iget-object v5, p0, Lcom/android/server/ibl;->cjf:Ljava/util/ArrayList;
    ...
    :cond_0
    sget-boolean v1, Lcom/android/server/ibl;->h:Z
    ...
    iget-object v3, p0, Lcom/android/server/ibl;->cjf:Ljava/util/ArrayList;
...
.method private b(Lorg/json/JSONArray;)V
    ...
    :cond_0
    iget-object v2, p0, Lcom/android/server/ibl;->vdb:Ljava/util/ArrayList;
    ...
    iget-object v5, p0, Lcom/android/server/ibl;->vdb:Ljava/util/ArrayList;
    ...
    :cond_1
    sget-boolean v5, Lcom/android/server/ibl;->h:Z
    ...
    sget-boolean p1, Lcom/android/server/ibl;->h:Z
    ...
    iget-object p0, p0, Lcom/android/server/ibl;->vdb:Ljava/util/ArrayList;
    ...
    :goto_3
    iget-boolean v2, p0, Lcom/android/server/ibl;->zgw:Z

    if-nez v2, :cond_5

    iput-boolean v3, p0, Lcom/android/server/ibl;->zgw:Z

    sget-boolean v2, Lcom/android/server/ibl;->h:Z
...
.method static synthetic bio(Lcom/android/server/ibl;)Z
    .locals 0

    iget-boolean p0, p0, Lcom/android/server/ibl;->vdw:Z
...
.method static synthetic bvj()Z
    ...
    sget-boolean v0, Lcom/android/server/ibl;->B:Z
...
.method private c(Ljava/lang/String;)V
    ...
    sget-boolean v0, Lcom/android/server/ibl;->h:Z
    ...
    invoke-direct {p0, v0}, Lcom/android/server/ibl;->d(Lorg/json/JSONArray;)V
...
.method private cjf(Z)V
    ...
    iget-boolean v1, p0, Lcom/android/server/ibl;->d:Z

    if-ne v1, p1, :cond_0

    iget v1, p0, Lcom/android/server/ibl;->f:I
    ...
    invoke-direct {p0, v4, v0, v1, v1}, Lcom/android/server/ibl;->j(IIII)V
    ...
    invoke-direct {p0, v4, v0, v4, v1}, Lcom/android/server/ibl;->j(IIII)V
...
.method private d(Lorg/json/JSONArray;)V
    ...
    iget-object v3, p0, Lcom/android/server/ibl;->ire:Ljava/lang/Object;
    ...
    iput-boolean v2, p0, Lcom/android/server/ibl;->hmo:Z
    ...
    iput-wide v4, p0, Lcom/android/server/ibl;->fto:J
    ...
    iget-object v4, p0, Lcom/android/server/ibl;->lqr:Ljava/util/HashSet;
    ...
    iget-object v6, p0, Lcom/android/server/ibl;->lqr:Ljava/util/HashSet;
    ...
    iget-object v0, p0, Lcom/android/server/ibl;->lqr:Ljava/util/HashSet;
    ...
    iget-boolean v0, p0, Lcom/android/server/ibl;->hmo:Z
    ...
    iget-wide v0, p0, Lcom/android/server/ibl;->fto:J
    ...
    iget-object v1, p0, Lcom/android/server/ibl;->lqr:Ljava/util/HashSet;
    ...
    iget-boolean v1, p0, Lcom/android/server/ibl;->hmo:Z
    ...
    iget-wide v1, p0, Lcom/android/server/ibl;->fto:J
...
.method static synthetic dma()Z
    ...
    sget-boolean v0, Lcom/android/server/ibl;->R:Z
...
.method private ear()V
    ...
    iget-object v0, p0, Lcom/android/server/ibl;->irq:Landroid/os/Handler;
    ...
    :cond_3
    sget-boolean v2, Lcom/android/server/ibl;->R:Z
    ...
    :cond_4
    sget-boolean v2, Lcom/android/server/ibl;->B:Z
    ...
    iget-object p0, p0, Lcom/android/server/ibl;->irq:Landroid/os/Handler;
    ...
    :cond_6
    sget-boolean p0, Lcom/android/server/ibl;->h:Z
...
.method public static fto()Lcom/android/server/ibl;
    .locals 1

    sget-object v0, Lcom/android/server/ibl;->j:Lcom/android/server/ibl;
...
.method static synthetic gck(Lcom/android/server/ibl;Z)V
    ...
    invoke-direct {p0, p1}, Lcom/android/server/ibl;->cjf(Z)V

    return-void
.end method

.method static synthetic gwm(Lcom/android/server/ibl;)Landroid/content/Context;
    .locals 0
...
.method private h(Lorg/json/JSONArray;)V
    ...
    :cond_0
    iget-object v0, p0, Lcom/android/server/ibl;->ivd:Ljava/lang/Object;

    monitor-enter v0

    :try_start_0
    iget-object v1, p0, Lcom/android/server/ibl;->b:Ljava/util/HashMap;
    ...
    iget-object v6, p0, Lcom/android/server/ibl;->ivd:Ljava/lang/Object;
    ...
    :try_start_2
    iget-object v8, p0, Lcom/android/server/ibl;->b:Ljava/util/HashMap;
    ...
    invoke-direct {p0, v3}, Lcom/android/server/ibl;->n(Z)V
    ...
    iget-object v3, p0, Lcom/android/server/ibl;->ivd:Ljava/lang/Object;
    ...
    iput v2, p0, Lcom/android/server/ibl;->e:I
    ...
    iget v5, p0, Lcom/android/server/ibl;->e:I
...
.method private static hmo()Ljava/lang/Object;
    .locals 9
...
.method private i(Lorg/json/JSONArray;)V
    ...
    :cond_0
    iget-object v2, p0, Lcom/android/server/ibl;->vju:Ljava/util/ArrayList;
    ...
    iget-object v5, p0, Lcom/android/server/ibl;->vju:Ljava/util/ArrayList;
    ...
    iget-object p0, p0, Lcom/android/server/ibl;->vju:Ljava/util/ArrayList;
...
.method static synthetic ibl(Lcom/android/server/ibl;)V
    .locals 0

    invoke-direct {p0}, Lcom/android/server/ibl;->a()V
...
.method static synthetic igw(Lcom/android/server/ibl;)Z
    ...
    iget-boolean p0, p0, Lcom/android/server/ibl;->c:Z
...
.method private irq()Z
    ...
    iget-object v0, p0, Lcom/android/server/ibl;->ire:Ljava/lang/Object;

    monitor-enter v0

    :try_start_0
    iget-boolean p0, p0, Lcom/android/server/ibl;->hmo:Z
...
.method private j(IIII)V
    ...
    invoke-direct {p0, p2, p1}, Lcom/android/server/ibl;->k(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    :goto_0
    iput-boolean p1, p0, Lcom/android/server/ibl;->d:Z
...
.method private k(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    sget-boolean v3, Lcom/android/server/ibl;->h:Z
...
.method static synthetic kth(Lcom/android/server/ibl;)Ljava/lang/Object;
    .locals 0

    iget-object p0, p0, Lcom/android/server/ibl;->ivd:Ljava/lang/Object;
...
.method private l(Z)V
    ...
    iget-boolean v0, p0, Lcom/android/server/ibl;->c:Z
    ...
    invoke-direct {p0, v0, p1}, Lcom/android/server/ibl;->k(Ljava/lang/String;Ljava/lang/String;)Z
...
.method private les()V
    ...
    iget-object v1, p0, Lcom/android/server/ibl;->ivd:Ljava/lang/Object;

    monitor-enter v1

    :try_start_0
    iget-object p0, p0, Lcom/android/server/ibl;->b:Ljava/util/HashMap;
...
.method private n(Z)V
    ...
    :try_start_0
    iput-boolean p1, p0, Lcom/android/server/ibl;->c:Z
    ...
    iget-boolean p1, p0, Lcom/android/server/ibl;->c:Z
    ...
    invoke-direct {p0, p1}, Lcom/android/server/ibl;->l(Z)V
...
.method private o(Z)V
    ...
    :try_start_0
    iput-boolean p1, p0, Lcom/android/server/ibl;->vdw:Z
...
.method static synthetic oif(Lcom/android/server/ibl;Lorg/json/JSONArray;)V
    .locals 0
...
.method static synthetic qbh(Lcom/android/server/ibl;Z)V
    .locals 0
...
.method private qeg(ZI)V
    .locals 8

    const-string v0, "CommonFrontMonitor"

    :try_start_0
    invoke-static {}, Lcom/android/server/ibl;->hmo()Ljava/lang/Object;
...
.method static synthetic vdb(Lcom/android/server/ibl;)Landroid/os/Handler;
    .locals 0
...
.method private vdw(Ljava/lang/String;)Z
    .locals 1
    ...
    :try_start_0
    iget-object p0, p0, Lcom/android/server/ibl;->lqr:Ljava/util/HashSet;
...
.method static synthetic wtn(Lcom/android/server/ibl;)I
    .locals 0

    iget p0, p0, Lcom/android/server/ibl;->e:I
...
.method static synthetic you(Lcom/android/server/ibl;Ljava/lang/String;)V
    ...
    invoke-direct {p0, p1}, Lcom/android/server/ibl;->c(Ljava/lang/String;)V

    return-void
.end method

.method static synthetic ywr(Lcom/android/server/ibl;Ljava/lang/String;Ljava/lang/String;)Z
    .locals 0

    invoke-direct {p0, p1, p2}, Lcom/android/server/ibl;->k(Ljava/lang/String;Ljava/lang/String;)Z
...
.method static synthetic zgw(Lcom/android/server/ibl;Lorg/json/JSONArray;)V
    .locals 0
...
.method public bud(Landroid/content/Context;)V
    ...
    :cond_1
    invoke-direct {p0}, Lcom/android/server/ibl;->les()V

    new-instance p1, Lcom/oneplus/config/ConfigObserver;

    iget-object v0, p0, Lcom/android/server/ibl;->zta:Landroid/content/Context;

    iget-object v1, p0, Lcom/android/server/ibl;->irq:Landroid/os/Handler;
    ...
    iput-object p1, p0, Lcom/android/server/ibl;->a:Lcom/oneplus/config/ConfigObserver;
    ...
    iget-object p1, p0, Lcom/android/server/ibl;->les:Ljava/lang/Object;
    ...
    invoke-direct {p0}, Lcom/android/server/ibl;->cgv()Z

    move-result v1

    if-eqz v1, :cond_2

    invoke-virtual {p0, v0}, Lcom/android/server/ibl;->p(Z)V

    :cond_2
    sget-boolean v1, Lcom/android/server/ibl;->B:Z

    if-eqz v1, :cond_3

    invoke-direct {p0, v3}, Lcom/android/server/ibl;->m(Z)V
    ...
    iget-object v4, p0, Lcom/android/server/ibl;->irq:Landroid/os/Handler;
    ...
    iput-object p1, p0, Lcom/android/server/ibl;->obl:Landroid/database/ContentObserver;
    ...
    sget-object v1, Lcom/android/server/ibl;->H:Landroid/net/Uri;

    iget-object v4, p0, Lcom/android/server/ibl;->obl:Landroid/database/ContentObserver;
    ...
    iget-object v2, p0, Lcom/android/server/ibl;->irq:Landroid/os/Handler;
    ...
    iput-object p1, p0, Lcom/android/server/ibl;->ear:Lcom/oneplus/config/ConfigObserver;
    ...
    iget-object p1, p0, Lcom/android/server/ibl;->bud:Ljava/util/ArrayList;
    ...
    sget-object v1, Lcom/android/server/ibl;->u:Landroid/net/Uri;
    ...
    iput-object p1, p0, Lcom/android/server/ibl;->oxb:Landroid/database/ContentObserver;
    ...
    iget-object v2, p0, Lcom/android/server/ibl;->oxb:Landroid/database/ContentObserver;
    ...
    new-instance v4, Lcom/android/server/ibl$qbh;

    invoke-direct {v4, p0}, Lcom/android/server/ibl$qbh;-><init>(Lcom/android/server/ibl;)V
    ...
    new-instance v2, Lcom/android/server/ibl$oif;

    invoke-direct {v2, p0}, Lcom/android/server/ibl$oif;-><init>(Lcom/android/server/ibl;)V
    ...
    :cond_b
    sget-boolean p1, Lcom/android/server/ibl;->B:Z
    ...
    new-instance v2, Lcom/android/server/ibl$ywr;

    invoke-direct {v2, p0}, Lcom/android/server/ibl$ywr;-><init>(Lcom/android/server/ibl;)V

    const-string v3, "WhitelistAdaptiveColorGamutConfig"

    invoke-direct {p1, v0, v1, v2, v3}, Lcom/oneplus/config/ConfigObserver;-><init>(Landroid/content/Context;Landroid/os/Handler;Lcom/oneplus/config/ConfigObserver$ConfigUpdater;Ljava/lang/String;)V

    iput-object p1, p0, Lcom/android/server/ibl;->ugm:Lcom/oneplus/config/ConfigObserver;
    ...
    sget-boolean p1, Lcom/android/server/ibl;->R:Z
    ...
    :cond_f
    iget-object p1, p0, Lcom/android/server/ibl;->lqr:Ljava/util/HashSet;
    ...
    iput-object p1, p0, Lcom/android/server/ibl;->veq:Lcom/oneplus/config/ConfigObserver;

    invoke-virtual {p1}, Lcom/oneplus/config/ConfigObserver;->register()V

    :cond_10
    invoke-direct {p0}, Lcom/android/server/ibl;->ear()V

    iget-object p1, p0, Lcom/android/server/ibl;->zta:Landroid/content/Context;

    iget-object p0, p0, Lcom/android/server/ibl;->g:Landroid/content/BroadcastReceiver;
...
.method public frontPackageChanged(Ljava/lang/String;IILjava/lang/String;II)V
    ...
    iget-object p2, p0, Lcom/android/server/ibl;->les:Ljava/lang/Object;

    monitor-enter p2

    :try_start_0
    sget-boolean p3, Lcom/android/server/ibl;->R:Z
    ...
    invoke-direct {p0}, Lcom/android/server/ibl;->irq()Z

    move-result p3

    if-eqz p3, :cond_2

    invoke-direct {p0, p1}, Lcom/android/server/ibl;->vdw(Ljava/lang/String;)Z

    move-result p3

    if-eqz p3, :cond_0

    iget-boolean p3, p0, Lcom/android/server/ibl;->cgv:Z

    if-nez p3, :cond_0

    const-string p3, "/sys/module/memplus_core/parameters/memory_plus_wake_memex"

    invoke-direct {p0}, Lcom/android/server/ibl;->lqr()J
    ...
    invoke-direct {p0, p3, v0}, Lcom/android/server/ibl;->k(Ljava/lang/String;Ljava/lang/String;)Z

    iput-boolean p6, p0, Lcom/android/server/ibl;->cgv:Z
    ...
    iput-boolean p5, p0, Lcom/android/server/ibl;->cgv:Z

    :cond_1
    :goto_0
    sget-boolean p3, Lcom/android/server/ibl;->h:Z
    ...
    :cond_2
    invoke-direct {p0}, Lcom/android/server/ibl;->ire()Z
    ...
    iget-object p3, p0, Lcom/android/server/ibl;->irq:Landroid/os/Handler;
    ...
    iget-object p3, p0, Lcom/android/server/ibl;->bud:Ljava/util/ArrayList;
    ...
    invoke-virtual {p0, p5}, Lcom/android/server/ibl;->p(Z)V

    goto :goto_1

    :cond_4
    invoke-virtual {p0, p6}, Lcom/android/server/ibl;->p(Z)V
    ...
    iget-object v0, p0, Lcom/android/server/ibl;->cjf:Ljava/util/ArrayList;
    ...
    invoke-direct {p0, p3, p6}, Lcom/android/server/ibl;->qeg(ZI)V
    ...
    :cond_d
    sget-boolean p3, Lcom/android/server/ibl;->B:Z

    if-eqz p3, :cond_f

    iget-object p3, p0, Lcom/android/server/ibl;->vdb:Ljava/util/ArrayList;
    ...
    invoke-direct {p0, p6}, Lcom/android/server/ibl;->m(Z)V

    goto :goto_4

    :cond_e
    invoke-direct {p0, p5}, Lcom/android/server/ibl;->m(Z)V
...
.method public oxb(Ljava/util/ArrayList;)V
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public vju(II)V
    .locals 1

    iget-boolean v0, p0, Lcom/android/server/ibl;->vdw:Z
...
.method public zta(Ljava/lang/String;Ljava/lang/String;II)V
    ...
    iget-object p3, p0, Lcom/android/server/ibl;->ivd:Ljava/lang/Object;
    ...
    iget-object v0, p0, Lcom/android/server/ibl;->b:Ljava/util/HashMap;
