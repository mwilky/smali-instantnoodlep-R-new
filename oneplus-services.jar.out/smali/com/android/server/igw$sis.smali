...
# direct methods
.method public constructor <init>(Lcom/android/server/igw;Landroid/os/Handler;)V
    .locals 0

    iput-object p1, p0, Lcom/android/server/igw$sis;->zta:Lcom/android/server/igw;
...
.method public onChange(ZLandroid/net/Uri;)V
    ...
    iget-object v1, p0, Lcom/android/server/igw$sis;->zta:Lcom/android/server/igw;
    ...
    invoke-static {v1, p1}, Lcom/android/server/igw;->sis(Lcom/android/server/igw;I)I

    iget-object p1, p0, Lcom/android/server/igw$sis;->zta:Lcom/android/server/igw;
    ...
    invoke-static {p1}, Lcom/android/server/igw;->irq(Lcom/android/server/igw;)Lnet/oneplus/odm/OpDeviceManagerInjector;
    ...
    iget-object v4, p0, Lcom/android/server/igw$sis;->zta:Lcom/android/server/igw;
    ...
    iget-object v5, p0, Lcom/android/server/igw$sis;->zta:Lcom/android/server/igw;
    ...
    iget-object v0, p0, Lcom/android/server/igw$sis;->zta:Lcom/android/server/igw;

    invoke-static {v0, v3, v4}, Lcom/android/server/igw;->f(Lcom/android/server/igw;J)J

    new-instance v0, Ljava/lang/StringBuilder;

    invoke-direct {v0}, Ljava/lang/StringBuilder;-><init>()V

    iget-object v7, p0, Lcom/android/server/igw$sis;->zta:Lcom/android/server/igw;
    ...
    invoke-static {v7}, Lcom/android/server/igw;->ivd(Lcom/android/server/igw;)Landroid/content/Context;
    ...
    invoke-static {p1, v0, v6}, Lcom/android/server/igw;->g(Lcom/android/server/igw;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {p1, v3, v4}, Lcom/android/server/igw;->f(Lcom/android/server/igw;J)J

    new-instance p1, Ljava/lang/StringBuilder;

    invoke-direct {p1}, Ljava/lang/StringBuilder;-><init>()V

    iget-object p2, p0, Lcom/android/server/igw$sis;->zta:Lcom/android/server/igw;

    invoke-static {p2}, Lcom/android/server/igw;->e(Lcom/android/server/igw;)J
    ...
    invoke-static {p2}, Lcom/android/server/igw;->ivd(Lcom/android/server/igw;)Landroid/content/Context;
    ...
    iget-object p0, p0, Lcom/android/server/igw$sis;->zta:Lcom/android/server/igw;
