...
.method public handleMessage(Landroid/os/Message;)V
    ...
    iget-object v0, p0, Lcom/android/server/dma$you;->zta:Lcom/android/server/dma;

    invoke-virtual {v0}, Lcom/android/server/dma;->ugm()Z
    ...
    invoke-static {}, Lcom/android/server/dma;->you()Landroid/util/ArrayMap;
    ...
    :try_start_0
    invoke-static {}, Lcom/android/server/dma;->bio()Z
    ...
    check-cast p1, Lcom/android/server/dma$sis;

    if-eqz p1, :cond_5

    invoke-static {p1}, Lcom/android/server/dma$sis;->rtg(Lcom/android/server/dma$sis;)Z
    ...
    invoke-static {p1}, Lcom/android/server/dma$sis;->ssp(Lcom/android/server/dma$sis;)Ljava/lang/String;
    ...
    :cond_3
    invoke-static {p1}, Lcom/android/server/dma$sis;->cno(Lcom/android/server/dma$sis;)Z
    ...
    check-cast v2, Lcom/android/server/dma$sis;
    ...
    :cond_7
    invoke-virtual {v2}, Lcom/android/server/dma$sis;->kth()V
    ...
    :cond_9
    new-instance v2, Lcom/android/server/dma$sis;

    iget-object p0, p0, Lcom/android/server/dma$you;->zta:Lcom/android/server/dma;

    invoke-direct {v2, p0, v0, p1}, Lcom/android/server/dma$sis;-><init>(Lcom/android/server/dma;ILjava/lang/String;)V
    ...
    invoke-static {p0}, Lcom/android/server/dma;->zta(Lcom/android/server/dma;)V
