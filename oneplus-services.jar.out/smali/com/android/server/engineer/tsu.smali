.class public Lcom/android/server/engineer/tsu;
...
.method static constructor <clinit>()V
    ...
    const-class v0, Lcom/android/server/engineer/tsu;

    invoke-virtual {v0}, Ljava/lang/Class;->getSimpleName()Ljava/lang/String;

    move-result-object v0

    sput-object v0, Lcom/android/server/engineer/tsu;->cno:Ljava/lang/String;

    const/4 v0, 0x0

    sput-boolean v0, Lcom/android/server/engineer/tsu;->bio:Z
    ...
    sput-object v1, Lcom/android/server/engineer/tsu;->igw:Ljava/lang/String;
    ...
    sget-object v1, Lcom/android/server/engineer/tsu;->igw:Ljava/lang/String;
    ...
    :cond_0
    sput-boolean v0, Lcom/android/server/engineer/tsu;->wtn:Z
...
.method public constructor <init>(Lcom/android/server/engineer/OneplusEngineerService;Landroid/content/Context;)V
    ...
    new-instance v0, Lcom/android/server/engineer/tsu$zta;

    invoke-direct {v0, p0}, Lcom/android/server/engineer/tsu$zta;-><init>(Lcom/android/server/engineer/tsu;)V

    iput-object v0, p0, Lcom/android/server/engineer/tsu;->ssp:Landroid/content/BroadcastReceiver;

    iput-object p1, p0, Lcom/android/server/engineer/tsu;->zta:Lcom/android/server/engineer/OneplusEngineerService;

    iput-object p2, p0, Lcom/android/server/engineer/tsu;->you:Landroid/content/Context;
    ...
    iget-object p0, p0, Lcom/android/server/engineer/tsu;->ssp:Landroid/content/BroadcastReceiver;
...
.method private bio(Ljava/io/PrintWriter;)V
    ...
    iget-object p1, p0, Lcom/android/server/engineer/tsu;->you:Landroid/content/Context;

    const-string v0, "get_config_params"

    invoke-direct {p0, p1, v0}, Lcom/android/server/engineer/tsu;->kth(Landroid/content/Context;Ljava/lang/String;)V

    const/4 p0, 0x1

    sput-boolean p0, Lcom/android/server/engineer/tsu;->bio:Z

    :goto_0
    sget-boolean p0, Lcom/android/server/engineer/tsu;->bio:Z
...
.method private bvj(Ljava/lang/String;Ljava/io/PrintWriter;)V
    .locals 6
    ...
    invoke-static {p0, p1, v4}, Lcom/android/server/engineer/sis;->bio(I[BI)Z
    ...
    invoke-static {p0}, Lcom/android/server/engineer/rtg;->cjf([B)Z
    ...
    :cond_4
    iget-object p0, p0, Lcom/android/server/engineer/tsu;->zta:Lcom/android/server/engineer/OneplusEngineerService;
...
.method static synthetic cno(Lcom/android/server/engineer/tsu;Landroid/net/LocalServerSocket;)Landroid/net/LocalServerSocket;
    .locals 0

    iput-object p1, p0, Lcom/android/server/engineer/tsu;->tsu:Landroid/net/LocalServerSocket;
...
.method private gck()Ljava/lang/String;
    .locals 11
    ...
    invoke-static {v4}, Lcom/android/server/engineer/rtg;->sis([B)Ljava/lang/String;
    ...
    :try_start_0
    iget-object v6, p0, Lcom/android/server/engineer/tsu;->you:Landroid/content/Context;
    ...
    sget-object v7, Lcom/android/server/engineer/tsu;->cno:Ljava/lang/String;
    ...
    :goto_5
    invoke-direct {p0}, Lcom/android/server/engineer/tsu;->gwm()Z
...
.method private ibl(Ljava/lang/String;Ljava/io/PrintWriter;)V
    ...
    invoke-static {p0}, Lcom/android/server/engineer/rtg;->ibl(Ljava/lang/String;)Z
    ...
    invoke-static {p1, p0}, Lcom/android/server/engineer/rtg;->veq(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    :try_start_3
    invoke-static {p1, p0}, Lcom/android/server/engineer/rtg;->ear(IB)Z
    ...
    invoke-static {p0}, Lcom/android/server/engineer/rtg;->ywr(Ljava/lang/String;)Z
...
.method private igw(Ljava/io/PrintWriter;)V
    ...
    sget-boolean v0, Lcom/android/server/engineer/tsu;->wtn:Z
...
.method private kth(Landroid/content/Context;Ljava/lang/String;)V
    ...
    sget-object p0, Lcom/android/server/engineer/tsu;->cno:Ljava/lang/String;
...
.method private oif(Ljava/lang/String;Ljava/io/PrintWriter;)V
    .locals 10
    ...
    :pswitch_0
    invoke-direct {p0}, Lcom/android/server/engineer/tsu;->gck()Ljava/lang/String;
    ...
    :pswitch_1
    iget-object p0, p0, Lcom/android/server/engineer/tsu;->you:Landroid/content/Context;
    ...
    :pswitch_7
    invoke-static {}, Lcom/android/server/engineer/rtg;->gck()[B
    ...
    invoke-static {p0}, Lcom/android/server/engineer/rtg;->sis([B)Ljava/lang/String;
    ...
    invoke-static {p0, v3}, Lcom/android/server/engineer/rtg;->zgw(Ljava/lang/String;I)I
    ...
    invoke-static {p1, v4}, Lcom/android/server/engineer/rtg;->zgw(Ljava/lang/String;I)I
    ...
    new-instance v1, Lcom/android/server/engineer/tsu$you;

    const/4 v2, 0x0

    invoke-direct {v1, p0, v2}, Lcom/android/server/engineer/tsu$you;-><init>(Lcom/android/server/engineer/tsu;Lcom/android/server/engineer/tsu$zta;)V

    invoke-virtual {v1, p1}, Lcom/android/server/engineer/tsu$you;->zta(Ljava/lang/String;)Ljava/lang/String;
...
.method private qbh(Ljava/lang/String;Ljava/io/PrintWriter;)V
    .locals 20
    ...
    :sswitch_0
    const-string v6, "--execute_switch_log"
    ...
    :sswitch_1
    const-string v6, "--execute_start_mmi"
    ...
    :sswitch_2
    const-string v6, "--execute_show_production_message"
    ...
    :sswitch_3
    const-string v6, "--execute_switch_production_mode"
    ...
    :sswitch_4
    const-string v6, "--execute_engineer_order"
    ...
    :sswitch_5
    const-string v6, "--execute_launch_wifi_mmi"
    ...
    :sswitch_6
    const-string v6, "--execute_check_calibration_status"
    ...
    :sswitch_7
    const-string v6, "--execute_add_cover_ui"
    ...
    :sswitch_8
    const-string v6, "--execute_switch_wifi_mmi"
    ...
    :sswitch_9
    const-string v6, "--execute_power_off"
    ...
    :sswitch_a
    const-string v6, "--execute_model_test"
    ...
    :sswitch_b
    const-string v6, "--execute_stop_mmi"
    ...
    :sswitch_c
    const-string v6, "--execute_remove_cover_ui"
    ...
    :sswitch_d
    const-string v6, "--execute_check_key_status"
    ...
    :sswitch_e
    const-string v6, "--execute_start_dsocket"
    ...
    :sswitch_f
    const-string v6, "--execute_master_clear"
    ...
    :sswitch_10
    const-string v6, "--execute_reboot_device"
    ...
    :sswitch_11
    const-string v6, "--execute_detect_ms_result"
    ...
    :sswitch_12
    const-string v6, "--execute_stop_dsocket"
    ...
    const-string v13, "com.oneplus.factorymode.assistant.SmartCoverUIService"

    const-string v14, "com.oem.autotest.connector.AutoTestServer"

    const-string v15, "com.oem.autotest"

    const-string v11, "com.oem.engineermode.EngineerModeMain"

    const-string v7, "exception caught : "

    const-wide/16 v16, 0x1f4

    const-string v9, "FAIL:Error"

    const-string v10, "FAIL:ERROR"
    ...
    const-string v15, "FAIL:System Not Ready"
    ...
    invoke-direct {v0, v0}, Lcom/android/server/engineer/tsu;->ugm(Landroid/os/ShellCommand;)Landroid/content/Intent;
    ...
    new-instance v3, Lcom/android/server/engineer/tsu$you;

    const/4 v4, 0x0

    invoke-direct {v3, v0, v4}, Lcom/android/server/engineer/tsu$you;-><init>(Lcom/android/server/engineer/tsu;Lcom/android/server/engineer/tsu$zta;)V

    invoke-virtual {v3, v1}, Lcom/android/server/engineer/tsu$you;->zta(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v1}, Lcom/android/server/engineer/rtg;->oif(Ljava/lang/String;)Z

    move-result v4

    if-eqz v4, :cond_8

    invoke-static {v0}, Lcom/android/server/engineer/rtg;->gwm(Ljava/lang/String;)Z
    ...
    invoke-direct {v0, v1, v2}, Lcom/android/server/engineer/tsu;->kth(Landroid/content/Context;Ljava/lang/String;)V
    ...
    invoke-direct {v3, v8, v13}, Landroid/content/ComponentName;-><init>(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct {v0, v3, v1, v4}, Lcom/android/server/engineer/tsu;->zgw(Landroid/content/Context;Landroid/content/Intent;I)I
    ...
    invoke-direct {v0, v1, v3, v4}, Lcom/android/server/engineer/tsu;->zgw(Landroid/content/Context;Landroid/content/Intent;I)I
    ...
    :sswitch_data_0
    .sparse-switch
        -0x7430403c -> :sswitch_12
        -0x6f6b949c -> :sswitch_11
        -0x69f0f8ba -> :sswitch_10
        -0x5c039fa6 -> :sswitch_f
        -0x3d93faf0 -> :sswitch_e
        -0x1290a56d -> :sswitch_d
        -0x71598f3 -> :sswitch_c
        -0x5815fca -> :sswitch_b
        0xf240492 -> :sswitch_a
        0x26942d4b -> :sswitch_9
        0x35c1b0e0 -> :sswitch_8
        0x45553c24 -> :sswitch_7
        0x55700ba8 -> :sswitch_6
...
.method static synthetic rtg(Lcom/android/server/engineer/tsu;Landroid/net/LocalSocket;)Landroid/net/LocalSocket;
    .locals 0

    iput-object p1, p0, Lcom/android/server/engineer/tsu;->rtg:Landroid/net/LocalSocket;
...
.method static synthetic ssp(Lcom/android/server/engineer/tsu;)Landroid/net/LocalServerSocket;
    .locals 0

    iget-object p0, p0, Lcom/android/server/engineer/tsu;->tsu:Landroid/net/LocalServerSocket;

    return-object p0
.end method

.method static synthetic tsu(Lcom/android/server/engineer/tsu;)Landroid/net/LocalSocket;
    .locals 0

    iget-object p0, p0, Lcom/android/server/engineer/tsu;->rtg:Landroid/net/LocalSocket;

    return-object p0
.end method

.method private ugm(Landroid/os/ShellCommand;)Landroid/content/Intent;
    .locals 7
...
.method private vdb(B)I
    ...
    invoke-static {}, Lcom/android/server/engineer/rtg;->igw()Ljava/lang/Object;

    move-result-object v0

    if-eqz v0, :cond_0

    invoke-static {p0}, Lcom/android/server/engineer/rtg;->ssp(Ljava/util/ArrayList;)Ljava/util/ArrayList;
...
.method private wtn(Ljava/lang/String;Ljava/io/PrintWriter;)V
    .locals 11
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
    ...
    :cond_5
    invoke-static {p0}, Lcom/android/server/engineer/rtg;->fto(Ljava/util/ArrayList;)Ljava/lang/String;
    ...
    invoke-static {p1}, Lcom/android/server/engineer/rtg;->ssp(Ljava/util/ArrayList;)Ljava/util/ArrayList;
...
.method static synthetic you(Lcom/android/server/engineer/tsu;)Ljava/io/PrintWriter;
    .locals 0

    iget-object p0, p0, Lcom/android/server/engineer/tsu;->sis:Ljava/io/PrintWriter;

    return-object p0
.end method

.method private ywr(Ljava/lang/String;Ljava/io/PrintWriter;)V
    .locals 5
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
    ...
    :pswitch_1
    invoke-direct {p0, v2}, Lcom/android/server/engineer/tsu;->vdb(B)I
    ...
    invoke-direct {p0, p1, p2}, Lcom/android/server/engineer/tsu;->kth(Landroid/content/Context;Ljava/lang/String;)V

    sput-boolean v2, Lcom/android/server/engineer/tsu;->bio:Z
...
.method private zgw(Landroid/content/Context;Landroid/content/Intent;I)I
    .locals 12
...
.method public onCommand(Ljava/lang/String;)I
    ...
    iput-object v7, v1, Lcom/android/server/engineer/tsu;->sis:Ljava/io/PrintWriter;
    ...
    :try_start_0
    iget-object v7, v1, Lcom/android/server/engineer/tsu;->zta:Lcom/android/server/engineer/OneplusEngineerService;
    ...
    iget-object v3, v1, Lcom/android/server/engineer/tsu;->sis:Ljava/io/PrintWriter;
    ...
    invoke-static {v4, v13}, Lcom/android/server/engineer/rtg;->zgw(Ljava/lang/String;I)I
    ...
    iget-object v7, v1, Lcom/android/server/engineer/tsu;->sis:Ljava/io/PrintWriter;
    ...
    :cond_d
    :goto_5
    iget-object v5, v1, Lcom/android/server/engineer/tsu;->sis:Ljava/io/PrintWriter;
    ...
    iget-object v4, v1, Lcom/android/server/engineer/tsu;->sis:Ljava/io/PrintWriter;
    ...
    invoke-static {v4, v5}, Lcom/android/server/engineer/rtg;->zgw(Ljava/lang/String;I)I
    ...
    :pswitch_3
    :try_start_7
    iget-object v3, v1, Lcom/android/server/engineer/tsu;->zta:Lcom/android/server/engineer/OneplusEngineerService;
    ...
    iget-object v5, v1, Lcom/android/server/engineer/tsu;->zta:Lcom/android/server/engineer/OneplusEngineerService;
    ...
    iget-object v3, v1, Lcom/android/server/engineer/tsu;->you:Landroid/content/Context;
    ...
    iget-object v2, v1, Lcom/android/server/engineer/tsu;->sis:Ljava/io/PrintWriter;
    ...
    iget-object v1, v1, Lcom/android/server/engineer/tsu;->sis:Ljava/io/PrintWriter;
    ...
    iget-object v2, v1, Lcom/android/server/engineer/tsu;->zta:Lcom/android/server/engineer/OneplusEngineerService;
    ...
    invoke-static {v2}, Lcom/android/server/engineer/rtg;->ywr(Ljava/lang/String;)Z
    ...
    invoke-direct {v1, v2}, Lcom/android/server/engineer/tsu;->bio(Ljava/io/PrintWriter;)V
    :try_end_18
    ...
    invoke-direct {v1, v2, v3}, Lcom/android/server/engineer/tsu;->wtn(Ljava/lang/String;Ljava/io/PrintWriter;)V
    :try_end_1a
    ...
    invoke-direct {v1, v2}, Lcom/android/server/engineer/tsu;->igw(Ljava/io/PrintWriter;)V
    :try_end_1b
    ...
    invoke-direct {v1, v2, v3}, Lcom/android/server/engineer/tsu;->ywr(Ljava/lang/String;Ljava/io/PrintWriter;)V
    :try_end_1c
    ...
    :goto_16
    invoke-direct {v1, v2, v3}, Lcom/android/server/engineer/tsu;->qbh(Ljava/lang/String;Ljava/io/PrintWriter;)V
    ...
    invoke-direct {v1, v2, v3}, Lcom/android/server/engineer/tsu;->bvj(Ljava/lang/String;Ljava/io/PrintWriter;)V
    ...
    invoke-direct {v1, v2, v3}, Lcom/android/server/engineer/tsu;->ibl(Ljava/lang/String;Ljava/io/PrintWriter;)V
    ...
    invoke-direct {v1, v2, v3}, Lcom/android/server/engineer/tsu;->oif(Ljava/lang/String;Ljava/io/PrintWriter;)V
    :try_end_1d
