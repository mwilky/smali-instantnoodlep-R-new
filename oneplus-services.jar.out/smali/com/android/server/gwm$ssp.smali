.class Lcom/android/server/gwm$ssp;
...
.field final synthetic ear:Lcom/android/server/gwm;
...
# direct methods
.method constructor <init>(Lcom/android/server/gwm;Landroid/os/Handler;Landroid/content/Context;)V
    .locals 1

    iput-object p1, p0, Lcom/android/server/gwm$ssp;->ear:Lcom/android/server/gwm;
    ...
    iput-object p1, p0, Lcom/android/server/gwm$ssp;->wtn:Landroid/content/Intent;

    new-instance p1, Lcom/android/server/gwm$ssp$zta;

    invoke-direct {p1, p0}, Lcom/android/server/gwm$ssp$zta;-><init>(Lcom/android/server/gwm$ssp;)V

    iput-object p1, p0, Lcom/android/server/gwm$ssp;->cjf:Ljava/lang/Runnable;

    iput-object p2, p0, Lcom/android/server/gwm$ssp;->zta:Landroid/os/Handler;

    iput-object p3, p0, Lcom/android/server/gwm$ssp;->you:Landroid/content/Context;

    new-instance p1, Ljava/util/TreeMap;

    invoke-direct {p1}, Ljava/util/TreeMap;-><init>()V

    iput-object p1, p0, Lcom/android/server/gwm$ssp;->sis:Ljava/util/TreeMap;

    const/4 p1, 0x0

    iput-boolean p1, p0, Lcom/android/server/gwm$ssp;->oxb:Z

    const-wide/16 p2, 0x7d0

    iput-wide p2, p0, Lcom/android/server/gwm$ssp;->bvj:J

    iput-boolean p1, p0, Lcom/android/server/gwm$ssp;->zgw:Z
    ...
    iput-object p1, p0, Lcom/android/server/gwm$ssp;->gck:Ljava/text/DecimalFormat;

    iget-object p1, p0, Lcom/android/server/gwm$ssp;->wtn:Landroid/content/Intent;

    const-string p2, "com.android.systemui"

    invoke-virtual {p1, p2}, Landroid/content/Intent;->setPackage(Ljava/lang/String;)Landroid/content/Intent;

    iget-object p1, p0, Lcom/android/server/gwm$ssp;->sis:Ljava/util/TreeMap;
    ...
    invoke-direct {p0}, Lcom/android/server/gwm$ssp;->wtn()V
...
.method private bio()V
    ...
    iget v1, p0, Lcom/android/server/gwm$ssp;->ywr:F
    ...
    iget v1, p0, Lcom/android/server/gwm$ssp;->ugm:F

    div-float/2addr v2, v1

    iget-wide v3, p0, Lcom/android/server/gwm$ssp;->bvj:J
    ...
    iput-wide v1, p0, Lcom/android/server/gwm$ssp;->bvj:J

    new-instance v1, Ljava/lang/StringBuilder;

    invoke-direct {v1}, Ljava/lang/StringBuilder;-><init>()V

    iget-wide v2, p0, Lcom/android/server/gwm$ssp;->bvj:J
...
.method private bvj()V
    ...
    iput-boolean v0, p0, Lcom/android/server/gwm$ssp;->zgw:Z

    invoke-static {}, Ljava/lang/System;->currentTimeMillis()J

    move-result-wide v0

    iput-wide v0, p0, Lcom/android/server/gwm$ssp;->dma:J

    :try_start_0
    const-string v0, "/sys/class/power_supply/bms/remaining_capacity"

    invoke-static {v0}, Lcom/android/server/gwm;->oxb(Ljava/lang/String;)Ljava/lang/String;
    ...
    iget v1, p0, Lcom/android/server/gwm$ssp;->gwm:F
    ...
    iput v0, p0, Lcom/android/server/gwm$ssp;->oif:F
    :try_end_0
...
.method private cno(II)J
    ...
    invoke-direct {p0, p2}, Lcom/android/server/gwm$ssp;->igw(I)V
    ...
    iget-object p0, p0, Lcom/android/server/gwm$ssp;->obl:[I
...
.method private synthetic dma()V
    ...
    iget-object p0, p0, Lcom/android/server/gwm$ssp;->wtn:Landroid/content/Intent;
...
.method private igw(I)V
    ...
    iput-object v1, p0, Lcom/android/server/gwm$ssp;->obl:[I
...
.method private kth()V
    ...
    iget-object v1, p0, Lcom/android/server/gwm$ssp;->ear:Lcom/android/server/gwm;

    invoke-static {v1}, Lcom/android/server/gwm;->rtg(Lcom/android/server/gwm;)I
    ...
    iget v2, p0, Lcom/android/server/gwm$ssp;->vdb:F
    ...
    iget-object v3, p0, Lcom/android/server/gwm$ssp;->ear:Lcom/android/server/gwm;

    invoke-static {v3}, Lcom/android/server/gwm;->rtg(Lcom/android/server/gwm;)I
    ...
    iget v3, p0, Lcom/android/server/gwm$ssp;->ywr:F
    ...
    iput v0, p0, Lcom/android/server/gwm$ssp;->ywr:F
    ...
    iget v4, p0, Lcom/android/server/gwm$ssp;->ywr:F
    ...
    iget-object v4, p0, Lcom/android/server/gwm$ssp;->ear:Lcom/android/server/gwm;

    invoke-static {v4}, Lcom/android/server/gwm;->rtg(Lcom/android/server/gwm;)I
    ...
    iget v5, p0, Lcom/android/server/gwm$ssp;->ywr:F
    ...
    iget v5, p0, Lcom/android/server/gwm$ssp;->vdb:F
    ...
    iget v1, p0, Lcom/android/server/gwm$ssp;->vdb:F
    ...
    invoke-static {v0}, Lcom/android/server/gwm;->bio(Lcom/android/server/gwm;)Landroid/os/Handler;

    move-result-object v0

    new-instance v1, Lcom/android/server/zta;

    invoke-direct {v1, p0}, Lcom/android/server/zta;-><init>(Lcom/android/server/gwm$ssp;)V
...
.method private qbh()V
    ...
    invoke-static {v1}, Lcom/android/server/gwm;->oxb(Ljava/lang/String;)Ljava/lang/String;
    ...
    iput v1, p0, Lcom/android/server/gwm$ssp;->ibl:I
    ...
    iput v0, p0, Lcom/android/server/gwm$ssp;->qbh:F

    iget v0, p0, Lcom/android/server/gwm$ssp;->ibl:I

    iget-wide v1, p0, Lcom/android/server/gwm$ssp;->bvj:J

    invoke-direct {p0, v0, v1, v2}, Lcom/android/server/gwm$ssp;->rtg(IJ)F
    ...
    iget v1, p0, Lcom/android/server/gwm$ssp;->ibl:I
    ...
    iget v1, p0, Lcom/android/server/gwm$ssp;->qbh:F
...
.method private rtg(IJ)F
    ...
    iget p0, p0, Lcom/android/server/gwm$ssp;->gwm:F
...
.method private ssp(I)J
    ...
    :cond_1
    :try_start_0
    invoke-direct {p0}, Lcom/android/server/gwm$ssp;->qbh()V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0

    iget-object v0, p0, Lcom/android/server/gwm$ssp;->igw:Ljava/util/HashMap;
    ...
    iget-object v4, p0, Lcom/android/server/gwm$ssp;->sis:Ljava/util/TreeMap;

    iget v5, p0, Lcom/android/server/gwm$ssp;->qbh:F
    ...
    iget v5, p0, Lcom/android/server/gwm$ssp;->ibl:I
    ...
    iget v7, p0, Lcom/android/server/gwm$ssp;->qbh:F
    ...
    iget-object v2, p0, Lcom/android/server/gwm$ssp;->ear:Lcom/android/server/gwm;

    invoke-static {v2}, Lcom/android/server/gwm;->rtg(Lcom/android/server/gwm;)I

    move-result v2

    invoke-direct {p0, v2, p1}, Lcom/android/server/gwm$ssp;->cno(II)J
    ...
    invoke-direct {p0, v0, p1}, Lcom/android/server/gwm$ssp;->cno(II)J
    ...
    iget v0, p0, Lcom/android/server/gwm$ssp;->qbh:F
    ...
    invoke-direct {p0, p1}, Lcom/android/server/gwm$ssp;->sis(Ljava/lang/String;)V
...
.method private wtn()V
    ...
    iput-object v0, p0, Lcom/android/server/gwm$ssp;->tsu:Ljava/util/TreeMap;

    new-instance v0, Ljava/util/TreeMap;

    invoke-direct {v0}, Ljava/util/TreeMap;-><init>()V

    iput-object v0, p0, Lcom/android/server/gwm$ssp;->rtg:Ljava/util/TreeMap;

    new-instance v0, Ljava/util/TreeMap;

    invoke-direct {v0}, Ljava/util/TreeMap;-><init>()V

    iput-object v0, p0, Lcom/android/server/gwm$ssp;->ssp:Ljava/util/TreeMap;

    new-instance v0, Ljava/util/TreeMap;

    invoke-direct {v0}, Ljava/util/TreeMap;-><init>()V

    iput-object v0, p0, Lcom/android/server/gwm$ssp;->cno:Ljava/util/TreeMap;

    new-instance v0, Ljava/util/TreeMap;

    invoke-direct {v0}, Ljava/util/TreeMap;-><init>()V

    iput-object v0, p0, Lcom/android/server/gwm$ssp;->kth:Ljava/util/TreeMap;

    new-instance v0, Ljava/util/TreeMap;

    invoke-direct {v0}, Ljava/util/TreeMap;-><init>()V

    iput-object v0, p0, Lcom/android/server/gwm$ssp;->bio:Ljava/util/TreeMap;

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    iput-object v0, p0, Lcom/android/server/gwm$ssp;->igw:Ljava/util/HashMap;

    iget-object v0, p0, Lcom/android/server/gwm$ssp;->kth:Ljava/util/TreeMap;
    ...
    iget-object v0, p0, Lcom/android/server/gwm$ssp;->tsu:Ljava/util/TreeMap;
    ...
    iget-object v2, p0, Lcom/android/server/gwm$ssp;->tsu:Ljava/util/TreeMap;
    ...
    iget-object v2, p0, Lcom/android/server/gwm$ssp;->rtg:Ljava/util/TreeMap;
    ...
    iget-object v2, p0, Lcom/android/server/gwm$ssp;->ssp:Ljava/util/TreeMap;
    ...
    iget-object v2, p0, Lcom/android/server/gwm$ssp;->cno:Ljava/util/TreeMap;
    ...
    iget-object v2, p0, Lcom/android/server/gwm$ssp;->kth:Ljava/util/TreeMap;
    ...
    iget-object p0, p0, Lcom/android/server/gwm$ssp;->bio:Ljava/util/TreeMap;
...
.method static synthetic you(Lcom/android/server/gwm$ssp;)V
    .locals 0

    invoke-direct {p0}, Lcom/android/server/gwm$ssp;->bvj()V

    return-void
.end method

.method static synthetic zta(Lcom/android/server/gwm$ssp;I)J
    .locals 0

    invoke-direct {p0, p1}, Lcom/android/server/gwm$ssp;->ssp(I)J
...
.method oif(I)Z
    ...
    iput v0, p0, Lcom/android/server/gwm$ssp;->gwm:F
    ...
    invoke-direct {p0, v0, v1}, Lcom/android/server/gwm$ssp;->gck(FF)Z
    ...
    iput p1, p0, Lcom/android/server/gwm$ssp;->ywr:F
    ...
    iget-wide v2, p0, Lcom/android/server/gwm$ssp;->dma:J
    ...
    iget v1, p0, Lcom/android/server/gwm$ssp;->oif:F
    ...
    iput v1, p0, Lcom/android/server/gwm$ssp;->ywr:F
    ...
    :cond_2
    :goto_0
    invoke-virtual {p0}, Lcom/android/server/gwm$ssp;->tsu()V
...
.method tsu()V
    ...
    :try_start_1
    iget-object v1, p0, Lcom/android/server/gwm$ssp;->sis:Ljava/util/TreeMap;

    iget-object v2, p0, Lcom/android/server/gwm$ssp;->sis:Ljava/util/TreeMap;

    iget v3, p0, Lcom/android/server/gwm$ssp;->qbh:F
    ...
    invoke-direct {p0, v1, v2, v3}, Lcom/android/server/gwm$ssp;->rtg(IJ)F

    move-result v1

    iput v1, p0, Lcom/android/server/gwm$ssp;->ugm:F
    :try_end_1
    .catch Ljava/lang/Exception; {:try_start_1 .. :try_end_1} :catch_0
    ...
    iget v2, p0, Lcom/android/server/gwm$ssp;->ywr:F
    ...
    iget v2, p0, Lcom/android/server/gwm$ssp;->qbh:F
    ...
    invoke-direct {p0, v1}, Lcom/android/server/gwm$ssp;->sis(Ljava/lang/String;)V
    ...
    invoke-direct {p0}, Lcom/android/server/gwm$ssp;->bio()V
    ...
    invoke-direct {p0}, Lcom/android/server/gwm$ssp;->kth()V
...
.method public synthetic ywr()V
    ...
    invoke-direct {p0}, Lcom/android/server/gwm$ssp;->dma()V
