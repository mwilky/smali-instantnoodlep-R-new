.class Lcom/android/server/policy/OpPhoneWindowManager$KillApp;
.super Ljava/lang/Object;
.source "OpPhoneWindowManager.java"
...
.method constructor <init>(Lcom/android/server/policy/OpPhoneWindowManager;)V
    ...
    iput-object p1, p0, Lcom/android/server/policy/OpPhoneWindowManager$KillApp;->this$0:Lcom/android/server/policy/OpPhoneWindowManager;
...
.method private getApplicationNameFromPageName(Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-object v4, p0, Lcom/android/server/policy/OpPhoneWindowManager$KillApp;->this$0:Lcom/android/server/policy/OpPhoneWindowManager;

    iget-object v4, v4, Lcom/android/server/policy/OpPhoneWindowManager;->mContext:Landroid/content/Context;
...
.method public run()V
    ...
    iget-object v10, p0, Lcom/android/server/policy/OpPhoneWindowManager$KillApp;->this$0:Lcom/android/server/policy/OpPhoneWindowManager;

    iget-object v7, v10, Lcom/android/server/policy/OpPhoneWindowManager;->mContext:Landroid/content/Context;
    ...
    invoke-direct {p0, v5}, Lcom/android/server/policy/OpPhoneWindowManager$KillApp;->isWhitelisted(Ljava/lang/String;)Z

    move-result v6

    if-nez v6, :cond_1

    invoke-direct {p0, v5}, Lcom/android/server/policy/OpPhoneWindowManager$KillApp;->isHomeApplication(Ljava/lang/String;)Z
    ...
    :goto_0
    invoke-direct {p0, v5}, Lcom/android/server/policy/OpPhoneWindowManager$KillApp;->getApplicationNameFromPageName(Ljava/lang/String;)Ljava/lang/String;
