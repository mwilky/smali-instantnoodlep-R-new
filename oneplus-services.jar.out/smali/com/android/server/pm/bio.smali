...
# static fields
.field private static final cno:Ljava/lang/String; = "PackageManager[ReserveApp]"

.field private static final kth:Ljava/util/List;
...
.field private sis:Lcom/android/server/pm/PackageManagerService$PmsInner;

.field private ssp:Lcom/android/server/pm/cno;

.field private tsu:Lcom/android/server/pm/parsing/PackageParser2;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/android/server/pm/bio;->kth:Ljava/util/List;
    ...
    sget-object v0, Lcom/android/server/pm/bio;->kth:Ljava/util/List;
    ...
    sget-object v1, Lcom/android/server/pm/bio;->kth:Ljava/util/List;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/android/server/pm/bio;->ssp:Lcom/android/server/pm/cno;
...
.method public addForInitLI(Lcom/android/server/pm/PackageManagerService;Lcom/android/server/pm/parsing/pkg/ParsedPackage;Lcom/android/server/pm/PackageSetting;Ljava/io/File;Ljava/lang/String;Ljava/lang/String;JZ)Z
    ...
    :cond_5
    iget-object p4, p0, Lcom/android/server/pm/bio;->sis:Lcom/android/server/pm/PackageManagerService$PmsInner;
...
.method public collectReserveApps(I)V
    ...
    iget-object v1, v0, Lcom/android/server/pm/bio;->sis:Lcom/android/server/pm/PackageManagerService$PmsInner;

    const/4 v3, 0x0

    const-wide/16 v5, 0x0

    iget-object v7, v0, Lcom/android/server/pm/bio;->tsu:Lcom/android/server/pm/parsing/PackageParser2;

    iget-object v8, v0, Lcom/android/server/pm/bio;->rtg:Ljava/util/concurrent/ExecutorService;
    ...
    iget-object v10, v0, Lcom/android/server/pm/bio;->sis:Lcom/android/server/pm/PackageManagerService$PmsInner;

    const/4 v12, 0x0

    const-wide/16 v14, 0x0

    iget-object v1, v0, Lcom/android/server/pm/bio;->tsu:Lcom/android/server/pm/parsing/PackageParser2;

    iget-object v2, v0, Lcom/android/server/pm/bio;->rtg:Ljava/util/concurrent/ExecutorService;
    ...
    iget-object v2, v0, Lcom/android/server/pm/bio;->sis:Lcom/android/server/pm/PackageManagerService$PmsInner;

    const/16 v18, 0x0

    const-wide/16 v20, 0x0

    iget-object v3, v0, Lcom/android/server/pm/bio;->tsu:Lcom/android/server/pm/parsing/PackageParser2;

    iget-object v4, v0, Lcom/android/server/pm/bio;->rtg:Ljava/util/concurrent/ExecutorService;
    ...
    :cond_2
    iget-object v0, v0, Lcom/android/server/pm/bio;->ssp:Lcom/android/server/pm/cno;
...
.method public initInstance(Lcom/android/server/pm/PackageManagerService$PmsInner;Lcom/android/server/pm/parsing/PackageParser2;Ljava/util/concurrent/ExecutorService;)V
    ...
    iput-object p1, p0, Lcom/android/server/pm/bio;->sis:Lcom/android/server/pm/PackageManagerService$PmsInner;

    iput-object p2, p0, Lcom/android/server/pm/bio;->tsu:Lcom/android/server/pm/parsing/PackageParser2;

    iput-object p3, p0, Lcom/android/server/pm/bio;->rtg:Ljava/util/concurrent/ExecutorService;
...
.method public isReserveApp(Ljava/lang/String;)Z
    ...
    iget-object p0, p0, Lcom/android/server/pm/bio;->ssp:Lcom/android/server/pm/cno;
...
.method public pruneNonExistReserveApps(Ljava/util/Collection;Landroid/util/ArrayMap;)V
    ...
    const-string v0, " no longer exists; its data will be wiped"
