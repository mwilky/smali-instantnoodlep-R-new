...
.field private static obl:Lcom/android/server/pm/you; = null
...
# instance fields
.field final bio:Lcom/android/server/pm/you$zta;
...
.method static constructor <clinit>()V
    ...
    sput-boolean v0, Lcom/android/server/pm/you;->oif:Z
    ...
    sput-boolean v0, Lcom/android/server/pm/you;->gwm:Z

    sput-boolean v0, Lcom/android/server/pm/you;->ugm:Z

    const/4 v0, 0x0

    sput-object v0, Lcom/android/server/pm/you;->obl:Lcom/android/server/pm/you;
...
.method private constructor <init>()V
    ...
    iput-boolean v0, p0, Lcom/android/server/pm/you;->gck:Z

    const-string v1, "unlocked"

    iput-object v1, p0, Lcom/android/server/pm/you;->dma:Ljava/lang/String;

    iput v0, p0, Lcom/android/server/pm/you;->ywr:I
    ...
    iput-object v0, p0, Lcom/android/server/pm/you;->kth:Lcom/android/server/ServiceThread;

    invoke-virtual {v0}, Lcom/android/server/ServiceThread;->start()V

    new-instance v0, Lcom/android/server/pm/you$zta;

    iget-object v1, p0, Lcom/android/server/pm/you;->kth:Lcom/android/server/ServiceThread;
    ...
    iput-object v0, p0, Lcom/android/server/pm/you;->bio:Lcom/android/server/pm/you$zta;
...
.method static synthetic bio(Lcom/android/server/pm/you;)Ljava/util/ArrayList;
    .locals 0
...
.method static synthetic cno(Lcom/android/server/pm/you;)V
    .locals 0

    invoke-direct {p0}, Lcom/android/server/pm/you;->ugm()V
...
.method private declared-synchronized dma()V
    ...
    iget-object v0, p0, Lcom/android/server/pm/you;->sis:Ljava/util/ArrayList;
...
.method static synthetic gck(Lcom/android/server/pm/you;Ljava/lang/String;)V
    .locals 0

    invoke-direct {p0, p1}, Lcom/android/server/pm/you;->oif(Ljava/lang/String;)V
...
.method private gwm(Lorg/json/JSONArray;)V
    ...
    iget-object v2, p0, Lcom/android/server/pm/you;->rtg:Ljava/util/ArrayList;
    ...
    :try_start_1
    iget-object v4, p0, Lcom/android/server/pm/you;->ssp:Ljava/util/ArrayList;
    ...
    sget-boolean v3, Lcom/android/server/pm/you;->ibl:Z

    if-eq v2, v3, :cond_a

    sput-boolean v2, Lcom/android/server/pm/you;->ibl:Z
    ...
    invoke-virtual {p0, v2}, Lcom/android/server/pm/you;->zgw(Z)V
...
.method private ibl(Ljava/lang/String;Ljava/lang/String;Z)Z
    ...
    iget v0, p0, Lcom/android/server/pm/you;->ywr:I

    const/4 v1, 0x0

    if-nez v0, :cond_8

    iget-object v0, p0, Lcom/android/server/pm/you;->igw:Lcom/android/server/pm/PackageManagerService;
    ...
    sget-boolean v2, Lcom/android/server/pm/you;->gwm:Z
    ...
    sget-boolean v2, Lcom/android/server/pm/you;->ugm:Z
    ...
    :try_start_0
    iget-object p0, p0, Lcom/android/server/pm/you;->igw:Lcom/android/server/pm/PackageManagerService;
...
.method static synthetic igw(Lcom/android/server/pm/you;)Ljava/util/ArrayList;
    .locals 0
...
.method static synthetic kth(Lcom/android/server/pm/you;)Ljava/util/ArrayList;
    .locals 0
...
.method static synthetic rtg(Lcom/android/server/pm/you;Ljava/lang/String;)Ljava/lang/String;
    .locals 0

    iput-object p1, p0, Lcom/android/server/pm/you;->dma:Ljava/lang/String;

    return-object p1
.end method

.method static synthetic sis(Lcom/android/server/pm/you;Lorg/json/JSONArray;)V
    .locals 0

    invoke-direct {p0, p1}, Lcom/android/server/pm/you;->gwm(Lorg/json/JSONArray;)V

    return-void
.end method

.method static synthetic ssp(Lcom/android/server/pm/you;Ljava/lang/String;Ljava/lang/String;Z)Z
    .locals 0

    invoke-direct {p0, p1, p2, p3}, Lcom/android/server/pm/you;->ibl(Ljava/lang/String;Ljava/lang/String;Z)Z
...
.method static synthetic tsu(Lcom/android/server/pm/you;)Ljava/lang/String;
    .locals 0

    iget-object p0, p0, Lcom/android/server/pm/you;->dma:Ljava/lang/String;
...
.method private ugm()V
    ...
    iput-boolean v1, p0, Lcom/android/server/pm/you;->gck:Z

    sget-boolean v1, Lcom/android/server/pm/you;->oif:Z
...
.method private vdb(ILjava/lang/String;Ljava/lang/String;)V
    ...
    iget-object v0, p0, Lcom/android/server/pm/you;->bio:Lcom/android/server/pm/you$zta;
    ...
    iget-object p0, p0, Lcom/android/server/pm/you;->bio:Lcom/android/server/pm/you$zta;
...
.method static synthetic wtn(Lcom/android/server/pm/you;Ljava/lang/String;)V
    .locals 0

    invoke-direct {p0, p1}, Lcom/android/server/pm/you;->qbh(Ljava/lang/String;)V
...
.method public static ywr(Landroid/content/Context;)Lcom/android/server/pm/you;
    .locals 1

    sget-object v0, Lcom/android/server/pm/you;->obl:Lcom/android/server/pm/you;
    ...
    :cond_0
    sput-object p0, Lcom/android/server/pm/you;->oxb:Landroid/content/Context;

    sget-object p0, Lcom/android/server/pm/you;->obl:Lcom/android/server/pm/you;
...
.method public bvj()V
    ...
    sget-object v1, Lcom/android/server/pm/you;->oxb:Landroid/content/Context;

    iget-object v2, p0, Lcom/android/server/pm/you;->bio:Lcom/android/server/pm/you$zta;
    ...
    iput-object v0, p0, Lcom/android/server/pm/you;->wtn:Lcom/oneplus/config/ConfigObserver;
...
.method public frontPackageChanged(Ljava/lang/String;IILjava/lang/String;II)V
    ...
    iget p2, p0, Lcom/android/server/pm/you;->ywr:I
    ...
    :cond_1
    iget-object p1, p0, Lcom/android/server/pm/you;->tsu:Ljava/util/ArrayList;

    monitor-enter p1

    :try_start_0
    iget-object p2, p0, Lcom/android/server/pm/you;->tsu:Ljava/util/ArrayList;
...
.method public initInstance(Lcom/android/server/pm/PackageManagerService;)V
    ...
    iput-object p1, p0, Lcom/android/server/pm/you;->igw:Lcom/android/server/pm/PackageManagerService;

    iget-boolean p1, p0, Lcom/android/server/pm/you;->gck:Z
...
.method public notifyDexoptSecondaryDex(Ljava/lang/String;Ljava/lang/String;)V
    ...
    :cond_0
    iget-object v0, p0, Lcom/android/server/pm/you;->ssp:Ljava/util/ArrayList;

    monitor-enter v0

    :try_start_0
    iget-object v1, p0, Lcom/android/server/pm/you;->ssp:Ljava/util/ArrayList;
    ...
    sget-boolean p0, Lcom/android/server/pm/you;->oif:Z
    ...
    invoke-direct {p0, v0, p1, p2}, Lcom/android/server/pm/you;->vdb(ILjava/lang/String;Ljava/lang/String;)V
...
.method public shutdown()V
    ...
    invoke-direct {p0}, Lcom/android/server/pm/you;->dma()V
...
.method public startUser(IZ)V
    ...
    iput p1, p0, Lcom/android/server/pm/you;->ywr:I
...
.method public zgw(Z)V
    ...
    :cond_0
    sput-boolean p1, Lcom/android/server/pm/you;->bvj:Z
    ...
    invoke-direct {p0, v0, p1}, Lcom/android/server/pm/you;->obl(Ljava/lang/String;Ljava/lang/String;)V
