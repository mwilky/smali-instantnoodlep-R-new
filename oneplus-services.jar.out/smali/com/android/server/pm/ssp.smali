...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/android/server/pm/ssp$you;
    }
.end annotation
...
.method synthetic constructor <init>(Lcom/android/server/pm/ssp$zta;)V
    .locals 0

    invoke-direct {p0}, Lcom/android/server/pm/ssp;-><init>()V
...
.method private tsu(Ljava/io/File;IIJ)V
    ...
    :try_start_0
    iget-object v4, v0, Lcom/android/server/pm/ssp;->zta:Lcom/android/server/pm/PackageManagerService$PmsInner;

    iget-object v10, v0, Lcom/android/server/pm/ssp;->you:Lcom/android/server/pm/parsing/PackageParser2;

    iget-object v11, v0, Lcom/android/server/pm/ssp;->sis:Ljava/util/concurrent/ExecutorService;
...
.method public static you()Lcom/android/server/pm/ssp;
    .locals 1

    sget-object v0, Lcom/android/server/pm/ssp$you;->zta:Lcom/android/server/pm/ssp;
...
.method public collectCotaSystemApps(II)V
    ...
    invoke-direct/range {v2 .. v7}, Lcom/android/server/pm/ssp;->tsu(Ljava/io/File;IIJ)V
...
.method public init(Lcom/android/server/pm/PackageManagerService$PmsInner;Lcom/android/server/pm/parsing/PackageParser2;Ljava/util/concurrent/ExecutorService;)V
    ...
    iput-object p1, p0, Lcom/android/server/pm/ssp;->zta:Lcom/android/server/pm/PackageManagerService$PmsInner;

    iput-object p2, p0, Lcom/android/server/pm/ssp;->you:Lcom/android/server/pm/parsing/PackageParser2;

    iput-object p3, p0, Lcom/android/server/pm/ssp;->sis:Ljava/util/concurrent/ExecutorService;
...
.method public zta(I)V
    ...
    invoke-direct/range {v1 .. v6}, Lcom/android/server/pm/ssp;->tsu(Ljava/io/File;IIJ)V
