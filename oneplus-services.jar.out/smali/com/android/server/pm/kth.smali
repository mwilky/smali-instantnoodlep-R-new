...
.field private ssp:Lcom/android/server/pm/ssp;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/android/server/pm/kth;->kth:Ljava/util/List;
    ...
    sget-object v0, Lcom/android/server/pm/kth;->kth:Ljava/util/List;
    ...
    sget-object v1, Lcom/android/server/pm/kth;->kth:Ljava/util/List;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/android/server/pm/kth;->ssp:Lcom/android/server/pm/ssp;
...
.method public addForInitLI(Lcom/android/server/pm/PackageManagerService;Lcom/android/server/pm/parsing/pkg/ParsedPackage;Lcom/android/server/pm/PackageSetting;Ljava/io/File;Ljava/lang/String;Ljava/lang/String;JZ)Z
    ...
    :cond_5
    iget-object p4, p0, Lcom/android/server/pm/kth;->sis:Lcom/android/server/pm/PackageManagerService$PmsInner;
...
.method public collectReserveApps(I)V
    ...
    iget-object v0, p0, Lcom/android/server/pm/kth;->sis:Lcom/android/server/pm/PackageManagerService$PmsInner;

    const/4 v2, 0x0

    const-wide/16 v4, 0x0

    iget-object v6, p0, Lcom/android/server/pm/kth;->tsu:Lcom/android/server/pm/parsing/PackageParser2;

    iget-object v7, p0, Lcom/android/server/pm/kth;->rtg:Ljava/util/concurrent/ExecutorService;

    move v3, p1

    invoke-virtual/range {v0 .. v7}, Lcom/android/server/pm/PackageManagerService$PmsInner;->scanDirLI(Ljava/io/File;IIJLcom/android/server/pm/parsing/PackageParser2;Ljava/util/concurrent/ExecutorService;)V
    ...
    iget-object v3, p0, Lcom/android/server/pm/kth;->sis:Lcom/android/server/pm/PackageManagerService$PmsInner;

    const/4 v5, 0x0

    const-wide/16 v0, 0x0

    iget-object v9, p0, Lcom/android/server/pm/kth;->tsu:Lcom/android/server/pm/parsing/PackageParser2;

    iget-object v10, p0, Lcom/android/server/pm/kth;->rtg:Ljava/util/concurrent/ExecutorService;
    ...
    invoke-virtual/range {v3 .. v10}, Lcom/android/server/pm/PackageManagerService$PmsInner;->scanDirLI(Ljava/io/File;IIJLcom/android/server/pm/parsing/PackageParser2;Ljava/util/concurrent/ExecutorService;)V

    :cond_1
    iget-object p0, p0, Lcom/android/server/pm/kth;->ssp:Lcom/android/server/pm/ssp;
...
.method public initInstance(Lcom/android/server/pm/PackageManagerService$PmsInner;Lcom/android/server/pm/parsing/PackageParser2;Ljava/util/concurrent/ExecutorService;)V
    ...
    iput-object p1, p0, Lcom/android/server/pm/kth;->sis:Lcom/android/server/pm/PackageManagerService$PmsInner;

    iput-object p2, p0, Lcom/android/server/pm/kth;->tsu:Lcom/android/server/pm/parsing/PackageParser2;

    iput-object p3, p0, Lcom/android/server/pm/kth;->rtg:Ljava/util/concurrent/ExecutorService;
