...
.field private static dma:Lcom/android/server/am/i; = null
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/android/server/am/i;->vju:Ljava/util/HashSet;

    new-instance v0, Ljava/util/HashSet;

    invoke-direct {v0}, Ljava/util/HashSet;-><init>()V

    sput-object v0, Lcom/android/server/am/i;->bud:Ljava/util/HashSet;

    new-instance v0, Ljava/util/HashSet;

    invoke-direct {v0}, Ljava/util/HashSet;-><init>()V

    sput-object v0, Lcom/android/server/am/i;->les:Ljava/util/HashSet;
...
.method private constructor <init>(Landroid/content/Context;)V
    ...
    iput v0, p0, Lcom/android/server/am/i;->igw:I
    ...
    invoke-direct {p0}, Lcom/android/server/am/i;->qbh()V

    invoke-direct {p0}, Lcom/android/server/am/i;->ywr()V

    const-string p1, ""

    iput-object p1, p0, Lcom/android/server/am/i;->kth:Ljava/lang/String;

    iput-object p1, p0, Lcom/android/server/am/i;->bio:Ljava/lang/String;
...
.method private synthetic bvj()V
    ...
    sget-object v3, Lcom/android/server/am/i;->vju:Ljava/util/HashSet;

    monitor-enter v3

    :try_start_0
    sget-object v4, Lcom/android/server/am/i;->vju:Ljava/util/HashSet;
    ...
    sget-object v3, Lcom/android/server/am/i;->bud:Ljava/util/HashSet;

    monitor-enter v3

    :try_start_1
    sget-object v4, Lcom/android/server/am/i;->bud:Ljava/util/HashSet;
    ...
    iget-object p0, p0, Lcom/android/server/am/i;->you:Landroid/content/pm/PackageManager;
    ...
    sget-object v1, Lcom/android/server/am/i;->les:Ljava/util/HashSet;

    monitor-enter v1

    :try_start_2
    sget-object v2, Lcom/android/server/am/i;->les:Ljava/util/HashSet;
...
.method private dma()V
    ...
    sput p0, Lcom/android/server/am/i;->fto:I

    const-wide/16 v0, 0xbb8

    sput-wide v0, Lcom/android/server/am/i;->lqr:J

    const/4 p0, 0x1

    sput-boolean p0, Lcom/android/server/am/i;->veq:Z

    new-instance p0, Ljava/util/ArrayList;

    invoke-direct {p0}, Ljava/util/ArrayList;-><init>()V

    sput-object p0, Lcom/android/server/am/i;->cgv:Ljava/util/List;
...
.method public static gck(Landroid/content/Context;)Lcom/android/server/am/i;
    .locals 1

    sget-object v0, Lcom/android/server/am/i;->dma:Lcom/android/server/am/i;
    ...
    sput-object v0, Lcom/android/server/am/i;->dma:Lcom/android/server/am/i;

    :cond_0
    sget-object p0, Lcom/android/server/am/i;->dma:Lcom/android/server/am/i;
...
.method private kth(Ljava/lang/String;)Z
    ...
    iget-wide v2, p0, Lcom/android/server/am/i;->gck:J

    sub-long/2addr v0, v2

    sget-wide v2, Lcom/android/server/am/i;->lqr:J
    ...
    iget-object v0, p0, Lcom/android/server/am/i;->wtn:Ljava/lang/String;
    ...
    iget p1, p0, Lcom/android/server/am/i;->igw:I

    sget v0, Lcom/android/server/am/i;->fto:I
...
.method public static oif(Ljava/lang/String;)Z
    ...
    sget-object v0, Lcom/android/server/am/i;->les:Ljava/util/HashSet;
...
.method public static sis(Ljava/lang/String;)V
    ...
    sget-object v0, Lcom/android/server/am/i;->bud:Ljava/util/HashSet;

    monitor-enter v0

    :try_start_0
    sget-object v1, Lcom/android/server/am/i;->bud:Ljava/util/HashSet;
...
.method private zgw(Ljava/lang/String;)V
    ...
    iget v0, p0, Lcom/android/server/am/i;->igw:I
    ...
    iput-wide v2, p0, Lcom/android/server/am/i;->gck:J

    iput-object p1, p0, Lcom/android/server/am/i;->wtn:Ljava/lang/String;

    iput v1, p0, Lcom/android/server/am/i;->igw:I

    return-void

    :cond_0
    iget-wide v4, p0, Lcom/android/server/am/i;->gck:J

    sub-long/2addr v2, v4

    sget-wide v4, Lcom/android/server/am/i;->lqr:J
    ...
    iput p1, p0, Lcom/android/server/am/i;->igw:I
...
.method public static zta(Ljava/lang/String;)V
    ...
    sget-object v0, Lcom/android/server/am/i;->vju:Ljava/util/HashSet;

    monitor-enter v0

    :try_start_0
    sget-object v1, Lcom/android/server/am/i;->vju:Ljava/util/HashSet;
...
.method protected bio(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Lcom/android/server/am/ServiceRecord;ILandroid/content/Intent;Lcom/android/server/am/StartAppRecorder$zta;)V
    ...
    invoke-direct {p0, p1, p6}, Lcom/android/server/am/i;->tsu(Ljava/lang/String;Landroid/content/Intent;)Z
    ...
    invoke-static {p5}, Lcom/android/server/am/i;->oif(Ljava/lang/String;)Z
    ...
    :cond_2
    sget-object p5, Lcom/android/server/am/i;->vju:Ljava/util/HashSet;

    monitor-enter p5

    :try_start_0
    sget-object p6, Lcom/android/server/am/i;->vju:Ljava/util/HashSet;
    ...
    sget-object p6, Lcom/android/server/am/i;->bud:Ljava/util/HashSet;

    monitor-enter p6

    :try_start_1
    sget-object p5, Lcom/android/server/am/i;->bud:Ljava/util/HashSet;
    ...
    iget-object p5, p0, Lcom/android/server/am/i;->kth:Ljava/lang/String;

    monitor-enter p5

    :try_start_2
    iget-object p6, p0, Lcom/android/server/am/i;->kth:Ljava/lang/String;
    ...
    iget-object p6, p0, Lcom/android/server/am/i;->bio:Ljava/lang/String;

    monitor-enter p6

    :try_start_3
    iget-object p5, p0, Lcom/android/server/am/i;->bio:Ljava/lang/String;
    ...
    sget-boolean p4, Lcom/android/server/am/i;->veq:Z

    if-eqz p4, :cond_8

    sget-object p4, Lcom/android/server/am/i;->cgv:Ljava/util/List;
    ...
    invoke-direct {p0, p1}, Lcom/android/server/am/i;->kth(Ljava/lang/String;)Z
...
.method protected cno(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Lcom/android/server/am/ProcessRecord;ILjava/lang/String;Lcom/android/server/am/StartAppRecorder$zta;)V
    ...
    iget-object v0, p0, Lcom/android/server/am/i;->cno:Ljava/util/List;
...
.method protected gwm(Ljava/lang/String;)V
    ...
    iget-object v0, p0, Lcom/android/server/am/i;->kth:Ljava/lang/String;
...
.method public synthetic ibl()V
    ...
    invoke-direct {p0}, Lcom/android/server/am/i;->bvj()V
...
.method protected igw()V
    ...
    iput-object v0, p0, Lcom/android/server/am/i;->wtn:Ljava/lang/String;
...
.method protected ugm(Ljava/lang/String;)V
    ...
    iget-object v0, p0, Lcom/android/server/am/i;->bio:Ljava/lang/String;
...
.method protected vdb(Lcom/android/server/am/StartAppSpecialUidsPolicy$StartType;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    sget-boolean v0, Lcom/android/server/am/i;->veq:Z

    if-eqz v0, :cond_2

    sget-object v0, Lcom/android/server/am/i;->cgv:Ljava/util/List;
    ...
    invoke-direct {p0, p1}, Lcom/android/server/am/i;->zgw(Ljava/lang/String;)V
...
.method protected wtn()V
    ...
    sget-boolean v1, Lcom/android/server/am/i;->veq:Z
    ...
    sget v1, Lcom/android/server/am/i;->fto:I
    ...
    sget-wide v1, Lcom/android/server/am/i;->lqr:J
    ...
    sget-object v1, Lcom/android/server/am/i;->cgv:Ljava/util/List;
    ...
    sget-object v2, Lcom/android/server/am/i;->vju:Ljava/util/HashSet;
    ...
    sget-object v2, Lcom/android/server/am/i;->bud:Ljava/util/HashSet;
    ...
    iget-object v1, p0, Lcom/android/server/am/i;->kth:Ljava/lang/String;
    ...
    iget-object p0, p0, Lcom/android/server/am/i;->bio:Ljava/lang/String;
