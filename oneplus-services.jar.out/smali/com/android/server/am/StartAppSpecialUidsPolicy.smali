...
# static fields
.field protected static final cjf:Ljava/lang/String; = "SpecialUidsPolicy: caller is a assistant app"

.field protected static final ear:Ljava/lang/String; = "SpecialUidsPolicy: caller is a accessibility app"

.field protected static final gwm:Ljava/lang/String; = "SpecialUidsPolicy: caller is a system app"

.field private static hmo:Lcom/android/server/am/StartAppSpecialUidsPolicy; = null

.field protected static final ibl:Ljava/lang/String; = "SpecialUidsPolicy: callee is a special app"

.field protected static final ire:Ljava/lang/String; = "SpecialUidsPolicy: callee is a high power usage app"

.field protected static final obl:Ljava/lang/String; = "SpecialUidsPolicy: caller is a launcher app"

.field protected static final oxb:Ljava/lang/String; = "SpecialUidsPolicy: caller is a nfc app"

.field protected static final ugm:Ljava/lang/String; = "SpecialUidsPolicy: callee has same uid as caller\'s"

.field protected static final vdb:Ljava/lang/String; = "SpecialUidsPolicy: caller is a dialer app"

.field protected static final zgw:Ljava/lang/String; = "SpecialUidsPolicy: caller is a sms app"
...
.method private constructor <init>(Landroid/content/Context;)V
    ...
    invoke-direct {v0, p0}, Lcom/android/server/am/cno;-><init>(Lcom/android/server/am/StartAppSpecialUidsPolicy;)V
...
.method private bio(I)V
    ...
    invoke-direct {p0, p1}, Lcom/android/server/am/StartAppSpecialUidsPolicy;->gck(I)Z
...
.method private bvj()V
    ...
    invoke-virtual {v1, v0}, Lcom/android/server/am/hmo;->vdb(Ljava/lang/String;)I
    ...
    invoke-virtual {v2, v0}, Lcom/android/server/am/hmo;->vdb(Ljava/lang/String;)I
...
.method private synthetic dma()V
    ...
    invoke-direct {p0}, Lcom/android/server/am/StartAppSpecialUidsPolicy;->bvj()V

    invoke-direct {p0}, Lcom/android/server/am/StartAppSpecialUidsPolicy;->gwm()V

    invoke-virtual {p0}, Lcom/android/server/am/StartAppSpecialUidsPolicy;->igw()V
...
.method private gwm()V
    ...
    invoke-virtual {v2, v1}, Lcom/android/server/am/hmo;->vdb(Ljava/lang/String;)I
...
.method public static wtn(Landroid/content/Context;)Lcom/android/server/am/StartAppSpecialUidsPolicy;
    .locals 1

    sget-object v0, Lcom/android/server/am/StartAppSpecialUidsPolicy;->hmo:Lcom/android/server/am/StartAppSpecialUidsPolicy;
    ...
    sput-object v0, Lcom/android/server/am/StartAppSpecialUidsPolicy;->hmo:Lcom/android/server/am/StartAppSpecialUidsPolicy;

    :cond_0
    sget-object p0, Lcom/android/server/am/StartAppSpecialUidsPolicy;->hmo:Lcom/android/server/am/StartAppSpecialUidsPolicy;
...
# virtual methods
.method protected ibl(Ljava/util/Set;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method protected igw()V
    ...
    const-string v1, "dump # mLauncherAppUids:"

    invoke-virtual {v0, v1}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget-object v1, p0, Lcom/android/server/am/StartAppSpecialUidsPolicy;->cno:Ljava/util/Set;
...
.method public ssp(Ljava/lang/String;Ljava/lang/String;IILcom/android/server/am/StartAppSpecialUidsPolicy$StartType;Lcom/android/server/am/StartAppRecorder$zta;)V
    .locals 1
    ...
    invoke-direct {p0, p2}, Lcom/android/server/am/StartAppSpecialUidsPolicy;->cno(Ljava/lang/String;)Z
    ...
    invoke-virtual {p1, p4}, Lcom/android/server/am/hmo;->lqr(I)Z
...
.method public synthetic ywr()V
    ...
    invoke-direct {p0}, Lcom/android/server/am/StartAppSpecialUidsPolicy;->dma()V
