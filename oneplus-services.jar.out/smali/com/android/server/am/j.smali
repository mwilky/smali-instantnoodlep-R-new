...
.field private static dma:Lcom/android/server/am/j; = null
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/android/server/am/j;->vju:Ljava/util/HashSet;

    new-instance v0, Ljava/util/HashSet;

    invoke-direct {v0}, Ljava/util/HashSet;-><init>()V

    sput-object v0, Lcom/android/server/am/j;->bud:Ljava/util/HashSet;

    new-instance v0, Ljava/util/HashSet;

    invoke-direct {v0}, Ljava/util/HashSet;-><init>()V

    sput-object v0, Lcom/android/server/am/j;->les:Ljava/util/HashSet;
...
.method private constructor <init>(Landroid/content/Context;)V
    ...
    iput-object p1, p0, Lcom/android/server/am/j;->you:Landroid/content/pm/PackageManager;

    invoke-direct {p0}, Lcom/android/server/am/j;->dma()V

    invoke-direct {p0}, Lcom/android/server/am/j;->qbh()V

    invoke-direct {p0}, Lcom/android/server/am/j;->ywr()V

    const-string p1, ""

    iput-object p1, p0, Lcom/android/server/am/j;->kth:Ljava/lang/String;

    iput-object p1, p0, Lcom/android/server/am/j;->bio:Ljava/lang/String;
...
.method private synthetic bvj()V
    ...
    iget-object v1, p0, Lcom/android/server/am/j;->you:Landroid/content/pm/PackageManager;
    ...
    sget-object v3, Lcom/android/server/am/j;->vju:Ljava/util/HashSet;

    monitor-enter v3

    :try_start_0
    sget-object v4, Lcom/android/server/am/j;->vju:Ljava/util/HashSet;
    ...
    sget-object v3, Lcom/android/server/am/j;->bud:Ljava/util/HashSet;

    monitor-enter v3

    :try_start_1
    sget-object v4, Lcom/android/server/am/j;->bud:Ljava/util/HashSet;
    ...
    iget-object p0, p0, Lcom/android/server/am/j;->you:Landroid/content/pm/PackageManager;
    ...
    sget-object v1, Lcom/android/server/am/j;->les:Ljava/util/HashSet;

    monitor-enter v1

    :try_start_2
    sget-object v2, Lcom/android/server/am/j;->les:Ljava/util/HashSet;
...
.method private dma()V
    ...
    sput p0, Lcom/android/server/am/j;->fto:I

    const-wide/16 v0, 0xbb8

    sput-wide v0, Lcom/android/server/am/j;->lqr:J

    const/4 p0, 0x1

    sput-boolean p0, Lcom/android/server/am/j;->veq:Z

    new-instance p0, Ljava/util/ArrayList;

    invoke-direct {p0}, Ljava/util/ArrayList;-><init>()V

    sput-object p0, Lcom/android/server/am/j;->cgv:Ljava/util/List;
...
.method public static gck(Landroid/content/Context;)Lcom/android/server/am/j;
    .locals 1

    sget-object v0, Lcom/android/server/am/j;->dma:Lcom/android/server/am/j;
    ...
    sput-object v0, Lcom/android/server/am/j;->dma:Lcom/android/server/am/j;

    :cond_0
    sget-object p0, Lcom/android/server/am/j;->dma:Lcom/android/server/am/j;
...
.method private kth(Ljava/lang/String;)Z
    ...
    iget-wide v2, p0, Lcom/android/server/am/j;->gck:J

    sub-long/2addr v0, v2

    sget-wide v2, Lcom/android/server/am/j;->lqr:J
    ...
    iget-object v0, p0, Lcom/android/server/am/j;->wtn:Ljava/lang/String;
    ...
    iget p1, p0, Lcom/android/server/am/j;->igw:I

    sget v0, Lcom/android/server/am/j;->fto:I
...
.method public static oif(Ljava/lang/String;)Z
    ...
    sget-object v0, Lcom/android/server/am/j;->les:Ljava/util/HashSet;
...
.method private qbh()V
    ...
    iput-object v1, v0, Lcom/android/server/am/j;->tsu:Ljava/util/List;
    ...
    iput-object v1, v0, Lcom/android/server/am/j;->rtg:Ljava/util/List;
    ...
    iput-object v1, v0, Lcom/android/server/am/j;->ssp:Ljava/util/List;
    ...
    iput-object v1, v0, Lcom/android/server/am/j;->cno:Ljava/util/List;

    sget-object v1, Lcom/android/server/am/hmo;->s:Landroid/os/Handler;

    new-instance v2, Lcom/android/server/am/rtg;

    invoke-direct {v2, v0}, Lcom/android/server/am/rtg;-><init>(Lcom/android/server/am/j;)V
...
.method public static sis(Ljava/lang/String;)V
    ...
    sget-object v0, Lcom/android/server/am/j;->bud:Ljava/util/HashSet;

    monitor-enter v0

    :try_start_0
    sget-object v1, Lcom/android/server/am/j;->bud:Ljava/util/HashSet;
...
.method private tsu(Ljava/lang/String;Landroid/content/Intent;)Z
    ...
    iget-object v0, p0, Lcom/android/server/am/j;->tsu:Ljava/util/List;

    monitor-enter v0

    :try_start_0
    iget-object p0, p0, Lcom/android/server/am/j;->tsu:Ljava/util/List;
...
.method private ywr()V
    ...
    :try_start_0
    iget-object v1, p0, Lcom/android/server/am/j;->tsu:Ljava/util/List;
...
.method private zgw(Ljava/lang/String;)V
    ...
    iput-wide v2, p0, Lcom/android/server/am/j;->gck:J

    iput-object p1, p0, Lcom/android/server/am/j;->wtn:Ljava/lang/String;

    iput v1, p0, Lcom/android/server/am/j;->igw:I

    return-void

    :cond_0
    iget-wide v4, p0, Lcom/android/server/am/j;->gck:J

    sub-long/2addr v2, v4

    sget-wide v4, Lcom/android/server/am/j;->lqr:J
    ...
    iput p1, p0, Lcom/android/server/am/j;->igw:I
...
.method public static zta(Ljava/lang/String;)V
    ...
    sget-object v0, Lcom/android/server/am/j;->vju:Ljava/util/HashSet;

    monitor-enter v0

    :try_start_0
    sget-object v1, Lcom/android/server/am/j;->vju:Ljava/util/HashSet;
...
.method protected bio(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Lcom/android/server/am/ServiceRecord;ILandroid/content/Intent;Lcom/android/server/am/StartAppRecorder$zta;)V
    ...
    iget-boolean v0, p0, Lcom/android/server/am/j;->sis:Z

    if-eqz v0, :cond_0

    invoke-direct {p0, p1, p6}, Lcom/android/server/am/j;->tsu(Ljava/lang/String;Landroid/content/Intent;)Z
    ...
    invoke-static {p5}, Lcom/android/server/am/j;->oif(Ljava/lang/String;)Z
    ...
    :cond_2
    sget-object p5, Lcom/android/server/am/j;->vju:Ljava/util/HashSet;

    monitor-enter p5

    :try_start_0
    sget-object p6, Lcom/android/server/am/j;->vju:Ljava/util/HashSet;
    ...
    sget-object p6, Lcom/android/server/am/j;->bud:Ljava/util/HashSet;

    monitor-enter p6

    :try_start_1
    sget-object p5, Lcom/android/server/am/j;->bud:Ljava/util/HashSet;
    ...
    iget-object p5, p0, Lcom/android/server/am/j;->kth:Ljava/lang/String;

    monitor-enter p5

    :try_start_2
    iget-object p6, p0, Lcom/android/server/am/j;->kth:Ljava/lang/String;
    ...
    iget-object p6, p0, Lcom/android/server/am/j;->bio:Ljava/lang/String;

    monitor-enter p6

    :try_start_3
    iget-object p5, p0, Lcom/android/server/am/j;->bio:Ljava/lang/String;
    ...
    sget-boolean p4, Lcom/android/server/am/j;->veq:Z

    if-eqz p4, :cond_8

    sget-object p4, Lcom/android/server/am/j;->cgv:Ljava/util/List;
    ...
    invoke-direct {p0, p1}, Lcom/android/server/am/j;->kth(Ljava/lang/String;)Z
...
.method protected cno(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Lcom/android/server/am/ProcessRecord;ILjava/lang/String;Lcom/android/server/am/StartAppRecorder$zta;)V
    ...
    iget-object v0, p0, Lcom/android/server/am/j;->cno:Ljava/util/List;
    ...
    iget-object p0, p0, Lcom/android/server/am/j;->ssp:Ljava/util/List;
...
.method protected gwm(Ljava/lang/String;)V
    ...
    iget-object v0, p0, Lcom/android/server/am/j;->kth:Ljava/lang/String;
...
.method public synthetic ibl()V
    ...
    invoke-direct {p0}, Lcom/android/server/am/j;->bvj()V
...
.method protected igw()V
    ...
    iput-object v0, p0, Lcom/android/server/am/j;->wtn:Ljava/lang/String;
...
.method protected obl(Ljava/util/List;)V
    ...
    iget-object v2, p0, Lcom/android/server/am/j;->tsu:Ljava/util/List;
...
.method protected oxb(Z)V
    ...
    iput-boolean p1, p0, Lcom/android/server/am/j;->sis:Z
...
.method protected rtg(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Lcom/android/server/am/StartAppRecorder$zta;)V
    ...
    iget-object v0, p0, Lcom/android/server/am/j;->rtg:Ljava/util/List;
...
.method protected ugm(Ljava/lang/String;)V
    ...
    iget-object v0, p0, Lcom/android/server/am/j;->bio:Ljava/lang/String;
...
.method protected vdb(Lcom/android/server/am/StartAppSpecialUidsPolicy$StartType;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    sget-boolean v0, Lcom/android/server/am/j;->veq:Z

    if-eqz v0, :cond_2

    sget-object v0, Lcom/android/server/am/j;->cgv:Ljava/util/List;
    ...
    invoke-direct {p0, p1}, Lcom/android/server/am/j;->zgw(Ljava/lang/String;)V
...
.method protected wtn()V
    ...
    sget-boolean v1, Lcom/android/server/am/j;->veq:Z
    ...
    sget v1, Lcom/android/server/am/j;->fto:I
    ...
    sget-wide v1, Lcom/android/server/am/j;->lqr:J
    ...
    sget-object v1, Lcom/android/server/am/j;->cgv:Ljava/util/List;
    ...
    iget-boolean v1, p0, Lcom/android/server/am/j;->sis:Z
    ...
    sget-object v2, Lcom/android/server/am/j;->vju:Ljava/util/HashSet;
    ...
    sget-object v2, Lcom/android/server/am/j;->bud:Ljava/util/HashSet;
    ...
    iget-object v1, p0, Lcom/android/server/am/j;->rtg:Ljava/util/List;
    ...
    iget-object v1, p0, Lcom/android/server/am/j;->ssp:Ljava/util/List;
    ...
    iget-object v1, p0, Lcom/android/server/am/j;->cno:Ljava/util/List;
    ...
    iget-object v1, p0, Lcom/android/server/am/j;->kth:Ljava/lang/String;
    ...
    iget-object p0, p0, Lcom/android/server/am/j;->bio:Ljava/lang/String;
