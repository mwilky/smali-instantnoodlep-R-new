...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/android/server/am/vdb$you;
    }
.end annotation
...
.method private constructor <init>()V
    ...
    iput-object v0, p0, Lcom/android/server/am/vdb;->wtn:Ljava/util/HashSet;
    ...
    iput-object v0, p0, Lcom/android/server/am/vdb;->gck:Lcom/android/server/am/OPSystemCpuLoadMonitor$SystemLoadType;
    ...
    iput-object v0, p0, Lcom/android/server/am/vdb;->dma:Lcom/android/server/am/OPBRPorcessSpeedMonitor$ProcessBRSpeedType;

    return-void
.end method

.method synthetic constructor <init>(Lcom/android/server/am/vdb$zta;)V
    .locals 0

    invoke-direct {p0}, Lcom/android/server/am/vdb;-><init>()V

    return-void
.end method

.method public static cno()Lcom/android/server/am/vdb;
    .locals 1

    invoke-static {}, Lcom/android/server/am/vdb$you;->zta()Lcom/android/server/am/vdb;
...
.method private igw(Lcom/android/server/am/ActivityManagerService;Landroid/os/Handler;)V
    ...
    iput-object v8, p0, Lcom/android/server/am/vdb;->tsu:Lcom/android/server/am/BroadcastQueue;
    ...
    iput-object v2, p0, Lcom/android/server/am/vdb;->rtg:Lcom/android/server/am/BroadcastQueue;
    ...
    iput-object v8, p0, Lcom/android/server/am/vdb;->ssp:Lcom/android/server/am/BroadcastQueue;
    ...
    iput-object v2, p0, Lcom/android/server/am/vdb;->cno:Lcom/android/server/am/BroadcastQueue;
    ...
    iput-object v8, p0, Lcom/android/server/am/vdb;->kth:Lcom/android/server/am/BroadcastQueue;
    ...
    iput-object v0, p0, Lcom/android/server/am/vdb;->bio:Lcom/android/server/am/BroadcastQueue;

    iget-object v0, p0, Lcom/android/server/am/vdb;->zta:Lcom/android/server/am/ActivityManagerService;
    ...
    iget-object v3, p0, Lcom/android/server/am/vdb;->tsu:Lcom/android/server/am/BroadcastQueue;
    ...
    iget-object v3, p0, Lcom/android/server/am/vdb;->rtg:Lcom/android/server/am/BroadcastQueue;
    ...
    iget-object v3, p0, Lcom/android/server/am/vdb;->ssp:Lcom/android/server/am/BroadcastQueue;
    ...
    iget-object v3, p0, Lcom/android/server/am/vdb;->cno:Lcom/android/server/am/BroadcastQueue;
    ...
    iget-object v3, p0, Lcom/android/server/am/vdb;->kth:Lcom/android/server/am/BroadcastQueue;
    ...
    iget-object p0, p0, Lcom/android/server/am/vdb;->bio:Lcom/android/server/am/BroadcastQueue;

    aput-object p0, v1, v2

    sget-boolean p0, Lcom/android/server/am/zgw;->gck:Z
...
.method public static obl(Lcom/android/server/am/BroadcastQueue;Lcom/android/server/am/ProcessRecord;Lcom/android/server/am/BroadcastRecord;)Z
    ...
    invoke-static {}, Lcom/android/server/am/zgw;->cjf()Z
...
.method private tsu(Ljava/io/PrintWriter;)V
    ...
    :goto_0
    iget-object v3, p0, Lcom/android/server/am/vdb;->zta:Lcom/android/server/am/ActivityManagerService;
    ...
    iget-object v4, p0, Lcom/android/server/am/vdb;->zta:Lcom/android/server/am/ActivityManagerService;
    ...
    iget-object v6, p0, Lcom/android/server/am/vdb;->zta:Lcom/android/server/am/ActivityManagerService;
...
.method public bio(Lcom/android/server/am/ActivityManagerService;)V
    ...
    iput-object v0, p0, Lcom/android/server/am/vdb;->you:Landroid/os/Handler;

    iput-object p1, p0, Lcom/android/server/am/vdb;->zta:Lcom/android/server/am/ActivityManagerService;

    invoke-direct {p0, p1, v0}, Lcom/android/server/am/vdb;->igw(Lcom/android/server/am/ActivityManagerService;Landroid/os/Handler;)V

    sget-boolean p0, Lcom/android/server/am/zgw;->wtn:Z
...
.method public bvj(Lcom/android/server/am/OPBRPorcessSpeedMonitor$ProcessBRSpeedType;)V
    ...
    iget-object v1, p0, Lcom/android/server/am/vdb;->dma:Lcom/android/server/am/OPBRPorcessSpeedMonitor$ProcessBRSpeedType;
    ...
    iget-object v1, p0, Lcom/android/server/am/vdb;->gck:Lcom/android/server/am/OPSystemCpuLoadMonitor$SystemLoadType;

    iget-object p0, p0, Lcom/android/server/am/vdb;->dma:Lcom/android/server/am/OPBRPorcessSpeedMonitor$ProcessBRSpeedType;
...
.method cjf(ZLandroid/content/pm/ApplicationInfo;)V
    ...
    invoke-virtual {p0, v0}, Lcom/android/server/am/vdb;->gck(Ljava/lang/String;)Z
    ...
    invoke-virtual {p0, p1}, Lcom/android/server/am/vdb;->ywr(Ljava/lang/String;)Z
...
.method public oif(Ljava/lang/String;Z)V
    ...
    :cond_0
    iget-object p2, p0, Lcom/android/server/am/vdb;->wtn:Ljava/util/HashSet;
...
.method public oxb(Landroid/content/Context;)V
    ...
    iput-object p1, p0, Lcom/android/server/am/vdb;->sis:Landroid/content/Context;
    ...
    iget-object p0, p0, Lcom/android/server/am/vdb;->sis:Landroid/content/Context;

    invoke-virtual {v0, p0}, Lcom/android/server/am/ugm;->ywr(Landroid/content/Context;)V
    ...
    invoke-virtual {p0, p1}, Lcom/android/server/am/zgw;->bvj(Landroid/content/Context;)V
...
.method public qbh(Ljava/lang/String;IILjava/lang/String;II)V
    ...
    iget-object p1, p0, Lcom/android/server/am/vdb;->zta:Lcom/android/server/am/ActivityManagerService;
...
.method public rtg(Ljava/lang/String;Ljava/io/PrintWriter;)V
    ...
    sget-boolean v1, Lcom/android/server/am/zgw;->kth:Z
    ...
    :pswitch_0
    invoke-direct {p0, p2}, Lcom/android/server/am/vdb;->tsu(Ljava/io/PrintWriter;)V

    goto/16 :goto_6

    :pswitch_1
    sput-boolean v5, Lcom/android/server/am/zgw;->ear:Z
    ...
    :pswitch_2
    sput-boolean v6, Lcom/android/server/am/zgw;->ear:Z
    ...
    :pswitch_3
    sput-boolean v5, Lcom/android/server/am/zgw;->dma:Z
    ...
    :pswitch_4
    sput-boolean v6, Lcom/android/server/am/zgw;->dma:Z
    ...
    :pswitch_5
    sput-boolean v5, Lcom/android/server/am/zgw;->gck:Z
    ...
    :pswitch_6
    sput-boolean v6, Lcom/android/server/am/zgw;->gck:Z
    ...
    :pswitch_7
    sput-boolean v5, Lcom/android/server/am/zgw;->qbh:Z
    ...
    :pswitch_8
    sput-boolean v6, Lcom/android/server/am/zgw;->qbh:Z
    ...
    :pswitch_9
    sput-boolean v5, Lcom/android/server/am/zgw;->wtn:Z
    ...
    :pswitch_a
    sput-boolean v6, Lcom/android/server/am/zgw;->wtn:Z
    ...
    invoke-virtual {p0, p2}, Lcom/android/server/am/ugm;->cno(Ljava/io/PrintWriter;)V

    goto :goto_6

    :pswitch_e
    invoke-static {p2}, Lcom/android/server/am/vdb;->kth(Ljava/io/PrintWriter;)V
...
.method sis(IZ)Lcom/android/server/am/BroadcastQueue;
    ...
    iget-object p0, p0, Lcom/android/server/am/vdb;->tsu:Lcom/android/server/am/BroadcastQueue;

    goto :goto_0

    :cond_0
    iget-object p0, p0, Lcom/android/server/am/vdb;->rtg:Lcom/android/server/am/BroadcastQueue;
    ...
    iget-object p0, p0, Lcom/android/server/am/vdb;->ssp:Lcom/android/server/am/BroadcastQueue;

    goto :goto_0

    :cond_2
    iget-object p0, p0, Lcom/android/server/am/vdb;->cno:Lcom/android/server/am/BroadcastQueue;
    ...
    iget-object p0, p0, Lcom/android/server/am/vdb;->kth:Lcom/android/server/am/BroadcastQueue;
...
.method public ssp(ZLcom/android/server/am/BroadcastRecord;)V
    ...
    invoke-direct {v0, v2}, Lcom/android/server/am/vdb;->wtn(I)Z
    ...
    invoke-virtual {v0, v6}, Lcom/android/server/am/vdb;->dma(Landroid/content/pm/ApplicationInfo;)Z
    ...
    invoke-virtual {v0, v4}, Lcom/android/server/am/vdb;->dma(Landroid/content/pm/ApplicationInfo;)Z
    ...
    invoke-virtual {v0, v6, v4}, Lcom/android/server/am/vdb;->cjf(ZLandroid/content/pm/ApplicationInfo;)V
    ...
    :cond_3
    invoke-virtual {v0, v8, v2}, Lcom/android/server/am/vdb;->sis(IZ)Lcom/android/server/am/BroadcastQueue;
...
.method public ugm()V
    ...
    iget-object v1, p0, Lcom/android/server/am/vdb;->zta:Lcom/android/server/am/ActivityManagerService;

    iget-object v2, p0, Lcom/android/server/am/vdb;->gck:Lcom/android/server/am/OPSystemCpuLoadMonitor$SystemLoadType;
