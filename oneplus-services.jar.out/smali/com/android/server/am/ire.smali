...
.field private static final bud:Ljava/lang/String; = "persist.sys.memplus.swappiness"

.field public static final bvj:Ljava/lang/String; = "OnePlusSmartBoostManager"

.field private static final c:I = 0x0

.field private static final cgv:Ljava/lang/String; = "persist.sys.ramboost.olmemplus_option"

.field private static final cjf:Ljava/lang/String; = "persist.sys.ramboost.debug"

.field private static final d:I = 0x1

.field private static final e:I = 0x2

.field private static final ear:Ljava/lang/String; = "persist.sys.ramboost.ioppreload"

.field private static final f:I = 0x2

.field private static final fto:Ljava/lang/String; = "persist.sys.ramboost.oliop"

.field private static g:I = 0x0

.field private static gwm:Z = false

.field private static final h:Ljava/lang/String; = "RamBoost"

.field private static final hmo:Ljava/lang/String; = "persist.sys.ramboost.olhotcount"

.field private static final i:Ljava/lang/String; = "/system/etc/smartboost.xml"

.field public static final ibl:Z

.field private static final ire:Ljava/lang/String; = "/sys/module/smartboost_core/parameters/page_cache_reside_switch"

.field private static final irq:Ljava/lang/String; = "persist.sys.memplus.direct_swappiness"
...
.field private static final les:Ljava/lang/String; = "/proc/sys/vm/swappiness"

.field private static final lqr:Ljava/lang/String; = "/sys/module/fsc/parameters/enable"

.field private static final m:Ljava/lang/String; = "0"

.field private static n:Lcom/android/server/am/ire; = null

.field private static o:Ljava/io/File; = null

.field private static obl:Z = false

.field private static final oxb:Ljava/lang/String; = "persist.sys.ramboost.enable"
...
.field private static final vdw:Ljava/lang/String; = "/proc/sys/vm/direct_swappiness"

.field private static final veq:Ljava/lang/String; = "persist.sys.ramboost.olmemplus"
...
.field private dma:Lcom/android/server/am/b;
...
.field private qbh:Ljava/util/List;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/List<",
            "Ljava/lang/String;",
...
.field private you:Lcom/android/server/am/ire$sis;
...
.method static constructor <clinit>()V
    ...
    sput-boolean v1, Lcom/android/server/am/ire;->ibl:Z
    ...
    sput-boolean v1, Lcom/android/server/am/ire;->obl:Z
    ...
    :cond_0
    sput v3, Lcom/android/server/am/ire;->g:I

    const/4 v0, 0x0

    sput-object v0, Lcom/android/server/am/ire;->n:Lcom/android/server/am/ire;

    const-string v0, "sys/module/memplus_core/parameters/memory_plus_wake_gcd"

    sput-object v0, Lcom/android/server/am/ire;->p:Ljava/lang/String;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/android/server/am/ire;->you:Lcom/android/server/am/ire$sis;
    ...
    iput-object v0, p0, Lcom/android/server/am/ire;->dma:Lcom/android/server/am/b;

    const/4 v0, 0x1

    iput v0, p0, Lcom/android/server/am/ire;->ywr:I
    ...
    iput-object v0, p0, Lcom/android/server/am/ire;->qbh:Ljava/util/List;

    const-string v0, ""

    iput-object v0, p0, Lcom/android/server/am/ire;->oif:Ljava/lang/String;

    sget-boolean v0, Lcom/android/server/am/ire;->ibl:Z
    ...
    invoke-direct {v0, p0, v1}, Lcom/android/server/am/ire$sis;-><init>(Lcom/android/server/am/ire;Landroid/os/Looper;)V
    ...
    sput-boolean v0, Lcom/android/server/am/ire;->gwm:Z
    ...
    :cond_0
    sget-object v0, Lcom/android/server/am/ire;->q:Ljava/lang/String;
    ...
    sget-object v1, Lcom/android/server/am/ire;->s:Ljava/lang/String;
...
.method private a(J)V
    ...
    iget-object v2, p0, Lcom/android/server/am/ire;->dma:Lcom/android/server/am/b;

    const/4 v3, 0x0

    invoke-virtual {v2, v3}, Lcom/android/server/am/b;->irq(Z)Ljava/util/ArrayList;
    ...
    iget-object p0, p0, Lcom/android/server/am/ire;->you:Lcom/android/server/am/ire$sis;
...
.method static synthetic bio(Lcom/android/server/am/ire;J)V
    .locals 0
...
.method private bud()I
    ...
    sget-boolean v4, Lcom/android/server/am/ire;->zgw:Z
...
.method private bvj(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    sget-boolean v3, Lcom/android/server/am/ire;->zgw:Z
...
.method private c(Z)V
    ...
    :cond_2
    sput-boolean v2, Lcom/android/server/am/ire;->ugm:Z
    ...
    :cond_3
    sput v2, Lcom/android/server/am/ire;->g:I
    ...
    sget v0, Lcom/android/server/am/ire;->g:I
    ...
    sget-boolean p1, Lcom/android/server/am/ire;->gwm:Z
    ...
    sget-boolean v4, Lcom/android/server/am/ire;->gwm:Z
    ...
    :goto_2
    sget-boolean p1, Lcom/android/server/am/ire;->obl:Z
    ...
    :goto_4
    sget p1, Lcom/android/server/am/ire;->g:I
...
.method private cgv(Lorg/json/JSONArray;)V
    ...
    sget-boolean v8, Lcom/android/server/am/ire;->zgw:Z
    ...
    sget-boolean v7, Lcom/android/server/am/ire;->zgw:Z
    ...
    sput-boolean v3, Lcom/android/server/am/ire;->vdb:Z
    ...
    sget-boolean v5, Lcom/android/server/am/ire;->vdb:Z
...
.method private d(Ljava/lang/String;Ljava/lang/String;I)Z
    ...
    new-instance v4, Lcom/android/server/am/ire$zta;

    invoke-direct {v4, p0, p1, p2, p3}, Lcom/android/server/am/ire$zta;-><init>(Lcom/android/server/am/ire;Ljava/lang/String;Ljava/lang/String;I)V
...
.method static synthetic dma(Lcom/android/server/am/ire;Z)V
    .locals 0
...
.method private e(III)Z
    ...
    sget-boolean p0, Lcom/android/server/am/ire;->zgw:Z
...
.method static synthetic gck(Lcom/android/server/am/ire;)I
    .locals 0
...
.method private ibl(Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-object p0, p0, Lcom/android/server/am/ire;->qbh:Ljava/util/List;
...
.method static synthetic igw(Lcom/android/server/am/ire;Ljava/lang/String;Ljava/lang/String;I)Z
    .locals 0
...
.method private irq(ILjava/lang/String;Ljava/lang/String;)I
    ...
    iput-object p1, p0, Lcom/android/server/am/ire;->oif:Ljava/lang/String;

    iget-object p1, p0, Lcom/android/server/am/ire;->you:Lcom/android/server/am/ire$sis;
...
.method static synthetic kth(Lcom/android/server/am/ire;)I
    .locals 0
...
.method static synthetic qbh(Lcom/android/server/am/ire;Ljava/lang/String;)I
    .locals 0
...
.method public static final vdb()Lcom/android/server/am/ire;
    ...
    sget-object v0, Lcom/android/server/am/ire;->n:Lcom/android/server/am/ire;
    ...
    sget-object v1, Lcom/android/server/am/ire;->p:Ljava/lang/String;

    invoke-direct {v0, v1}, Ljava/io/File;-><init>(Ljava/lang/String;)V

    sput-object v0, Lcom/android/server/am/ire;->o:Ljava/io/File;
...
.method private veq()I
    ...
    const-string v1, "/system/etc/smartboost.xml"
...
.method static synthetic wtn(Lcom/android/server/am/ire;I)Z
    .locals 0
...
.method static synthetic ywr(Lcom/android/server/am/ire;ILjava/lang/String;Ljava/lang/String;)I
    .locals 0
...
.method public cjf(Landroid/content/Context;)V
    ...
    iget-object v1, p0, Lcom/android/server/am/ire;->you:Lcom/android/server/am/ire$sis;

    new-instance v2, Lcom/android/server/am/ire$you;

    invoke-direct {v2, p0}, Lcom/android/server/am/ire$you;-><init>(Lcom/android/server/am/ire;)V
...
.method public hmo(ILjava/lang/String;Ljava/lang/String;)V
    ...
    iput-object p2, p0, Lcom/android/server/am/ire;->oif:Ljava/lang/String;

    goto :goto_0

    :cond_1
    iget-object v0, p0, Lcom/android/server/am/ire;->oif:Ljava/lang/String;
...
.method public lqr()V
    ...
    iput v1, p0, Lcom/android/server/am/ire;->ywr:I
    ...
    sget-boolean v2, Lcom/android/server/am/ire;->vdb:Z
    ...
    iget v2, p0, Lcom/android/server/am/ire;->ywr:I
    ...
    iget v0, p0, Lcom/android/server/am/ire;->ywr:I
    ...
    :try_start_0
    sget-object p0, Lcom/android/server/am/ire;->o:Ljava/io/File;
    ...
    sget-object v0, Lcom/android/server/am/ire;->o:Ljava/io/File;
...
.method public oxb(Landroid/content/Context;)V
    ...
    iput-object p1, p0, Lcom/android/server/am/ire;->dma:Lcom/android/server/am/b;
