...
.method public rtg(Lcom/android/server/am/ActivityManagerService;Lcom/android/server/am/BroadcastRecord;I)V
    ...
    invoke-virtual {v9, v8, v10}, Lcom/android/server/am/vdb;->cjf(ZLandroid/content/pm/ApplicationInfo;)V
    ...
    invoke-virtual {v8, v7}, Lcom/android/server/am/vdb;->dma(Landroid/content/pm/ApplicationInfo;)Z
    ...
    invoke-direct {p0, p1, v1}, Lcom/android/server/am/irq;->tsu(Ljava/lang/String;Ljava/util/List;)V

    const-string p1, "highUsedList"

    invoke-direct {p0, p1, v2}, Lcom/android/server/am/irq;->tsu(Ljava/lang/String;Ljava/util/List;)V

    const-string p1, "systemList"

    invoke-direct {p0, p1, v3}, Lcom/android/server/am/irq;->tsu(Ljava/lang/String;Ljava/util/List;)V

    const-string p1, "otherList"

    invoke-direct {p0, p1, v4}, Lcom/android/server/am/irq;->tsu(Ljava/lang/String;Ljava/util/List;)V
...
.method protected you(Ljava/util/List;Landroid/content/Intent;)Ljava/util/List;
    ...
    invoke-virtual {v5, v9}, Lcom/android/server/am/vdb;->dma(Landroid/content/pm/ApplicationInfo;)Z

    move-result v5

    if-nez v5, :cond_2

    sget-boolean v5, Lcom/android/server/am/zgw;->ear:Z
