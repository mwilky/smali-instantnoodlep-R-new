...
.method public noteBluetoothConnectedChanged(Ljava/lang/String;Z)V
    ...
    invoke-static {v0}, Lcom/android/server/am/dma;->sis(Ljava/lang/String;)V
    ...
    invoke-static {p2}, Lcom/android/server/am/AppRecordManager;->sis(Ljava/lang/String;)Lcom/android/server/am/bio;

    move-result-object v2

    invoke-virtual {v2, v1}, Lcom/android/server/am/bio;->s(I)V
    ...
    :cond_2
    invoke-static {p1}, Lcom/android/server/am/AppRecordManager;->sis(Ljava/lang/String;)Lcom/android/server/am/bio;

    move-result-object p2

    invoke-virtual {p2, v1}, Lcom/android/server/am/bio;->s(I)V
...
.method public noteFrontPackageChanged(Ljava/lang/String;IILjava/lang/String;II)V
    ...
    invoke-static {p4}, Lcom/android/server/am/dma;->sis(Ljava/lang/String;)V

    sget-boolean p4, Lcom/android/server/am/dma;->kth:Z
    ...
    invoke-static {p4, p3}, Lcom/android/server/am/AppRecordManager;->zta(II)Lcom/android/server/am/bio;

    move-result-object p5

    invoke-virtual {p5, p3}, Lcom/android/server/am/bio;->rtg(I)Lcom/android/server/am/e;
    ...
    invoke-virtual {p5, v1}, Lcom/android/server/am/bio;->zta(I)V
    ...
    invoke-virtual {p5}, Lcom/android/server/am/bio;->sis()I
    ...
    invoke-virtual {p5, v1}, Lcom/android/server/am/bio;->s(I)V
...
.method public notePSSChanged(II)V
    ...
    invoke-virtual {v0, p2}, Lcom/android/server/am/bio;->rtg(I)Lcom/android/server/am/e;
...
.method public noteProcessStateChanged(IILjava/lang/String;Ljava/lang/String;ZII)V
    ...
    sget-boolean v5, Lcom/android/server/am/dma;->kth:Z
    ...
    invoke-virtual {v5, p2}, Lcom/android/server/am/bio;->rtg(I)Lcom/android/server/am/e;
    ...
    invoke-static {v7}, Lcom/android/server/am/dma;->igw(Ljava/lang/String;)V
