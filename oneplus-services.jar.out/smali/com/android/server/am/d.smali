...
.field private static ibl:Lcom/android/server/am/d; = null
...
.method static constructor <clinit>()V
    ...
    sput-boolean v0, Lcom/android/server/am/d;->oif:Z
    ...
    sput-boolean v0, Lcom/android/server/am/d;->bvj:Z

    const/4 v0, 0x0

    sput-object v0, Lcom/android/server/am/d;->ibl:Lcom/android/server/am/d;

    sput-object v0, Lcom/android/server/am/d;->gwm:Landroid/os/Handler;
...
.method protected constructor <init>(Landroid/content/Context;)V
    ...
    iput-boolean v0, p0, Lcom/android/server/am/d;->zta:Z

    const-string v1, ""

    iput-object v1, p0, Lcom/android/server/am/d;->you:Ljava/lang/String;

    new-instance v1, Ljava/lang/Object;

    invoke-direct {v1}, Ljava/lang/Object;-><init>()V

    iput-object v1, p0, Lcom/android/server/am/d;->sis:Ljava/lang/Object;

    const/4 v1, 0x0

    iput-object v1, p0, Lcom/android/server/am/d;->tsu:Landroid/content/Context;

    iput-object v1, p0, Lcom/android/server/am/d;->rtg:Lcom/oneplus/config/ConfigObserver;

    new-instance v2, Ljava/util/HashSet;

    invoke-direct {v2}, Ljava/util/HashSet;-><init>()V

    iput-object v2, p0, Lcom/android/server/am/d;->ssp:Ljava/util/HashSet;

    iput-object v1, p0, Lcom/android/server/am/d;->cno:Ljava/lang/reflect/Method;

    iput-object v1, p0, Lcom/android/server/am/d;->kth:Ljava/lang/Object;

    iput-boolean v0, p0, Lcom/android/server/am/d;->bio:Z

    new-instance v0, Lcom/android/server/am/d$zta;

    invoke-direct {v0, p0}, Lcom/android/server/am/d$zta;-><init>(Lcom/android/server/am/d;)V

    iput-object v0, p0, Lcom/android/server/am/d;->igw:Landroid/content/BroadcastReceiver;
    ...
    iput-object p1, p0, Lcom/android/server/am/d;->tsu:Landroid/content/Context;

    new-instance p1, Lcom/android/server/am/d$sis;
    ...
    invoke-direct {p1, p0, v0}, Lcom/android/server/am/d$sis;-><init>(Lcom/android/server/am/d;Landroid/os/Looper;)V

    sput-object p1, Lcom/android/server/am/d;->gwm:Landroid/os/Handler;
    ...
    iget-object v0, p0, Lcom/android/server/am/d;->tsu:Landroid/content/Context;

    iget-object v2, p0, Lcom/android/server/am/d;->igw:Landroid/content/BroadcastReceiver;

    sget-object v3, Lcom/android/server/am/d;->gwm:Landroid/os/Handler;
    ...
    invoke-direct {p0}, Lcom/android/server/am/d;->gwm()V

    invoke-direct {p0}, Lcom/android/server/am/d;->ugm()V

    invoke-direct {p0}, Lcom/android/server/am/d;->ywr()V

    sput-object p0, Lcom/android/server/am/d;->ibl:Lcom/android/server/am/d;

    return-void
.end method

.method static synthetic bio(Lcom/android/server/am/d;Z)Z
    .locals 0

    iput-boolean p1, p0, Lcom/android/server/am/d;->bio:Z
...
.method private cjf(ZLjava/lang/String;)V
    ...
    sget-boolean v0, Lcom/android/server/am/d;->oif:Z
    ...
    :cond_0
    :try_start_0
    iget-object p2, p0, Lcom/android/server/am/d;->cno:Ljava/lang/reflect/Method;

    if-nez p2, :cond_1

    invoke-direct {p0}, Lcom/android/server/am/d;->oif()Ljava/lang/reflect/Method;

    move-result-object p2

    iput-object p2, p0, Lcom/android/server/am/d;->cno:Ljava/lang/reflect/Method;

    :cond_1
    iget-object p2, p0, Lcom/android/server/am/d;->kth:Ljava/lang/Object;

    if-nez p2, :cond_2

    invoke-direct {p0}, Lcom/android/server/am/d;->qbh()Ljava/lang/Object;

    move-result-object p2

    iput-object p2, p0, Lcom/android/server/am/d;->kth:Ljava/lang/Object;

    :cond_2
    sget-boolean p2, Lcom/android/server/am/d;->oif:Z
    ...
    iget-object v0, p0, Lcom/android/server/am/d;->kth:Ljava/lang/Object;
    ...
    iget-object v0, p0, Lcom/android/server/am/d;->cno:Ljava/lang/reflect/Method;
    ...
    iget-object v2, p0, Lcom/android/server/am/d;->cno:Ljava/lang/reflect/Method;

    iget-object v3, p0, Lcom/android/server/am/d;->kth:Ljava/lang/Object;
    ...
    iput-boolean p1, p0, Lcom/android/server/am/d;->zta:Z
    :try_end_0
...
.method static synthetic cno(Lcom/android/server/am/d;)Lcom/oneplus/config/ConfigObserver;
    .locals 0

    iget-object p0, p0, Lcom/android/server/am/d;->rtg:Lcom/oneplus/config/ConfigObserver;
...
.method private dma(Ljava/lang/String;Ljava/lang/Boolean;)V
    ...
    iget-object v0, p0, Lcom/android/server/am/d;->ssp:Ljava/util/HashSet;
    ...
    iget-object p2, p0, Lcom/android/server/am/d;->ssp:Ljava/util/HashSet;
    ...
    iget-object p0, p0, Lcom/android/server/am/d;->ssp:Ljava/util/HashSet;
...
.method private ear()V
    ...
    iget-object v0, p0, Lcom/android/server/am/d;->sis:Ljava/lang/Object;

    monitor-enter v0

    :try_start_0
    iget-object v1, p0, Lcom/android/server/am/d;->you:Ljava/lang/String;
    ...
    sget-boolean v3, Lcom/android/server/am/d;->bvj:Z
    ...
    iget-object v3, p0, Lcom/android/server/am/d;->you:Ljava/lang/String;
    ...
    iget-boolean v3, p0, Lcom/android/server/am/d;->zta:Z
    ...
    sget-boolean v0, Lcom/android/server/am/d;->bvj:Z

    if-eqz v0, :cond_0

    invoke-direct {p0, v1, v2}, Lcom/android/server/am/d;->oxb(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct {p0, v0, v2}, Lcom/android/server/am/d;->cjf(ZLjava/lang/String;)V
...
.method public static final ibl(Landroid/content/Context;)Lcom/android/server/am/d;
    .locals 1

    sget-object v0, Lcom/android/server/am/d;->ibl:Lcom/android/server/am/d;

    if-nez v0, :cond_0

    new-instance v0, Lcom/android/server/am/d;

    invoke-direct {v0, p0}, Lcom/android/server/am/d;-><init>(Landroid/content/Context;)V

    sput-object v0, Lcom/android/server/am/d;->ibl:Lcom/android/server/am/d;

    :cond_0
    sget-object p0, Lcom/android/server/am/d;->ibl:Lcom/android/server/am/d;

    return-object p0
.end method

.method static synthetic igw(Lcom/android/server/am/d;)Z
    .locals 0

    iget-boolean p0, p0, Lcom/android/server/am/d;->zta:Z

    return p0
.end method

.method static synthetic kth(Lcom/android/server/am/d;)Z
    .locals 0

    iget-boolean p0, p0, Lcom/android/server/am/d;->bio:Z
...
.method private obl(Lorg/json/JSONArray;)V
    ...
    sget-boolean v4, Lcom/android/server/am/d;->bvj:Z

    if-eq v3, v4, :cond_2

    sput-boolean v3, Lcom/android/server/am/d;->bvj:Z
    ...
    invoke-direct {p0}, Lcom/android/server/am/d;->ear()V
    ...
    iget-object v3, p0, Lcom/android/server/am/d;->ssp:Ljava/util/HashSet;
    ...
    :try_start_1
    iget-object v4, p0, Lcom/android/server/am/d;->ssp:Ljava/util/HashSet;
    ...
    iget-object v5, p0, Lcom/android/server/am/d;->ssp:Ljava/util/HashSet;
    ...
    :try_start_3
    iget-object v6, p0, Lcom/android/server/am/d;->ssp:Ljava/util/HashSet;
    ...
    sget-boolean v1, Lcom/android/server/am/d;->bvj:Z
...
.method private oif()Ljava/lang/reflect/Method;
    ...
    iput-object v0, p0, Lcom/android/server/am/d;->cno:Ljava/lang/reflect/Method;
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
...
.method private oxb(Ljava/lang/String;Ljava/lang/String;)V
    ...
    sget-object p1, Lcom/android/server/am/d;->gwm:Landroid/os/Handler;
...
.method static synthetic rtg(Lcom/android/server/am/d;Ljava/lang/Object;)Ljava/lang/String;
    .locals 0

    invoke-direct {p0, p1}, Lcom/android/server/am/d;->bvj(Ljava/lang/Object;)Ljava/lang/String;
...
.method static synthetic sis(Lcom/android/server/am/d;)V
    .locals 0
...
.method static synthetic ssp(Lcom/android/server/am/d;)Landroid/content/Context;
    .locals 0

    iget-object p0, p0, Lcom/android/server/am/d;->tsu:Landroid/content/Context;

    return-object p0
.end method

.method static synthetic tsu(Lcom/android/server/am/d;Ljava/lang/String;Ljava/lang/Boolean;)V
    .locals 0

    invoke-direct {p0, p1, p2}, Lcom/android/server/am/d;->dma(Ljava/lang/String;Ljava/lang/Boolean;)V
...
.method private ugm()V
    ...
    iget-object v2, p0, Lcom/android/server/am/d;->tsu:Landroid/content/Context;

    sget-object v3, Lcom/android/server/am/d;->gwm:Landroid/os/Handler;

    new-instance v4, Lcom/android/server/am/d$you;

    invoke-direct {v4, p0}, Lcom/android/server/am/d$you;-><init>(Lcom/android/server/am/d;)V
    ...
    sget-object p0, Lcom/android/server/am/d;->gwm:Landroid/os/Handler;
...
.method private vdb()V
    ...
    :try_start_0
    iget-object v1, p0, Lcom/android/server/am/d;->ssp:Ljava/util/HashSet;
...
.method static synthetic wtn(Lcom/android/server/am/d;ZLjava/lang/String;)V
    .locals 0

    invoke-direct {p0, p1, p2}, Lcom/android/server/am/d;->cjf(ZLjava/lang/String;)V

    return-void
.end method

.method static synthetic you()Lcom/android/server/am/d;
    .locals 1
...
.method private ywr()V
    ...
    iget-object v2, p0, Lcom/android/server/am/d;->you:Ljava/lang/String;
    ...
    iget-boolean v2, p0, Lcom/android/server/am/d;->zta:Z
...
.method private zgw(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    :try_start_0
    iget-object v2, p0, Lcom/android/server/am/d;->ssp:Ljava/util/HashSet;
...
.method static synthetic zta(Lcom/android/server/am/d;Lorg/json/JSONArray;)V
    ...
    invoke-direct {p0, p1}, Lcom/android/server/am/d;->obl(Lorg/json/JSONArray;)V
...
.method public frontPackageChanged(Ljava/lang/String;IILjava/lang/String;II)V
    ...
    sget-object p3, Lcom/android/server/am/d;->ibl:Lcom/android/server/am/d;
    ...
    iget-object p2, p0, Lcom/android/server/am/d;->sis:Ljava/lang/Object;

    monitor-enter p2

    :try_start_0
    iput-object p1, p0, Lcom/android/server/am/d;->you:Ljava/lang/String;

    monitor-exit p2
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    sget-boolean p2, Lcom/android/server/am/d;->bvj:Z
    ...
    :cond_1
    invoke-direct {p0, p1, p4}, Lcom/android/server/am/d;->zgw(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    invoke-direct {p0, p1, p2}, Lcom/android/server/am/d;->oxb(Ljava/lang/String;Ljava/lang/String;)V
