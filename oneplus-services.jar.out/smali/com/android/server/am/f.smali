...
.field private static ssp:Lcom/android/server/am/f; = null

.field protected static wtn:J = 0xea60L


# instance fields
.field private rtg:Lcom/android/server/am/f$zta;
...
.method private constructor <init>(Lcom/android/server/am/ActivityManagerService;)V
    ...
    iput-object p1, p0, Lcom/android/server/am/f;->zta:Lcom/android/server/am/ActivityManagerService;

    new-instance p1, Ljava/util/ArrayList;

    invoke-direct {p1}, Ljava/util/ArrayList;-><init>()V

    iput-object p1, p0, Lcom/android/server/am/f;->you:Ljava/util/ArrayList;

    new-instance p1, Lcom/android/internal/app/ProcessMap;

    invoke-direct {p1}, Lcom/android/internal/app/ProcessMap;-><init>()V

    iput-object p1, p0, Lcom/android/server/am/f;->sis:Lcom/android/internal/app/ProcessMap;

    new-instance p1, Lcom/android/internal/app/ProcessMap;

    invoke-direct {p1}, Lcom/android/internal/app/ProcessMap;-><init>()V

    iput-object p1, p0, Lcom/android/server/am/f;->tsu:Lcom/android/internal/app/ProcessMap;
...
.method private synthetic rtg(Ljava/lang/String;)V
    ...
    iget-object p0, p0, Lcom/android/server/am/f;->zta:Lcom/android/server/am/ActivityManagerService;
...
.method private sis(Lcom/android/server/am/ProcessRecord;)Z
    ...
    sget v0, Lcom/android/server/am/f;->dma:I
    ...
    sget p1, Lcom/android/server/am/f;->dma:I
...
.method private you(Lcom/android/server/am/ProcessRecord;Ljava/lang/String;)V
    ...
    invoke-direct {p0, p1}, Lcom/android/server/am/f;->sis(Lcom/android/server/am/ProcessRecord;)Z
    ...
    invoke-direct {v1, p0, p1}, Lcom/android/server/am/tsu;-><init>(Lcom/android/server/am/f;Ljava/lang/String;)V
...
.method public static zta(Lcom/android/server/am/ActivityManagerService;)Lcom/android/server/am/f;
    .locals 1

    sget-object v0, Lcom/android/server/am/f;->ssp:Lcom/android/server/am/f;

    if-nez v0, :cond_0

    new-instance v0, Lcom/android/server/am/f;

    invoke-direct {v0, p0}, Lcom/android/server/am/f;-><init>(Lcom/android/server/am/ActivityManagerService;)V

    sput-object v0, Lcom/android/server/am/f;->ssp:Lcom/android/server/am/f;

    :cond_0
    sget-object p0, Lcom/android/server/am/f;->ssp:Lcom/android/server/am/f;
...
.method protected cno(Lcom/android/server/am/ProcessRecord;J)V
    ...
    iget-object v0, p0, Lcom/android/server/am/f;->rtg:Lcom/android/server/am/f$zta;
    ...
    iput-object v0, p0, Lcom/android/server/am/f;->rtg:Lcom/android/server/am/f$zta;

    :cond_0
    iget-object v0, p0, Lcom/android/server/am/f;->rtg:Lcom/android/server/am/f$zta;

    iget-object v0, v0, Lcom/android/server/am/f$zta;->you:Ljava/lang/String;
    ...
    iget v1, v0, Lcom/android/server/am/f$zta;->sis:I
    ...
    invoke-static {v0, v1, v2, p2, p3}, Lcom/android/server/am/f$zta;->you(Lcom/android/server/am/f$zta;Ljava/lang/String;IJ)Z
    ...
    invoke-static {v0, p2, p3}, Lcom/android/server/am/f$zta;->sis(Lcom/android/server/am/f$zta;J)V

    iget-object p2, p0, Lcom/android/server/am/f;->rtg:Lcom/android/server/am/f$zta;

    invoke-static {p2}, Lcom/android/server/am/f$zta;->tsu(Lcom/android/server/am/f$zta;)Z
    ...
    invoke-direct {p0, p1, p2}, Lcom/android/server/am/f;->you(Lcom/android/server/am/ProcessRecord;Ljava/lang/String;)V

    goto :goto_1

    :cond_2
    :goto_0
    iget-object p0, p0, Lcom/android/server/am/f;->rtg:Lcom/android/server/am/f$zta;

    iget-object v0, p1, Lcom/android/server/am/ProcessRecord;->processName:Ljava/lang/String;

    iget p1, p1, Lcom/android/server/am/ProcessRecord;->uid:I

    invoke-static {p0, v0, p1, p2, p3}, Lcom/android/server/am/f$zta;->zta(Lcom/android/server/am/f$zta;Ljava/lang/String;IJ)V
...
.method protected kth(Lcom/android/server/am/ProcessRecord;J)V
    ...
    iget-object v0, p0, Lcom/android/server/am/f;->sis:Lcom/android/internal/app/ProcessMap;
    ...
    iget-object v1, p0, Lcom/android/server/am/f;->tsu:Lcom/android/internal/app/ProcessMap;
    ...
    sget-wide v7, Lcom/android/server/am/f;->wtn:J
    ...
    sget v2, Lcom/android/server/am/f;->gck:I

    if-lt v0, v2, :cond_1

    iget-object p2, p0, Lcom/android/server/am/f;->sis:Lcom/android/internal/app/ProcessMap;
    ...
    iget-object p2, p0, Lcom/android/server/am/f;->tsu:Lcom/android/internal/app/ProcessMap;
    ...
    iget-object p0, p0, Lcom/android/server/am/f;->tsu:Lcom/android/internal/app/ProcessMap;
    ...
    sget-wide v3, Lcom/android/server/am/f;->wtn:J
...
.method public synthetic ssp(Ljava/lang/String;)V
    ...
    invoke-direct {p0, p1}, Lcom/android/server/am/f;->rtg(Ljava/lang/String;)V
...
.method protected tsu(Lcom/android/server/am/ProcessRecord;)Z
    ...
    :cond_5
    iget-object v1, p0, Lcom/android/server/am/f;->you:Ljava/util/ArrayList;

    monitor-enter v1

    :try_start_0
    iget-object p0, p0, Lcom/android/server/am/f;->you:Ljava/util/ArrayList;
    ...
    sget v1, Lcom/android/server/am/f;->dma:I
