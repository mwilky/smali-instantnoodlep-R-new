...
.method public run()V
    ...
    :cond_0
    iget-object v0, p0, Lcom/android/server/am/k$zta;->zta:Lcom/android/server/am/k;

    invoke-static {v0}, Lcom/android/server/am/k;->zta(Lcom/android/server/am/k;)V

    iget-object v0, p0, Lcom/android/server/am/k$zta;->zta:Lcom/android/server/am/k;

    invoke-static {v0}, Lcom/android/server/am/k;->you(Lcom/android/server/am/k;)V

    iget-object v0, p0, Lcom/android/server/am/k$zta;->zta:Lcom/android/server/am/k;

    invoke-static {v0}, Lcom/android/server/am/k;->sis(Lcom/android/server/am/k;)J

    move-result-wide v0

    iget-object v2, p0, Lcom/android/server/am/k$zta;->zta:Lcom/android/server/am/k;

    invoke-static {v2}, Lcom/android/server/am/k;->tsu(Lcom/android/server/am/k;)Landroid/os/Handler;
