...
.method public constructor <init>()V
    ...
    new-instance v0, Lcom/android/server/am/AppRecordManagerService$rtg;

    invoke-direct {v0, p0}, Lcom/android/server/am/AppRecordManagerService$rtg;-><init>(Lcom/android/server/am/AppRecordManagerService;)V

    iput-object v0, p0, Lcom/android/server/am/AppRecordManagerService;->mOMMFrontMonitor:Lcom/android/server/am/AppRecordManagerService$rtg;
    ...
    new-instance v0, Lcom/android/server/am/AppRecordManagerService$cno;

    invoke-direct {v0, p0}, Lcom/android/server/am/AppRecordManagerService$cno;-><init>(Lcom/android/server/am/AppRecordManagerService;)V

    iput-object v0, p0, Lcom/android/server/am/AppRecordManagerService;->mTouchWindowListener:Lcom/android/server/am/AppRecordManagerService$cno;
    ...
    iput-object v0, p0, Lcom/android/server/am/AppRecordManagerService;->mBluetoothList:Ljava/util/List;
...
.method private addPackage(Ljava/lang/String;)V
    ...
    invoke-virtual {p0, p1}, Lcom/android/server/am/AppRecordManagerService;->createAppRecordFromPMS(Ljava/lang/String;)Lcom/android/server/am/bio;
    ...
    :cond_0
    iget-boolean p1, v0, Lcom/android/server/am/bio;->sis:Z

    if-eqz p1, :cond_1

    const/16 p1, 0x4000

    invoke-virtual {v0, p1}, Lcom/android/server/am/bio;->zta(I)V
    ...
    iget v3, v0, Lcom/android/server/am/bio;->zta:I
    ...
    iget-object v3, v0, Lcom/android/server/am/bio;->you:Ljava/lang/String;
    ...
    :cond_2
    iget-object p0, v0, Lcom/android/server/am/bio;->you:Ljava/lang/String;
...
.method private dump(Z)V
    ...
    check-cast v2, Lcom/android/server/am/bio;

    if-nez p1, :cond_2

    invoke-virtual {v2}, Lcom/android/server/am/bio;->bio()I
    ...
    invoke-virtual {v2}, Lcom/android/server/am/bio;->toString()Ljava/lang/String;
...
.method private dumpApp(I)V
    ...
    iget v3, v2, Lcom/android/server/am/bio;->zta:I
...
.method private dumpApp(Ljava/lang/String;)V
    ...
    iget-object v3, v2, Lcom/android/server/am/bio;->you:Ljava/lang/String;
...
.method private updateLockedTaskInfoLocked()V
    ...
    invoke-static {v7}, Lcom/android/server/am/dma;->sis(Ljava/lang/String;)V
...
.method static synthetic zta(Ljava/lang/String;Ljava/lang/String;II)V
    ...
    invoke-virtual {v0, p0, p1, p2, p3}, Lcom/android/server/am/wtn;->wtn(Ljava/lang/String;Ljava/lang/String;II)V
...
.method public addIsolatedUid(II)V
    ...
    check-cast p2, Lcom/android/server/am/bio;

    invoke-virtual {p2, p1}, Lcom/android/server/am/bio;->you(I)V
...
.method public createAppRecordFromPMS(Ljava/lang/String;)Lcom/android/server/am/bio;
    .locals 2
    ...
    invoke-direct {v0, v1, p1, p0}, Lcom/android/server/am/bio;-><init>(ILjava/lang/String;Z)V
...
.method dumpOMMAppRecordInfo(Ljava/io/PrintWriter;)V
    ...
    check-cast v3, Lcom/android/server/am/bio;

    invoke-virtual {v3}, Lcom/android/server/am/bio;->cno()Ljava/util/HashMap;
    ...
    iget-object v5, v3, Lcom/android/server/am/bio;->you:Ljava/lang/String;
    ...
    check-cast v5, Lcom/android/server/am/e;
    ...
    iget v8, v5, Lcom/android/server/am/e;->you:I
    ...
    :cond_4
    invoke-virtual {v5}, Lcom/android/server/am/e;->toString()Ljava/lang/String;
...
.method public dumpsysOMM(Ljava/lang/String;Ljava/io/PrintWriter;)V
    ...
    invoke-static {p1, p2}, Lcom/android/server/am/dma;->you(Ljava/lang/String;Ljava/io/PrintWriter;)V
...
.method public forceStopPackageSmart(Ljava/lang/String;I)V
    ...
    invoke-virtual {p0, p1}, Lcom/android/server/am/AppRecordManagerService;->getAppRecord(Ljava/lang/String;)Lcom/android/server/am/bio;
    ...
    :cond_0
    invoke-virtual {p0, p1, p2}, Lcom/android/server/am/bio;->sis(Ljava/lang/String;I)V
...
.method getAppRecord(II)Lcom/android/server/am/bio;
    .locals 3
...
.method getAppRecord(ILjava/lang/String;)Lcom/android/server/am/bio;
    .locals 6
    ...
    check-cast p0, Lcom/android/server/am/bio;

    if-nez p0, :cond_7

    new-instance p0, Lcom/android/server/am/bio;

    invoke-direct {p0, v0, p2}, Lcom/android/server/am/bio;-><init>(ILjava/lang/String;)V
    ...
    :cond_5
    new-instance v3, Lcom/android/server/am/bio;

    invoke-direct {v3, v0, p2}, Lcom/android/server/am/bio;-><init>(ILjava/lang/String;)V
    ...
    invoke-direct {v0, p1, p2}, Lcom/android/server/am/bio;-><init>(ILjava/lang/String;)V
    ...
    invoke-direct {p0, p1, p2}, Lcom/android/server/am/bio;-><init>(ILjava/lang/String;)V
...
.method getAppRecord(Ljava/lang/String;)Lcom/android/server/am/bio;
    .locals 1
    ...
    invoke-virtual {p0, v0, p1}, Lcom/android/server/am/AppRecordManagerService;->getAppRecord(ILjava/lang/String;)Lcom/android/server/am/bio;
...
.method getAppRecord(I)Ljava/util/concurrent/ConcurrentHashMap;
    ...
    invoke-direct {p0, p1, v2}, Lcom/android/server/am/bio;-><init>(ILjava/lang/String;)V
...
.method public getAppRecordFromUid(I)Lcom/android/server/am/bio;
    .locals 2
    ...
    invoke-direct {v0, p1, p0}, Lcom/android/server/am/bio;-><init>(ILjava/lang/String;)V
...
.method public getPackageName(II)Ljava/lang/String;
    ...
    iget-object p0, p1, Lcom/android/server/am/bio;->you:Ljava/lang/String;
...
.method getPackagesFromUid(I)Ljava/util/ArrayList;
    ...
    iget-object p1, p1, Lcom/android/server/am/bio;->you:Ljava/lang/String;
...
.method public getPackagesUsingFlag(I)Ljava/util/ArrayList;
    ...
    invoke-virtual {v3}, Lcom/android/server/am/bio;->tsu()I
    ...
    iget-object v4, v3, Lcom/android/server/am/bio;->you:Ljava/lang/String;
    ...
    iget-object v3, v3, Lcom/android/server/am/bio;->you:Ljava/lang/String;
...
.method public getProcState(I)I
    ...
    invoke-virtual {p0}, Lcom/android/server/am/bio;->kth()I
...
.method public getUidState(I)I
    ...
    invoke-virtual {p0}, Lcom/android/server/am/bio;->bio()I
...
.method public getUidsFromPackageName(Ljava/lang/String;)Ljava/util/ArrayList;
    ...
    iget v3, v3, Lcom/android/server/am/bio;->zta:I
...
.method public initAppRecord(Lcom/android/server/pm/PackageManagerService;Landroid/util/ArrayMap;)V
    ...
    :cond_0
    new-instance v1, Lcom/android/server/am/bio;
    ...
    invoke-direct {v1, v2, v3, v4}, Lcom/android/server/am/bio;-><init>(ILjava/lang/String;Z)V
    ...
    invoke-virtual {v1, p2}, Lcom/android/server/am/bio;->zta(I)V
    ...
    iget v3, v1, Lcom/android/server/am/bio;->zta:I
    ...
    :cond_2
    iget-object v3, v1, Lcom/android/server/am/bio;->you:Ljava/lang/String;
...
.method public initEnv(Landroid/content/Context;)V
    ...
    invoke-virtual {v0, p1}, Lcom/android/server/dma;->vdb(Landroid/content/Context;)V
    ...
    invoke-virtual {p1, v0}, Lcom/android/server/am/ivd;->ssp(Landroid/content/Context;)V
...
.method public noteBluetoothConnectedChanged(Ljava/lang/String;Z)V
    ...
    invoke-virtual {p0, p1, p2}, Lcom/android/server/am/bio;->ywr(Ljava/lang/String;Z)V
...
.method public noteFlashlightOff(I)V
    ...
    invoke-virtual {p1}, Lcom/android/server/am/bio;->qbh()V
...
.method public noteFlashlightOn(I)V
    ...
    invoke-virtual {p1}, Lcom/android/server/am/bio;->oif()V
...
.method public noteFloatWindowChange(Ljava/lang/String;IIZ)V
    ...
    invoke-virtual {p0, p2, p1}, Lcom/android/server/am/AppRecordManagerService;->getAppRecord(ILjava/lang/String;)Lcom/android/server/am/bio;

    move-result-object p0

    invoke-virtual {p0, p1, p2, p3, p4}, Lcom/android/server/am/bio;->bvj(Ljava/lang/String;IIZ)V
...
.method public noteFreezeStateChange(IZ)V
    ...
    invoke-virtual {v0, p1, p2}, Lcom/android/server/am/bio;->ibl(IZ)V
...
.method public noteFrontPackageChanged(Ljava/lang/String;IILjava/lang/String;II)V
    ...
    invoke-virtual/range {v1 .. v8}, Lcom/android/server/am/bio;->gwm(Ljava/lang/String;IILjava/lang/String;IIZ)V

    move-object v4, p4

    move/from16 v5, p5

    invoke-virtual {p0, v5, p4}, Lcom/android/server/am/AppRecordManagerService;->getAppRecord(ILjava/lang/String;)Lcom/android/server/am/bio;
    ...
    invoke-virtual/range {v0 .. v7}, Lcom/android/server/am/bio;->gwm(Ljava/lang/String;IILjava/lang/String;IIZ)V
...
.method public noteHighUsedAppChanged(Ljava/util/ArrayList;Z)V
    ...
    iget-object v1, p0, Lcom/android/server/am/AppRecordManagerService;->mPrehighResult:Ljava/util/ArrayList;
    ...
    :cond_1
    invoke-virtual {p0, v0}, Lcom/android/server/am/AppRecordManagerService;->getAppRecord(Ljava/lang/String;)Lcom/android/server/am/bio;

    move-result-object v1

    const/4 v2, 0x1

    invoke-virtual {v1, v0, v2}, Lcom/android/server/am/bio;->ugm(Ljava/lang/String;Z)V
...
.method public noteNotificationChanged(Ljava/lang/String;IIZ)V
    ...
    invoke-virtual {p0, p1, p2, p3, p4}, Lcom/android/server/am/bio;->vdb(Ljava/lang/String;IIZ)V
...
.method public notePSSChanged(II)V
    ...
    invoke-virtual {v0}, Lcom/android/server/am/e;->ywr()V

    invoke-virtual {p0, p1, p2}, Lcom/android/server/am/bio;->zgw(II)V
...
.method public notePauseGps(ILjava/lang/String;Z)V
    ...
    invoke-virtual {p1, p2, p3}, Lcom/android/server/am/bio;->obl(Ljava/lang/String;Z)V
...
.method public notePauseGps(Ljava/lang/String;Ljava/lang/String;Z)V
    ...
    invoke-virtual {p0, p2, p3}, Lcom/android/server/am/bio;->obl(Ljava/lang/String;Z)V
...
.method public notePredctionAppChanged(Ljava/lang/String;Z)V
    ...
    invoke-virtual {p0, p1, p2}, Lcom/android/server/am/bio;->oxb(Ljava/lang/String;Z)V
...
.method public noteProcessStateChanged(IILjava/lang/String;Ljava/lang/String;ZII)V
    ...
    invoke-virtual {p0, p1, p3}, Lcom/android/server/am/AppRecordManagerService;->getAppRecord(ILjava/lang/String;)Lcom/android/server/am/bio;
    ...
    invoke-virtual/range {v0 .. v7}, Lcom/android/server/am/bio;->cjf(IILjava/lang/String;Ljava/lang/String;ZII)V
...
.method public noteRfcommSocketToServiceRecord(II)V
    ...
    invoke-virtual {p0, p1}, Lcom/android/server/am/bio;->lqr(Z)V
...
.method public noteStartAudio(I)V
    ...
    invoke-virtual {p1}, Lcom/android/server/am/bio;->veq()V
...
.method public noteStartAudio(II)V
    ...
    invoke-virtual {p0, p2}, Lcom/android/server/am/bio;->cgv(I)V
...
.method public noteStartCamera(I)V
    ...
    invoke-virtual {p1}, Lcom/android/server/am/bio;->vju()V
...
.method public noteStartGps(Ljava/lang/String;Ljava/lang/String;J)V
    ...
    invoke-virtual {p0, p2, p3, p4}, Lcom/android/server/am/bio;->bud(Ljava/lang/String;J)V
...
.method public noteStartSensor(II)V
    ...
    invoke-virtual {p1, p2}, Lcom/android/server/am/bio;->les(I)V
...
.method public noteStartTraffic(ILjava/lang/String;)V
    ...
    invoke-virtual {p0, p1, p2}, Lcom/android/server/am/AppRecordManagerService;->getAppRecord(ILjava/lang/String;)Lcom/android/server/am/bio;

    move-result-object p0

    invoke-virtual {p0}, Lcom/android/server/am/bio;->irq()V
...
.method public noteStartTrafficHigh(ILjava/lang/String;)V
    ...
    invoke-virtual {p0}, Lcom/android/server/am/bio;->vdw()V
...
.method public noteStartVideo(I)V
    ...
    invoke-virtual {p1}, Lcom/android/server/am/bio;->qeg()V
...
.method public noteStartVideo(II)V
    ...
    invoke-virtual {p0, p2}, Lcom/android/server/am/bio;->ivd(I)V
...
.method public noteStopAudio(I)V
    ...
    invoke-virtual {p1}, Lcom/android/server/am/bio;->a()V
...
.method public noteStopAudio(II)V
    ...
    invoke-virtual {p0, p2}, Lcom/android/server/am/bio;->b(I)V
...
.method public noteStopCamera(I)V
    ...
    invoke-virtual {p1}, Lcom/android/server/am/bio;->c()V
...
.method public noteStopGps(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {p0, p2}, Lcom/android/server/am/bio;->d(Ljava/lang/String;)V
...
.method public noteStopSensor(II)V
    ...
    invoke-virtual {p1, p2}, Lcom/android/server/am/bio;->e(I)V
...
.method public noteStopTraffic(ILjava/lang/String;)V
    ...
    invoke-virtual {p0}, Lcom/android/server/am/bio;->f()V
...
.method public noteStopTrafficHigh(ILjava/lang/String;)V
    ...
    invoke-virtual {p0}, Lcom/android/server/am/bio;->g()V
...
.method public noteStopVideo(I)V
    ...
    invoke-virtual {p1}, Lcom/android/server/am/bio;->h()V
...
.method public noteStopVideo(II)V
    ...
    invoke-virtual {p0, p2}, Lcom/android/server/am/bio;->i(I)V
...
.method public noteUserLockAppChanged(Ljava/lang/String;IZ)V
    ...
    invoke-virtual {p0, v2, p1}, Lcom/android/server/am/AppRecordManagerService;->getAppRecord(ILjava/lang/String;)Lcom/android/server/am/bio;

    move-result-object p0

    invoke-virtual {p0, p1, v2, p3}, Lcom/android/server/am/bio;->j(Ljava/lang/String;IZ)V
...
.method public noteVibratorOff(I)V
    ...
    invoke-virtual {p1}, Lcom/android/server/am/bio;->k()V
...
.method public noteVibratorOn(IJ)V
    ...
    invoke-virtual {p1, p2, p3}, Lcom/android/server/am/bio;->l(J)V
...
.method public processDie(Lcom/android/server/am/ProcessRecord;I)V
    ...
    invoke-virtual {p0, p2, v0}, Lcom/android/server/am/AppRecordManagerService;->getAppRecord(ILjava/lang/String;)Lcom/android/server/am/bio;
    ...
    invoke-virtual {p0, p2, v0, p1}, Lcom/android/server/am/bio;->r(III)V
...
.method public processStart(Lcom/android/server/am/ProcessRecord;I)V
    ...
    invoke-virtual {p0, v0, v2}, Lcom/android/server/am/AppRecordManagerService;->getAppRecord(ILjava/lang/String;)Lcom/android/server/am/bio;
    ...
    invoke-virtual {v0, v2}, Lcom/android/server/am/bio;->zta(I)V
    ...
    invoke-virtual/range {v3 .. v8}, Lcom/android/server/am/bio;->s(ILjava/lang/String;ZILjava/lang/String;)V
    ...
    invoke-virtual {v0, p0, p2, v1}, Lcom/android/server/am/bio;->j(Ljava/lang/String;IZ)V
    ...
    invoke-virtual {v0, p0, v1}, Lcom/android/server/am/bio;->ugm(Ljava/lang/String;Z)V
...
.method public removeIsolatedUid(I)V
    ...
    invoke-virtual {v1, p1}, Lcom/android/server/am/bio;->u(I)V
...
.method public schedulePerformPoll()V
    ...
    invoke-virtual {p0}, Lcom/android/server/dma;->obl()V
