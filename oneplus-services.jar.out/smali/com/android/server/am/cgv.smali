...
.field private kth:Lcom/android/server/am/cgv$sis;
...
.method static constructor <clinit>()V
    ...
    :cond_1
    sput-boolean v1, Lcom/android/server/am/cgv;->bvj:Z

    sget-boolean v0, Landroid/os/Build;->DEBUG_ONEPLUS:Z

    sput-boolean v0, Lcom/android/server/am/cgv;->ibl:Z
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-boolean v0, p0, Lcom/android/server/am/cgv;->cno:Z

    const-wide/32 v1, 0x6ddd00

    iput-wide v1, p0, Lcom/android/server/am/cgv;->bio:J

    iput-boolean v0, p0, Lcom/android/server/am/cgv;->igw:Z

    const-wide/16 v1, 0x0

    iput-wide v1, p0, Lcom/android/server/am/cgv;->wtn:J
    ...
    iput-object v1, p0, Lcom/android/server/am/cgv;->dma:Ljava/util/regex/Pattern;
    ...
    iput-object v1, p0, Lcom/android/server/am/cgv;->ywr:Ljava/util/regex/Pattern;
    ...
    iput-object p1, p0, Lcom/android/server/am/cgv;->kth:Lcom/android/server/am/cgv$sis;

    invoke-virtual {p1, v0}, Landroid/os/Handler;->obtainMessage(I)Landroid/os/Message;

    move-result-object p1

    iget-object p0, p0, Lcom/android/server/am/cgv;->kth:Lcom/android/server/am/cgv$sis;
...
.method static synthetic bio(Lcom/android/server/am/cgv;)Z
    .locals 0

    iget-boolean p0, p0, Lcom/android/server/am/cgv;->igw:Z

    return p0
.end method

.method static synthetic cno(Lcom/android/server/am/cgv;)Z
    .locals 0

    iget-boolean p0, p0, Lcom/android/server/am/cgv;->cno:Z
...
.method private dma(Ljava/lang/StringBuilder;)V
    ...
    iget-boolean v8, v1, Lcom/android/server/am/cgv;->igw:Z
    ...
    sget-boolean v11, Lcom/android/server/am/cgv;->ibl:Z
    ...
    iget-object v10, v1, Lcom/android/server/am/cgv;->dma:Ljava/util/regex/Pattern;
    ...
    iget-object v10, v1, Lcom/android/server/am/cgv;->ywr:Ljava/util/regex/Pattern;
    ...
    sget-boolean v10, Lcom/android/server/am/cgv;->ibl:Z
    ...
    :cond_6
    sget-boolean v0, Lcom/android/server/am/cgv;->ibl:Z
    ...
    iget-object v0, v1, Lcom/android/server/am/cgv;->you:Landroid/os/DropBoxManager;

    if-eqz v0, :cond_8

    iget-object v1, v1, Lcom/android/server/am/cgv;->sis:Ljava/lang/String;
...
.method static synthetic igw(Lcom/android/server/am/cgv;)J
    .locals 2

    iget-wide v0, p0, Lcom/android/server/am/cgv;->bio:J

    return-wide v0
.end method

.method static synthetic kth(Lcom/android/server/am/cgv;Z)Z
    .locals 0

    iput-boolean p1, p0, Lcom/android/server/am/cgv;->cno:Z
...
.method static synthetic sis(Lcom/android/server/am/cgv;)Lcom/oneplus/config/ConfigObserver;
    ...
    iget-object p0, p0, Lcom/android/server/am/cgv;->rtg:Lcom/oneplus/config/ConfigObserver;

    return-object p0
.end method

.method static synthetic ssp(Lcom/android/server/am/cgv;Ljava/lang/StringBuilder;)V
    .locals 0

    invoke-direct {p0, p1}, Lcom/android/server/am/cgv;->dma(Ljava/lang/StringBuilder;)V
...
.method static synthetic tsu(Lcom/android/server/am/cgv;Lcom/oneplus/config/ConfigObserver;)Lcom/oneplus/config/ConfigObserver;
    ...
    iput-object p1, p0, Lcom/android/server/am/cgv;->rtg:Lcom/oneplus/config/ConfigObserver;

    return-object p1
.end method

.method static synthetic wtn(Lcom/android/server/am/cgv;J)J
    .locals 0
...
.method static synthetic you(Lcom/android/server/am/cgv;Lcom/android/server/am/cgv$you;)Lcom/android/server/am/cgv$you;
    ...
    iput-object p1, p0, Lcom/android/server/am/cgv;->ssp:Lcom/android/server/am/cgv$you;
...
.method static synthetic zta(Lcom/android/server/am/cgv;)Lcom/android/server/am/cgv$you;
    ...
    iget-object p0, p0, Lcom/android/server/am/cgv;->ssp:Lcom/android/server/am/cgv$you;
...
.method public collectBatteryStats(Lcom/android/internal/os/BatteryStatsImpl;IIIZ)V
    ...
    :cond_0
    sget-boolean p2, Lcom/android/server/am/cgv;->ibl:Z
    ...
    iget-boolean p4, p0, Lcom/android/server/am/cgv;->cno:Z

    if-eqz p4, :cond_2

    iget-wide p4, p0, Lcom/android/server/am/cgv;->wtn:J
    ...
    invoke-virtual {p0, p3, p2}, Lcom/android/server/am/cgv;->gck(Ljava/lang/String;Landroid/os/DropBoxManager;)V

    invoke-virtual {p1}, Lcom/android/internal/os/BatteryStatsImpl;->getResetTime()J

    move-result-wide p1

    iput-wide p1, p0, Lcom/android/server/am/cgv;->wtn:J
...
.method public gck(Ljava/lang/String;Landroid/os/DropBoxManager;)V
    ...
    iget-object v0, p0, Lcom/android/server/am/cgv;->you:Landroid/os/DropBoxManager;

    if-nez v0, :cond_0

    iput-object p2, p0, Lcom/android/server/am/cgv;->you:Landroid/os/DropBoxManager;

    :cond_0
    iget-object p2, p0, Lcom/android/server/am/cgv;->sis:Ljava/lang/String;

    if-nez p2, :cond_1

    iput-object p1, p0, Lcom/android/server/am/cgv;->sis:Ljava/lang/String;
    ...
    iget-object p1, p0, Lcom/android/server/am/cgv;->kth:Lcom/android/server/am/cgv$sis;
