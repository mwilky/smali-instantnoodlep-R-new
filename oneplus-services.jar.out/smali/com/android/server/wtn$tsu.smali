.class Lcom/android/server/wtn$tsu;
...
# instance fields
.field final synthetic zta:Lcom/android/server/wtn;
...
.method constructor <init>(Lcom/android/server/wtn;Landroid/os/Looper;)V
    ...
    iput-object p1, p0, Lcom/android/server/wtn$tsu;->zta:Lcom/android/server/wtn;
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    invoke-static {v1}, Lcom/android/server/wtn;->irq(Lcom/android/server/wtn;)Lnet/oneplus/odm/OpDeviceManagerInjector;
    ...
    invoke-static {v3}, Lcom/android/server/wtn;->irq(Lcom/android/server/wtn;)Lnet/oneplus/odm/OpDeviceManagerInjector;
    ...
    invoke-static {v2}, Lcom/android/server/wtn;->irq(Lcom/android/server/wtn;)Lnet/oneplus/odm/OpDeviceManagerInjector;
    ...
    iget-object v15, v0, Lcom/android/server/wtn$tsu;->zta:Lcom/android/server/wtn;
    ...
    invoke-static {v5}, Lcom/android/server/wtn;->you(Lcom/android/server/wtn;)J
    ...
    iget-wide v3, v3, Lcom/android/server/wtn$rtg;->sis:J
    ...
    iget-wide v3, v3, Lcom/android/server/wtn$rtg;->tsu:J
    ...
    invoke-static {v3}, Lcom/android/server/wtn;->zta(Lcom/android/server/wtn;)I
    ...
    iget-wide v3, v3, Lcom/android/server/wtn$rtg;->rtg:J
    ...
    iget-wide v3, v3, Lcom/android/server/wtn$rtg;->ssp:J
    ...
    invoke-virtual {v2}, Lcom/android/server/wtn$rtg;->toString()Ljava/lang/String;
    ...
    invoke-static {v2}, Lcom/android/server/wtn;->zta(Lcom/android/server/wtn;)I
    ...
    invoke-virtual {v1}, Lcom/android/server/wtn$rtg;->ssp()V
    ...
    invoke-virtual {v1}, Lcom/android/server/wtn$rtg;->sis()V

    invoke-static {}, Lcom/android/server/wtn$rtg;->zta()Lcom/android/server/wtn$rtg;

    move-result-object v1

    invoke-virtual {v1}, Lcom/android/server/wtn$rtg;->rtg()V
    ...
    invoke-virtual {v1}, Lcom/android/server/wtn$rtg;->you()V
    ...
    invoke-virtual {v0}, Lcom/android/server/wtn$rtg;->tsu()V

    invoke-static {}, Lcom/android/server/wtn$rtg;->zta()Lcom/android/server/wtn$rtg;

    move-result-object v0

    invoke-virtual {v0}, Lcom/android/server/wtn$rtg;->rtg()V
    ...
    invoke-virtual {v8, v9, v10}, Lcom/android/server/wtn$rtg;->kth(J)V
    ...
    iget-object v9, v0, Lcom/android/server/wtn$tsu;->zta:Lcom/android/server/wtn;

    invoke-static {v9}, Lcom/android/server/wtn;->tsu(Lcom/android/server/wtn;)J
    ...
    invoke-virtual {v2, v3, v4}, Lcom/android/server/wtn$rtg;->bio(J)V
