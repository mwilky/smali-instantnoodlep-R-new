.class Lcom/android/server/bio$sis;
...
# direct methods
.method public constructor <init>(Lcom/android/server/bio;Landroid/os/Handler;)V
    .locals 0

    iput-object p1, p0, Lcom/android/server/bio$sis;->zta:Lcom/android/server/bio;
...
.method public onChange(ZLandroid/net/Uri;)V
    ...
    iget-object v1, p0, Lcom/android/server/bio$sis;->zta:Lcom/android/server/bio;
    ...
    invoke-static {v1, p1}, Lcom/android/server/bio;->sis(Lcom/android/server/bio;I)I

    iget-object p1, p0, Lcom/android/server/bio$sis;->zta:Lcom/android/server/bio;
    ...
    invoke-static {p1}, Lcom/android/server/bio;->irq(Lcom/android/server/bio;)Lnet/oneplus/odm/OpDeviceManagerInjector;
    ...
    iget-object v4, p0, Lcom/android/server/bio$sis;->zta:Lcom/android/server/bio;
    ...
    iget-object v5, p0, Lcom/android/server/bio$sis;->zta:Lcom/android/server/bio;
    ...
    iget-object v0, p0, Lcom/android/server/bio$sis;->zta:Lcom/android/server/bio;

    invoke-static {v0, v3, v4}, Lcom/android/server/bio;->f(Lcom/android/server/bio;J)J

    new-instance v0, Ljava/lang/StringBuilder;

    invoke-direct {v0}, Ljava/lang/StringBuilder;-><init>()V

    iget-object v7, p0, Lcom/android/server/bio$sis;->zta:Lcom/android/server/bio;
    ...
    invoke-static {v7}, Lcom/android/server/bio;->ivd(Lcom/android/server/bio;)Landroid/content/Context;
    ...
    invoke-static {p1, v0, v6}, Lcom/android/server/bio;->g(Lcom/android/server/bio;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {p1, v3, v4}, Lcom/android/server/bio;->f(Lcom/android/server/bio;J)J

    new-instance p1, Ljava/lang/StringBuilder;

    invoke-direct {p1}, Ljava/lang/StringBuilder;-><init>()V

    iget-object p2, p0, Lcom/android/server/bio$sis;->zta:Lcom/android/server/bio;

    invoke-static {p2}, Lcom/android/server/bio;->e(Lcom/android/server/bio;)J
    ...
    invoke-static {p2}, Lcom/android/server/bio;->ivd(Lcom/android/server/bio;)Landroid/content/Context;
    ...
    iget-object p0, p0, Lcom/android/server/bio$sis;->zta:Lcom/android/server/bio;
