...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iget-object v0, v7, Landroidx/appcompat/widget/SwitchCompat;->mTextPaint:Landroid/text/TextPaint;
    ...
    invoke-virtual {v15, v0}, Landroidx/appcompat/widget/TintTypedArray;->getText(I)Ljava/lang/CharSequence;
    ...
    invoke-virtual {v15, v0, v13}, Landroidx/appcompat/widget/TintTypedArray;->getBoolean(IZ)Z
    ...
    invoke-virtual {v15, v0, v12}, Landroidx/appcompat/widget/TintTypedArray;->getDimensionPixelSize(II)I
    ...
    invoke-virtual {v15, v0, v12}, Landroidx/appcompat/widget/TintTypedArray;->getBoolean(IZ)Z
    ...
    invoke-virtual {v15, v0, v1}, Landroidx/appcompat/widget/TintTypedArray;->getDimensionPixelSize(II)I

    move-result v0

    invoke-direct {v7, v0}, Landroidx/appcompat/widget/SwitchCompat;->setRadius(I)V

    sget v2, Landroidx/appcompat/R$styleable;->SwitchCompat_thumbTint:I
    ...
    invoke-virtual {v15, v3, v1}, Landroidx/appcompat/widget/TintTypedArray;->getInt(II)I
    ...
    iput-object v3, v7, Landroidx/appcompat/widget/SwitchCompat;->mThumbTintMode:Landroid/graphics/PorterDuff$Mode;

    iput-boolean v13, v7, Landroidx/appcompat/widget/SwitchCompat;->mHasThumbTintMode:Z

    :cond_4
    iget-boolean v4, v7, Landroidx/appcompat/widget/SwitchCompat;->mHasThumbTint:Z

    if-nez v4, :cond_5

    iget-boolean v4, v7, Landroidx/appcompat/widget/SwitchCompat;->mHasThumbTintMode:Z
    ...
    invoke-virtual {v15, v4}, Landroidx/appcompat/widget/TintTypedArray;->getColorStateList(I)Landroid/content/res/ColorStateList;

    move-result-object v4

    if-eqz v4, :cond_7

    iput-object v4, v7, Landroidx/appcompat/widget/SwitchCompat;->mTrackTintList:Landroid/content/res/ColorStateList;
    ...
    invoke-virtual {v15, v5, v1}, Landroidx/appcompat/widget/TintTypedArray;->getInt(II)I
    ...
    iget-object v5, v7, Landroidx/appcompat/widget/SwitchCompat;->mTrackTintMode:Landroid/graphics/PorterDuff$Mode;
    ...
    :cond_8
    iget-boolean v5, v7, Landroidx/appcompat/widget/SwitchCompat;->mHasTrackTint:Z

    if-nez v5, :cond_9

    iget-boolean v5, v7, Landroidx/appcompat/widget/SwitchCompat;->mHasTrackTintMode:Z
    ...
    invoke-virtual {v15, v5, v12}, Landroidx/appcompat/widget/TintTypedArray;->getResourceId(II)I

    move-result v5

    if-eqz v5, :cond_b

    invoke-virtual {v7, v8, v5}, Landroidx/appcompat/widget/SwitchCompat;->setSwitchTextAppearance(Landroid/content/Context;I)V
    ...
    iput-object v6, v7, Landroidx/appcompat/widget/SwitchCompat;->mTextHelper:Landroidx/appcompat/widget/AppCompatTextHelper;

    invoke-virtual {v6, v9, v10}, Landroidx/appcompat/widget/AppCompatTextHelper;->loadFromAttributes(Landroid/util/AttributeSet;I)V
    ...
    iput v11, v7, Landroidx/appcompat/widget/SwitchCompat;->mTouchSlop:I

    invoke-virtual {v6}, Landroid/view/ViewConfiguration;->getScaledMinimumFlingVelocity()I

    move-result v11

    iput v11, v7, Landroidx/appcompat/widget/SwitchCompat;->mMinFlingVelocity:I
    ...
    iput-object v11, v7, Landroidx/appcompat/widget/SwitchCompat;->mVibrator:Landroid/os/Vibrator;
