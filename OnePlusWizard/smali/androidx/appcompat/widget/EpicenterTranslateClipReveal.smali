...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    sget v2, Landroidx/appcompat/R$styleable;->EpicenterTranslateClipReveal_interpolatorX:I
    ...
    iput-object v3, p0, Landroidx/appcompat/widget/EpicenterTranslateClipReveal;->mInterpolatorX:Landroid/animation/TimeInterpolator;

    goto :goto_0

    :cond_0
    sget-object v3, Landroidx/animation/AnimatorUtils;->LinearOutSlowInInterpolator:Landroid/view/animation/Interpolator;

    iput-object v3, p0, Landroidx/appcompat/widget/EpicenterTranslateClipReveal;->mInterpolatorX:Landroid/animation/TimeInterpolator;

    :goto_0
    sget v3, Landroidx/appcompat/R$styleable;->EpicenterTranslateClipReveal_interpolatorY:I
    ...
    iput-object v4, p0, Landroidx/appcompat/widget/EpicenterTranslateClipReveal;->mInterpolatorY:Landroid/animation/TimeInterpolator;

    goto :goto_1

    :cond_1
    sget-object v4, Landroidx/animation/AnimatorUtils;->LinearOutSlowInInterpolator:Landroid/view/animation/Interpolator;

    iput-object v4, p0, Landroidx/appcompat/widget/EpicenterTranslateClipReveal;->mInterpolatorY:Landroid/animation/TimeInterpolator;

    :goto_1
    sget v4, Landroidx/appcompat/R$styleable;->EpicenterTranslateClipReveal_interpolatorZ:I
    ...
    iput-object v4, p0, Landroidx/appcompat/widget/EpicenterTranslateClipReveal;->mInterpolatorZ:Landroid/animation/TimeInterpolator;
...
.method private static createRectAnimator(Landroid/view/View;Landroidx/appcompat/widget/EpicenterTranslateClipReveal$State;Landroidx/appcompat/widget/EpicenterTranslateClipReveal$State;FLandroidx/appcompat/widget/EpicenterTranslateClipReveal$State;Landroidx/appcompat/widget/EpicenterTranslateClipReveal$State;FLandroid/transition/TransitionValues;Landroid/animation/TimeInterpolator;Landroid/animation/TimeInterpolator;Landroid/animation/TimeInterpolator;)Landroid/animation/Animator;
    ...
    new-instance v4, Landroidx/appcompat/widget/EpicenterTranslateClipReveal$StateEvaluator;

    const/4 v5, 0x0

    invoke-direct {v4, v5}, Landroidx/appcompat/widget/EpicenterTranslateClipReveal$StateEvaluator;-><init>(Landroidx/appcompat/widget/EpicenterTranslateClipReveal$1;)V
    ...
    :cond_0
    new-instance v7, Landroidx/appcompat/widget/EpicenterTranslateClipReveal$StateProperty;

    const/16 v10, 0x78

    invoke-direct {v7, v10}, Landroidx/appcompat/widget/EpicenterTranslateClipReveal$StateProperty;-><init>(C)V

    new-array v10, v6, [Landroidx/appcompat/widget/EpicenterTranslateClipReveal$State;
    ...
    :cond_1
    new-instance v11, Landroidx/appcompat/widget/EpicenterTranslateClipReveal$StateProperty;

    const/16 v12, 0x79

    invoke-direct {v11, v12}, Landroidx/appcompat/widget/EpicenterTranslateClipReveal$StateProperty;-><init>(C)V

    new-array v12, v6, [Landroidx/appcompat/widget/EpicenterTranslateClipReveal$State;
    ...
    new-instance v15, Landroidx/appcompat/widget/EpicenterTranslateClipReveal$1;

    invoke-direct {v15, v0, v14}, Landroidx/appcompat/widget/EpicenterTranslateClipReveal$1;-><init>(Landroid/view/View;Landroid/graphics/Rect;)V
...
.method public onAppear(Landroid/view/ViewGroup;Landroid/view/View;Landroid/transition/TransitionValues;Landroid/transition/TransitionValues;)Landroid/animation/Animator;
    ...
    invoke-direct {v0, v14}, Landroidx/appcompat/widget/EpicenterTranslateClipReveal;->getEpicenterOrCenter(Landroid/graphics/Rect;)Landroid/graphics/Rect;
    ...
    invoke-direct {v0, v13}, Landroidx/appcompat/widget/EpicenterTranslateClipReveal;->getBestRect(Landroid/transition/TransitionValues;)Landroid/graphics/Rect;

    move-result-object v4

    invoke-direct {v0, v4}, Landroidx/appcompat/widget/EpicenterTranslateClipReveal;->getEpicenterOrCenter(Landroid/graphics/Rect;)Landroid/graphics/Rect;

    move-result-object v1

    invoke-virtual {v12, v1}, Landroid/view/View;->setClipBounds(Landroid/graphics/Rect;)V

    new-instance v2, Landroidx/appcompat/widget/EpicenterTranslateClipReveal$State;

    iget v3, v1, Landroid/graphics/Rect;->left:I

    iget v5, v1, Landroid/graphics/Rect;->right:I

    invoke-direct {v2, v3, v5, v11}, Landroidx/appcompat/widget/EpicenterTranslateClipReveal$State;-><init>(IIF)V
    ...
    invoke-direct {v5, v3, v6, v8}, Landroidx/appcompat/widget/EpicenterTranslateClipReveal$State;-><init>(IIF)V
    ...
    invoke-direct {v3, v6, v8, v10}, Landroidx/appcompat/widget/EpicenterTranslateClipReveal$State;-><init>(IIF)V

    new-instance v6, Landroidx/appcompat/widget/EpicenterTranslateClipReveal$State;
    ...
    invoke-direct {v6, v8, v1, v7}, Landroidx/appcompat/widget/EpicenterTranslateClipReveal$State;-><init>(IIF)V

    iget-object v8, v0, Landroidx/appcompat/widget/EpicenterTranslateClipReveal;->mInterpolatorX:Landroid/animation/TimeInterpolator;

    iget-object v1, v0, Landroidx/appcompat/widget/EpicenterTranslateClipReveal;->mInterpolatorY:Landroid/animation/TimeInterpolator;

    move/from16 v19, v11

    iget-object v11, v0, Landroidx/appcompat/widget/EpicenterTranslateClipReveal;->mInterpolatorZ:Landroid/animation/TimeInterpolator;
...
.method public onDisappear(Landroid/view/ViewGroup;Landroid/view/View;Landroid/transition/TransitionValues;Landroid/transition/TransitionValues;)Landroid/animation/Animator;
    ...
    invoke-direct {v0, v1}, Landroidx/appcompat/widget/EpicenterTranslateClipReveal;->getBestRect(Landroid/transition/TransitionValues;)Landroid/graphics/Rect;

    move-result-object v8

    invoke-direct {v0, v8}, Landroidx/appcompat/widget/EpicenterTranslateClipReveal;->getEpicenterOrCenter(Landroid/graphics/Rect;)Landroid/graphics/Rect;
    ...
    invoke-direct {v3, v4, v6, v10}, Landroidx/appcompat/widget/EpicenterTranslateClipReveal$State;-><init>(IIF)V
    ...
    invoke-direct {v6, v4, v7, v12}, Landroidx/appcompat/widget/EpicenterTranslateClipReveal$State;-><init>(IIF)V
    ...
    invoke-direct {v4, v7, v1, v9}, Landroidx/appcompat/widget/EpicenterTranslateClipReveal$State;-><init>(IIF)V

    new-instance v7, Landroidx/appcompat/widget/EpicenterTranslateClipReveal$State;

    iget v1, v5, Landroid/graphics/Rect;->top:I

    iget v2, v5, Landroid/graphics/Rect;->bottom:I

    invoke-direct {v7, v1, v2, v11}, Landroidx/appcompat/widget/EpicenterTranslateClipReveal$State;-><init>(IIF)V

    iget-object v1, v0, Landroidx/appcompat/widget/EpicenterTranslateClipReveal;->mInterpolatorX:Landroid/animation/TimeInterpolator;

    iget-object v2, v0, Landroidx/appcompat/widget/EpicenterTranslateClipReveal;->mInterpolatorY:Landroid/animation/TimeInterpolator;

    move/from16 v18, v12

    iget-object v12, v0, Landroidx/appcompat/widget/EpicenterTranslateClipReveal;->mInterpolatorZ:Landroid/animation/TimeInterpolator;
    ...
    invoke-static/range {v2 .. v12}, Landroidx/appcompat/widget/EpicenterTranslateClipReveal;->createRectAnimator(Landroid/view/View;Landroidx/appcompat/widget/EpicenterTranslateClipReveal$State;Landroidx/appcompat/widget/EpicenterTranslateClipReveal$State;FLandroidx/appcompat/widget/EpicenterTranslateClipReveal$State;Landroidx/appcompat/widget/EpicenterTranslateClipReveal$State;FLandroid/transition/TransitionValues;Landroid/animation/TimeInterpolator;Landroid/animation/TimeInterpolator;Landroid/animation/TimeInterpolator;)Landroid/animation/Animator;
