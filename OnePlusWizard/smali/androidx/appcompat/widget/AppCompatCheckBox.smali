...
.method private notifyViewAccessibilityStateChangedIfNeededInternal(I)V
    ...
    sget-object v1, Landroidx/appcompat/widget/AppCompatCheckBox;->TAG:Ljava/lang/String;
...
.method public init(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    sget v2, Landroidx/appcompat/R$styleable;->AppCompatCheckBox_threeState:I

    invoke-virtual {v0, v2, v1}, Landroid/content/res/TypedArray;->getBoolean(IZ)Z

    move-result v2

    sget v3, Landroidx/appcompat/R$styleable;->AppCompatCheckBox_android_checked:I

    invoke-virtual {v0, v3, v1}, Landroid/content/res/TypedArray;->getBoolean(IZ)Z

    move-result v3

    sget v4, Landroidx/appcompat/R$styleable;->AppCompatCheckBox_indeterminate:I

    invoke-virtual {v0, v4, v1}, Landroid/content/res/TypedArray;->getBoolean(IZ)Z

    move-result v1

    invoke-virtual {p0, v2}, Landroidx/appcompat/widget/AppCompatCheckBox;->setThreeState(Z)V
    ...
    :goto_0
    invoke-virtual {p0, v4}, Landroidx/appcompat/widget/AppCompatCheckBox;->setTriStateChecked(Ljava/lang/Boolean;)V

    goto :goto_1

    :cond_1
    invoke-virtual {p0, v3}, Landroidx/appcompat/widget/AppCompatCheckBox;->setCheckedInternal(Z)V
...
.method protected onCreateDrawableState(I)[I
    ...
    sget-object v1, Landroidx/appcompat/widget/AppCompatCheckBox;->INDETERMINATE_STATE_SET:[I

    invoke-static {v0, v1}, Landroidx/appcompat/widget/AppCompatCheckBox;->mergeDrawableStates([I[I)[I
    ...
    sget-object v1, Landroidx/appcompat/widget/AppCompatCheckBox;->CHECKED_STATE_SET:[I
...
.method public onRestoreInstanceState(Landroid/os/Parcelable;)V
    ...
    check-cast v0, Landroidx/appcompat/widget/AppCompatCheckBox$SavedState;

    invoke-virtual {v0}, Landroidx/appcompat/widget/AppCompatCheckBox$SavedState;->getSuperState()Landroid/os/Parcelable;

    move-result-object v1

    invoke-super {p0, v1}, Landroid/widget/CheckBox;->onRestoreInstanceState(Landroid/os/Parcelable;)V

    iget-boolean v1, v0, Landroidx/appcompat/widget/AppCompatCheckBox$SavedState;->threeState:Z

    iput-boolean v1, p0, Landroidx/appcompat/widget/AppCompatCheckBox;->mThreeState:Z

    if-eqz v1, :cond_1

    iget-boolean v1, v0, Landroidx/appcompat/widget/AppCompatCheckBox$SavedState;->indeterminate:Z
    ...
    :cond_0
    iget-boolean v1, v0, Landroidx/appcompat/widget/AppCompatCheckBox$SavedState;->checked:Z
    ...
    :goto_0
    invoke-virtual {p0, v1}, Landroidx/appcompat/widget/AppCompatCheckBox;->setTriStateChecked(Ljava/lang/Boolean;)V
    ...
    invoke-virtual {p0, v1}, Landroidx/appcompat/widget/AppCompatCheckBox;->setCheckedInternal(Z)V
...
.method public onSaveInstanceState()Landroid/os/Parcelable;
    ...
    iput-boolean v2, v1, Landroidx/appcompat/widget/AppCompatCheckBox$SavedState;->checked:Z

    iget-boolean v2, p0, Landroidx/appcompat/widget/AppCompatCheckBox;->mThreeState:Z

    iput-boolean v2, v1, Landroidx/appcompat/widget/AppCompatCheckBox$SavedState;->threeState:Z

    iget-boolean v2, p0, Landroidx/appcompat/widget/AppCompatCheckBox;->mIndeterminate:Z

    iput-boolean v2, v1, Landroidx/appcompat/widget/AppCompatCheckBox$SavedState;->indeterminate:Z
...
.method public setChecked(Z)V
    ...
    invoke-virtual {p0, v0}, Landroidx/appcompat/widget/AppCompatCheckBox;->setChecked(Ljava/lang/Boolean;)V
...
.method public setCheckedInternal(ZZ)V
    ...
    iget-boolean v3, p0, Landroidx/appcompat/widget/AppCompatCheckBox;->mBroadcasting:Z
    ...
    iget-object v1, p0, Landroidx/appcompat/widget/AppCompatCheckBox;->mOnCheckedChangeListener:Landroid/widget/CompoundButton$OnCheckedChangeListener;
    ...
    :cond_3
    iget-object v1, p0, Landroidx/appcompat/widget/AppCompatCheckBox;->mOnCheckedChangeWidgetListener:Landroid/widget/CompoundButton$OnCheckedChangeListener;
