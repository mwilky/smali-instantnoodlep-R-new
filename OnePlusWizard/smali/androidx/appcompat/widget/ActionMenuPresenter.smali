...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-boolean v0, p0, Landroidx/appcompat/widget/ActionMenuPresenter;->mIsBottomAppBar:Z
...
.method public onSubMenuSelected(Landroidx/appcompat/view/menu/SubMenuBuilder;)Z
    ...
    invoke-virtual {v4, v5}, Landroidx/appcompat/widget/ActionMenuPresenter$ActionButtonSubmenu;->setGravity(I)V
...
.method public updateMenuView(Z)V
    ...
    iget-object v6, p0, Landroidx/appcompat/widget/ActionMenuPresenter;->mSystemContext:Landroid/content/Context;

    invoke-direct {v3, p0, v6}, Landroidx/appcompat/widget/ActionMenuPresenter$OverflowMenuButton;-><init>(Landroidx/appcompat/widget/ActionMenuPresenter;Landroid/content/Context;)V
    ...
    invoke-virtual {v3}, Landroidx/appcompat/widget/ActionMenuPresenter$OverflowMenuButton;->getParent()Landroid/view/ViewParent;
    ...
    invoke-virtual {v6}, Landroidx/appcompat/widget/ActionMenuView;->generateOverflowButtonLayoutParams()Landroidx/appcompat/widget/ActionMenuView$LayoutParams;
    ...
    invoke-virtual {v3, v6}, Landroidx/appcompat/widget/ActionMenuView;->setOverflowReserved(Z)V

    iget-boolean v3, p0, Landroidx/appcompat/widget/ActionMenuPresenter;->mIsBottomAppBar:Z
    ...
    :cond_b
    iget-boolean v6, p0, Landroidx/appcompat/widget/ActionMenuPresenter;->mIsBottomAppBar:Z
    ...
    :goto_6
    iget-object v6, p0, Landroidx/appcompat/widget/ActionMenuPresenter;->mMenu:Landroidx/appcompat/view/menu/MenuBuilder;

    if-eqz v6, :cond_11

    iget-object v6, p0, Landroidx/appcompat/widget/ActionMenuPresenter;->mMenu:Landroidx/appcompat/view/menu/MenuBuilder;

    invoke-virtual {v6}, Landroidx/appcompat/view/menu/MenuBuilder;->flagActionItems()V
    ...
    invoke-virtual {p0, v5, v9}, Landroidx/appcompat/widget/ActionMenuPresenter;->shouldIncludeItem(ILandroidx/appcompat/view/menu/MenuItemImpl;)Z
    ...
    instance-of v11, v10, Landroidx/appcompat/view/menu/MenuView$ItemView;
    ...
    :goto_8
    invoke-virtual {p0, v9, v10, v3}, Landroidx/appcompat/widget/ActionMenuPresenter;->getItemView(Landroidx/appcompat/view/menu/MenuItemImpl;Landroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    invoke-virtual {p0, v12, v5}, Landroidx/appcompat/widget/ActionMenuPresenter;->addItemView(Landroid/view/View;I)V
    ...
    invoke-virtual {p0, v3, v5}, Landroidx/appcompat/widget/ActionMenuPresenter;->filterLeftoverView(Landroid/view/ViewGroup;I)Z
