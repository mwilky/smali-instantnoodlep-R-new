...
.method private createSubDecor()Landroid/view/ViewGroup;
    ...
    const-string v7, "mWindowNoTitle:"

    invoke-virtual {v6, v7}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget-boolean v7, p0, Landroidx/appcompat/app/AppCompatDelegateImpl;->mWindowNoTitle:Z
    ...
    sget v3, Landroidx/appcompat/R$layout;->dialog_title_material:I
    ...
    sget v10, Landroidx/appcompat/R$attr;->actionBarTheme:I

    invoke-virtual {v9, v10, v6, v3}, Landroid/content/res/Resources$Theme;->resolveAttribute(ILandroid/util/TypedValue;Z)Z

    new-instance v3, Ljava/lang/StringBuilder;

    invoke-direct {v3}, Ljava/lang/StringBuilder;-><init>()V

    const-string v9, "actionBarTheme:"
    ...
    invoke-direct {v3, v7, v9}, Landroidx/appcompat/view/ContextThemeWrapper;-><init>(Landroid/content/Context;I)V
    ...
    sget v9, Landroidx/appcompat/R$layout;->screen_toolbar:I
    ...
    sget v7, Landroidx/appcompat/R$id;->decor_content_parent:I

    invoke-virtual {v5, v7}, Landroid/view/ViewGroup;->findViewById(I)Landroid/view/View;

    move-result-object v7

    check-cast v7, Landroidx/appcompat/widget/DecorContentParent;

    iput-object v7, p0, Landroidx/appcompat/app/AppCompatDelegateImpl;->mDecorContentParent:Landroidx/appcompat/widget/DecorContentParent;

    invoke-virtual {p0}, Landroidx/appcompat/app/AppCompatDelegateImpl;->getWindowCallback()Landroid/view/Window$Callback;

    move-result-object v9

    invoke-interface {v7, v9}, Landroidx/appcompat/widget/DecorContentParent;->setWindowCallback(Landroid/view/Window$Callback;)V

    iget-boolean v7, p0, Landroidx/appcompat/app/AppCompatDelegateImpl;->mOverlayActionBar:Z

    if-eqz v7, :cond_6

    iget-object v7, p0, Landroidx/appcompat/app/AppCompatDelegateImpl;->mDecorContentParent:Landroidx/appcompat/widget/DecorContentParent;

    invoke-interface {v7, v4}, Landroidx/appcompat/widget/DecorContentParent;->initFeature(I)V
    ...
    invoke-interface {v4, v7}, Landroidx/appcompat/widget/DecorContentParent;->initFeature(I)V
    ...
    sget v3, Landroidx/appcompat/R$layout;->screen_simple_overlay_action_mode:I
    ...
    :cond_a
    sget v3, Landroidx/appcompat/R$layout;->screen_simple:I
    ...
    sget v3, Landroidx/appcompat/R$id;->action_bar_activity_content_androidx:I
    ...
    invoke-virtual {v3, v7}, Landroidx/appcompat/widget/ContentFrameLayout;->addView(Landroid/view/View;)V
...
.method public attachBaseContext(Landroid/content/Context;)V
    ...
    invoke-direct {p0, v1, v0}, Landroidx/appcompat/app/AppCompatDelegateImpl;->applyDayNight(ZLandroid/content/res/Configuration;)Z
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    invoke-direct {p0, v1, v2}, Landroidx/appcompat/app/AppCompatDelegateImpl;->applyDayNight(ZLandroid/content/res/Configuration;)Z
