...
.method public onContentChanged()V
    ...
    :cond_0
    iget-object v1, p0, Landroidx/appcompat/app/ListActivity;->mList:Landroid/widget/ListView;

    iget-object v2, p0, Landroidx/appcompat/app/ListActivity;->mOnClickListener:Landroid/widget/AdapterView$OnItemClickListener;

    invoke-virtual {v1, v2}, Landroid/widget/ListView;->setOnItemClickListener(Landroid/widget/AdapterView$OnItemClickListener;)V

    iget-boolean v1, p0, Landroidx/appcompat/app/ListActivity;->mFinishedStart:Z

    if-eqz v1, :cond_1

    iget-object v1, p0, Landroidx/appcompat/app/ListActivity;->mAdapter:Landroid/widget/ListAdapter;

    invoke-virtual {p0, v1}, Landroidx/appcompat/app/ListActivity;->setListAdapter(Landroid/widget/ListAdapter;)V

    :cond_1
    iget-object v1, p0, Landroidx/appcompat/app/ListActivity;->mHandler:Landroid/os/Handler;

    iget-object v2, p0, Landroidx/appcompat/app/ListActivity;->mRequestFocus:Ljava/lang/Runnable;

    invoke-virtual {v1, v2}, Landroid/os/Handler;->post(Ljava/lang/Runnable;)Z

    const/4 v1, 0x1

    iput-boolean v1, p0, Landroidx/appcompat/app/ListActivity;->mFinishedStart:Z
