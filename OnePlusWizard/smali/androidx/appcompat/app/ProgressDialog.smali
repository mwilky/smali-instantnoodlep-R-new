...
.method public constructor <init>(Landroid/content/Context;I)V
    ...
    iput v0, p0, Landroidx/appcompat/app/ProgressDialog;->mProgressStyle:I
...
.method static synthetic access$100(Landroidx/appcompat/app/ProgressDialog;)Ljava/lang/String;
    ...
    iget-object v0, p0, Landroidx/appcompat/app/ProgressDialog;->mProgressNumberFormat:Ljava/lang/String;
...
.method static synthetic access$200(Landroidx/appcompat/app/ProgressDialog;)Landroid/widget/TextView;
    ...
    iget-object v0, p0, Landroidx/appcompat/app/ProgressDialog;->mProgressNumber:Landroid/widget/TextView;
...
.method static synthetic access$300(Landroidx/appcompat/app/ProgressDialog;)Ljava/text/NumberFormat;
    ...
    iget-object v0, p0, Landroidx/appcompat/app/ProgressDialog;->mProgressPercentFormat:Ljava/text/NumberFormat;
...
.method static synthetic access$400(Landroidx/appcompat/app/ProgressDialog;)Landroid/widget/TextView;
    ...
    iget-object v0, p0, Landroidx/appcompat/app/ProgressDialog;->mProgressPercent:Landroid/widget/TextView;
...
.method public static show(Landroid/content/Context;Ljava/lang/CharSequence;Ljava/lang/CharSequence;ZZLandroid/content/DialogInterface$OnCancelListener;)Landroidx/appcompat/app/ProgressDialog;
    ...
    new-instance v0, Landroidx/appcompat/app/ProgressDialog;

    invoke-direct {v0, p0}, Landroidx/appcompat/app/ProgressDialog;-><init>(Landroid/content/Context;)V

    invoke-virtual {v0, p1}, Landroidx/appcompat/app/ProgressDialog;->setTitle(Ljava/lang/CharSequence;)V

    invoke-virtual {v0, p2}, Landroidx/appcompat/app/ProgressDialog;->setMessage(Ljava/lang/CharSequence;)V

    invoke-virtual {v0, p3}, Landroidx/appcompat/app/ProgressDialog;->setIndeterminate(Z)V

    const/4 v1, 0x0

    invoke-virtual {v0, v1}, Landroidx/appcompat/app/ProgressDialog;->setCancelable(Z)V

    invoke-virtual {v0, p5}, Landroidx/appcompat/app/ProgressDialog;->setOnCancelListener(Landroid/content/DialogInterface$OnCancelListener;)V

    invoke-virtual {v0}, Landroidx/appcompat/app/ProgressDialog;->show()V
...
.method protected onCreate(Landroid/os/Bundle;)V
    ...
    iput-object v2, p0, Landroidx/appcompat/app/ProgressDialog;->mProgress:Landroid/widget/ProgressBar;

    sget v2, Landroidx/appcompat/R$id;->progress_number:I
    ...
    iput-object v2, p0, Landroidx/appcompat/app/ProgressDialog;->mProgressNumber:Landroid/widget/TextView;

    sget v2, Landroidx/appcompat/R$id;->progress_percent:I
    ...
    iput-object v2, p0, Landroidx/appcompat/app/ProgressDialog;->mProgressPercent:Landroid/widget/TextView;

    invoke-virtual {p0, v1}, Landroidx/appcompat/app/ProgressDialog;->setView(Landroid/view/View;)V
    ...
    iput-object v2, p0, Landroidx/appcompat/app/ProgressDialog;->mMessageView:Landroid/widget/TextView;

    invoke-virtual {p0, v1}, Landroidx/appcompat/app/ProgressDialog;->setView(Landroid/view/View;)V

    :goto_0
    iget v1, p0, Landroidx/appcompat/app/ProgressDialog;->mMax:I

    if-lez v1, :cond_1

    invoke-virtual {p0, v1}, Landroidx/appcompat/app/ProgressDialog;->setMax(I)V

    :cond_1
    iget v1, p0, Landroidx/appcompat/app/ProgressDialog;->mProgressVal:I

    if-lez v1, :cond_2

    invoke-virtual {p0, v1}, Landroidx/appcompat/app/ProgressDialog;->setProgress(I)V

    :cond_2
    iget v1, p0, Landroidx/appcompat/app/ProgressDialog;->mSecondaryProgressVal:I

    if-lez v1, :cond_3

    invoke-virtual {p0, v1}, Landroidx/appcompat/app/ProgressDialog;->setSecondaryProgress(I)V

    :cond_3
    iget v1, p0, Landroidx/appcompat/app/ProgressDialog;->mIncrementBy:I

    if-lez v1, :cond_4

    invoke-virtual {p0, v1}, Landroidx/appcompat/app/ProgressDialog;->incrementProgressBy(I)V

    :cond_4
    iget v1, p0, Landroidx/appcompat/app/ProgressDialog;->mIncrementSecondaryBy:I

    if-lez v1, :cond_5

    invoke-virtual {p0, v1}, Landroidx/appcompat/app/ProgressDialog;->incrementSecondaryProgressBy(I)V

    :cond_5
    iget-object v1, p0, Landroidx/appcompat/app/ProgressDialog;->mProgressDrawable:Landroid/graphics/drawable/Drawable;

    if-eqz v1, :cond_6

    invoke-virtual {p0, v1}, Landroidx/appcompat/app/ProgressDialog;->setProgressDrawable(Landroid/graphics/drawable/Drawable;)V

    :cond_6
    iget-object v1, p0, Landroidx/appcompat/app/ProgressDialog;->mIndeterminateDrawable:Landroid/graphics/drawable/Drawable;

    if-eqz v1, :cond_7

    invoke-virtual {p0, v1}, Landroidx/appcompat/app/ProgressDialog;->setIndeterminateDrawable(Landroid/graphics/drawable/Drawable;)V

    :cond_7
    iget-object v1, p0, Landroidx/appcompat/app/ProgressDialog;->mMessage:Ljava/lang/CharSequence;

    if-eqz v1, :cond_8

    invoke-virtual {p0, v1}, Landroidx/appcompat/app/ProgressDialog;->setMessage(Ljava/lang/CharSequence;)V

    :cond_8
    iget-boolean v1, p0, Landroidx/appcompat/app/ProgressDialog;->mIndeterminate:Z

    invoke-virtual {p0, v1}, Landroidx/appcompat/app/ProgressDialog;->setIndeterminate(Z)V

    invoke-direct {p0}, Landroidx/appcompat/app/ProgressDialog;->onProgressChanged()V

    const/4 v1, 0x0

    invoke-virtual {p0, v1}, Landroidx/appcompat/app/ProgressDialog;->setCancelable(Z)V
...
.method public setMessage(Ljava/lang/CharSequence;)V
    ...
    :cond_0
    iget-object v0, p0, Landroidx/appcompat/app/ProgressDialog;->mMessageView:Landroid/widget/TextView;
...
.method public setTitle(Ljava/lang/CharSequence;)V
    ...
    invoke-super {p0, v0}, Landroidx/appcompat/app/AlertDialog;->setTitle(Ljava/lang/CharSequence;)V
