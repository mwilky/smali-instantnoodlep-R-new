...
.method static synthetic access$500(Lcom/android/settingslib/media/LocalMediaManager;)Landroid/content/Context;
    ...
    iget-object v0, p0, Lcom/android/settingslib/media/LocalMediaManager;->mContext:Landroid/content/Context;
...
.method public adjustSessionVolume(Ljava/lang/String;I)V
    ...
    invoke-virtual {v1, v2, p2}, Lcom/android/settingslib/media/InfoMediaManager;->adjustSessionVolume(Landroid/media/RoutingSessionInfo;I)V
...
.method public connectDevice(Lcom/android/settingslib/media/MediaDevice;)Z
    ...
    invoke-virtual {p0, v2, v3}, Lcom/android/settingslib/media/LocalMediaManager;->getMediaDeviceById(Ljava/util/List;Ljava/lang/String;)Lcom/android/settingslib/media/MediaDevice;
    ...
    invoke-virtual {v0, v3}, Lcom/android/settingslib/media/MediaDevice;->setState(I)V
    ...
    :cond_1
    iget-object v2, p0, Lcom/android/settingslib/media/LocalMediaManager;->mCurrentConnectedDevice:Lcom/android/settingslib/media/MediaDevice;
    ...
    const-string v3, "connectDevice() this device all ready connected! : "
    ...
    invoke-virtual {v2}, Lcom/android/settingslib/media/MediaDevice;->disconnect()V

    :cond_3
    invoke-virtual {v0, v3}, Lcom/android/settingslib/media/MediaDevice;->setState(I)V

    iget-object v1, p0, Lcom/android/settingslib/media/LocalMediaManager;->mPackageName:Ljava/lang/String;
    ...
    invoke-virtual {v1, v0}, Lcom/android/settingslib/media/InfoMediaManager;->connectDeviceWithoutPackageName(Lcom/android/settingslib/media/MediaDevice;)Z
...
.method public getActiveMediaSession()Ljava/util/List;
    ...
    invoke-virtual {v0}, Lcom/android/settingslib/media/InfoMediaManager;->getActiveMediaSession()Ljava/util/List;
...
.method public getDeselectableMediaDevice()Ljava/util/List;
    ...
    invoke-virtual {v0}, Lcom/android/settingslib/media/InfoMediaManager;->getDeselectableMediaDevice()Ljava/util/List;
...
.method public getSelectableMediaDevice()Ljava/util/List;
    ...
    invoke-virtual {v0}, Lcom/android/settingslib/media/InfoMediaManager;->getSelectableMediaDevice()Ljava/util/List;
...
.method public getSelectedMediaDevice()Ljava/util/List;
    ...
    invoke-virtual {v0}, Lcom/android/settingslib/media/InfoMediaManager;->getSelectedMediaDevice()Ljava/util/List;
