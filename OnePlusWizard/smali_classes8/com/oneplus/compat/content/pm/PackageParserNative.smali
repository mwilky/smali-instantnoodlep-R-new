...
.method public static generatePackageInfo(Lcom/oneplus/compat/content/pm/PackageParserNative$PackageNative;[IIJJLjava/util/Set;Lcom/oneplus/compat/content/pm/PackageUserStateNative;)Landroid/content/pm/PackageInfo;
    ...
    const-string v13, "generatePackageInfo"

    invoke-static {v1, v13, v5}, Lcom/oneplus/utils/reflection/MethodReflection;->findMethod(Ljava/lang/Class;Ljava/lang/String;[Ljava/lang/Class;)Ljava/lang/reflect/Method;
    ...
    aput-object p7, v4, v12

    iget-object v6, v0, Lcom/oneplus/compat/content/pm/PackageUserStateNative;->mPackageUserState:Ljava/lang/Object;

    aput-object v6, v4, v7

    invoke-static {v5, v13, v4}, Lcom/oneplus/utils/reflection/MethodReflection;->invokeMethod(Ljava/lang/reflect/Method;Ljava/lang/Object;[Ljava/lang/Object;)Ljava/lang/Object;
...
.method public parsePackage(Ljava/io/File;I)Lcom/oneplus/compat/content/pm/PackageParserNative$PackageNative;
    ...
    iget-object v1, p0, Lcom/oneplus/compat/content/pm/PackageParserNative;->mPackageParserWrapper:Lcom/oneplus/inner/content/pm/PackageParserWrapper;

    invoke-virtual {v1, p1, p2}, Lcom/oneplus/inner/content/pm/PackageParserWrapper;->parsePackage(Ljava/io/File;I)Lcom/oneplus/inner/content/pm/PackageParserWrapper$PackageWrapper;

    move-result-object v1

    invoke-direct {v0, v1}, Lcom/oneplus/compat/content/pm/PackageParserNative$PackageNative;-><init>(Lcom/oneplus/inner/content/pm/PackageParserWrapper$PackageWrapper;)V
    ...
    new-instance v3, Lcom/oneplus/compat/content/pm/PackageParserNative$PackageNative;

    iget-object v6, p0, Lcom/oneplus/compat/content/pm/PackageParserNative;->mPackageParser:Ljava/lang/Object;
    ...
    invoke-static {v2, v6, v1}, Lcom/oneplus/utils/reflection/MethodReflection;->invokeMethod(Ljava/lang/reflect/Method;Ljava/lang/Object;[Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object v1

    invoke-direct {v3, v1}, Lcom/oneplus/compat/content/pm/PackageParserNative$PackageNative;-><init>(Ljava/lang/Object;)V
...
.method public setCallback(Lcom/oneplus/compat/content/pm/PackageParserNative$CallbackNative;)V
    ...
    invoke-static {v0, v5}, Lcom/oneplus/utils/reflection/ClassReflection;->findConstructor(Ljava/lang/String;[Ljava/lang/Class;)Ljava/lang/reflect/Constructor;
    ...
    iput-object v6, p0, Lcom/oneplus/compat/content/pm/PackageParserNative;->mPackageParser:Ljava/lang/Object;
    :try_end_0
    .catch Ljava/lang/IllegalAccessException; {:try_start_0 .. :try_end_0} :catch_0
    .catch Ljava/lang/InstantiationException; {:try_start_0 .. :try_end_0} :catch_0
    .catch Ljava/lang/reflect/InvocationTargetException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    invoke-static {v6}, Lcom/oneplus/utils/reflection/utils/ExceptionUtil;->handleReflectionException(Ljava/lang/Exception;)V
    ...
    const-string v7, "setCallback"

    invoke-static {v1, v7, v6}, Lcom/oneplus/utils/reflection/MethodReflection;->findMethod(Ljava/lang/Class;Ljava/lang/String;[Ljava/lang/Class;)Ljava/lang/reflect/Method;

    move-result-object v6

    iget-object v7, p0, Lcom/oneplus/compat/content/pm/PackageParserNative;->mPackageParser:Ljava/lang/Object;
    ...
    invoke-static {v9, v5, v3}, Ljava/lang/reflect/Proxy;->newProxyInstance(Ljava/lang/ClassLoader;[Ljava/lang/Class;Ljava/lang/reflect/InvocationHandler;)Ljava/lang/Object;

    move-result-object v5

    aput-object v5, v8, v4

    invoke-static {v6, v7, v8}, Lcom/oneplus/utils/reflection/MethodReflection;->invokeMethod(Ljava/lang/reflect/Method;Ljava/lang/Object;[Ljava/lang/Object;)Ljava/lang/Object;
