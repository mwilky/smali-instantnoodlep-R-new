...
.method public run()V
    ...
    :cond_0
    iget-object v0, p0, Lcom/oneplus/loading/LoadingHelper$3;->val$callback:Lcom/oneplus/loading/LoadingHelper$FinishShowCallback;

    if-eqz v0, :cond_1

    const/4 v1, 0x1

    invoke-interface {v0, v1}, Lcom/oneplus/loading/LoadingHelper$FinishShowCallback;->finish(Z)V
