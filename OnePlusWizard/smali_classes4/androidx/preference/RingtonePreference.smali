...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V
    ...
    iput v1, p0, Landroidx/preference/RingtonePreference;->mRingtoneType:I

    sget v2, Landroidx/preference/R$styleable;->RingtonePreference_android_showDefault:I

    invoke-virtual {v0, v2, v1}, Landroid/content/res/TypedArray;->getBoolean(IZ)Z

    move-result v2

    iput-boolean v2, p0, Landroidx/preference/RingtonePreference;->mShowDefault:Z

    sget v2, Landroidx/preference/R$styleable;->RingtonePreference_android_showSilent:I

    invoke-virtual {v0, v2, v1}, Landroid/content/res/TypedArray;->getBoolean(IZ)Z

    move-result v1

    iput-boolean v1, p0, Landroidx/preference/RingtonePreference;->mShowSilent:Z
...
.method public onActivityResult(IILandroid/content/Intent;)Z
    ...
    iget v0, p0, Landroidx/preference/RingtonePreference;->mRequestCode:I
    ...
    :goto_0
    invoke-virtual {p0, v1}, Landroidx/preference/RingtonePreference;->callChangeListener(Ljava/lang/Object;)Z

    move-result v1

    if-eqz v1, :cond_1

    invoke-virtual {p0, v0}, Landroidx/preference/RingtonePreference;->onSaveRingtone(Landroid/net/Uri;)V
...
.method protected onAttachedToHierarchy(Landroidx/preference/PreferenceManager;)V
    ...
    iput v0, p0, Landroidx/preference/RingtonePreference;->mRequestCode:I
...
.method protected onClick()V
    ...
    invoke-virtual {v2}, Landroidx/preference/PreferenceManager;->getActivity()Landroid/app/Activity;

    move-result-object v2

    iget v3, p0, Landroidx/preference/RingtonePreference;->mRequestCode:I
...
.method protected onPrepareRingtonePickerIntent(Landroid/content/Intent;)V
    ...
    sput-object v4, Landroidx/preference/RingtonePreference;->getDefaultRingtoneUriBySubId:Ljava/lang/reflect/Method;
...
.method protected onSaveRingtone(Landroid/net/Uri;)V
    ...
    :goto_0
    invoke-virtual {p0, v0}, Landroidx/preference/RingtonePreference;->persistString(Ljava/lang/String;)Z
...
.method protected onSetInitialValue(ZLjava/lang/Object;)V
    ...
    invoke-virtual {p0, v1}, Landroidx/preference/RingtonePreference;->onSaveRingtone(Landroid/net/Uri;)V
