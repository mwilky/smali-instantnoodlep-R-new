...
.field final mDynamicGroupEnabled:Z
...
.method constructor <init>(Landroid/content/Context;)V
    ...
    const-string v4, "androidx.mediarouter.FEATURE"
    ...
    :goto_0
    const-string v1, "seamless_transfer"
    ...
    iput-boolean v2, p0, Landroidx/mediarouter/media/MediaRouter$GlobalMediaRouter;->mDynamicGroupEnabled:Z
    ...
    :cond_2
    iput-boolean v3, p0, Landroidx/mediarouter/media/MediaRouter$GlobalMediaRouter;->mDynamicGroupEnabled:Z
    ...
    invoke-direct {v4, p0, v2}, Landroidx/mediarouter/media/MediaRouter$GlobalMediaRouter$Mr2ProviderCallback;-><init>(Landroidx/mediarouter/media/MediaRouter$GlobalMediaRouter;Landroidx/mediarouter/media/MediaRouter$1;)V
    ...
    iput-object v1, p0, Landroidx/mediarouter/media/MediaRouter$GlobalMediaRouter;->mSystemProvider:Landroidx/mediarouter/media/SystemMediaRouteProvider;
...
.method isDynamicGroupEnabled()Z
    .locals 1

    iget-boolean v0, p0, Landroidx/mediarouter/media/MediaRouter$GlobalMediaRouter;->mDynamicGroupEnabled:Z
...
.method selectRoute(Landroidx/mediarouter/media/MediaRouter$RouteInfo;I)V
    ...
    invoke-virtual {v1, v0}, Landroidx/mediarouter/media/MediaRoute2Provider;->transferTo(Ljava/lang/String;)V
...
.method setSelectedRouteInternal(Landroidx/mediarouter/media/MediaRouter$RouteInfo;I)V
    ...
    iget-object v5, v3, Landroidx/mediarouter/media/MediaRouter$RouteInfo;->mDescriptorId:Ljava/lang/String;

    iget-object v6, p0, Landroidx/mediarouter/media/MediaRouter$GlobalMediaRouter;->mSelectedRoute:Landroidx/mediarouter/media/MediaRouter$RouteInfo;

    iget-object v6, v6, Landroidx/mediarouter/media/MediaRouter$RouteInfo;->mDescriptorId:Ljava/lang/String;

    invoke-virtual {v4, v5, v6}, Landroidx/mediarouter/media/MediaRouteProvider;->onCreateRouteController(Ljava/lang/String;Ljava/lang/String;)Landroidx/mediarouter/media/MediaRouteProvider$RouteController;
    ...
    iget-object v6, v3, Landroidx/mediarouter/media/MediaRouter$RouteInfo;->mUniqueId:Ljava/lang/String;
...
.method public updateDiscoveryRequest()V
    ...
    invoke-virtual {v2, v9}, Landroidx/mediarouter/media/MediaRouteSelector$Builder;->addSelector(Landroidx/mediarouter/media/MediaRouteSelector;)Landroidx/mediarouter/media/MediaRouteSelector$Builder;
    ...
    invoke-direct {v5, v4, v1}, Landroidx/mediarouter/media/MediaRouteDiscoveryRequest;-><init>(Landroidx/mediarouter/media/MediaRouteSelector;Z)V
...
.method updateSelectedRouteIfNeeded(Z)V
    ...
    iget-object v5, v4, Landroidx/mediarouter/media/MediaRouter$RouteInfo;->mUniqueId:Ljava/lang/String;
    ...
    invoke-virtual {v5, v1}, Landroidx/mediarouter/media/MediaRouteProvider$RouteController;->onUnselect(I)V
    ...
    invoke-virtual {p0, v0, v1}, Landroidx/mediarouter/media/MediaRouter$GlobalMediaRouter;->setSelectedRouteInternal(Landroidx/mediarouter/media/MediaRouter$RouteInfo;I)V
