...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    sget v1, Lcom/google/android/material/R$styleable;->rectangleFloatingActionButton_tintColor:I
    ...
    sget v3, Lcom/google/android/material/R$drawable;->rectangle_floating_action_button:I
    ...
    invoke-virtual {p0, v4}, Lcom/google/android/material/floatingactionbutton/RectangleFloatingActionButton;->setBackground(Landroid/graphics/drawable/Drawable;)V
    ...
    sget v6, Lcom/google/android/material/R$layout;->float_switch_button:I

    invoke-virtual {v5, v6, p0}, Landroid/view/LayoutInflater;->inflate(ILandroid/view/ViewGroup;)Landroid/view/View;

    sget v6, Lcom/google/android/material/R$id;->normal_imageview:I

    invoke-virtual {p0, v6}, Lcom/google/android/material/floatingactionbutton/RectangleFloatingActionButton;->findViewById(I)Landroid/view/View;

    move-result-object v6

    check-cast v6, Landroid/widget/ImageView;

    iput-object v6, p0, Lcom/google/android/material/floatingactionbutton/RectangleFloatingActionButton;->mNormalImageView:Landroid/widget/ImageView;

    sget v6, Lcom/google/android/material/R$styleable;->rectangleFloatingActionButton_image:I

    invoke-virtual {v0, v6}, Landroid/content/res/TypedArray;->getDrawable(I)Landroid/graphics/drawable/Drawable;

    move-result-object v6

    iget-object v7, p0, Lcom/google/android/material/floatingactionbutton/RectangleFloatingActionButton;->mNormalImageView:Landroid/widget/ImageView;

    invoke-virtual {v7, v6}, Landroid/widget/ImageView;->setImageDrawable(Landroid/graphics/drawable/Drawable;)V

    sget v7, Lcom/google/android/material/R$id;->switch_imageview:I

    invoke-virtual {p0, v7}, Lcom/google/android/material/floatingactionbutton/RectangleFloatingActionButton;->findViewById(I)Landroid/view/View;

    move-result-object v7

    check-cast v7, Landroid/widget/ImageView;

    iput-object v7, p0, Lcom/google/android/material/floatingactionbutton/RectangleFloatingActionButton;->mSwitchImageView:Landroid/widget/ImageView;
...
.method public setPivotType(I)V
    ...
    invoke-virtual {p0, v1}, Lcom/google/android/material/floatingactionbutton/RectangleFloatingActionButton;->setPivotY(F)V
