...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V
    ...
    sget v2, Lcom/google/android/material/picker/YearPickerView;->ITEM_LAYOUT:I

    const/4 v3, 0x1

    invoke-virtual {v1, v2, p0, v3}, Landroid/view/LayoutInflater;->inflate(ILandroid/view/ViewGroup;Z)Landroid/view/View;

    sget v1, Lcom/google/android/material/R$dimen;->datepicker_view_animator_height:I

    invoke-virtual {v0, v1}, Landroid/content/res/Resources;->getDimensionPixelOffset(I)I

    move-result v1

    iput v1, p0, Lcom/google/android/material/picker/YearPickerView;->mViewSize:I

    sget v1, Lcom/google/android/material/R$dimen;->datepicker_year_label_height:I

    invoke-virtual {v0, v1}, Landroid/content/res/Resources;->getDimensionPixelOffset(I)I

    move-result v1

    iput v1, p0, Lcom/google/android/material/picker/YearPickerView;->mChildSize:I

    sget v1, Lcom/google/android/material/R$id;->year_picker:I

    invoke-virtual {p0, v1}, Lcom/google/android/material/picker/YearPickerView;->findViewById(I)Landroid/view/View;

    move-result-object v1

    check-cast v1, Lcom/google/android/material/picker/NumberPicker;

    iput-object v1, p0, Lcom/google/android/material/picker/YearPickerView;->mPicker:Lcom/google/android/material/picker/NumberPicker;

    const/4 v2, 0x5

    invoke-virtual {v1, v2}, Lcom/google/android/material/picker/NumberPicker;->setSelectNumberCount(I)V
...
.method public setRange(Ljava/util/Calendar;Ljava/util/Calendar;)V
    ...
    iget-object v2, p0, Lcom/google/android/material/picker/YearPickerView;->mPicker:Lcom/google/android/material/picker/NumberPicker;

    invoke-virtual {v2, v1}, Lcom/google/android/material/picker/NumberPicker;->setMinValue(I)V

    iget-object v2, p0, Lcom/google/android/material/picker/YearPickerView;->mPicker:Lcom/google/android/material/picker/NumberPicker;

    invoke-virtual {v2, v0}, Lcom/google/android/material/picker/NumberPicker;->setMaxValue(I)V
