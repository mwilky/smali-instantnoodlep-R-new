...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iput v0, p0, Lcom/google/android/material/picker/NumericTextView;->mMinValue:I

    const/16 v0, 0x63

    iput v0, p0, Lcom/google/android/material/picker/NumericTextView;->mMaxValue:I

    const/4 v0, 0x2

    iput v0, p0, Lcom/google/android/material/picker/NumericTextView;->mMaxCount:I

    const/4 v0, 0x1

    iput-boolean v0, p0, Lcom/google/android/material/picker/NumericTextView;->mShowLeadingZeroes:Z

    invoke-virtual {p0, v0}, Lcom/google/android/material/picker/NumericTextView;->setFocusable(Z)V
...
.method private handleKeyUp(I)Z
    ...
    iput v3, p0, Lcom/google/android/material/picker/NumericTextView;->mValue:I

    sub-int/2addr v2, v1

    iput v2, p0, Lcom/google/android/material/picker/NumericTextView;->mCount:I
    ...
    iput v4, p0, Lcom/google/android/material/picker/NumericTextView;->mCount:I
    ...
    iget v3, p0, Lcom/google/android/material/picker/NumericTextView;->mCount:I
    ...
    iget v4, p0, Lcom/google/android/material/picker/NumericTextView;->mValue:I
    ...
    :goto_1
    invoke-virtual {p0, v2}, Lcom/google/android/material/picker/NumericTextView;->setText(Ljava/lang/CharSequence;)V

    iget-object v3, p0, Lcom/google/android/material/picker/NumericTextView;->mListener:Lcom/google/android/material/picker/NumericTextView$OnValueChangedListener;

    if-eqz v3, :cond_6

    iget v3, p0, Lcom/google/android/material/picker/NumericTextView;->mValue:I

    iget v4, p0, Lcom/google/android/material/picker/NumericTextView;->mMinValue:I
    ...
    :cond_5
    iget-object v4, p0, Lcom/google/android/material/picker/NumericTextView;->mListener:Lcom/google/android/material/picker/NumericTextView$OnValueChangedListener;

    iget v5, p0, Lcom/google/android/material/picker/NumericTextView;->mValue:I

    invoke-interface {v4, p0, v5, v3, v0}, Lcom/google/android/material/picker/NumericTextView$OnValueChangedListener;->onValueChanged(Lcom/google/android/material/picker/NumericTextView;IZZ)V
...
.method private updateDisplayedValue()V
    ...
    invoke-virtual {p0, v1}, Lcom/google/android/material/picker/NumericTextView;->setText(Ljava/lang/CharSequence;)V
...
.method private updateMinimumWidth()V
    ...
    iget v4, p0, Lcom/google/android/material/picker/NumericTextView;->mMaxCount:I
    ...
    invoke-virtual {p0, v3}, Lcom/google/android/material/picker/NumericTextView;->setText(Ljava/lang/CharSequence;)V

    invoke-virtual {p0, v6, v6}, Lcom/google/android/material/picker/NumericTextView;->measure(II)V
    ...
    invoke-virtual {p0, v1}, Lcom/google/android/material/picker/NumericTextView;->setMinWidth(I)V

    invoke-virtual {p0, v1}, Lcom/google/android/material/picker/NumericTextView;->setMinimumWidth(I)V
...
.method public final getRangeMaximum()I
    ...
    iget v0, p0, Lcom/google/android/material/picker/NumericTextView;->mMaxValue:I
...
.method protected onFocusChanged(ZILandroid/graphics/Rect;)V
    ...
    iget v1, p0, Lcom/google/android/material/picker/NumericTextView;->mValue:I

    iput v1, p0, Lcom/google/android/material/picker/NumericTextView;->mPreviousValue:I

    const/4 v1, 0x0

    iput v1, p0, Lcom/google/android/material/picker/NumericTextView;->mValue:I

    iput v1, p0, Lcom/google/android/material/picker/NumericTextView;->mCount:I

    invoke-virtual {p0}, Lcom/google/android/material/picker/NumericTextView;->getText()Ljava/lang/CharSequence;

    move-result-object v1

    invoke-virtual {p0, v1}, Lcom/google/android/material/picker/NumericTextView;->setHint(Ljava/lang/CharSequence;)V
    ...
    :cond_0
    iget v1, p0, Lcom/google/android/material/picker/NumericTextView;->mCount:I

    if-nez v1, :cond_1

    iget v1, p0, Lcom/google/android/material/picker/NumericTextView;->mPreviousValue:I
    ...
    invoke-virtual {p0, v0}, Lcom/google/android/material/picker/NumericTextView;->setHint(Ljava/lang/CharSequence;)V

    :cond_1
    iget v0, p0, Lcom/google/android/material/picker/NumericTextView;->mValue:I

    iget v1, p0, Lcom/google/android/material/picker/NumericTextView;->mMinValue:I
    ...
    invoke-virtual {p0, v0}, Lcom/google/android/material/picker/NumericTextView;->setValue(I)V
    ...
    invoke-interface {v0, p0, v1, v2, v2}, Lcom/google/android/material/picker/NumericTextView$OnValueChangedListener;->onValueChanged(Lcom/google/android/material/picker/NumericTextView;IZZ)V
...
.method public final setRange(II)V
    ...
    sget-wide v2, Lcom/google/android/material/picker/NumericTextView;->LOG_RADIX:D
