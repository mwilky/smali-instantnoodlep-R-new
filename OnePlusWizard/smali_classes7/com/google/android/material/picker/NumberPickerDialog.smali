...
.method public constructor <init>(Landroid/content/Context;I)V
    ...
    iput v0, p0, Lcom/google/android/material/picker/NumberPickerDialog;->OP_NUMBER_PICKER_DEFAULT_MIN_VALUE:I

    const/16 v1, 0x3c

    iput v1, p0, Lcom/google/android/material/picker/NumberPickerDialog;->OP_NUMBER_PICKER_DEFAULT_MAX_VALUE:I

    iput v0, p0, Lcom/google/android/material/picker/NumberPickerDialog;->mValue:I

    iput v0, p0, Lcom/google/android/material/picker/NumberPickerDialog;->mMinValue:I

    iput v1, p0, Lcom/google/android/material/picker/NumberPickerDialog;->mMaxValue:I

    const/4 v0, 0x0

    new-array v0, v0, [Ljava/lang/String;

    iput-object v0, p0, Lcom/google/android/material/picker/NumberPickerDialog;->mDisplayValue:[Ljava/lang/String;
...
.method public onClick(Landroid/content/DialogInterface;I)V
    ...
    :cond_0
    iget-object v0, p0, Lcom/google/android/material/picker/NumberPickerDialog;->mNumberSetListener:Lcom/google/android/material/picker/NumberPickerDialog$OnNumberSetListener;
    ...
    invoke-interface {v0, v1}, Lcom/google/android/material/picker/NumberPickerDialog$OnNumberSetListener;->onNumberSet(I)V
...
.method protected onCreate(Landroid/os/Bundle;)V
    ...
    sget v2, Lcom/google/android/material/R$id;->numberPicker:I

    invoke-virtual {v1, v2}, Landroid/view/View;->findViewById(I)Landroid/view/View;

    move-result-object v2

    check-cast v2, Lcom/google/android/material/picker/NumberPicker;

    iput-object v2, p0, Lcom/google/android/material/picker/NumberPickerDialog;->mNumberPicker:Lcom/google/android/material/picker/NumberPicker;

    iget v3, p0, Lcom/google/android/material/picker/NumberPickerDialog;->mMinValue:I

    invoke-virtual {v2, v3}, Lcom/google/android/material/picker/NumberPicker;->setMinValue(I)V
    ...
    iget v3, p0, Lcom/google/android/material/picker/NumberPickerDialog;->mMaxValue:I

    invoke-virtual {v2, v3}, Lcom/google/android/material/picker/NumberPicker;->setMaxValue(I)V

    iget-object v2, p0, Lcom/google/android/material/picker/NumberPickerDialog;->mNumberPicker:Lcom/google/android/material/picker/NumberPicker;

    iget v3, p0, Lcom/google/android/material/picker/NumberPickerDialog;->mValue:I

    invoke-virtual {v2, v3}, Lcom/google/android/material/picker/NumberPicker;->setValue(I)V

    iget-object v2, p0, Lcom/google/android/material/picker/NumberPickerDialog;->mDisplayValue:[Ljava/lang/String;
    ...
    invoke-virtual {v3, v2}, Lcom/google/android/material/picker/NumberPicker;->setDisplayedValues([Ljava/lang/String;)V

    :cond_0
    sget v2, Lcom/google/android/material/R$id;->min:I
    ...
    iput-object v2, p0, Lcom/google/android/material/picker/NumberPickerDialog;->mMin:Landroid/widget/TextView;

    invoke-direct {p0}, Lcom/google/android/material/picker/NumberPickerDialog;->updateMinutes()V

    iget-object v2, p0, Lcom/google/android/material/picker/NumberPickerDialog;->mNumberPicker:Lcom/google/android/material/picker/NumberPicker;

    new-instance v3, Lcom/google/android/material/picker/NumberPickerDialog$1;

    invoke-direct {v3, p0}, Lcom/google/android/material/picker/NumberPickerDialog$1;-><init>(Lcom/google/android/material/picker/NumberPickerDialog;)V

    invoke-virtual {v2, v3}, Lcom/google/android/material/picker/NumberPicker;->setOnValueChangedListener(Lcom/google/android/material/picker/NumberPicker$OnValueChangeListener;)V

    const/4 v2, 0x1

    invoke-virtual {p0, v2}, Lcom/google/android/material/picker/NumberPickerDialog;->setShowInBottom(Z)V
    ...
    invoke-virtual {p0, v2, v3, p0}, Lcom/google/android/material/picker/NumberPickerDialog;->setButton(ILjava/lang/CharSequence;Landroid/content/DialogInterface$OnClickListener;)V
    ...
    invoke-virtual {p0, v1}, Lcom/google/android/material/picker/NumberPickerDialog;->setView(Landroid/view/View;)V
