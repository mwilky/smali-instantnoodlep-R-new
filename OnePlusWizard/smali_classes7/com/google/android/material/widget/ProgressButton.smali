...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput-object v0, p0, Lcom/google/android/material/widget/ProgressButton;->xfermode:Landroid/graphics/PorterDuffXfermode;

    const/16 v0, 0x23

    iput v0, p0, Lcom/google/android/material/widget/ProgressButton;->DEFAULT_HEIGHT_DP:I

    const/high16 v0, 0x42c80000    # 100.0f

    iput v0, p0, Lcom/google/android/material/widget/ProgressButton;->maxProgress:F
...
.method private drawBackGround(Landroid/graphics/Canvas;)V
    ...
    iget-object v3, p0, Lcom/google/android/material/widget/ProgressButton;->bgPaint:Landroid/graphics/Paint;
...
.method private drawColorProgressText(Landroid/graphics/Canvas;)V
    ...
    iget v4, p0, Lcom/google/android/material/widget/ProgressButton;->progress:F

    iget v5, p0, Lcom/google/android/material/widget/ProgressButton;->maxProgress:F
    ...
    invoke-virtual {p1, v2, v6, v5, v7}, Landroid/graphics/Canvas;->clipRect(FFFF)Z

    iget-object v6, p0, Lcom/google/android/material/widget/ProgressButton;->progressText:Ljava/lang/String;

    iget-object v7, p0, Lcom/google/android/material/widget/ProgressButton;->textPaint:Landroid/graphics/Paint;

    invoke-virtual {p1, v6, v2, v3, v7}, Landroid/graphics/Canvas;->drawText(Ljava/lang/String;FFLandroid/graphics/Paint;)V
...
.method private drawProgress(Landroid/graphics/Canvas;)V
    ...
    iget v2, p0, Lcom/google/android/material/widget/ProgressButton;->progressColor:I
    ...
    iget-object v2, p0, Lcom/google/android/material/widget/ProgressButton;->xfermode:Landroid/graphics/PorterDuffXfermode;
    ...
    iget-object v2, p0, Lcom/google/android/material/widget/ProgressButton;->pgBitmap:Landroid/graphics/Bitmap;
    ...
    iput-object v1, p0, Lcom/google/android/material/widget/ProgressButton;->bitmapShader:Landroid/graphics/BitmapShader;

    iget-object v2, p0, Lcom/google/android/material/widget/ProgressButton;->pgPaint:Landroid/graphics/Paint;

    invoke-virtual {v2, v1}, Landroid/graphics/Paint;->setShader(Landroid/graphics/Shader;)Landroid/graphics/Shader;

    iget-object v1, p0, Lcom/google/android/material/widget/ProgressButton;->bgRectf:Landroid/graphics/RectF;

    iget v2, p0, Lcom/google/android/material/widget/ProgressButton;->radius:I

    int-to-float v3, v2

    int-to-float v2, v2

    iget-object v4, p0, Lcom/google/android/material/widget/ProgressButton;->pgPaint:Landroid/graphics/Paint;
...
.method private drawProgressText(Landroid/graphics/Canvas;)V
    ...
    iget-object v4, p0, Lcom/google/android/material/widget/ProgressButton;->progressText:Ljava/lang/String;

    iget-object v5, p0, Lcom/google/android/material/widget/ProgressButton;->textPaint:Landroid/graphics/Paint;
...
.method private initAttrs(Landroid/util/AttributeSet;)V
    ...
    :try_start_0
    sget v1, Lcom/google/android/material/R$styleable;->ProgressButton_progress_textSize:I
    ...
    iput v1, p0, Lcom/google/android/material/widget/ProgressButton;->textSize:I

    sget v1, Lcom/google/android/material/R$styleable;->ProgressButton_progress_loadingColor:I

    invoke-virtual {p0}, Lcom/google/android/material/widget/ProgressButton;->getResources()Landroid/content/res/Resources;

    move-result-object v2

    sget v3, Lcom/google/android/material/R$color;->oneplus_accent_color:I
    ...
    iput v1, p0, Lcom/google/android/material/widget/ProgressButton;->progressColor:I

    sget v1, Lcom/google/android/material/R$styleable;->ProgressButton_progress_radius:I
    ...
    iput v1, p0, Lcom/google/android/material/widget/ProgressButton;->radius:I

    sget v1, Lcom/google/android/material/R$styleable;->ProgressButton_progress_borderWidth:I
    ...
    iput v1, p0, Lcom/google/android/material/widget/ProgressButton;->borderWidth:I
    :try_end_0
...
.method protected onMeasure(II)V
    ...
    :cond_1
    iget v4, p0, Lcom/google/android/material/widget/ProgressButton;->DEFAULT_HEIGHT_DP:I

    invoke-direct {p0, v4}, Lcom/google/android/material/widget/ProgressButton;->dp2px(I)I
    ...
    :goto_0
    invoke-virtual {p0, v0, v3}, Lcom/google/android/material/widget/ProgressButton;->setMeasuredDimension(II)V

    iget-object v4, p0, Lcom/google/android/material/widget/ProgressButton;->pgBitmap:Landroid/graphics/Bitmap;
