...
.method private drawIndicator(Landroid/graphics/Canvas;III)V
    ...
    iget-object v7, p0, Lcom/google/android/material/indicator/draw/controller/DrawController;->drawer:Lcom/google/android/material/indicator/draw/drawer/Drawer;

    invoke-virtual {v7, p2, p3, p4}, Lcom/google/android/material/indicator/draw/drawer/Drawer;->setup(III)V

    iget-object v7, p0, Lcom/google/android/material/indicator/draw/controller/DrawController;->value:Lcom/google/android/material/indicator/animation/data/Value;

    if-eqz v7, :cond_4

    if-eqz v5, :cond_4

    iget-object v8, p0, Lcom/google/android/material/indicator/draw/controller/DrawController;->drawer:Lcom/google/android/material/indicator/draw/drawer/Drawer;

    invoke-virtual {v8, p1, v7}, Lcom/google/android/material/indicator/draw/drawer/Drawer;->drawWorm(Landroid/graphics/Canvas;Lcom/google/android/material/indicator/animation/data/Value;)V
    ...
    invoke-virtual {v7, p1, v5}, Lcom/google/android/material/indicator/draw/drawer/Drawer;->drawBasic(Landroid/graphics/Canvas;Z)V
...
.method private onIndicatorTouched(FF)V
    ...
    iget-object v1, p0, Lcom/google/android/material/indicator/draw/controller/DrawController;->listener:Lcom/google/android/material/indicator/draw/controller/DrawController$ClickListener;

    invoke-interface {v1, v0}, Lcom/google/android/material/indicator/draw/controller/DrawController$ClickListener;->onIndicatorClicked(I)V
...
.method public touch(Landroid/view/MotionEvent;)V
    ...
    invoke-direct {p0, v0, v1}, Lcom/google/android/material/indicator/draw/controller/DrawController;->onIndicatorTouched(FF)V
