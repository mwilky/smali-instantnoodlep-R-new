...
.method private wormAnimation()V
    ...
    :goto_2
    iget-object v5, p0, Lcom/google/android/material/indicator/animation/controller/AnimationController;->indicator:Lcom/google/android/material/indicator/draw/data/Indicator;

    invoke-virtual {v5}, Lcom/google/android/material/indicator/draw/data/Indicator;->getRadius()I

    move-result v5

    iget-object v6, p0, Lcom/google/android/material/indicator/animation/controller/AnimationController;->indicator:Lcom/google/android/material/indicator/draw/data/Indicator;

    invoke-virtual {v6}, Lcom/google/android/material/indicator/draw/data/Indicator;->getAnimationDuration()J

    move-result-wide v6

    iget-object v8, p0, Lcom/google/android/material/indicator/animation/controller/AnimationController;->valueController:Lcom/google/android/material/indicator/animation/controller/ValueController;

    invoke-virtual {v8}, Lcom/google/android/material/indicator/animation/controller/ValueController;->worm()Lcom/google/android/material/indicator/animation/type/WormAnimation;

    move-result-object v8

    invoke-virtual {v8, v2, v3, v5, v4}, Lcom/google/android/material/indicator/animation/type/WormAnimation;->with(IIIZ)Lcom/google/android/material/indicator/animation/type/WormAnimation;

    move-result-object v8

    invoke-virtual {v8, v6, v7}, Lcom/google/android/material/indicator/animation/type/WormAnimation;->duration(J)Lcom/google/android/material/indicator/animation/type/WormAnimation;

    move-result-object v8

    iget-boolean v9, p0, Lcom/google/android/material/indicator/animation/controller/AnimationController;->isInteractive:Z

    if-eqz v9, :cond_3

    iget v9, p0, Lcom/google/android/material/indicator/animation/controller/AnimationController;->progress:F

    invoke-virtual {v8, v9}, Lcom/google/android/material/indicator/animation/type/BaseAnimation;->progress(F)Lcom/google/android/material/indicator/animation/type/BaseAnimation;

    goto :goto_3

    :cond_3
    invoke-virtual {v8}, Lcom/google/android/material/indicator/animation/type/BaseAnimation;->start()V

    :goto_3
    iput-object v8, p0, Lcom/google/android/material/indicator/animation/controller/AnimationController;->runningAnimation:Lcom/google/android/material/indicator/animation/type/BaseAnimation;
...
.method public end()V
    ...
    iget-object v0, p0, Lcom/google/android/material/indicator/animation/controller/AnimationController;->runningAnimation:Lcom/google/android/material/indicator/animation/type/BaseAnimation;

    if-eqz v0, :cond_0

    invoke-virtual {v0}, Lcom/google/android/material/indicator/animation/type/BaseAnimation;->end()V
