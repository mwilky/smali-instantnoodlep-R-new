...
.method private updateStatusLabel()V
    ...
    iget-object v3, p0, Lcom/android/settingslib/wifi/WifiStatusTracker;->mConnectivityManager:Landroid/net/ConnectivityManager;
    ...
    sget v4, Lcom/android/settingslib/R$string;->wifi_status_sign_in_required:I
    ...
    invoke-virtual {v3}, Landroid/net/NetworkCapabilities;->isPrivateDnsBroken()Z
    ...
    sget v4, Lcom/android/settingslib/R$string;->wifi_status_no_internet:I
    ...
    iget v4, p0, Lcom/android/settingslib/wifi/WifiStatusTracker;->rssi:I

    invoke-static {v2, v1, v4}, Lcom/android/settingslib/wifi/AccessPoint;->getSpeedLabel(Landroid/content/Context;Landroid/net/ScoredNetwork;I)Ljava/lang/String;
...
.method public handleBroadcast(Landroid/content/Intent;)V
    ...
    iput v2, p0, Lcom/android/settingslib/wifi/WifiStatusTracker;->wifiStandard:I

    iget-object v2, p0, Lcom/android/settingslib/wifi/WifiStatusTracker;->mWifiInfo:Landroid/net/wifi/WifiInfo;

    invoke-virtual {v2}, Landroid/net/wifi/WifiInfo;->isVhtMax8SpatialStreamsSupported()Z

    move-result v2

    iput-boolean v2, p0, Lcom/android/settingslib/wifi/WifiStatusTracker;->vhtMax8SpatialStreamsSupport:Z

    iget-object v2, p0, Lcom/android/settingslib/wifi/WifiStatusTracker;->mWifiInfo:Landroid/net/wifi/WifiInfo;

    invoke-virtual {v2}, Landroid/net/wifi/WifiInfo;->isHe8ssCapableAp()Z

    move-result v2

    iput-boolean v2, p0, Lcom/android/settingslib/wifi/WifiStatusTracker;->he8ssCapableAp:Z
