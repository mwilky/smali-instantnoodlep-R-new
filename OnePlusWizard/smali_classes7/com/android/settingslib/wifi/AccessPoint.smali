...
.field public static final SECURITY_MAX_VAL:I = 0xa
...
.method private static getSecurity(Landroid/content/Context;Landroid/net/wifi/ScanResult;)I
    ...
    const-string v9, "OWE_TRANSITION"

    invoke-virtual {v8, v9}, Ljava/lang/String;->contains(Ljava/lang/CharSequence;)Z

    move-result v8

    iget-object v9, v1, Landroid/net/wifi/ScanResult;->capabilities:Ljava/lang/String;
    ...
    iget-object v10, v1, Landroid/net/wifi/ScanResult;->capabilities:Ljava/lang/String;

    const-string v11, "WAPI-PSK"

    invoke-virtual {v10, v11}, Ljava/lang/String;->contains(Ljava/lang/CharSequence;)Z

    move-result v10

    iget-object v11, v1, Landroid/net/wifi/ScanResult;->capabilities:Ljava/lang/String;
    ...
    invoke-virtual {v12}, Landroid/net/wifi/WifiManager;->isEnhancedOpenSupported()Z
...
.method public static getSummary(Landroid/content/Context;Ljava/lang/String;Landroid/net/NetworkInfo$DetailedState;ZLjava/lang/String;)Ljava/lang/String;
    ...
    sget v2, Lcom/android/settingslib/R$string;->private_dns_broken:I
    ...
    :cond_5
    sget v2, Lcom/android/settingslib/R$string;->wifi_connected_no_internet:I
...
.method private updateWifiGeneration()V
    ...
    iget-boolean v4, p0, Lcom/android/settingslib/wifi/AccessPoint;->mHe8ssCapableAp:Z

    if-eqz v4, :cond_0

    const/4 v4, 0x0

    iput-boolean v4, p0, Lcom/android/settingslib/wifi/AccessPoint;->mHe8ssCapableAp:Z
...
.method public getSettingsSummary(Z)Ljava/lang/String;
    ...
    invoke-virtual {v7}, Landroid/net/wifi/WifiInfo;->getRequestingPackageName()Ljava/lang/String;
...
.method public isHe8ssCapableAp()Z
    ...
    :cond_0
    iget-boolean v0, p0, Lcom/android/settingslib/wifi/AccessPoint;->mHe8ssCapableAp:Z
...
.method public isSuiteBSupported()Z
    ...
    invoke-virtual {v0, v1}, Landroid/net/wifi/WifiManager;->getCapabilities(Ljava/lang/String;)Ljava/lang/String;
...
.method public isVhtMax8SpatialStreamsSupported()Z
    ...
    :cond_0
    iget-boolean v0, p0, Lcom/android/settingslib/wifi/AccessPoint;->mVhtMax8SpatialStreamsSupport:Z
...
.method public saveWifiState(Landroid/os/Bundle;)V
    ...
    const-string v1, "key_is_owe_transition_mode"
...
.method setScanResults(Ljava/util/Collection;)V
    ...
    iget-object v3, p0, Lcom/android/settingslib/wifi/AccessPoint;->mKey:Ljava/lang/String;
