...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput v0, p0, Lcom/android/setupwizardlib/view/StickyHeaderListView;->statusBarInset:I

    new-instance v0, Landroid/graphics/RectF;

    invoke-direct {v0}, Landroid/graphics/RectF;-><init>()V

    iput-object v0, p0, Lcom/android/setupwizardlib/view/StickyHeaderListView;->stickyRect:Landroid/graphics/RectF;
...
.method public dispatchTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget-object v0, p0, Lcom/android/setupwizardlib/view/StickyHeaderListView;->stickyRect:Landroid/graphics/RectF;
    ...
    iget-object v1, p0, Lcom/android/setupwizardlib/view/StickyHeaderListView;->stickyRect:Landroid/graphics/RectF;
    ...
    iget-object v0, p0, Lcom/android/setupwizardlib/view/StickyHeaderListView;->stickyContainer:Landroid/view/View;
...
.method public draw(Landroid/graphics/Canvas;)V
    ...
    iget-object v0, p0, Lcom/android/setupwizardlib/view/StickyHeaderListView;->sticky:Landroid/view/View;
    ...
    iget-object v1, p0, Lcom/android/setupwizardlib/view/StickyHeaderListView;->stickyContainer:Landroid/view/View;
    ...
    :cond_0
    iget-object v1, p0, Lcom/android/setupwizardlib/view/StickyHeaderListView;->sticky:Landroid/view/View;

    :goto_0
    iget-object v2, p0, Lcom/android/setupwizardlib/view/StickyHeaderListView;->stickyContainer:Landroid/view/View;

    const/4 v3, 0x0

    if-eqz v2, :cond_1

    iget-object v2, p0, Lcom/android/setupwizardlib/view/StickyHeaderListView;->sticky:Landroid/view/View;
    ...
    iget v6, p0, Lcom/android/setupwizardlib/view/StickyHeaderListView;->statusBarInset:I
    ...
    :cond_2
    iget-object v3, p0, Lcom/android/setupwizardlib/view/StickyHeaderListView;->stickyRect:Landroid/graphics/RectF;
    ...
    :cond_3
    :goto_2
    iget-object v5, p0, Lcom/android/setupwizardlib/view/StickyHeaderListView;->stickyRect:Landroid/graphics/RectF;

    neg-int v6, v2

    iget v7, p0, Lcom/android/setupwizardlib/view/StickyHeaderListView;->statusBarInset:I
    ...
    iget v9, p0, Lcom/android/setupwizardlib/view/StickyHeaderListView;->statusBarInset:I
...
.method public updateStickyView()V
    ...
    iput-object v0, p0, Lcom/android/setupwizardlib/view/StickyHeaderListView;->sticky:Landroid/view/View;
    ...
    iput-object v0, p0, Lcom/android/setupwizardlib/view/StickyHeaderListView;->stickyContainer:Landroid/view/View;
