...
.method public static asInterface(Landroid/os/IBinder;)Landroid/net/IIpMemoryStoreCallbacks;
    ...
    check-cast v1, Landroid/net/IIpMemoryStoreCallbacks;

    return-object v1

    :cond_1
    new-instance v1, Landroid/net/IIpMemoryStoreCallbacks$Stub$Proxy;

    invoke-direct {v1, p0}, Landroid/net/IIpMemoryStoreCallbacks$Stub$Proxy;-><init>(Landroid/os/IBinder;)V
...
.method public onTransact(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z
    ...
    invoke-static {v2}, Landroid/net/IIpMemoryStore$Stub;->asInterface(Landroid/os/IBinder;)Landroid/net/IIpMemoryStore;

    move-result-object v2

    invoke-virtual {p0, v2}, Landroid/net/IIpMemoryStoreCallbacks$Stub;->onIpMemoryStoreFetched(Landroid/net/IIpMemoryStore;)V
