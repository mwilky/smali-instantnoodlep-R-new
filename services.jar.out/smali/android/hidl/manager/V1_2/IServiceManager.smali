...
.method public static asInterface(Landroid/os/IHwBinder;)Landroid/hidl/manager/V1_2/IServiceManager;
    ...
    check-cast v0, Landroid/hidl/manager/V1_2/IServiceManager;

    return-object v0

    :cond_1
    new-instance v3, Landroid/hidl/manager/V1_2/IServiceManager$Proxy;

    invoke-direct {v3, p0}, Landroid/hidl/manager/V1_2/IServiceManager$Proxy;-><init>(Landroid/os/IHwBinder;)V

    :try_start_0
    invoke-interface {v3}, Landroid/hidl/manager/V1_2/IServiceManager;->interfaceChain()Ljava/util/ArrayList;
...
.method public static castFrom(Landroid/os/IHwInterface;)Landroid/hidl/manager/V1_2/IServiceManager;
    ...
    invoke-static {v0}, Landroid/hidl/manager/V1_2/IServiceManager;->asInterface(Landroid/os/IHwBinder;)Landroid/hidl/manager/V1_2/IServiceManager;
