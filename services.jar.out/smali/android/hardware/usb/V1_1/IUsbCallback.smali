...
.method public static asInterface(Landroid/os/IHwBinder;)Landroid/hardware/usb/V1_1/IUsbCallback;
    ...
    :cond_1
    new-instance v3, Landroid/hardware/usb/V1_1/IUsbCallback$Proxy;

    invoke-direct {v3, p0}, Landroid/hardware/usb/V1_1/IUsbCallback$Proxy;-><init>(Landroid/os/IHwBinder;)V

    :try_start_0
    invoke-interface {v3}, Landroid/hardware/usb/V1_1/IUsbCallback;->interfaceChain()Ljava/util/ArrayList;
