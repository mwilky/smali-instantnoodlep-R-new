...
.method public static asInterface(Landroid/os/IHwBinder;)Landroid/hardware/health/V2_0/IHealth;
    ...
    :cond_1
    new-instance v3, Landroid/hardware/health/V2_0/IHealth$Proxy;

    invoke-direct {v3, p0}, Landroid/hardware/health/V2_0/IHealth$Proxy;-><init>(Landroid/os/IHwBinder;)V

    :try_start_0
    invoke-interface {v3}, Landroid/hardware/health/V2_0/IHealth;->interfaceChain()Ljava/util/ArrayList;
