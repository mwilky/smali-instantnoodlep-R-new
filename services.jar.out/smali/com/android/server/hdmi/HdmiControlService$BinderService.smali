...
.method public addHdmiControlStatusChangeListener(Landroid/hardware/hdmi/IHdmiControlStatusChangeListener;)V
    ...
    invoke-static {v0, p1}, Lcom/android/server/hdmi/HdmiControlService;->access$3300(Lcom/android/server/hdmi/HdmiControlService;Landroid/hardware/hdmi/IHdmiControlStatusChangeListener;)V
...
.method public addHdmiMhlVendorCommandListener(Landroid/hardware/hdmi/IHdmiMhlVendorCommandListener;)V
    ...
    invoke-static {v0, p1}, Lcom/android/server/hdmi/HdmiControlService;->access$4700(Lcom/android/server/hdmi/HdmiControlService;Landroid/hardware/hdmi/IHdmiMhlVendorCommandListener;)V
...
.method public addVendorCommandListener(Landroid/hardware/hdmi/IHdmiVendorCommandListener;I)V
    ...
    invoke-static {v0, p1, p2}, Lcom/android/server/hdmi/HdmiControlService;->access$4500(Lcom/android/server/hdmi/HdmiControlService;Landroid/hardware/hdmi/IHdmiVendorCommandListener;I)V
...
.method protected dump(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    invoke-static {v2}, Lcom/android/server/hdmi/HdmiControlService;->access$4800(Lcom/android/server/hdmi/HdmiControlService;)Z
    ...
    invoke-static {v2}, Lcom/android/server/hdmi/HdmiControlService;->access$4900(Lcom/android/server/hdmi/HdmiControlService;)I
    ...
    invoke-static {v1}, Lcom/android/server/hdmi/HdmiControlService;->access$5300(Lcom/android/server/hdmi/HdmiControlService;)Ljava/util/List;
...
.method public getActiveSource()Landroid/hardware/hdmi/HdmiDeviceInfo;
    ...
    invoke-virtual {v3}, Lcom/android/server/hdmi/HdmiControlService;->playback()Lcom/android/server/hdmi/HdmiCecLocalDevicePlayback;
    ...
    iget-boolean v3, v3, Lcom/android/server/hdmi/HdmiCecLocalDevicePlayback;->mIsActiveSource:Z
    ...
    invoke-virtual {v3}, Lcom/android/server/hdmi/HdmiControlService;->getLocalActiveSource()Lcom/android/server/hdmi/HdmiCecLocalDevice$ActiveSource;

    move-result-object v3

    iget v4, v3, Lcom/android/server/hdmi/HdmiCecLocalDevice$ActiveSource;->physicalAddress:I
    ...
    iget v6, v3, Lcom/android/server/hdmi/HdmiCecLocalDevice$ActiveSource;->physicalAddress:I
    ...
    :cond_4
    iget v1, v3, Lcom/android/server/hdmi/HdmiCecLocalDevice$ActiveSource;->logicalAddress:I
    ...
    iget v5, v3, Lcom/android/server/hdmi/HdmiCecLocalDevice$ActiveSource;->logicalAddress:I
    ...
    invoke-virtual {v2, v4}, Lcom/android/server/hdmi/HdmiControlService;->pathToPortId(I)I

    move-result v7

    iget v2, v3, Lcom/android/server/hdmi/HdmiCecLocalDevice$ActiveSource;->logicalAddress:I
    ...
    iget v2, v3, Lcom/android/server/hdmi/HdmiCecLocalDevice$ActiveSource;->physicalAddress:I
    ...
    iget v5, v3, Lcom/android/server/hdmi/HdmiCecLocalDevice$ActiveSource;->physicalAddress:I

    invoke-virtual {v4, v5}, Lcom/android/server/hdmi/HdmiControlService;->pathToPortId(I)I

    move-result v4

    invoke-direct {v1, v2, v4}, Landroid/hardware/hdmi/HdmiDeviceInfo;-><init>(II)V
    ...
    invoke-virtual {v3}, Lcom/android/server/hdmi/HdmiCecLocalDevice$ActiveSource;->isValid()Z
    ...
    iget v6, v3, Lcom/android/server/hdmi/HdmiCecLocalDevice$ActiveSource;->logicalAddress:I

    iget v7, v3, Lcom/android/server/hdmi/HdmiCecLocalDevice$ActiveSource;->physicalAddress:I
    ...
    invoke-virtual {v0, v4}, Lcom/android/server/hdmi/HdmiCecLocalDeviceTv;->getSafeDeviceInfoByPath(I)Landroid/hardware/hdmi/HdmiDeviceInfo;
    ...
    invoke-direct {v2, v4, v5}, Landroid/hardware/hdmi/HdmiDeviceInfo;-><init>(II)V
...
.method public getInputDevices()Ljava/util/List;
    ...
    invoke-static {v3}, Lcom/android/server/hdmi/HdmiControlService;->access$4200(Lcom/android/server/hdmi/HdmiControlService;)Ljava/util/List;
...
.method public getPhysicalAddress()I
    ...
    invoke-static {v1}, Lcom/android/server/hdmi/HdmiControlService;->access$3800(Lcom/android/server/hdmi/HdmiControlService;)I
...
.method public getSupportedTypes()[I
    ...
    invoke-static {v0}, Lcom/android/server/hdmi/HdmiControlService;->access$700(Lcom/android/server/hdmi/HdmiControlService;)Ljava/util/List;
...
.method public removeSystemAudioModeChangeListener(Landroid/hardware/hdmi/IHdmiSystemAudioModeChangeListener;)V
    ...
    invoke-static {v0, p1}, Lcom/android/server/hdmi/HdmiControlService;->access$4000(Lcom/android/server/hdmi/HdmiControlService;Landroid/hardware/hdmi/IHdmiSystemAudioModeChangeListener;)V
...
.method public setHdmiCecVolumeControlEnabled(Z)V
    ...
    invoke-virtual {v2, p1}, Lcom/android/server/hdmi/HdmiControlService;->setHdmiCecVolumeControlEnabled(Z)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public setHdmiRecordListener(Landroid/hardware/hdmi/IHdmiRecordListener;)V
    ...
    invoke-static {v0, p1}, Lcom/android/server/hdmi/HdmiControlService;->access$4600(Lcom/android/server/hdmi/HdmiControlService;Landroid/hardware/hdmi/IHdmiRecordListener;)V
...
.method public setInputChangeListener(Landroid/hardware/hdmi/IHdmiInputChangeListener;)V
    ...
    invoke-static {v0, p1}, Lcom/android/server/hdmi/HdmiControlService;->access$4100(Lcom/android/server/hdmi/HdmiControlService;Landroid/hardware/hdmi/IHdmiInputChangeListener;)V
