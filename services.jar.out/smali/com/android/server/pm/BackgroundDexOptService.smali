...
.method private idleOptimizePackages(Lcom/android/server/pm/PackageManagerService;Landroid/util/ArraySet;J)I
    ...
    invoke-direct {v8, v1}, Lcom/android/server/pm/BackgroundDexOptService;->reconcileSecondaryDexFiles(Lcom/android/server/pm/dex/DexManager;)I
    ...
    invoke-direct {v8, v10}, Lcom/android/server/pm/BackgroundDexOptService;->notifyPinService(Landroid/util/ArraySet;)V

    invoke-direct {v8, v10}, Lcom/android/server/pm/BackgroundDexOptService;->notifyPackagesUpdated(Landroid/util/ArraySet;)V
    ...
    :try_start_1
    invoke-direct {v8, v12, v13}, Lcom/android/server/pm/BackgroundDexOptService;->shouldDowngrade(J)Z
    ...
    invoke-virtual {v9, v1, v2}, Lcom/android/server/pm/PackageManagerService;->getUnusedPackages(J)Ljava/util/Set;
    ...
    invoke-direct {v8, v3, v4}, Lcom/android/server/pm/BackgroundDexOptService;->abortIdleOptimizations(J)I
    ...
    :cond_1
    :try_start_2
    invoke-direct {v8, v9, v2, v4}, Lcom/android/server/pm/BackgroundDexOptService;->downgradePackage(Lcom/android/server/pm/PackageManagerService;Ljava/lang/String;Z)Z
    ...
    invoke-direct {v8, v9, v2, v15}, Lcom/android/server/pm/BackgroundDexOptService;->downgradePackage(Lcom/android/server/pm/PackageManagerService;Ljava/lang/String;Z)Z
