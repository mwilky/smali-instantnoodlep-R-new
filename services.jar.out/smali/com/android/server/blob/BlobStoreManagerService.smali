...
.method private acquireLeaseInternal(Landroid/app/blob/BlobHandle;ILjava/lang/CharSequence;JILjava/lang/String;)V
    ...
    invoke-direct {p0, v0}, Lcom/android/server/blob/BlobStoreManagerService;->getUserBlobsLocked(I)Landroid/util/ArrayMap;
    ...
    invoke-virtual {v0, v11, v10}, Lcom/android/server/blob/BlobMetadata;->isAccessAllowedForCaller(Ljava/lang/String;I)Z
...
.method private createSessionInternal(Landroid/app/blob/BlobHandle;ILjava/lang/String;)J
    ...
    :try_start_0
    invoke-direct {p0}, Lcom/android/server/blob/BlobStoreManagerService;->generateNextSessionIdLocked()J
    ...
    invoke-direct {p0, v3, v4}, Lcom/android/server/blob/BlobStoreManagerService;->addSessionForUserLocked(Lcom/android/server/blob/BlobStoreSession;I)V
...
.method private deleteBlobInternal(JI)V
    ...
    new-instance v3, Lcom/android/server/blob/-$$Lambda$BlobStoreManagerService$vK7iR484xvuS8i9lQSvit82CZ1Y;

    invoke-direct {v3, p1, p2}, Lcom/android/server/blob/-$$Lambda$BlobStoreManagerService$vK7iR484xvuS8i9lQSvit82CZ1Y;-><init>(J)V
...
.method private getLeasedBlobsInternal(ILjava/lang/String;)Ljava/util/List;
    ...
    new-instance v1, Lcom/android/server/blob/-$$Lambda$BlobStoreManagerService$aItjHisYe9F3klKg4mEt7x5Adpk;

    invoke-direct {v1, p2, p1, v0}, Lcom/android/server/blob/-$$Lambda$BlobStoreManagerService$aItjHisYe9F3klKg4mEt7x5Adpk;-><init>(Ljava/lang/String;ILjava/util/ArrayList;)V
...
.method private handleUserRemoved(I)V
    ...
    iget-object v5, p0, Lcom/android/server/blob/BlobStoreManagerService;->mActiveBlobIds:Landroid/util/ArraySet;
...
.method static synthetic lambda$deleteBlobInternal$5(JLjava/util/Map$Entry;)Z
    .locals 3
...
.method static synthetic lambda$getLeasedBlobsInternal$6(Ljava/lang/String;ILjava/util/ArrayList;Lcom/android/server/blob/BlobMetadata;)V
    .locals 1
...
.method static synthetic lambda$getTotalUsageBytesLocked$0(Ljava/lang/String;ILjava/util/concurrent/atomic/AtomicLong;Lcom/android/server/blob/BlobMetadata;)V
    .locals 2
...
.method static synthetic lambda$queryBlobsForUserInternal$3(Ljava/util/function/Function;Landroid/app/blob/BlobHandle;Ljava/util/ArrayList;Lcom/android/server/blob/BlobMetadata$Leasee;)V
    .locals 7
...
.method static synthetic lambda$queryBlobsForUserInternal$4(Ljava/util/function/Function;Ljava/util/ArrayList;Landroid/app/blob/BlobHandle;Lcom/android/server/blob/BlobMetadata;)V
    .locals 11
    ...
    new-instance v1, Lcom/android/server/blob/-$$Lambda$BlobStoreManagerService$Z_FlOpuEEFmK4yxgPaKwmJJOIRk;

    invoke-direct {v1, p0, p2, v0}, Lcom/android/server/blob/-$$Lambda$BlobStoreManagerService$Z_FlOpuEEFmK4yxgPaKwmJJOIRk;-><init>(Ljava/util/function/Function;Landroid/app/blob/BlobHandle;Ljava/util/ArrayList;)V
...
.method private onStateChangedInternal(Lcom/android/server/blob/BlobStoreSession;)V
    ...
    invoke-direct {v1, v10}, Lcom/android/server/blob/BlobStoreManagerService;->getUserBlobsLocked(I)Landroid/util/ArrayMap;
    ...
    new-instance v12, Lcom/android/server/blob/BlobMetadata;

    iget-object v5, v1, Lcom/android/server/blob/BlobStoreManagerService;->mContext:Landroid/content/Context;
    ...
    invoke-direct/range {v4 .. v9}, Lcom/android/server/blob/BlobMetadata;-><init>(Landroid/content/Context;JLandroid/app/blob/BlobHandle;I)V

    move-object v0, v12

    invoke-direct {v1, v0, v11}, Lcom/android/server/blob/BlobStoreManagerService;->addBlobForUserLocked(Lcom/android/server/blob/BlobMetadata;Landroid/util/ArrayMap;)V
    ...
    invoke-virtual {v4, v0, v5}, Lcom/android/server/blob/BlobMetadata;->getExistingCommitter(Ljava/lang/String;I)Lcom/android/server/blob/BlobMetadata$Committer;
    ...
    :cond_2
    invoke-virtual {v5}, Lcom/android/server/blob/BlobMetadata$Committer;->getCommitTimeMs()J
    ...
    invoke-static {v6, v7, v8, v9}, Lcom/android/server/blob/BlobStoreConfig;->getAdjustedCommitTimeMs(JJ)J
    ...
    invoke-virtual {v4, v8}, Lcom/android/server/blob/BlobMetadata;->addOrReplaceCommitter(Lcom/android/server/blob/BlobMetadata$Committer;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    invoke-static/range {v12 .. v18}, Lcom/android/internal/util/FrameworkStatsLog;->write(IIJJI)V
    ...
    :try_start_2
    invoke-virtual {v4, v8}, Lcom/android/server/blob/BlobMetadata;->removeCommitter(Lcom/android/server/blob/BlobMetadata$Committer;)V

    goto :goto_2

    :cond_3
    invoke-virtual {v4, v5}, Lcom/android/server/blob/BlobMetadata;->addOrReplaceCommitter(Lcom/android/server/blob/BlobMetadata$Committer;)V

    :goto_2
    const-string v9, "BlobStore"

    const-string v12, "Error committing the blob"

    invoke-static {v9, v12, v0}, Landroid/util/Slog;->d(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)I
    ...
    invoke-static/range {v13 .. v19}, Lcom/android/internal/util/FrameworkStatsLog;->write(IIJJI)V

    const/4 v9, 0x1

    invoke-virtual {v2, v9}, Lcom/android/server/blob/BlobStoreSession;->sendCommitCallbackResult(I)V
    ...
    invoke-direct {v1, v4}, Lcom/android/server/blob/BlobStoreManagerService;->deleteBlobLocked(Lcom/android/server/blob/BlobMetadata;)V
    ...
    invoke-virtual/range {p1 .. p1}, Lcom/android/server/blob/BlobStoreSession;->getSessionFile()Ljava/io/File;

    move-result-object v0

    invoke-virtual {v0}, Ljava/io/File;->delete()Z

    iget-object v0, v1, Lcom/android/server/blob/BlobStoreManagerService;->mActiveBlobIds:Landroid/util/ArraySet;
    ...
    const-string v12, "Successfully committed session "
    ...
    new-instance v3, Lcom/android/server/blob/-$$Lambda$BlobStoreManagerService$3frkZPR_AQgwX8d7UH-6qOIAM74;

    invoke-direct {v3, v1, v2}, Lcom/android/server/blob/-$$Lambda$BlobStoreManagerService$3frkZPR_AQgwX8d7UH-6qOIAM74;-><init>(Lcom/android/server/blob/BlobStoreManagerService;Lcom/android/server/blob/BlobStoreSession;)V
...
.method private queryBlobsForUserInternal(I)Ljava/util/List;
    ...
    new-instance v3, Lcom/android/server/blob/-$$Lambda$BlobStoreManagerService$SymHWgpV-IAZS9iKc2BgJHU2rHM;

    invoke-direct {v3, p0, v2, p1}, Lcom/android/server/blob/-$$Lambda$BlobStoreManagerService$SymHWgpV-IAZS9iKc2BgJHU2rHM;-><init>(Lcom/android/server/blob/BlobStoreManagerService;Landroid/util/ArrayMap;I)V

    invoke-direct {p0, p1}, Lcom/android/server/blob/BlobStoreManagerService;->getUserBlobsLocked(I)Landroid/util/ArrayMap;

    move-result-object v4

    new-instance v5, Lcom/android/server/blob/-$$Lambda$BlobStoreManagerService$qEV9xl49VfIu-P3T8GwV1w5BMjU;

    invoke-direct {v5, v3, v0}, Lcom/android/server/blob/-$$Lambda$BlobStoreManagerService$qEV9xl49VfIu-P3T8GwV1w5BMjU;-><init>(Ljava/util/function/Function;Ljava/util/ArrayList;)V
...
.method private readBlobsInfoLocked(Landroid/util/SparseArray;)V
    ...
    invoke-virtual {v5, v6}, Lcom/android/server/blob/BlobMetadata;->removeInvalidCommitters(Landroid/util/SparseArray;)V

    invoke-virtual {v5, v6}, Lcom/android/server/blob/BlobMetadata;->removeInvalidLeasees(Landroid/util/SparseArray;)V
...
.method private releaseLeaseInternal(Landroid/app/blob/BlobHandle;ILjava/lang/String;)V
    ...
    :cond_0
    invoke-virtual {v2}, Lcom/android/server/blob/BlobMetadata;->hasLeases()Z
    ...
    new-instance v4, Lcom/android/server/blob/-$$Lambda$BlobStoreManagerService$9PfekqbRJVjWE_uPM40krWQmsqc;

    invoke-direct {v4, p0, v1, p1, v2}, Lcom/android/server/blob/-$$Lambda$BlobStoreManagerService$9PfekqbRJVjWE_uPM40krWQmsqc;-><init>(Lcom/android/server/blob/BlobStoreManagerService;Landroid/util/ArrayMap;Landroid/app/blob/BlobHandle;Lcom/android/server/blob/BlobMetadata;)V
...
.method getTotalUsageBytesLocked(ILjava/lang/String;)J
    ...
    new-instance v1, Lcom/android/server/blob/-$$Lambda$BlobStoreManagerService$xiorOw-VwaFgfqBbCJzEIZAec9E;

    invoke-direct {v1, p2, p1, v0}, Lcom/android/server/blob/-$$Lambda$BlobStoreManagerService$xiorOw-VwaFgfqBbCJzEIZAec9E;-><init>(Ljava/lang/String;ILjava/util/concurrent/atomic/AtomicLong;)V
...
.method handleIdleMaintenanceLocked()V
    ...
    new-instance v8, Lcom/android/server/blob/-$$Lambda$BlobStoreManagerService$Rs23KvXj2DJGs0OoSoc36nC1mWY;

    invoke-direct {v8, p0, v0}, Lcom/android/server/blob/-$$Lambda$BlobStoreManagerService$Rs23KvXj2DJGs0OoSoc36nC1mWY;-><init>(Lcom/android/server/blob/BlobStoreManagerService;Ljava/util/ArrayList;)V
    ...
    new-instance v7, Lcom/android/server/blob/-$$Lambda$BlobStoreManagerService$4LN0rBK2560vmid0r4iM6XUubrs;

    invoke-direct {v7, p0, v0}, Lcom/android/server/blob/-$$Lambda$BlobStoreManagerService$4LN0rBK2560vmid0r4iM6XUubrs;-><init>(Lcom/android/server/blob/BlobStoreManagerService;Ljava/util/ArrayList;)V
...
.method handlePackageRemoved(Ljava/lang/String;I)V
    ...
    new-instance v2, Lcom/android/server/blob/-$$Lambda$BlobStoreManagerService$prXFZlsTKnYXYnH3B-ig-XEG1cs;

    invoke-direct {v2, p0, p2, p1}, Lcom/android/server/blob/-$$Lambda$BlobStoreManagerService$prXFZlsTKnYXYnH3B-ig-XEG1cs;-><init>(Lcom/android/server/blob/BlobStoreManagerService;ILjava/lang/String;)V
    ...
    new-instance v4, Lcom/android/server/blob/-$$Lambda$BlobStoreManagerService$5313WA4sRJjWHGH12BRJUiBrCDA;

    invoke-direct {v4, p0, p1, p2}, Lcom/android/server/blob/-$$Lambda$BlobStoreManagerService$5313WA4sRJjWHGH12BRJUiBrCDA;-><init>(Lcom/android/server/blob/BlobStoreManagerService;Ljava/lang/String;I)V
...
.method public synthetic lambda$handleIdleMaintenanceLocked$10$BlobStoreManagerService(Ljava/util/ArrayList;Ljava/util/Map$Entry;)Z
    .locals 4
...
.method public synthetic lambda$handleIdleMaintenanceLocked$11$BlobStoreManagerService(Ljava/util/ArrayList;JLcom/android/server/blob/BlobStoreSession;)Z
    .locals 4
    ...
    invoke-virtual {p4}, Lcom/android/server/blob/BlobStoreSession;->getSessionFile()Ljava/io/File;
...
.method public synthetic lambda$handlePackageRemoved$8$BlobStoreManagerService(ILjava/lang/String;JLcom/android/server/blob/BlobStoreSession;)Z
    .locals 3
    ...
    invoke-virtual {p5}, Lcom/android/server/blob/BlobStoreSession;->getSessionFile()Ljava/io/File;
    ...
    invoke-virtual {p5}, Lcom/android/server/blob/BlobStoreSession;->getSessionId()J
...
.method public synthetic lambda$handlePackageRemoved$9$BlobStoreManagerService(Ljava/lang/String;ILjava/util/Map$Entry;)Z
    .locals 3
...
.method public synthetic lambda$onStateChangedInternal$7$BlobStoreManagerService(Lcom/android/server/blob/BlobStoreSession;)V
    .locals 2
...
.method public synthetic lambda$queryBlobsForUserInternal$2$BlobStoreManagerService(Landroid/util/ArrayMap;ILjava/lang/String;)Landroid/content/res/Resources;
    .locals 3
...
.method public synthetic lambda$releaseLeaseInternal$1$BlobStoreManagerService(Landroid/util/ArrayMap;Landroid/app/blob/BlobHandle;Lcom/android/server/blob/BlobMetadata;)V
    .locals 2
