...
.method public run()V
    ...
    iget v2, v1, Lcom/android/server/notification/NotificationManagerService$17;->val$callingUid:I

    iget v3, v1, Lcom/android/server/notification/NotificationManagerService$17;->val$callingPid:I

    iget-object v4, v1, Lcom/android/server/notification/NotificationManagerService$17;->val$pkg:Ljava/lang/String;

    iget v5, v1, Lcom/android/server/notification/NotificationManagerService$17;->val$userId:I

    iget v6, v1, Lcom/android/server/notification/NotificationManagerService$17;->val$mustHaveFlags:I

    iget v7, v1, Lcom/android/server/notification/NotificationManagerService$17;->val$mustNotHaveFlags:I
    ...
    iget-boolean v0, v1, Lcom/android/server/notification/NotificationManagerService$17;->val$doit:Z
    ...
    :try_start_0
    iget v0, v1, Lcom/android/server/notification/NotificationManagerService$17;->val$mustHaveFlags:I

    iget v3, v1, Lcom/android/server/notification/NotificationManagerService$17;->val$mustNotHaveFlags:I

    new-instance v4, Lcom/android/server/notification/-$$Lambda$NotificationManagerService$17$BB0ugLT6RGseF7yOjd2pLimTn-I;

    invoke-direct {v4, v0, v3}, Lcom/android/server/notification/-$$Lambda$NotificationManagerService$17$BB0ugLT6RGseF7yOjd2pLimTn-I;-><init>(II)V
    ...
    iget v12, v1, Lcom/android/server/notification/NotificationManagerService$17;->val$callingUid:I

    iget v13, v1, Lcom/android/server/notification/NotificationManagerService$17;->val$callingPid:I

    iget-object v14, v1, Lcom/android/server/notification/NotificationManagerService$17;->val$pkg:Ljava/lang/String;

    const/4 v15, 0x1

    iget-object v0, v1, Lcom/android/server/notification/NotificationManagerService$17;->val$channelId:Ljava/lang/String;
    ...
    invoke-static/range {v10 .. v23}, Lcom/android/server/notification/NotificationManagerService;->access$12000(Lcom/android/server/notification/NotificationManagerService;Ljava/util/ArrayList;IILjava/lang/String;ZLjava/lang/String;Lcom/android/server/notification/NotificationManagerService$FlagChecker;ZIZILjava/lang/String;Z)V
    ...
    iget-object v6, v1, Lcom/android/server/notification/NotificationManagerService$17;->val$pkg:Ljava/lang/String;

    const/16 v29, 0x1

    iget-object v7, v1, Lcom/android/server/notification/NotificationManagerService$17;->val$channelId:Ljava/lang/String;

    const/16 v32, 0x0

    iget v8, v1, Lcom/android/server/notification/NotificationManagerService$17;->val$userId:I

    const/16 v34, 0x0

    iget v10, v1, Lcom/android/server/notification/NotificationManagerService$17;->val$reason:I
    ...
    invoke-static/range {v24 .. v37}, Lcom/android/server/notification/NotificationManagerService;->access$12000(Lcom/android/server/notification/NotificationManagerService;Ljava/util/ArrayList;IILjava/lang/String;ZLjava/lang/String;Lcom/android/server/notification/NotificationManagerService$FlagChecker;ZIZILjava/lang/String;Z)V
