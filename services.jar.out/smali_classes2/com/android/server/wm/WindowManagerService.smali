...
.method public mirrorDisplay(ILandroid/view/SurfaceControl;)Z
    ...
    invoke-virtual {p2, v0}, Landroid/view/SurfaceControl;->copyFrom(Landroid/view/SurfaceControl;)V
...
.method public relayoutWindow(Lcom/android/server/wm/Session;Landroid/view/IWindow;ILandroid/view/WindowManager$LayoutParams;IIIIJLandroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/view/DisplayCutout$ParcelableWrapper;Landroid/util/MergedConfiguration;Landroid/view/SurfaceControl;Landroid/view/InsetsState;[Landroid/view/InsetsSourceControl;Landroid/graphics/Point;Landroid/view/SurfaceControl;)I
    ...
    iget v0, v3, Lcom/android/server/wm/WindowState;->mSystemUiVisibility:I
...
.method stopFreezingDisplayLocked()V
    ...
    :cond_3
    sget-boolean v7, Lcom/android/server/protolog/ProtoLog$Cache;->WM_DEBUG_ORIENTATION_enabled:Z
    ...
    invoke-static {v7, v8, v3, v6, v9}, Lcom/android/server/protolog/ProtoLogImpl;->d(Lcom/android/server/protolog/common/IProtoLogGroup;IILjava/lang/String;[Ljava/lang/Object;)V
    ...
    invoke-static {v10, v11, v3, v13, v12}, Lcom/android/server/protolog/ProtoLogImpl;->i(Lcom/android/server/protolog/common/IProtoLogGroup;IILjava/lang/String;[Ljava/lang/Object;)V
    ...
    sget-boolean v11, Lcom/android/server/protolog/ProtoLog$Cache;->WM_DEBUG_ORIENTATION_enabled:Z

    if-eqz v11, :cond_a

    sget-object v11, Lcom/android/server/wm/ProtoLogGroup;->WM_DEBUG_ORIENTATION:Lcom/android/server/wm/ProtoLogGroup;

    const v12, 0x616d601a

    move-object v13, v6

    check-cast v13, [Ljava/lang/Object;

    invoke-static {v11, v12, v3, v6, v13}, Lcom/android/server/protolog/ProtoLogImpl;->i(Lcom/android/server/protolog/common/IProtoLogGroup;IILjava/lang/String;[Ljava/lang/Object;)V
    ...
    iget v13, v0, Lcom/android/server/wm/WindowManagerService;->mEnterAnimId:I

    invoke-virtual {v11, v12, v13, v3}, Lcom/android/server/wm/DisplayRotation;->validateRotationAnimation(IIZ)Z
    ...
    iget v11, v15, Landroid/view/DisplayInfo;->logicalWidth:I

    iget v2, v15, Landroid/view/DisplayInfo;->logicalHeight:I

    iget v3, v0, Lcom/android/server/wm/WindowManagerService;->mExitAnimId:I

    iget v6, v0, Lcom/android/server/wm/WindowManagerService;->mEnterAnimId:I
    ...
    invoke-virtual {v1, v2}, Lcom/android/server/wm/DisplayContent;->setRotationAnimation(Lcom/android/server/wm/IScreenRotationAnimation;)V
    ...
    invoke-virtual {v3, v6, v11, v12}, Lcom/android/server/wm/WindowManagerService$H;->sendEmptyMessageDelayed(IJ)Z
    ...
    invoke-static {v3, v6, v13, v11, v12}, Lcom/android/server/protolog/ProtoLogImpl;->d(Lcom/android/server/protolog/common/IProtoLogGroup;IILjava/lang/String;[Ljava/lang/Object;)V
    ...
    invoke-static {v3}, Lcom/android/server/wm/OnePlusPerfManagerInjector;->screenFrozenBoost(Z)V
    ...
    invoke-static {v12, v13, v14, v0, v15}, Lcom/android/server/protolog/ProtoLogImpl;->d(Lcom/android/server/protolog/common/IProtoLogGroup;IILjava/lang/String;[Ljava/lang/Object;)V
