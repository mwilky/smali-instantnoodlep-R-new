...
.method checkCompleteDeferredRemoval()Z
    ...
    :cond_0
    iget-boolean v0, p0, Lcom/android/server/wm/ActivityStack;->mDeferRemoval:Z

    if-eqz v0, :cond_1

    invoke-virtual {p0}, Lcom/android/server/wm/ActivityStack;->removeImmediately()V

    :cond_1
    invoke-super {p0}, Lcom/android/server/wm/Task;->checkCompleteDeferredRemoval()Z
...
.method dump(Ljava/io/PrintWriter;Ljava/lang/String;Z)V
    ...
    const-string v1, "mDeferRemoval=true"
...
.method public dumpDebug(Landroid/util/proto/ProtoOutputStream;JI)V
    ...
    iget-boolean v4, p0, Lcom/android/server/wm/ActivityStack;->mDeferRemoval:Z
...
.method final moveTaskToFront(Lcom/android/server/wm/Task;ZLandroid/app/ActivityOptions;Lcom/android/server/am/AppTimeTracker;ZLjava/lang/String;)V
    ...
    sget-object v5, Lcom/android/server/wm/-$$Lambda$Q7nS26dC0McEbKsdlJZMFVXDNKY;->INSTANCE:Lcom/android/server/wm/-$$Lambda$Q7nS26dC0McEbKsdlJZMFVXDNKY;
    ...
    invoke-static {v5, v6, p4}, Lcom/android/internal/util/function/pooled/PooledLambda;->obtainConsumer(Ljava/util/function/BiConsumer;Lcom/android/internal/util/function/pooled/ArgumentPlaceholder;Ljava/lang/Object;)Lcom/android/internal/util/function/pooled/PooledConsumer;

    move-result-object v5

    invoke-virtual {p1, v5}, Lcom/android/server/wm/Task;->forAllActivities(Ljava/util/function/Consumer;)V
    ...
    invoke-virtual {v5}, Lcom/android/server/wm/DisplayContent;->deferUpdateImeTarget()V

    invoke-virtual {p0, p1}, Lcom/android/server/wm/ActivityStack;->positionChildAtTop(Lcom/android/server/wm/Task;)V
    ...
    invoke-virtual {v5}, Lcom/android/server/wm/ActivityRecord;->okToShowLocked()Z
    ...
    invoke-virtual {v6, p6}, Lcom/android/server/wm/ActivityRecord;->moveFocusableActivityToTop(Ljava/lang/String;)Z
    ...
    invoke-virtual {v1, v4, v4}, Lcom/android/server/wm/DisplayContent;->prepareAppTransition(IZ)V
    ...
    :goto_2
    invoke-direct {p0, v3, p1, v2, p3}, Lcom/android/server/wm/ActivityStack;->canEnterPipOnTaskSwitch(Lcom/android/server/wm/ActivityRecord;Lcom/android/server/wm/Task;Lcom/android/server/wm/ActivityRecord;Landroid/app/ActivityOptions;)Z
    ...
    iput-boolean v1, v3, Lcom/android/server/wm/ActivityRecord;->supportsEnterPipOnTaskSwitch:Z
    ...
    invoke-static {v1, v2}, Lcom/android/server/wm/EventLogTags;->writeWmTaskToFront(II)V
...
.method startActivityLocked(Lcom/android/server/wm/ActivityRecord;Lcom/android/server/wm/ActivityRecord;ZZLandroid/app/ActivityOptions;)V
    ...
    invoke-virtual {v0, v6}, Lcom/android/server/wm/ActivityStack;->hasChild(Lcom/android/server/wm/WindowContainer;)Z
    ...
    :cond_4
    invoke-virtual {v0, v6}, Lcom/android/server/wm/ActivityStack;->positionChildAtTop(Lcom/android/server/wm/Task;)V
    ...
    sget-boolean v7, Lcom/android/server/wm/ActivityTaskManagerDebugConfig;->DEBUG_ADD_REMOVE:Z
    ...
    invoke-static {v14, v7, v8}, Landroid/util/Slog;->i(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)I
    ...
    iget-object v8, v0, Lcom/android/server/wm/ActivityStack;->mChildren:Lcom/android/server/wm/WindowList;

    invoke-virtual {v8, v11}, Lcom/android/server/wm/WindowList;->indexOf(Ljava/lang/Object;)I
    ...
    iput-boolean v8, v6, Lcom/android/server/wm/ActivityStackSupervisor;->mUserLeaving:Z

    sget-boolean v6, Lcom/android/server/wm/ActivityTaskManagerDebugConfig;->DEBUG_USER_LEAVING:Z

    if-eqz v6, :cond_9

    const-string v6, "startActivity() behind front, mUserLeaving=false"
    ...
    sget-boolean v8, Lcom/android/server/wm/ActivityTaskManagerDebugConfig;->DEBUG_ADD_REMOVE:Z
    ...
    const-string v11, " to stack to task "
    ...
    invoke-static {v14, v8, v11}, Landroid/util/Slog;->i(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)I

    :cond_a
    invoke-virtual {v6, v1}, Lcom/android/server/wm/Task;->positionChildAtTop(Lcom/android/server/wm/ActivityRecord;)V

    sget-object v8, Lcom/android/server/wm/ActivityStack;->mActivityPluginDelegate:Lcom/android/server/wm/ActivityPluginDelegate;

    if-eqz v8, :cond_b

    iget-object v8, v1, Lcom/android/server/wm/ActivityRecord;->info:Landroid/content/pm/ActivityInfo;
    ...
    invoke-static {v8, v11}, Lcom/android/server/wm/ActivityPluginDelegate;->activityInvokeNotification(Ljava/lang/String;Z)V
    ...
    iget-object v8, v8, Lcom/android/server/wm/DisplayContent;->mDisplayContent:Lcom/android/server/wm/DisplayContent;
    ...
    invoke-virtual {v8, v11, v4}, Lcom/android/server/wm/DisplayContent;->prepareAppTransition(IZ)V
    ...
    invoke-virtual {v13}, Lcom/android/server/wm/DisplayContent;->isSingleTaskInstance()Z
    ...
    :cond_10
    invoke-direct {v0, v2, v12, v1, v5}, Lcom/android/server/wm/ActivityStack;->canEnterPipOnTaskSwitch(Lcom/android/server/wm/ActivityRecord;Lcom/android/server/wm/Task;Lcom/android/server/wm/ActivityRecord;Landroid/app/ActivityOptions;)Z
    ...
    invoke-virtual {v0, v12, v7, v7}, Lcom/android/server/wm/ActivityStack;->ensureActivitiesVisible(Lcom/android/server/wm/ActivityRecord;IZ)V
    ...
    :cond_17
    iget-boolean v13, v12, Lcom/android/server/wm/ActivityRecord;->nowVisible:Z
    ...
    invoke-virtual {v1, v12, v3, v13}, Lcom/android/server/wm/ActivityRecord;->showStartingWindow(Lcom/android/server/wm/ActivityRecord;ZZ)V
