...
.method public static asInterface(Landroid/os/IHwBinder;)Lvendor/oneplus/hardware/display/V1_0/IOneplusDisplay;
    ...
    :cond_1
    new-instance v3, Lvendor/oneplus/hardware/display/V1_0/IOneplusDisplay$Proxy;

    invoke-direct {v3, p0}, Lvendor/oneplus/hardware/display/V1_0/IOneplusDisplay$Proxy;-><init>(Landroid/os/IHwBinder;)V

    :try_start_0
    invoke-interface {v3}, Lvendor/oneplus/hardware/display/V1_0/IOneplusDisplay;->interfaceChain()Ljava/util/ArrayList;
...
.method public abstract setHbmBrightness(I)V
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
        }
...
.method public abstract toneColorGamut(Lvendor/oneplus/hardware/display/V1_0/ColorGamut;)V
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
        }
