...
.method public constructor <init>(Landroid/content/Context;Landroid/net/Uri;)V
    ...
    const-string p2, "No content URI"
...
.method private addReusedBitmap(Landroid/graphics/Bitmap;)V
    ...
    const-string p1, "addReusedBitmap() - quit already"
    ...
    const-string p1, "addReusedBitmap() - bitmap is null"
...
.method private decodeGifAsync()V
    ...
    const-string v0, "decodeGifAsync() - end "

    invoke-static {v5, v0}, Lcom/oneplus/base/Log;->d(Ljava/lang/String;Ljava/lang/String;)V
...
.method private decodeMovieAsync()Landroid/graphics/Movie;
    ...
    invoke-static {v0, v3, v2}, Lcom/oneplus/base/Log;->e(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V

    :cond_3
    :goto_1
    const-string v2, "decodeMovieAsync() - end"
...
.method private getABitmapForDecode(Landroid/graphics/Bitmap;)Landroid/graphics/Bitmap;
    ...
    const-string p1, "getABitmapForDecode() - get a null bitmap from queue."
    ...
    const-string v1, "getABitmapForDecode() - time to quit,bitmap:"
...
.method private loadFile()Z
    ...
    iget-object v1, p0, Lcom/oneplus/drawable/MovieDrawable;->m_Source:Ljava/lang/Object;
...
.method private onMovieDecoded(Landroid/graphics/Movie;)V
    ...
    const-string v1, "onMovieDecoded() - Failed."
...
.method private updateForGifDecoder(Landroid/graphics/Bitmap;)V
    ...
    const-string v0, "updateForGifDecoder() - bitmap is null."
...
.method public isTheSameSource(Landroid/net/Uri;)Z
    ...
    const-string v0, "isTheSameSource() - uri is null."
...
.method public isTheSameSource(Ljava/lang/String;)Z
    ...
    const-string v0, "isTheSameSource() - path is null."
...
.method public setVisible(ZZ)Z
    ...
    iget-object p1, p0, Lcom/oneplus/drawable/MovieDrawable;->m_Handler:Landroid/os/Handler;
