...
.method private extractXMPSegment()V
    ...
    sget-object v1, Lcom/oneplus/media/JfifImage;->TAG:Ljava/lang/String;

    const-string v2, "extractXMPSegment() - Fail to extract XMP segment"
...
.method private isXMPSegment(Lcom/oneplus/media/JfifSegment;)Z
    ...
    :cond_0
    iget-object v1, p1, Lcom/oneplus/media/JfifSegment;->data:[B
    ...
    const-string v1, "isXMPSegment() - Fail to check XMP segment"
...
.method private read(Ljava/io/InputStream;)Z
    ...
    const-string v2, "read() - Incorrect start of segment"
    ...
    const-string v2, "read() - Unexcepted EOF when reading segment"
    ...
    iget-object v3, p0, Lcom/oneplus/media/JfifImage;->m_CompressedImageData:[B
    ...
    const-string v2, "read() - Invalid length bits in segment"
    ...
    const-string v2, "read() - Incorrect start of JFIF data"
    ...
    const-string v2, "read() - Parse failed"
...
.method public getCompressedImageData()[B
    ...
    const-string v1, "JfifImage is closed"
...
.method public setXMPProperty(Lcom/oneplus/media/XMPPropertyKey;Ljava/lang/Object;)V
    ...
    iget-object p2, p0, Lcom/oneplus/media/JfifImage;->m_SimpleXMPContainer:Lcom/oneplus/media/SimpleXMPContainer;

    invoke-virtual {p2, p1}, Lcom/oneplus/media/SimpleXMPContainer;->deleteProperty(Lcom/oneplus/media/XMPPropertyKey;)V
...
.method public write(Ljava/io/OutputStream;)Z
    ...
    const-string v1, "write() - Error to write image"
