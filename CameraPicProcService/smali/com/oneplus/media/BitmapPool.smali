...
.method public constructor <init>(Ljava/lang/String;JJLandroid/graphics/Bitmap$Config;II)V
    ...
    const-string p2, "Cannot use both FLAG_NO_EMBEDDED_THUMB and FLAG_USE_EMBEDDED_THUMB_ONLY flags."
    ...
    const-string p3, "Invalid decoding count : "
    ...
    const-string p2, "No bitmap configuration"
    ...
    const-string p3, "Invalid idle capacity : "
    ...
    const-string p5, "Invalid capacity : "
...
.method private callOnBitmapDecoded(Lcom/oneplus/media/BitmapPool$DecodingHandle;Z)V
    ...
    iget-object v0, p1, Lcom/oneplus/media/BitmapPool$DecodingHandle;->periodicHandler:Lcom/oneplus/media/BitmapPool$PeriodicCallbackHandler;
    ...
    :cond_5
    iget-object p1, p1, Lcom/oneplus/media/BitmapPool$DecodingHandle;->periodicHandler:Lcom/oneplus/media/BitmapPool$PeriodicCallbackHandler;

    invoke-virtual {p1, p2}, Lcom/oneplus/media/BitmapPool$PeriodicCallbackHandler;->schedule(Ljava/lang/Runnable;)V

    goto :goto_1

    :cond_6
    iget-object p2, p0, Lcom/oneplus/media/BitmapPool;->m_Lock:Ljava/lang/Object;

    monitor-enter p2

    :try_start_0
    iget-boolean v2, v0, Lcom/oneplus/media/BitmapPool$BitmapInfo;->isValid:Z

    if-eqz v2, :cond_8

    iget-object v2, v0, Lcom/oneplus/media/BitmapPool$BitmapInfo;->source:Ljava/lang/Object;

    instance-of v2, v2, Ljava/lang/String;

    if-eqz v2, :cond_7

    iget-object v2, p1, Lcom/oneplus/media/BitmapPool$DecodingHandle;->callback:Lcom/oneplus/media/BitmapPool$Callback;

    iget-object v0, v0, Lcom/oneplus/media/BitmapPool$BitmapInfo;->source:Ljava/lang/Object;

    check-cast v0, Ljava/lang/String;

    invoke-virtual {v2, p1, v0, v1}, Lcom/oneplus/media/BitmapPool$Callback;->onBitmapDecoded(Lcom/oneplus/base/Handle;Ljava/lang/String;Landroid/graphics/Bitmap;)V
    ...
    invoke-virtual {v2, p1, v0, v1}, Lcom/oneplus/media/BitmapPool$Callback;->onBitmapDecoded(Lcom/oneplus/base/Handle;Landroid/net/Uri;Landroid/graphics/Bitmap;)V

    :cond_8
    :goto_0
    const/4 v0, 0x0

    iput-object v0, p1, Lcom/oneplus/media/BitmapPool$DecodingHandle;->bitmapInfo:Lcom/oneplus/media/BitmapPool$BitmapInfo;
...
.method private decode(Landroid/content/Context;Ljava/lang/Object;IIIILcom/oneplus/media/BitmapPool$Callback;Landroid/os/Handler;)Lcom/oneplus/base/Handle;
    ...
    iget-object v0, v8, Lcom/oneplus/media/BitmapPool;->TAG:Ljava/lang/String;
    ...
    iget-object v3, v8, Lcom/oneplus/media/BitmapPool;->TAG:Ljava/lang/String;
    ...
    :goto_1
    iget-object v9, v8, Lcom/oneplus/media/BitmapPool;->m_Lock:Ljava/lang/Object;

    monitor-enter v9

    :try_start_0
    iget-object v1, v8, Lcom/oneplus/media/BitmapPool;->m_BitmapInfos:Ljava/util/Hashtable;
    ...
    iget-object v1, v8, Lcom/oneplus/media/BitmapPool;->m_PendingDecodingQueue:Ljava/util/LinkedList;
    ...
    :cond_6
    iget-object v1, v8, Lcom/oneplus/media/BitmapPool;->m_DecodingExecutor:Ljava/util/concurrent/Executor;

    iget-object v2, v8, Lcom/oneplus/media/BitmapPool;->m_DecodingRunnable:Ljava/lang/Runnable;
    ...
    :cond_9
    invoke-direct {p0, v0, v11}, Lcom/oneplus/media/BitmapPool;->callOnBitmapDecoded(Lcom/oneplus/media/BitmapPool$DecodingHandle;Z)V
    ...
    iget-object v2, v8, Lcom/oneplus/media/BitmapPool;->m_BitmapInfos:Ljava/util/Hashtable;
    ...
    iget-object v0, v8, Lcom/oneplus/media/BitmapPool;->m_ContentResolver:Landroid/content/ContentResolver;
    ...
    iput-object v0, v8, Lcom/oneplus/media/BitmapPool;->m_ContentResolver:Landroid/content/ContentResolver;
...
.method private decodeBitmap(Lcom/oneplus/media/BitmapPool$BitmapInfo;)V
    ...
    const-string v2, "decodeBitmap() - Unknown source : "
...
.method private getCachedBitmap(Ljava/lang/Object;)Landroid/graphics/Bitmap;
    ...
    iget-boolean v2, p1, Lcom/oneplus/media/BitmapPool$BitmapInfo;->isDecoding:Z

    if-nez v2, :cond_1

    iget-object p1, p1, Lcom/oneplus/media/BitmapPool$BitmapInfo;->bitmap:Landroid/graphics/Bitmap;
...
.method private invalidate(Ljava/lang/Object;)V
    ...
    iget-object v1, p0, Lcom/oneplus/media/BitmapPool;->m_DecodingRunnable:Ljava/lang/Runnable;
...
.method private removeFromQueue(Lcom/oneplus/media/BitmapPool$BitmapInfo;)V
    ...
    iput-object v0, p1, Lcom/oneplus/media/BitmapPool$BitmapInfo;->previous:Lcom/oneplus/media/BitmapPool$BitmapInfo;
...
.method protected decodeVideo(Landroid/content/ContentResolver;Landroid/net/Uri;II)Landroid/graphics/Bitmap;
    ...
    invoke-virtual {p2, v1}, Landroid/media/MediaMetadataRetriever;->setDataSource(Ljava/io/FileDescriptor;)V
    ...
    invoke-virtual {p2, v1, v2}, Landroid/media/MediaMetadataRetriever;->getFrameAtTime(J)Landroid/graphics/Bitmap;
...
.method protected decodeVideo(Ljava/lang/String;II)Landroid/graphics/Bitmap;
    ...
    :goto_0
    invoke-static {p1, p2, p3}, Lcom/oneplus/media/ImageUtils;->createThumbnailImage(Landroid/graphics/Bitmap;II)Landroid/graphics/Bitmap;
