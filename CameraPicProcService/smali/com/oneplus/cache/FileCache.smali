...
.method private final checkSize(J)Z
    ...
    iget-wide p1, p0, Lcom/oneplus/cache/FileCache;->capacity:J
    :try_end_0
...
.method private final completeAccess(Lcom/oneplus/cache/FileCache$FileAccess;)V
    ...
    const-string v3, "completeAccess() - Failed to delete file for "
...
.method private final createEmptyFile(Z)Ljava/io/File;
    ...
    sget-object v2, Lcom/oneplus/cache/FileCache;->TAG:Ljava/lang/String;
...
.method private final removeEntry(Lcom/oneplus/cache/FileCache$CacheEntry;)V
    ...
    invoke-virtual {p1, v0}, Lcom/oneplus/cache/FileCache$CacheEntry;->setValid(Z)V
...
.method private final touch()V
    ...
    invoke-virtual {v5}, Lcom/oneplus/cache/FileCache$CacheEntry;->getKey()Ljava/io/Serializable;

    move-result-object v6

    invoke-virtual {v3, v6}, Ljava/io/ObjectOutputStream;->writeObject(Ljava/lang/Object;)V

    invoke-virtual {v5}, Lcom/oneplus/cache/FileCache$CacheEntry;->getFile()Ljava/io/File;
    ...
    invoke-virtual {v3, v6}, Ljava/io/ObjectOutputStream;->writeUTF(Ljava/lang/String;)V

    invoke-virtual {v5}, Lcom/oneplus/cache/FileCache$CacheEntry;->getNextEntry()Lcom/oneplus/cache/FileCache$CacheEntry;
    ...
    const-string v2, "touch() - Failed to save state"
...
.method public final add(Ljava/io/Serializable;Ljava/io/File;Z)Z
    ...
    const-string v2, "add() - Failed to remove current entry for "
    ...
    const-string p3, "add() - Failed to add file by copying"
    ...
    const-string p3, "add() - Failed to delete temporary file "
