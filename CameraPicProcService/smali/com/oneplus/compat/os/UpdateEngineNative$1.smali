...
.method public onPayloadApplicationComplete(I)V
    ...
    iget-object v0, p0, Lcom/oneplus/compat/os/UpdateEngineNative$1;->val$callbackNative:Lcom/oneplus/compat/os/UpdateEngineCallbackNative;

    invoke-virtual {v0, p1}, Lcom/oneplus/compat/os/UpdateEngineCallbackNative;->onPayloadApplicationComplete(I)V
...
.method public onStatusUpdate(IF)V
    ...
    invoke-virtual {v0, p1, p2}, Lcom/oneplus/compat/os/UpdateEngineCallbackNative;->onStatusUpdate(IF)V
