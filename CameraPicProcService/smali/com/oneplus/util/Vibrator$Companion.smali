...
.method private final enable(Lcom/oneplus/util/Vibrator$Companion$DisableVibratorHandle;)V
    ...
    check-cast v0, Lcom/oneplus/util/Vibrator$Companion;

    invoke-direct {v0}, Lcom/oneplus/util/Vibrator$Companion;->verifyAccess()V
    ...
    const-string v0, "enable() - Enable, remaining counts : "
...
.method public final disable()Lcom/oneplus/base/Handle;
    ...
    new-instance v0, Lcom/oneplus/util/Vibrator$Companion$DisableVibratorHandle;

    invoke-direct {v0}, Lcom/oneplus/util/Vibrator$Companion$DisableVibratorHandle;-><init>()V
    ...
    const-string v2, "disable() - Disable, remaining counts : "
...
.method public final vibrate(Landroid/content/Context;II)Z
    ...
    const-string p1, "vibrate() - Vibration is disabled"

    invoke-static {v4, p1}, Lcom/oneplus/base/Log;->w(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v4, p3}, Lcom/oneplus/base/Log;->d(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct {v0, p1}, Lcom/oneplus/util/Vibrator$Companion;->initForSupportedOS1(Landroid/content/Context;)V
    ...
    invoke-direct {v0}, Lcom/oneplus/util/Vibrator$Companion;->getVibrationThread()Lcom/oneplus/base/HandlerThread;
    ...
    new-instance p3, Lcom/oneplus/util/Vibrator$Companion$vibrate$1;

    invoke-direct {p3, v1, v2, p2}, Lcom/oneplus/util/Vibrator$Companion$vibrate$1;-><init>(JI)V

    check-cast p3, Lkotlin/jvm/functions/Function0;

    invoke-virtual {p1, p3}, Lcom/oneplus/threading/Dispatcher;->post(Lkotlin/jvm/functions/Function0;)J
    ...
    invoke-direct {v0, p1}, Lcom/oneplus/util/Vibrator$Companion;->init(Landroid/content/Context;)V
    ...
    new-instance p3, Lcom/oneplus/util/Vibrator$Companion$vibrate$2;

    invoke-direct {p3, v1, v2, p2}, Lcom/oneplus/util/Vibrator$Companion$vibrate$2;-><init>(JI)V
