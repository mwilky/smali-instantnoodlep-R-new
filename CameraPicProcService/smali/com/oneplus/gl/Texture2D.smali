...
.method public constructor <init>(I)V
    ...
    const-string v0, "Incorrect texture id for texture"
...
.method public constructor <init>(Landroid/content/Context;I)V
    ...
    const-string p2, "No context for texture"
...
.method public constructor <init>(Landroid/graphics/Bitmap;)V
    ...
    const-string v0, "No source bitmap for texture"
...
.method public constructor <init>(Landroid/graphics/drawable/Drawable;)V
    ...
    const-string v0, "No source drawable for texture"
...
.method public readPixels(IIIILjava/nio/ByteBuffer;)Z
    ...
    const-string v3, "readPixels() - Insufficient buffer size: "
    ...
    iget-object v7, v0, Lcom/oneplus/gl/Texture2D;->m_Format:Lcom/oneplus/gl/Texture2D$Format;

    invoke-virtual {v7}, Lcom/oneplus/gl/Texture2D$Format;->ordinal()I
    ...
    iget-object v3, v0, Lcom/oneplus/gl/Texture2D;->m_Format:Lcom/oneplus/gl/Texture2D$Format;
    ...
    const-string v5, "readPixels() - Invalid size to read: "
    ...
    :cond_8
    :goto_3
    iget-object v3, v0, Lcom/oneplus/gl/Texture2D;->TAG:Ljava/lang/String;

    new-instance v4, Ljava/lang/StringBuilder;

    invoke-direct {v4}, Ljava/lang/StringBuilder;-><init>()V

    const-string v7, "readPixels() - Invalid coordinates to read: ("
...
.method public refresh()Lcom/oneplus/gl/Texture2D;
    ...
    iget v0, v1, Lcom/oneplus/gl/Texture2D;->m_TextureId:I
    ...
    :cond_0
    iget-object v0, v1, Lcom/oneplus/gl/Texture2D;->m_Bitmap:Landroid/graphics/Bitmap;
    ...
    iget-object v4, v1, Lcom/oneplus/gl/Texture2D;->m_Bitmap:Landroid/graphics/Bitmap;
    ...
    iput-object v4, v1, Lcom/oneplus/gl/Texture2D;->m_Format:Lcom/oneplus/gl/Texture2D$Format;
    ...
    iget-object v3, v1, Lcom/oneplus/gl/Texture2D;->m_Bitmap:Landroid/graphics/Bitmap;
    ...
    :goto_1
    iget v0, v1, Lcom/oneplus/gl/Texture2D;->m_Width:I

    iget v4, v1, Lcom/oneplus/gl/Texture2D;->m_Height:I

    iget-object v8, v1, Lcom/oneplus/gl/Texture2D;->m_Bitmap:Landroid/graphics/Bitmap;
    ...
    iget v8, v1, Lcom/oneplus/gl/Texture2D;->m_Width:I

    int-to-float v8, v8

    div-float/2addr v8, v10

    iget v9, v1, Lcom/oneplus/gl/Texture2D;->m_Height:I

    int-to-float v9, v9

    div-float/2addr v9, v10

    invoke-virtual {v0, v3, v2, v8, v9}, Landroid/graphics/Canvas;->scale(FFFF)V

    iget-object v2, v1, Lcom/oneplus/gl/Texture2D;->m_Bitmap:Landroid/graphics/Bitmap;
    ...
    invoke-virtual {v0, v2, v3, v8, v9}, Landroid/graphics/Canvas;->drawBitmap(Landroid/graphics/Bitmap;FFLandroid/graphics/Paint;)V
    ...
    iget v0, v0, Lcom/oneplus/gl/Texture$Filter;->glConstant:I

    int-to-float v0, v0

    invoke-static {v15, v5, v0}, Landroid/opengl/GLES20;->glTexParameterf(IIF)V
    ...
    invoke-static {v15, v2, v0}, Landroid/opengl/GLES20;->glTexParameterf(IIF)V

    const/4 v0, 0x0

    invoke-static {v15, v0, v4, v0}, Landroid/opengl/GLUtils;->texImage2D(IILandroid/graphics/Bitmap;I)V
    ...
    :cond_6
    iget-object v0, v1, Lcom/oneplus/gl/Texture2D;->m_Drawable:Landroid/graphics/drawable/Drawable;

    if-eqz v0, :cond_8

    iget-object v4, v1, Lcom/oneplus/gl/Texture2D;->m_DrawableSize:Landroid/util/Size;
    ...
    iput v0, v1, Lcom/oneplus/gl/Texture2D;->m_Width:I

    iget-object v0, v1, Lcom/oneplus/gl/Texture2D;->m_DrawableSize:Landroid/util/Size;

    invoke-virtual {v0}, Landroid/util/Size;->getHeight()I

    move-result v0

    iput v0, v1, Lcom/oneplus/gl/Texture2D;->m_Height:I
    ...
    invoke-static {v0, v4, v9}, Landroid/graphics/Bitmap;->createBitmap(IILandroid/graphics/Bitmap$Config;)Landroid/graphics/Bitmap;
    ...
    iget v9, v1, Lcom/oneplus/gl/Texture2D;->m_Width:I

    int-to-float v9, v9

    div-float/2addr v9, v10

    iget v12, v1, Lcom/oneplus/gl/Texture2D;->m_Height:I

    int-to-float v12, v12

    div-float/2addr v12, v10

    invoke-virtual {v0, v3, v2, v9, v12}, Landroid/graphics/Canvas;->scale(FFFF)V

    iget-object v2, v1, Lcom/oneplus/gl/Texture2D;->m_Drawable:Landroid/graphics/drawable/Drawable;

    iget v3, v1, Lcom/oneplus/gl/Texture2D;->m_Width:I
    ...
    iget v0, v1, Lcom/oneplus/gl/Texture2D;->m_Height:I

    if-lez v0, :cond_d

    sget-object v0, Lcom/oneplus/gl/Texture2D$1;->$SwitchMap$com$oneplus$gl$Texture2D$Format:[I

    iget-object v2, v1, Lcom/oneplus/gl/Texture2D;->m_Format:Lcom/oneplus/gl/Texture2D$Format;
    ...
    iget-object v3, v1, Lcom/oneplus/gl/Texture2D;->m_Format:Lcom/oneplus/gl/Texture2D$Format;
    ...
    iget v2, v1, Lcom/oneplus/gl/Texture2D;->m_Height:I
