...
.method private onDeviceAttached(Landroid/hardware/usb/UsbDevice;)V
    ...
    iget-object p1, p0, Lcom/oneplus/io/UsbManagerImpl;->TAG:Ljava/lang/String;

    const-string v1, "onDeviceAttached() - Duplicate device"
...
.method private onDeviceDetached(Landroid/hardware/usb/UsbDevice;)V
    ...
    const-string v1, "onDeviceAttached() - Unknown device"
...
.method private onDeviceOpened(Landroid/hardware/usb/UsbDevice;Landroid/hardware/usb/UsbDeviceConnection;)V
    ...
    const-string v5, "onDeviceOpened() - Device : "
    ...
    check-cast v1, Lcom/oneplus/io/UsbManagerImpl$OpenDeviceHandle;

    invoke-virtual {v1, p2}, Lcom/oneplus/io/UsbManagerImpl$OpenDeviceHandle;->callOnOpened(Landroid/hardware/usb/UsbDeviceConnection;)V
    ...
    check-cast p2, Lcom/oneplus/io/UsbManagerImpl$OpenDeviceHandle;

    invoke-virtual {p2}, Lcom/oneplus/io/UsbManagerImpl$OpenDeviceHandle;->callOnFailed()V
...
.method private onPermissionRequested(Landroid/hardware/usb/UsbDevice;Z)V
    ...
    :cond_0
    iget-object v1, p0, Lcom/oneplus/io/UsbManagerImpl;->TAG:Ljava/lang/String;

    new-instance v2, Ljava/lang/StringBuilder;

    invoke-direct {v2}, Ljava/lang/StringBuilder;-><init>()V

    const-string v3, "onPermissionRequested() - Device : "
    ...
    iget-object v1, v0, Lcom/oneplus/io/UsbManagerImpl$DeviceInfo;->permissionRequests:Ljava/util/List;

    invoke-interface {v1, p2}, Ljava/util/List;->get(I)Ljava/lang/Object;

    move-result-object v1

    check-cast v1, Lcom/oneplus/io/UsbManagerImpl$PermissionRequestInfo;

    invoke-virtual {v1, p1}, Lcom/oneplus/io/UsbManagerImpl$PermissionRequestInfo;->callOnRequested(Landroid/hardware/usb/UsbDevice;)V
    ...
    invoke-virtual {v1, p1}, Lcom/oneplus/io/UsbManagerImpl$PermissionRequestInfo;->callOnRejected(Landroid/hardware/usb/UsbDevice;)V
    ...
    :cond_2
    iget-object p1, v0, Lcom/oneplus/io/UsbManagerImpl$DeviceInfo;->permissionRequests:Ljava/util/List;
...
.method public isDeviceOpened(Landroid/hardware/usb/UsbDevice;)Z
    ...
    check-cast p1, Lcom/oneplus/io/UsbManagerImpl$DeviceInfo;

    if-eqz p1, :cond_1

    iget-object p1, p1, Lcom/oneplus/io/UsbManagerImpl$DeviceInfo;->connection:Landroid/hardware/usb/UsbDeviceConnection;
...
.method protected onInitialize()V
    ...
    const-string v2, "onInitialize() - Fail to setup device list"
...
.method public openDevice(Landroid/hardware/usb/UsbDevice;Lcom/oneplus/io/UsbManager$OpenDeviceCallback;Landroid/os/Handler;I)Lcom/oneplus/base/Handle;
    ...
    const-string p2, "openDevice() - No device to open"
    ...
    const-string p2, "openDevice() - No call-back"
    ...
    const-string p3, "openDevice() - Unknown device : "
    ...
    const-string p2, "openDevice() - Use current connection"

    invoke-static {p1, p2}, Lcom/oneplus/base/Log;->v(Ljava/lang/String;Ljava/lang/String;)V

    iget-object p1, v0, Lcom/oneplus/io/UsbManagerImpl$DeviceInfo;->connection:Landroid/hardware/usb/UsbDeviceConnection;

    invoke-virtual {v1, p1}, Lcom/oneplus/io/UsbManagerImpl$OpenDeviceHandle;->callOnOpened(Landroid/hardware/usb/UsbDeviceConnection;)V
...
.method public requestPermission(Landroid/hardware/usb/UsbDevice;Lcom/oneplus/io/UsbManager$PermissionCallback;Landroid/os/Handler;I)V
    ...
    const-string p2, "requestPermission() - No device"
    ...
    const-string p3, "requestPermission() - Unknown device"
    ...
    const-string v0, "android.mtp.MtpClient.action.USB_PERMISSION"

    invoke-direct {p4, v0}, Landroid/content/Intent;-><init>(Ljava/lang/String;)V

    const/4 v0, 0x0

    invoke-static {p2, v0, p4, v0}, Landroid/app/PendingIntent;->getBroadcast(Landroid/content/Context;ILandroid/content/Intent;I)Landroid/app/PendingIntent;
