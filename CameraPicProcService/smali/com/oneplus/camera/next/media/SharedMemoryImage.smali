...
.method public isIncludedInJavaHeap()Z
    ...
    iget-boolean v0, p0, Lcom/oneplus/camera/next/media/SharedMemoryImage;->isIncludedInJavaHeap:Z
...
.method public isNative()Z
    ...
    iget-boolean v0, p0, Lcom/oneplus/camera/next/media/SharedMemoryImage;->isNative:Z
...
.method protected onRelease(Z)V
    ...
    invoke-virtual {v0}, Lcom/oneplus/camera/next/media/SharedMemoryImage$Plane;->getSharedMemory()Landroid/os/SharedMemory;

    move-result-object v1

    invoke-virtual {v1}, Landroid/os/SharedMemory;->close()V

    invoke-virtual {v0}, Lcom/oneplus/camera/next/media/SharedMemoryImage$Plane;->release()V
    ...
    const-string v0, "null cannot be cast to non-null type com.oneplus.camera.next.media.SharedMemoryImage.Plane"
...
.method public writeToParcel(Landroid/os/Parcel;I)V
    ...
    invoke-virtual {v0}, Lcom/oneplus/camera/next/media/SharedMemoryImage$Plane;->isWritable()Z

    move-result v1

    invoke-virtual {p1, v1}, Landroid/os/Parcel;->writeByte(B)V

    invoke-virtual {v0}, Lcom/oneplus/camera/next/media/SharedMemoryImage$Plane;->getPixelStride()I

    move-result v1

    invoke-virtual {p1, v1}, Landroid/os/Parcel;->writeInt(I)V

    invoke-virtual {v0}, Lcom/oneplus/camera/next/media/SharedMemoryImage$Plane;->getRowStride()I
    ...
    const-string p2, "null cannot be cast to non-null type com.oneplus.camera.next.media.SharedMemoryImage.Plane"
