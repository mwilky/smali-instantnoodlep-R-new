...
.method protected constructor <init>(Lcom/oneplus/base/component/ComponentOwner;)V
    ...
    const-string v0, "Failed to get Context"
...
.method private final findCameraBuilder(Ljava/lang/String;)Lcom/oneplus/camera/next/hardware/CameraBuilder;
    ...
    iget-object v0, p0, Lcom/oneplus/camera/next/hardware/CameraManager;->cameraBuilderNameCache:Ljava/util/HashMap;
...
.method private final loadCameraInfoList()Ljava/util/List;
    ...
    const-string v2, "loadCameraInfoList() - No camera manager"
    ...
    const-string v3, "loadCameraInfoList() - Failed to load camera info list"
    ...
    const-string v2, "loadCameraInfoList() - Empty saved camera info list"
    ...
    const-string v3, "loadCameraInfoList() - Failed to load camera info list from file"
...
.method private final onCameraInfoUpdated(Ljava/util/List;I)V
    ...
    const-string p2, "onCameraInfoUpdated() - No camera manager"
    ...
    const-string p2, "onCameraInfoUpdated() - No camera change"
...
.method private final updateCameraInfoList()V
    ...
    const-string v2, "updateCameraInfoList() - No camera manager"
    ...
    const-string v5, "] not equal to project count["
    ...
    const-string v4, "updateCameraInfoList() - Create camera info list"
    ...
    const-string v6, "updateCameraInfoList() - Camera ID list : "
    ...
    const-string v5, "updateCameraInfoList() - Failed to get camera ID list"
    ...
    const-string v4, "updateCameraInfoList() - Get characteristics for camera "
    ...
    const-string v5, "updateCameraInfoList() - Camera info created for "
    ...
    const-string v4, "updateCameraInfoList() - No camera info created for "
    ...
    const-string v4, "updateCameraInfoList() - Failed to get characteristics for camera "
    ...
    const-string v2, "updateCameraInfoList() - Empty camera ID list"
...
.method protected getExpectedCameraCount()Ljava/lang/Integer;
    ...
    iget-object v0, p0, Lcom/oneplus/camera/next/hardware/CameraManager;->expectedCameraCount:Ljava/lang/Integer;
...
.method protected onCreateCameraBuilders()Ljava/util/List;
    ...
    new-instance v0, Lcom/oneplus/camera/next/hardware/camera2/Camera2Builder;

    invoke-direct {v0}, Lcom/oneplus/camera/next/hardware/camera2/Camera2Builder;-><init>()V
...
.method public final updateCameras()V
    ...
    const-string v1, "updateCameras() - Permission is not granted yet"
