...
.method public final invoke()Lcom/oneplus/util/CompoundComparator;
    ...
    new-instance v0, Lcom/oneplus/util/CompoundComparator;

    const/4 v1, 0x3

    new-array v1, v1, [Ljava/util/Comparator;

    sget-object v2, Lcom/oneplus/camera/next/hardware/CameraComparators;->Companion:Lcom/oneplus/camera/next/hardware/CameraComparators$Companion;

    invoke-virtual {v2}, Lcom/oneplus/camera/next/hardware/CameraComparators$Companion;->getLENS_COUNT_DESC()Ljava/util/Comparator;
    ...
    invoke-virtual {v2}, Lcom/oneplus/camera/next/hardware/CameraComparators$Companion;->getROLE_ASC()Ljava/util/Comparator;
    ...
    invoke-virtual {v2}, Lcom/oneplus/camera/next/hardware/CameraComparators$Companion;->getID_ASC()Ljava/util/Comparator;
    ...
    invoke-direct {v0, v1}, Lcom/oneplus/util/CompoundComparator;-><init>([Ljava/util/Comparator;)V
