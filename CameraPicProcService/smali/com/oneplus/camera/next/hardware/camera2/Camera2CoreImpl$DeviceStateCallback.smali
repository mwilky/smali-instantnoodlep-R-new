...
.method public onClosed(Landroid/hardware/camera2/CameraDevice;)V
    ...
    check-cast v2, Lcom/oneplus/camera/next/hardware/camera2/Camera2CoreImpl$DeviceStateCallback;
...
.method public onDisconnected(Landroid/hardware/camera2/CameraDevice;)V
    ...
    check-cast v0, Lcom/oneplus/camera/next/hardware/camera2/Camera2CoreImpl$DeviceStateCallback;
...
.method public onError(Landroid/hardware/camera2/CameraDevice;I)V
    ...
    check-cast v1, Lcom/oneplus/camera/next/hardware/camera2/Camera2CoreImpl$DeviceStateCallback;
    ...
    sget-object p2, Lcom/oneplus/camera/next/hardware/Camera$Error;->UNKNOWN:Lcom/oneplus/camera/next/hardware/Camera$Error;

    goto :goto_0

    :cond_1
    sget-object p2, Lcom/oneplus/camera/next/hardware/Camera$Error;->DISABLED:Lcom/oneplus/camera/next/hardware/Camera$Error;

    goto :goto_0

    :cond_2
    sget-object p2, Lcom/oneplus/camera/next/hardware/Camera$Error;->EVICTED:Lcom/oneplus/camera/next/hardware/Camera$Error;
    ...
    invoke-static {p1, v0}, Lcom/oneplus/camera/next/hardware/camera2/Camera2CoreImpl;->access$setOpeningCamera$p(Lcom/oneplus/camera/next/hardware/camera2/Camera2CoreImpl;Z)V

    const/4 v0, 0x0

    invoke-static {p1, v0, p2}, Lcom/oneplus/camera/next/hardware/camera2/Camera2CoreImpl;->access$completeOpeningDevice(Lcom/oneplus/camera/next/hardware/camera2/Camera2CoreImpl;Landroid/hardware/camera2/CameraDevice;Lcom/oneplus/camera/next/hardware/Camera$Error;)V

    goto :goto_1

    :cond_3
    invoke-static {p1, p2}, Lcom/oneplus/camera/next/hardware/camera2/Camera2CoreImpl;->access$notifyError(Lcom/oneplus/camera/next/hardware/camera2/Camera2CoreImpl;Lcom/oneplus/camera/next/hardware/Camera$Error;)V
...
.method public onOpened(Landroid/hardware/camera2/CameraDevice;)V
    ...
    const-string v1, "onOpened() - Unknown device, close immediately"
    ...
    invoke-static {v0, v1}, Lcom/oneplus/camera/next/hardware/camera2/Camera2CoreImpl;->access$setOpeningCamera$p(Lcom/oneplus/camera/next/hardware/camera2/Camera2CoreImpl;Z)V
    ...
    sget-object v2, Lcom/oneplus/camera/next/hardware/Camera$State;->CLOSING:Lcom/oneplus/camera/next/hardware/Camera$State;
    ...
    invoke-static {v0, p1, v2, v1, v2}, Lcom/oneplus/camera/next/hardware/AbstractCameraCore;->completeOpeningDevice$default(Lcom/oneplus/camera/next/hardware/AbstractCameraCore;Ljava/lang/Object;Lcom/oneplus/camera/next/hardware/Camera$Error;ILjava/lang/Object;)V
    ...
    const-string v2, "onOpened() - Closing device"
    ...
    new-instance v2, Lcom/oneplus/camera/next/hardware/camera2/Camera2CoreImpl$DeviceStateCallback$onOpened$2;

    invoke-direct {v2, p1, v0}, Lcom/oneplus/camera/next/hardware/camera2/Camera2CoreImpl$DeviceStateCallback$onOpened$2;-><init>(Landroid/hardware/camera2/CameraDevice;Lcom/oneplus/camera/next/hardware/camera2/Camera2CoreImpl;)V
