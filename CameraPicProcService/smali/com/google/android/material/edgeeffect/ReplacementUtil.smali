...
.method enableSpringEdgeEffect(Landroid/widget/ListView;)Landroid/widget/ListView;
    ...
    invoke-virtual {v0, v1, v4, p1}, Landroid/view/ViewGroup;->addView(Landroid/view/View;ILandroid/view/ViewGroup$LayoutParams;)V
...
.method enableSpringEdgeEffect(Landroid/view/View;)V
    ...
    :cond_1
    new-instance v1, Lcom/google/android/material/edgeeffect/SpringRelativeLayout;

    invoke-virtual {p1}, Landroid/widget/ListView;->getContext()Landroid/content/Context;

    move-result-object v2

    invoke-direct {v1, v2}, Lcom/google/android/material/edgeeffect/SpringRelativeLayout;-><init>(Landroid/content/Context;)V

    const/4 v2, 0x1

    invoke-virtual {v1, v2}, Lcom/google/android/material/edgeeffect/SpringRelativeLayout;->setFocusable(Z)V

    invoke-virtual {v1, v2}, Lcom/google/android/material/edgeeffect/SpringRelativeLayout;->setFocusableInTouchMode(Z)V

    const/4 v2, 0x0

    invoke-virtual {v1, v2}, Lcom/google/android/material/edgeeffect/SpringRelativeLayout;->setSaveEnabled(Z)V

    new-instance v3, Lcom/google/android/material/edgeeffect/SpringListView;

    invoke-virtual {p1}, Landroid/widget/ListView;->getContext()Landroid/content/Context;

    move-result-object v4

    invoke-direct {v3, v4}, Lcom/google/android/material/edgeeffect/SpringListView;-><init>(Landroid/content/Context;)V

    invoke-virtual {p1}, Landroid/widget/ListView;->getAdapter()Landroid/widget/ListAdapter;

    move-result-object v4

    invoke-virtual {v3, v4}, Lcom/google/android/material/edgeeffect/SpringListView;->setAdapter(Landroid/widget/ListAdapter;)V
    ...
    invoke-virtual {v3, v4}, Lcom/google/android/material/edgeeffect/SpringListView;->setClipToPadding(Z)V
    ...
    invoke-virtual {v3, v4}, Lcom/google/android/material/edgeeffect/SpringListView;->setDrawSelectorOnTop(Z)V
    ...
    invoke-virtual {v3, v4}, Lcom/google/android/material/edgeeffect/SpringListView;->setCacheColorHint(I)V
    ...
    invoke-virtual {v3, v4, v6, v7, v8}, Lcom/google/android/material/edgeeffect/SpringListView;->setPadding(IIII)V

    invoke-virtual {p1}, Landroid/widget/ListView;->getScrollBarStyle()I

    move-result v4

    invoke-virtual {v3, v4}, Lcom/google/android/material/edgeeffect/SpringListView;->setScrollBarStyle(I)V

    invoke-virtual {p1}, Landroid/widget/ListView;->getDivider()Landroid/graphics/drawable/Drawable;

    move-result-object v4

    invoke-virtual {v3, v4}, Lcom/google/android/material/edgeeffect/SpringListView;->setDivider(Landroid/graphics/drawable/Drawable;)V

    invoke-virtual {p1}, Landroid/widget/ListView;->getId()I

    move-result v4

    invoke-virtual {v3, v4}, Lcom/google/android/material/edgeeffect/SpringListView;->setId(I)V
    ...
    invoke-virtual {v3, v4}, Lcom/google/android/material/edgeeffect/SpringListView;->setEdgeEffectColor(I)V
    ...
    invoke-virtual {v3, v4}, Lcom/google/android/material/edgeeffect/SpringListView;->setLayoutParams(Landroid/view/ViewGroup$LayoutParams;)V

    invoke-virtual {v1, v3}, Lcom/google/android/material/edgeeffect/SpringRelativeLayout;->addView(Landroid/view/View;)V

    invoke-virtual {v3}, Lcom/google/android/material/edgeeffect/SpringListView;->getId()I

    move-result v4

    invoke-virtual {v1, v4}, Lcom/google/android/material/edgeeffect/SpringRelativeLayout;->addSpringView(I)V

    invoke-virtual {v1}, Lcom/google/android/material/edgeeffect/SpringRelativeLayout;->createViewEdgeEffectFactory()Lcom/google/android/material/edgeeffect/SpringRelativeLayout$ViewEdgeEffectFactory;

    move-result-object v4

    invoke-virtual {v3, v4}, Lcom/google/android/material/edgeeffect/SpringListView;->setEdgeEffectFactory(Lcom/google/android/material/edgeeffect/SpringRelativeLayout$SEdgeEffectFactory;)V
    ...
    invoke-direct {p1, v5, v2, v3}, Landroid/widget/LinearLayout$LayoutParams;-><init>(IIF)V
