...
.method public static c(Ljava/util/Locale;)Landroid/icu/text/DateFormat;
    ...
    invoke-static {v0, p0}, Lc/b/b/b/t/h;->e(Ljava/lang/String;Ljava/util/Locale;)Landroid/icu/text/DateFormat;
...
.method public static e(Ljava/lang/String;Ljava/util/Locale;)Landroid/icu/text/DateFormat;
    ...
    invoke-static {}, Lc/b/b/b/t/h;->p()Landroid/icu/util/TimeZone;
...
.method public static f(Ljava/util/Calendar;)Ljava/util/Calendar;
    ...
    invoke-static {p0}, Lc/b/b/b/t/h;->r(Ljava/util/Calendar;)Ljava/util/Calendar;
...
.method public static g(ILjava/util/Locale;)Ljava/text/DateFormat;
    ...
    invoke-static {}, Lc/b/b/b/t/h;->n()Ljava/util/TimeZone;
...
.method public static h(Ljava/util/Locale;)Ljava/text/DateFormat;
    ...
    invoke-static {v0, p0}, Lc/b/b/b/t/h;->g(ILjava/util/Locale;)Ljava/text/DateFormat;
...
.method public static j(Ljava/util/Locale;)Ljava/text/DateFormat;
    ...
    invoke-static {p0}, Lc/b/b/b/t/h;->i(Ljava/util/Locale;)Ljava/text/DateFormat;
    ...
    invoke-static {v0}, Lc/b/b/b/t/h;->w(Ljava/lang/String;)Ljava/lang/String;
...
.method public static m(Landroid/content/res/Resources;Ljava/text/SimpleDateFormat;)Ljava/lang/String;
    ...
    sget v0, Lc/b/b/b/j;->mtrl_picker_text_input_year_abbr:I

    invoke-virtual {p0, v0}, Landroid/content/res/Resources;->getString(I)Ljava/lang/String;

    move-result-object v0

    sget v1, Lc/b/b/b/j;->mtrl_picker_text_input_month_abbr:I

    invoke-virtual {p0, v1}, Landroid/content/res/Resources;->getString(I)Ljava/lang/String;

    move-result-object v1

    sget v2, Lc/b/b/b/j;->mtrl_picker_text_input_day_abbr:I
...
.method public static q()Ljava/util/Calendar;
    ...
    invoke-static {v0}, Lc/b/b/b/t/h;->r(Ljava/util/Calendar;)Ljava/util/Calendar;
...
.method public static u()Ljava/text/SimpleDateFormat;
    ...
    invoke-static {v0}, Lc/b/b/b/t/h;->v(Ljava/util/Locale;)Ljava/text/SimpleDateFormat;
...
.method public static v(Ljava/util/Locale;)Ljava/text/SimpleDateFormat;
    ...
    invoke-static {v0, p0}, Lc/b/b/b/t/h;->k(Ljava/lang/String;Ljava/util/Locale;)Ljava/text/SimpleDateFormat;
...
.method public static w(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p0, v0, v1, v2}, Lc/b/b/b/t/h;->b(Ljava/lang/String;Ljava/lang/String;II)I
    ...
    invoke-static {p0, v2, v1, v0}, Lc/b/b/b/t/h;->b(Ljava/lang/String;Ljava/lang/String;II)I
    ...
    invoke-static {p0, v2, v4, v0}, Lc/b/b/b/t/h;->b(Ljava/lang/String;Ljava/lang/String;II)I
