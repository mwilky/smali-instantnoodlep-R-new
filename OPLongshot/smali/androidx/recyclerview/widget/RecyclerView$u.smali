...
.method public a(I)Landroid/graphics/PointF;
    ...
    invoke-virtual {p0}, Landroidx/recyclerview/widget/RecyclerView$u;->e()Landroidx/recyclerview/widget/RecyclerView$k;
...
.method public b(I)Landroid/view/View;
    ...
    invoke-virtual {v0, p1}, Landroidx/recyclerview/widget/RecyclerView$k;->C(I)Landroid/view/View;
...
.method public c()I
    ...
    invoke-virtual {v0}, Landroidx/recyclerview/widget/RecyclerView$k;->J()I
...
.method public e()Landroidx/recyclerview/widget/RecyclerView$k;
    .locals 1
    .annotation build Landroidx/annotation/Nullable;
    .end annotation

    iget-object v0, p0, Landroidx/recyclerview/widget/RecyclerView$u;->c:Landroidx/recyclerview/widget/RecyclerView$k;
...
.method j(II)V
    ...
    iget-object v1, p0, Landroidx/recyclerview/widget/RecyclerView$u;->c:Landroidx/recyclerview/widget/RecyclerView$k;
    ...
    invoke-virtual {p0, v1}, Landroidx/recyclerview/widget/RecyclerView$u;->d(Landroid/view/View;)I

    move-result v1

    iget v3, p0, Landroidx/recyclerview/widget/RecyclerView$u;->a:I
    ...
    iget-object v3, p0, Landroidx/recyclerview/widget/RecyclerView$u;->g:Landroidx/recyclerview/widget/RecyclerView$u$a;

    invoke-virtual {p0, v1, v2, v3}, Landroidx/recyclerview/widget/RecyclerView$u;->o(Landroid/view/View;Landroidx/recyclerview/widget/RecyclerView$v;Landroidx/recyclerview/widget/RecyclerView$u$a;)V

    iget-object v1, p0, Landroidx/recyclerview/widget/RecyclerView$u;->g:Landroidx/recyclerview/widget/RecyclerView$u$a;

    invoke-virtual {v1, v0}, Landroidx/recyclerview/widget/RecyclerView$u$a;->c(Landroidx/recyclerview/widget/RecyclerView;)V
    ...
    :cond_5
    :goto_0
    iget-boolean v1, p0, Landroidx/recyclerview/widget/RecyclerView$u;->e:Z
    ...
    invoke-virtual {p0, p1, p2, v1, v2}, Landroidx/recyclerview/widget/RecyclerView$u;->l(IILandroidx/recyclerview/widget/RecyclerView$v;Landroidx/recyclerview/widget/RecyclerView$u$a;)V
    ...
    invoke-virtual {p2, v0}, Landroidx/recyclerview/widget/RecyclerView$u$a;->c(Landroidx/recyclerview/widget/RecyclerView;)V
...
.method protected k(Landroid/view/View;)V
    ...
    invoke-virtual {p0}, Landroidx/recyclerview/widget/RecyclerView$u;->f()I
...
.method q(Landroidx/recyclerview/widget/RecyclerView;Landroidx/recyclerview/widget/RecyclerView$k;)V
    ...
    iput-object p2, p0, Landroidx/recyclerview/widget/RecyclerView$u;->c:Landroidx/recyclerview/widget/RecyclerView$k;
    ...
    iput-boolean p1, p0, Landroidx/recyclerview/widget/RecyclerView$u;->e:Z
    ...
    invoke-virtual {p0, p2}, Landroidx/recyclerview/widget/RecyclerView$u;->b(I)Landroid/view/View;

    move-result-object p2

    iput-object p2, p0, Landroidx/recyclerview/widget/RecyclerView$u;->f:Landroid/view/View;

    invoke-virtual {p0}, Landroidx/recyclerview/widget/RecyclerView$u;->m()V

    iget-object p2, p0, Landroidx/recyclerview/widget/RecyclerView$u;->b:Landroidx/recyclerview/widget/RecyclerView;

    iget-object p2, p2, Landroidx/recyclerview/widget/RecyclerView;->mViewFlinger:Landroidx/recyclerview/widget/RecyclerView$x;

    invoke-virtual {p2}, Landroidx/recyclerview/widget/RecyclerView$x;->e()V
...
.method protected final r()V
    ...
    iput-object v1, p0, Landroidx/recyclerview/widget/RecyclerView$u;->f:Landroid/view/View;

    iput v2, p0, Landroidx/recyclerview/widget/RecyclerView$u;->a:I

    iput-boolean v0, p0, Landroidx/recyclerview/widget/RecyclerView$u;->d:Z

    iget-object v0, p0, Landroidx/recyclerview/widget/RecyclerView$u;->c:Landroidx/recyclerview/widget/RecyclerView$k;

    invoke-virtual {v0, p0}, Landroidx/recyclerview/widget/RecyclerView$k;->f1(Landroidx/recyclerview/widget/RecyclerView$u;)V

    iput-object v1, p0, Landroidx/recyclerview/widget/RecyclerView$u;->c:Landroidx/recyclerview/widget/RecyclerView$k;

    iput-object v1, p0, Landroidx/recyclerview/widget/RecyclerView$u;->b:Landroidx/recyclerview/widget/RecyclerView;
