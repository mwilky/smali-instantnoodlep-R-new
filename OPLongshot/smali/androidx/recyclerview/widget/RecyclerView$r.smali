...
.method public B(Landroid/view/View;)V
    ...
    invoke-virtual {v0}, Landroidx/recyclerview/widget/RecyclerView$y;->u()Z
...
.method public C(Landroidx/recyclerview/widget/RecyclerView$y;)V
    ...
    invoke-virtual {p1}, Landroidx/recyclerview/widget/RecyclerView$y;->w()Z
    ...
    invoke-virtual {p1}, Landroidx/recyclerview/widget/RecyclerView$y;->h()Z
    ...
    invoke-virtual {p1}, Landroidx/recyclerview/widget/RecyclerView$y;->u()Z
    ...
    invoke-virtual {p1, v3}, Landroidx/recyclerview/widget/RecyclerView$y;->p(I)Z
    ...
    iget v5, p1, Landroidx/recyclerview/widget/RecyclerView$y;->c:I
    ...
    iget v4, v4, Landroidx/recyclerview/widget/RecyclerView$y;->c:I
    ...
    iget-object v3, v3, Landroidx/recyclerview/widget/RecyclerView;->mViewInfoStore:Lb/o/d/q;

    invoke-virtual {v3, p1}, Lb/o/d/q;->q(Landroidx/recyclerview/widget/RecyclerView$y;)V
    ...
    iput-object v0, p1, Landroidx/recyclerview/widget/RecyclerView$y;->r:Landroidx/recyclerview/widget/RecyclerView;
...
.method public D(Landroid/view/View;)V
    ...
    invoke-virtual {p1, p0, v0}, Landroidx/recyclerview/widget/RecyclerView$y;->H(Landroidx/recyclerview/widget/RecyclerView$r;Z)V
...
.method public F(Landroidx/recyclerview/widget/RecyclerView$w;)V
    .locals 0
...
.method public final H(Landroidx/recyclerview/widget/RecyclerView$y;IIJ)Z
    .locals 9
    ...
    invoke-virtual {p1}, Landroidx/recyclerview/widget/RecyclerView$y;->l()I
    ...
    iput p3, p1, Landroidx/recyclerview/widget/RecyclerView$y;->g:I
...
.method public I(IZJ)Landroidx/recyclerview/widget/RecyclerView$y;
    .locals 16
    ...
    invoke-virtual {v1, v5}, Landroidx/recyclerview/widget/RecyclerView$y;->b(I)V

    invoke-virtual {v1}, Landroidx/recyclerview/widget/RecyclerView$y;->w()Z
    ...
    iget-object v9, v1, Landroidx/recyclerview/widget/RecyclerView$y;->a:Landroid/view/View;

    invoke-virtual {v5, v9, v8}, Landroidx/recyclerview/widget/RecyclerView;->removeDetachedView(Landroid/view/View;Z)V

    invoke-virtual {v1}, Landroidx/recyclerview/widget/RecyclerView$y;->K()V

    goto :goto_1

    :cond_2
    invoke-virtual {v1}, Landroidx/recyclerview/widget/RecyclerView$y;->L()Z

    move-result v5

    if-eqz v5, :cond_3

    invoke-virtual {v1}, Landroidx/recyclerview/widget/RecyclerView$y;->e()V
    ...
    iget-object v5, v5, Landroidx/recyclerview/widget/RecyclerView;->mAdapterHelper:Lb/o/d/a;

    invoke-virtual {v5, v3}, Lb/o/d/a;->m(I)I
    ...
    iput v5, v1, Landroidx/recyclerview/widget/RecyclerView$y;->c:I
    ...
    invoke-virtual {v6, v0}, Landroidx/recyclerview/widget/RecyclerView$r;->r(Landroidx/recyclerview/widget/RecyclerView$y;)V
    ...
    iget-object v5, v2, Landroidx/recyclerview/widget/RecyclerView$y;->a:Landroid/view/View;
    ...
    iput-object v10, v2, Landroidx/recyclerview/widget/RecyclerView$y;->b:Ljava/lang/ref/WeakReference;
    ...
    invoke-virtual {v9, v0}, Landroidx/recyclerview/widget/RecyclerView$y;->p(I)Z

    move-result v1

    if-eqz v1, :cond_11

    invoke-virtual {v9, v8, v0}, Landroidx/recyclerview/widget/RecyclerView$y;->F(II)V
    ...
    invoke-virtual {v9}, Landroidx/recyclerview/widget/RecyclerView$y;->o()Ljava/util/List;

    move-result-object v4

    invoke-virtual {v2, v1, v9, v0, v4}, Landroidx/recyclerview/widget/RecyclerView$ItemAnimator;->t(Landroidx/recyclerview/widget/RecyclerView$v;Landroidx/recyclerview/widget/RecyclerView$y;ILjava/util/List;)Landroidx/recyclerview/widget/RecyclerView$ItemAnimator$c;
    ...
    invoke-virtual {v9}, Landroidx/recyclerview/widget/RecyclerView$y;->s()Z

    move-result v0

    if-eqz v0, :cond_12

    iput v3, v9, Landroidx/recyclerview/widget/RecyclerView$y;->g:I
    ...
    invoke-virtual {v9}, Landroidx/recyclerview/widget/RecyclerView$y;->z()Z

    move-result v0

    if-nez v0, :cond_14

    invoke-virtual {v9}, Landroidx/recyclerview/widget/RecyclerView$y;->t()Z
    ...
    invoke-virtual {v0, v3}, Lb/o/d/a;->m(I)I
    ...
    invoke-virtual/range {v0 .. v5}, Landroidx/recyclerview/widget/RecyclerView$r;->H(Landroidx/recyclerview/widget/RecyclerView$y;IIJ)Z

    move-result v0

    :goto_7
    iget-object v1, v9, Landroidx/recyclerview/widget/RecyclerView$y;->a:Landroid/view/View;
    ...
    iget-object v2, v9, Landroidx/recyclerview/widget/RecyclerView$y;->a:Landroid/view/View;
    ...
    :goto_8
    iput-object v9, v1, Landroidx/recyclerview/widget/RecyclerView$l;->a:Landroidx/recyclerview/widget/RecyclerView$y;
    ...
    :goto_9
    iput-boolean v7, v1, Landroidx/recyclerview/widget/RecyclerView$l;->d:Z
...
.method public J(Landroidx/recyclerview/widget/RecyclerView$y;)V
    ...
    iget-boolean v0, p1, Landroidx/recyclerview/widget/RecyclerView$y;->o:Z
    ...
    iput-object v0, p1, Landroidx/recyclerview/widget/RecyclerView$y;->n:Landroidx/recyclerview/widget/RecyclerView$r;

    const/4 v0, 0x0

    iput-boolean v0, p1, Landroidx/recyclerview/widget/RecyclerView$y;->o:Z

    invoke-virtual {p1}, Landroidx/recyclerview/widget/RecyclerView$y;->e()V
...
.method public K()V
    ...
    iget-object v0, v0, Landroidx/recyclerview/widget/RecyclerView;->mLayout:Landroidx/recyclerview/widget/RecyclerView$k;

    if-eqz v0, :cond_0

    iget v0, v0, Landroidx/recyclerview/widget/RecyclerView$k;->m:I
...
.method public L(Landroidx/recyclerview/widget/RecyclerView$y;)Z
    .locals 7
    ...
    :cond_0
    iget v0, p1, Landroidx/recyclerview/widget/RecyclerView$y;->c:I
    ...
    iget v2, p1, Landroidx/recyclerview/widget/RecyclerView$y;->c:I
...
.method public M(II)V
    ...
    :cond_0
    iget v2, v1, Landroidx/recyclerview/widget/RecyclerView$y;->c:I
...
.method public a(Landroidx/recyclerview/widget/RecyclerView$y;Z)V
    ...
    iget-object v1, v1, Landroidx/recyclerview/widget/RecyclerView;->mAccessibilityDelegate:Lb/o/d/m;

    const/4 v2, 0x0

    if-eqz v1, :cond_1

    invoke-virtual {v1}, Lb/o/d/m;->getItemDelegate()Lb/h/l/a;

    move-result-object v1

    instance-of v3, v1, Lb/o/d/m$a;

    if-eqz v3, :cond_0

    check-cast v1, Lb/o/d/m$a;

    invoke-virtual {v1, v0}, Lb/o/d/m$a;->a(Landroid/view/View;)Lb/h/l/a;
    ...
    :goto_0
    invoke-static {v0, v1}, Landroidx/core/view/ViewCompat;->g0(Landroid/view/View;Lb/h/l/a;)V
    ...
    :cond_2
    iput-object v2, p1, Landroidx/recyclerview/widget/RecyclerView$y;->r:Landroidx/recyclerview/widget/RecyclerView;
...
.method public final b(Landroidx/recyclerview/widget/RecyclerView$y;)V
    ...
    iget-object v0, v0, Landroidx/recyclerview/widget/RecyclerView;->mAccessibilityDelegate:Lb/o/d/m;
    ...
    :cond_1
    invoke-virtual {v0}, Lb/o/d/m;->getItemDelegate()Lb/h/l/a;

    move-result-object v0

    instance-of v1, v0, Lb/o/d/m$a;
    ...
    invoke-virtual {v1, p1}, Lb/o/d/m$a;->b(Landroid/view/View;)V
...
.method public d()V
    ...
    invoke-virtual {v3}, Landroidx/recyclerview/widget/RecyclerView$y;->c()V
...
.method public f(I)I
    ...
    invoke-virtual {v0, p1}, Lb/o/d/a;->m(I)I
...
.method public g(Landroidx/recyclerview/widget/RecyclerView$y;)V
    ...
    iget-object v0, v0, Landroidx/recyclerview/widget/RecyclerView;->mViewInfoStore:Lb/o/d/q;

    invoke-virtual {v0, p1}, Lb/o/d/q;->q(Landroidx/recyclerview/widget/RecyclerView$y;)V

    :cond_2
    return-void
.end method

.method public h(I)Landroidx/recyclerview/widget/RecyclerView$y;
    .locals 9
    ...
    invoke-virtual {v5}, Landroidx/recyclerview/widget/RecyclerView$y;->L()Z

    move-result v6

    if-nez v6, :cond_1

    invoke-virtual {v5}, Landroidx/recyclerview/widget/RecyclerView$y;->m()I

    move-result v6

    if-ne v6, p1, :cond_1

    invoke-virtual {v5, v4}, Landroidx/recyclerview/widget/RecyclerView$y;->b(I)V
    ...
    iget-object v3, v3, Landroidx/recyclerview/widget/RecyclerView;->mAdapterHelper:Lb/o/d/a;

    invoke-virtual {v3, p1}, Lb/o/d/a;->m(I)I
    ...
    invoke-virtual {p1, v4}, Landroidx/recyclerview/widget/RecyclerView$y;->b(I)V
...
.method public l(JIZ)Landroidx/recyclerview/widget/RecyclerView$y;
    .locals 5
    ...
    invoke-virtual {v1}, Landroidx/recyclerview/widget/RecyclerView$y;->l()I
    ...
    invoke-virtual {v1, p1}, Landroidx/recyclerview/widget/RecyclerView$y;->b(I)V
    ...
    invoke-virtual {v1, p1, p2}, Landroidx/recyclerview/widget/RecyclerView$y;->F(II)V
    ...
    iget-object v3, v1, Landroidx/recyclerview/widget/RecyclerView$y;->a:Landroid/view/View;
    ...
    invoke-virtual {v2}, Landroidx/recyclerview/widget/RecyclerView$y;->k()J
    ...
    invoke-virtual {v2}, Landroidx/recyclerview/widget/RecyclerView$y;->r()Z

    move-result v3

    if-nez v3, :cond_6

    invoke-virtual {v2}, Landroidx/recyclerview/widget/RecyclerView$y;->l()I
...
.method public m(IZ)Landroidx/recyclerview/widget/RecyclerView$y;
    .locals 5
    ...
    invoke-virtual {v3}, Landroidx/recyclerview/widget/RecyclerView$y;->L()Z
    ...
    invoke-virtual {v3, p1}, Landroidx/recyclerview/widget/RecyclerView$y;->b(I)V
    ...
    iget-object v0, v0, Landroidx/recyclerview/widget/RecyclerView;->mChildHelper:Lb/o/d/d;

    invoke-virtual {v0, p1}, Lb/o/d/d;->e(I)Landroid/view/View;
    ...
    iget-object p2, p2, Landroidx/recyclerview/widget/RecyclerView;->mChildHelper:Lb/o/d/d;

    invoke-virtual {p2, v0}, Lb/o/d/d;->s(Landroid/view/View;)V

    iget-object p2, p0, Landroidx/recyclerview/widget/RecyclerView$r;->i:Landroidx/recyclerview/widget/RecyclerView;

    iget-object p2, p2, Landroidx/recyclerview/widget/RecyclerView;->mChildHelper:Lb/o/d/d;

    invoke-virtual {p2, v0}, Lb/o/d/d;->m(Landroid/view/View;)I
    ...
    invoke-virtual {v1, p2}, Lb/o/d/d;->d(I)V

    invoke-virtual {p0, v0}, Landroidx/recyclerview/widget/RecyclerView$r;->D(Landroid/view/View;)V

    const/16 p2, 0x2020

    invoke-virtual {p1, p2}, Landroidx/recyclerview/widget/RecyclerView$y;->b(I)V
    ...
    invoke-virtual {v2}, Landroidx/recyclerview/widget/RecyclerView$y;->t()Z

    move-result v3

    if-nez v3, :cond_6

    invoke-virtual {v2}, Landroidx/recyclerview/widget/RecyclerView$y;->m()I
...
.method public final q(Landroid/view/ViewGroup;Z)V
    ...
    invoke-virtual {p0, v2, v1}, Landroidx/recyclerview/widget/RecyclerView$r;->q(Landroid/view/ViewGroup;Z)V
...
.method public final r(Landroidx/recyclerview/widget/RecyclerView$y;)V
    .locals 1
    ...
    invoke-virtual {p0, p1, v0}, Landroidx/recyclerview/widget/RecyclerView$r;->q(Landroid/view/ViewGroup;Z)V
...
.method public s()V
    ...
    iget-object v2, v2, Landroidx/recyclerview/widget/RecyclerView$y;->a:Landroid/view/View;
...
.method public t()V
    ...
    invoke-virtual {v2, v3}, Landroidx/recyclerview/widget/RecyclerView$y;->a(Ljava/lang/Object;)V
...
.method public u(II)V
    ...
    iget v3, v2, Landroidx/recyclerview/widget/RecyclerView$y;->c:I

    if-lt v3, p1, :cond_0

    const/4 v3, 0x1

    invoke-virtual {v2, p2, v3}, Landroidx/recyclerview/widget/RecyclerView$y;->A(IZ)V
...
.method public v(II)V
    ...
    iget v7, v6, Landroidx/recyclerview/widget/RecyclerView$y;->c:I
    ...
    invoke-virtual {v6, v7, v4}, Landroidx/recyclerview/widget/RecyclerView$y;->A(IZ)V

    goto :goto_2

    :cond_2
    invoke-virtual {v6, v0, v4}, Landroidx/recyclerview/widget/RecyclerView$y;->A(IZ)V
...
.method public w(IIZ)V
    ...
    invoke-virtual {v2, v3, p3}, Landroidx/recyclerview/widget/RecyclerView$y;->A(IZ)V
