...
.field private d:Landroidx/appcompat/view/menu/MenuPresenter$a;
...
.method public a(Landroidx/appcompat/view/menu/MenuBuilder;)Z
    ...
    iget-object v0, p0, Landroidx/appcompat/view/menu/b;->d:Landroidx/appcompat/view/menu/MenuPresenter$a;
...
.method public b()V
    ...
    iget-object v0, p0, Landroidx/appcompat/view/menu/b;->b:Landroidx/appcompat/app/b;
...
.method public c(Landroid/os/IBinder;)V
    ...
    invoke-direct {v1, v2}, Landroidx/appcompat/app/b$b;-><init>(Landroid/content/Context;)V

    new-instance v2, Landroidx/appcompat/view/menu/ListMenuPresenter;

    invoke-virtual {v1}, Landroidx/appcompat/app/b$b;->b()Landroid/content/Context;
    ...
    invoke-virtual {v1, v2, p0}, Landroidx/appcompat/app/b$b;->c(Landroid/widget/ListAdapter;Landroid/content/DialogInterface$OnClickListener;)Landroidx/appcompat/app/b$b;
    ...
    invoke-virtual {v1, v2}, Landroidx/appcompat/app/b$b;->d(Landroid/view/View;)Landroidx/appcompat/app/b$b;
    ...
    invoke-virtual {v1, v2}, Landroidx/appcompat/app/b$b;->e(Landroid/graphics/drawable/Drawable;)Landroidx/appcompat/app/b$b;

    invoke-virtual {v0}, Landroidx/appcompat/view/menu/MenuBuilder;->getHeaderTitle()Ljava/lang/CharSequence;

    move-result-object v0

    invoke-virtual {v1, v0}, Landroidx/appcompat/app/b$b;->h(Ljava/lang/CharSequence;)Landroidx/appcompat/app/b$b;

    :goto_0
    invoke-virtual {v1, p0}, Landroidx/appcompat/app/b$b;->f(Landroid/content/DialogInterface$OnKeyListener;)Landroidx/appcompat/app/b$b;

    invoke-virtual {v1}, Landroidx/appcompat/app/b$b;->a()Landroidx/appcompat/app/b;

    move-result-object v0

    iput-object v0, p0, Landroidx/appcompat/view/menu/b;->b:Landroidx/appcompat/app/b;
    ...
    iget-object p1, p0, Landroidx/appcompat/view/menu/b;->b:Landroidx/appcompat/app/b;
...
.method public onCloseMenu(Landroidx/appcompat/view/menu/MenuBuilder;Z)V
    ...
    :cond_0
    invoke-virtual {p0}, Landroidx/appcompat/view/menu/b;->b()V
