...
.method private D()V
    ...
    invoke-direct {p0, v7}, Landroidx/appcompat/app/AlertController;->A(Landroid/view/ViewGroup;)V
    ...
    invoke-direct {p0, v0, v1}, Landroidx/appcompat/app/AlertController;->l(Landroid/view/View;Landroid/view/View;)Landroid/view/ViewGroup;

    move-result-object v0

    invoke-direct {p0, v4, v2}, Landroidx/appcompat/app/AlertController;->l(Landroid/view/View;Landroid/view/View;)Landroid/view/ViewGroup;

    move-result-object v6

    invoke-direct {p0, v5, v3}, Landroidx/appcompat/app/AlertController;->l(Landroid/view/View;Landroid/view/View;)Landroid/view/ViewGroup;
    ...
    invoke-direct {p0, v6}, Landroidx/appcompat/app/AlertController;->z(Landroid/view/ViewGroup;)V

    invoke-direct {p0, v8}, Landroidx/appcompat/app/AlertController;->y(Landroid/view/ViewGroup;)V
    ...
    invoke-direct/range {v4 .. v11}, Landroidx/appcompat/app/AlertController;->m(Landroid/view/View;Landroid/view/View;Landroid/view/View;Landroid/view/View;ZZZ)V
...
.method static synthetic b(Landroidx/appcompat/app/AlertController;Landroid/widget/FrameLayout;)V
    ...
    invoke-direct {p0, p1}, Landroidx/appcompat/app/AlertController;->p(Landroid/widget/FrameLayout;)V
...
.method static synthetic c(Landroidx/appcompat/app/AlertController;Z)V
    ...
    invoke-direct {p0, p1}, Landroidx/appcompat/app/AlertController;->E(Z)V
...
.method private l(Landroid/view/View;Landroid/view/View;)Landroid/view/ViewGroup;
    .locals 2
...
.method private m(Landroid/view/View;Landroid/view/View;Landroid/view/View;Landroid/view/View;ZZZ)V
    .locals 7
...
.method private p(Landroid/widget/FrameLayout;)V
    .locals 0
...
.method public i()V
    ...
    :cond_0
    invoke-direct {p0, v1}, Landroidx/appcompat/app/AlertController;->E(Z)V

    :cond_1
    :goto_0
    invoke-direct {p0}, Landroidx/appcompat/app/AlertController;->D()V

    invoke-direct {p0}, Landroidx/appcompat/app/AlertController;->B()V
...
.method public n(ILjava/lang/CharSequence;Landroid/content/DialogInterface$OnClickListener;Landroid/os/Message;Landroid/graphics/drawable/Drawable;)V
    .locals 0
