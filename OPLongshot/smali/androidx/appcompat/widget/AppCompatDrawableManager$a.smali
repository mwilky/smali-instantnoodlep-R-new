.class public final Landroidx/appcompat/widget/AppCompatDrawableManager$a;
...
.method public constructor <init>()V
    ...
    sget v2, Lb/c/e;->abc_textfield_search_default_mtrl_alpha:I

    const/4 v3, 0x0

    aput v2, v1, v3

    sget v2, Lb/c/e;->abc_textfield_default_mtrl_alpha:I

    const/4 v4, 0x1

    aput v2, v1, v4

    sget v2, Lb/c/e;->abc_ab_share_pack_mtrl_alpha:I
    ...
    sget v6, Lb/c/e;->abc_ic_commit_search_api_mtrl_alpha:I

    aput v6, v2, v3

    sget v6, Lb/c/e;->abc_seekbar_tick_mark_material:I

    aput v6, v2, v4

    sget v6, Lb/c/e;->abc_ic_menu_share_mtrl_alpha:I

    aput v6, v2, v5

    sget v6, Lb/c/e;->abc_ic_menu_copy_mtrl_am_alpha:I

    aput v6, v2, v0

    sget v6, Lb/c/e;->abc_ic_menu_cut_mtrl_alpha:I

    const/4 v7, 0x4

    aput v6, v2, v7

    sget v6, Lb/c/e;->abc_ic_menu_selectall_mtrl_alpha:I

    const/4 v8, 0x5

    aput v6, v2, v8

    sget v6, Lb/c/e;->abc_ic_menu_paste_mtrl_am_alpha:I
    ...
    sget v6, Lb/c/e;->abc_textfield_activated_mtrl_alpha:I

    aput v6, v2, v3

    sget v6, Lb/c/e;->abc_textfield_search_activated_mtrl_alpha:I

    aput v6, v2, v4

    sget v6, Lb/c/e;->abc_cab_background_top_mtrl_alpha:I

    aput v6, v2, v5

    sget v6, Lb/c/e;->abc_text_cursor_material:I

    aput v6, v2, v0

    sget v6, Lb/c/e;->abc_text_select_handle_left_mtrl_dark:I

    aput v6, v2, v7

    sget v6, Lb/c/e;->abc_text_select_handle_middle_mtrl_dark:I

    aput v6, v2, v8

    sget v6, Lb/c/e;->abc_text_select_handle_right_mtrl_dark:I

    aput v6, v2, v9

    sget v6, Lb/c/e;->abc_text_select_handle_left_mtrl_light:I

    aput v6, v2, v1

    sget v1, Lb/c/e;->abc_text_select_handle_middle_mtrl_light:I

    const/16 v6, 0x8

    aput v1, v2, v6

    sget v1, Lb/c/e;->abc_text_select_handle_right_mtrl_light:I

    const/16 v6, 0x9

    aput v1, v2, v6

    iput-object v2, p0, Landroidx/appcompat/widget/AppCompatDrawableManager$a;->c:[I

    new-array v1, v0, [I

    sget v2, Lb/c/e;->abc_popup_background_mtrl_mult:I

    aput v2, v1, v3

    sget v2, Lb/c/e;->abc_cab_background_internal_bg:I

    aput v2, v1, v4

    sget v2, Lb/c/e;->abc_menu_hardkey_panel_mtrl_mult:I
    ...
    sget v2, Lb/c/e;->abc_tab_indicator_material:I

    aput v2, v1, v3

    sget v2, Lb/c/e;->abc_textfield_search_material:I
    ...
    sget v2, Lb/c/e;->abc_btn_check_material:I

    aput v2, v1, v3

    sget v2, Lb/c/e;->abc_btn_radio_material:I

    aput v2, v1, v4

    sget v2, Lb/c/e;->abc_btn_check_material_anim:I

    aput v2, v1, v5

    sget v2, Lb/c/e;->abc_btn_radio_material_anim:I
...
.method public final b(Landroid/content/Context;)Landroid/content/res/ColorStateList;
    ...
    invoke-virtual {p0, p1, v0}, Landroidx/appcompat/widget/AppCompatDrawableManager$a;->c(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
...
.method public createDrawableFor(Landroidx/appcompat/widget/ResourceManagerInternal;Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    sget v0, Lb/c/e;->abc_cab_background_top_material:I
    ...
    sget v2, Lb/c/e;->abc_cab_background_top_mtrl_alpha:I
...
.method public final e(Landroid/content/Context;)Landroid/content/res/ColorStateList;
    ...
    sget v0, Lb/c/a;->colorButtonNormal:I
...
.method public final f(Landroid/content/Context;)Landroid/content/res/ColorStateList;
    ...
    sget v2, Lb/c/a;->colorSwitchThumbNormal:I
    ...
    sget v5, Lb/c/a;->colorControlActivated:I
    ...
    sget v2, Lb/c/a;->colorControlActivated:I
...
.method public getTintListForDrawableRes(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    sget v0, Lb/c/e;->abc_edit_text_material:I

    if-ne p2, v0, :cond_0

    sget p2, Lb/c/c;->abc_tint_edittext:I
    ...
    :cond_0
    sget v0, Lb/c/e;->abc_switch_track_mtrl_alpha:I

    if-ne p2, v0, :cond_1

    sget p2, Lb/c/c;->abc_tint_switch_track:I
    ...
    :cond_1
    sget v0, Lb/c/e;->abc_switch_thumb_material:I

    if-ne p2, v0, :cond_2

    invoke-virtual {p0, p1}, Landroidx/appcompat/widget/AppCompatDrawableManager$a;->f(Landroid/content/Context;)Landroid/content/res/ColorStateList;
    ...
    :cond_2
    sget v0, Lb/c/e;->abc_btn_default_mtrl_shape:I

    if-ne p2, v0, :cond_3

    invoke-virtual {p0, p1}, Landroidx/appcompat/widget/AppCompatDrawableManager$a;->e(Landroid/content/Context;)Landroid/content/res/ColorStateList;
    ...
    :cond_3
    sget v0, Lb/c/e;->abc_btn_borderless_material:I

    if-ne p2, v0, :cond_4

    invoke-virtual {p0, p1}, Landroidx/appcompat/widget/AppCompatDrawableManager$a;->b(Landroid/content/Context;)Landroid/content/res/ColorStateList;
    ...
    :cond_4
    sget v0, Lb/c/e;->abc_btn_colored_material:I

    if-ne p2, v0, :cond_5

    invoke-virtual {p0, p1}, Landroidx/appcompat/widget/AppCompatDrawableManager$a;->d(Landroid/content/Context;)Landroid/content/res/ColorStateList;
    ...
    :cond_5
    sget v0, Lb/c/e;->abc_spinner_mtrl_am_alpha:I

    if-eq p2, v0, :cond_b

    sget v0, Lb/c/e;->abc_spinner_textfield_background_material:I
    ...
    invoke-virtual {p0, v0, p2}, Landroidx/appcompat/widget/AppCompatDrawableManager$a;->a([II)Z

    move-result v0

    if-eqz v0, :cond_7

    sget p2, Lb/c/a;->colorControlNormal:I
    ...
    sget p2, Lb/c/c;->abc_tint_default:I
    ...
    sget p2, Lb/c/c;->abc_tint_btn_checkable:I
    ...
    :cond_9
    sget v0, Lb/c/e;->abc_seekbar_thumb_material:I

    if-ne p2, v0, :cond_a

    sget p2, Lb/c/c;->abc_tint_seek_thumb:I
    ...
    :cond_b
    :goto_0
    sget p2, Lb/c/c;->abc_tint_spinner:I
...
.method public tintDrawable(Landroid/content/Context;ILandroid/graphics/drawable/Drawable;)Z
    ...
    sget v0, Lb/c/e;->op_seekbar_track_material_dark:I
    ...
    sget v0, Lb/c/a;->colorControlNormal:I
    ...
    invoke-virtual {p0, p2, v0, v4}, Landroidx/appcompat/widget/AppCompatDrawableManager$a;->g(Landroid/graphics/drawable/Drawable;ILandroid/graphics/PorterDuff$Mode;)V
    ...
    invoke-virtual {p0, p2, v0, v3}, Landroidx/appcompat/widget/AppCompatDrawableManager$a;->g(Landroid/graphics/drawable/Drawable;ILandroid/graphics/PorterDuff$Mode;)V

    invoke-virtual {p3, v2}, Landroid/graphics/drawable/LayerDrawable;->findDrawableByLayerId(I)Landroid/graphics/drawable/Drawable;

    move-result-object p2

    sget p3, Lb/c/a;->colorControlActivated:I
    ...
    invoke-virtual {p0, p2, p1, p3}, Landroidx/appcompat/widget/AppCompatDrawableManager$a;->g(Landroid/graphics/drawable/Drawable;ILandroid/graphics/PorterDuff$Mode;)V

    return v1

    :cond_0
    sget v0, Lb/c/e;->abc_ratingbar_material:I

    if-eq p2, v0, :cond_2

    sget v0, Lb/c/e;->abc_ratingbar_indicator_material:I

    if-eq p2, v0, :cond_2

    sget v0, Lb/c/e;->abc_ratingbar_small_material:I
    ...
    sget v0, Lb/c/a;->colorControlActivated:I
...
.method public tintDrawableUsingColorFilter(Landroid/content/Context;ILandroid/graphics/drawable/Drawable;)Z
    ...
    invoke-virtual {p0, v1, p2}, Landroidx/appcompat/widget/AppCompatDrawableManager$a;->a([II)Z
    ...
    sget v2, Lb/c/a;->colorControlNormal:I
    ...
    :cond_2
    sget v1, Lb/c/e;->abc_list_divider_mtrl_alpha:I
    ...
    :cond_3
    sget v1, Lb/c/e;->abc_dialog_material_background:I
