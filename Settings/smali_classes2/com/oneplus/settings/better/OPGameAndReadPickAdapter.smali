...
.method public constructor <init>(Landroid/content/Context;Ljava/util/List;)V
    ...
    iput-object p1, p0, Lcom/oneplus/settings/better/OPGameAndReadPickAdapter;->mInflater:Landroid/view/LayoutInflater;
...
.method public getCount()I
    ...
    iget-object p0, p0, Lcom/oneplus/settings/better/OPGameAndReadPickAdapter;->mAppList:Ljava/util/List;
...
.method public getSelected(I)Z
    ...
    iget-object p0, p0, Lcom/oneplus/settings/better/OPGameAndReadPickAdapter;->mSelectedList:Ljava/util/List;
...
.method public getView(ILandroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    iget-object p3, p0, Lcom/oneplus/settings/better/OPGameAndReadPickAdapter;->mAppList:Ljava/util/List;
    ...
    iget-object p2, p0, Lcom/oneplus/settings/better/OPGameAndReadPickAdapter;->mInflater:Landroid/view/LayoutInflater;

    sget v0, Lcom/android/settings/R$layout;->op_game_read_app_list_item:I
    ...
    iput-object v1, v0, Lcom/oneplus/settings/better/OPGameAndReadPickAdapter$ItemViewHolder;->titleTv:Landroid/widget/TextView;
    ...
    iput-object v1, v0, Lcom/oneplus/settings/better/OPGameAndReadPickAdapter$ItemViewHolder;->appIconIv:Landroid/widget/ImageView;
    ...
    iput-object v1, v0, Lcom/oneplus/settings/better/OPGameAndReadPickAdapter$ItemViewHolder;->appNameTv:Landroid/widget/TextView;
    ...
    iput-object v1, v0, Lcom/oneplus/settings/better/OPGameAndReadPickAdapter$ItemViewHolder;->groupDivider:Landroid/view/View;
    ...
    iput-object v1, v0, Lcom/oneplus/settings/better/OPGameAndReadPickAdapter$ItemViewHolder;->checkBox:Landroid/widget/CheckBox;
    ...
    iget-object v5, v0, Lcom/oneplus/settings/better/OPGameAndReadPickAdapter$ItemViewHolder;->titleTv:Landroid/widget/TextView;

    invoke-virtual {v5, v2}, Landroid/widget/TextView;->setVisibility(I)V

    iget v5, p0, Lcom/oneplus/settings/better/OPGameAndReadPickAdapter;->mAppType:I
    ...
    iget-object v1, v0, Lcom/oneplus/settings/better/OPGameAndReadPickAdapter$ItemViewHolder;->titleTv:Landroid/widget/TextView;

    sget v5, Lcom/android/settings/R$string;->oneplus_recommended_opening:I
    ...
    sget v5, Lcom/android/settings/R$string;->oneplus_other_applications:I
    ...
    sget v5, Lcom/android/settings/R$string;->oneplus_app_list:I
    ...
    :goto_1
    iget-object v1, v0, Lcom/oneplus/settings/better/OPGameAndReadPickAdapter$ItemViewHolder;->appIconIv:Landroid/widget/ImageView;
    ...
    iget-object v1, v0, Lcom/oneplus/settings/better/OPGameAndReadPickAdapter$ItemViewHolder;->appNameTv:Landroid/widget/TextView;
    ...
    iget-object p3, v0, Lcom/oneplus/settings/better/OPGameAndReadPickAdapter$ItemViewHolder;->groupDivider:Landroid/view/View;
    ...
    iget-object p0, v0, Lcom/oneplus/settings/better/OPGameAndReadPickAdapter$ItemViewHolder;->checkBox:Landroid/widget/CheckBox;
...
.method public setData(Ljava/util/List;)V
    ...
    iget-object p1, p0, Lcom/oneplus/settings/better/OPGameAndReadPickAdapter;->mSelectedList:Ljava/util/List;
