...
.method private initializeNetworkReceiver()V
    ...
    iget-object p0, p0, Lcom/google/analytics/tracking/android/GAServiceManager;->ctx:Landroid/content/Context;

    invoke-virtual {v0, p0}, Lcom/google/analytics/tracking/android/GANetworkReceiver;->register(Landroid/content/Context;)V
...
.method getListener()Lcom/google/analytics/tracking/android/AnalyticsStoreStateListener;
    ...
    iget-object p0, p0, Lcom/google/analytics/tracking/android/GAServiceManager;->listener:Lcom/google/analytics/tracking/android/AnalyticsStoreStateListener;
...
.method declared-synchronized onRadioPowered()V
    ...
    :try_start_0
    iget-boolean v1, p0, Lcom/google/analytics/tracking/android/GAServiceManager;->storeIsEmpty:Z

    if-nez v1, :cond_0

    iget-boolean v1, p0, Lcom/google/analytics/tracking/android/GAServiceManager;->connected:Z
    ...
    iget-object v3, p0, Lcom/google/analytics/tracking/android/GAServiceManager;->handler:Landroid/os/Handler;
...
.method public setForceLocalDispatch()V
    ...
    iget-object p0, p0, Lcom/google/analytics/tracking/android/GAServiceManager;->thread:Lcom/google/analytics/tracking/android/AnalyticsThread;

    invoke-interface {p0}, Lcom/google/analytics/tracking/android/AnalyticsThread;->setForceLocalDispatch()V
